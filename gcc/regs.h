...
static inline unsigned int end_hard_regno(enum machine_mode mode,
                                          unsigned int regno) {
...
static inline void add_to_hard_reg_set(HARD_REG_SET *regs,
...
static inline bool in_hard_reg_set_p(const HARD_REG_SET regs,
                                     enum machine_mode mode,
                                     unsigned int regno) {
  unsigned int end_regno;
