...
extern int __evsig(evver_t, const sigset_t *, const ecb_t *, evsiginfo_t *,
                   int);
extern int __evtrap(evver_t, evpollcmds_t, event_t *, int, long int,
...
extern struct nd_hostservlist _netdir_getbyaddr(struct netconfig *,
                                                struct netbuf *);
extern struct nd_addrlist *_netdir_getbyname(struct netconfig *,
                                             struct nd_hostserv *);
...
extern void authdes_getcred(struct authdes_cred *, short *, short *, short *,
                            int *);
...
extern void callrpc(char *, unsigned long, unsigned long, unsigned long,
...
extern enum clnt_stat clnt_broadcast(unsigned long, unsigned long,
                                     unsigned long, xdrproc_t, char *,
                                     xdrproc_t, char *, resultproc_t);
extern enum clnt_stat clnt_call(CLIENT *, unsigned long, xdrproc_t, char *,
...
extern int netdir_getbyaddr(struct netconfig *, struct nd_hostservlist **,
                            struct netbuf *);
extern int netdir_getbyname(struct netconfig *, struct nd_hostserv *,
                            struct nd_addrlist **);
