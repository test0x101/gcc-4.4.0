...
void __register_frame_info_bases(const void *begin, struct object *ob,
...
static int fde_single_encoding_compare(struct object *ob, const fde *x,
                                       const fde *y) {
...
static int fde_mixed_encoding_compare(struct object *ob, const fde *x,
                                      const fde *y) {
...
static inline void fde_insert(struct fde_accumulator *accu,
                              const fde *this_fde) {
  if (accu->linear)
...
static inline void fde_split(struct object *ob, fde_compare_t fde_compare,
                             struct fde_vector *linear,
                             struct fde_vector *erratic) {
...
static void frame_downheap(struct object *ob, fde_compare_t fde_compare,
                           const fde **a, int lo, int hi) {
  int i, j;
...
static inline void fde_merge(struct object *ob, fde_compare_t fde_compare,
...
static inline void end_fde_sort(struct object *ob, struct fde_accumulator *accu,
                                size_t count) {
...
static void add_fdes(struct object *ob, struct fde_accumulator *accu,
                     const fde *this_fde) {
  const struct dwarf_cie *last_cie = 0;
...
static const fde *linear_search_fdes(struct object *ob, const fde *this_fde,
                                     void *pc) {
  const struct dwarf_cie *last_cie = 0;
  int encoding = ob->s.b.encoding;
  _Unwind_Ptr base = base_from_object(ob->s.b.encoding, ob);
...
static inline const fde *binary_search_unencoded_fdes(struct object *ob,
                                                      void *pc) {
...
static inline const fde *binary_search_single_encoding_fdes(struct object *ob,
                                                            void *pc) {
  struct fde_vector *vec = ob->u.sort;
  int encoding = ob->s.b.encoding;
...
static inline const fde *binary_search_mixed_encoding_fdes(struct object *ob,
                                                           void *pc) {
  struct fde_vector *vec = ob->u.sort;
  size_t lo, hi;
  ...
  for (lo = 0, hi = vec->count; lo < hi;) {
    ...
    p = read_encoded_value_with_base(encoding, base_from_object(encoding, ob),
                                     f->pc_begin, &pc_begin);
    read_encoded_value_with_base(encoding & 0x0F, 0, p, &pc_range);
