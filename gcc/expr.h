...
extern rtx expand_simple_binop(enum machine_mode, enum rtx_code, rtx, rtx, rtx,
...
rtx emit_conditional_move(rtx, enum rtx_code, rtx, rtx, enum machine_mode, rtx,
...
#endif
rtx emit_conditional_add(rtx, enum rtx_code, rtx, rtx, enum machine_mode, rtx,
                         rtx, enum machine_mode, int);
...
extern rtx emit_store_flag(rtx, enum rtx_code, rtx, rtx, enum machine_mode, int,
                           int);
...
extern void emit_push_insn(rtx, enum machine_mode, tree, rtx, unsigned int, int,
...
extern rtx expand_expr_real(tree, rtx, enum machine_mode, enum expand_modifier,
                            rtx *);

/* Generate code for computing expression EXP.
   An rtx for the computed value is returned.  The value is never null.
   In the case of a void EXP, const0_rtx is returned.  */
static inline rtx expand_expr(tree exp, rtx target, enum machine_mode mode,
...
extern rtx expand_divmod(int, enum tree_code, enum machine_mode, rtx, rtx, rtx,
                         int);
#endif
...
extern void store_bit_field(rtx, unsigned HOST_WIDE_INT, unsigned HOST_WIDE_INT,
...
extern rtx expand_mult_highpart_adjust(enum machine_mode, rtx, rtx, rtx, rtx,
                                       int);
