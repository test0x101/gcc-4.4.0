...
extern void sched_scan(const struct sched_scan_info_def *, bb_vec_t,
                       basic_block, insn_vec_t, rtx);
...
#define HDID(INSN) \
  (VEC_index(haifa_deps_insn_data_def, h_d_i_d, INSN_LUID(INSN)))
...
#define CANT_MOVE_BY_LUID(LUID) \
  (VEC_index(haifa_deps_insn_data_def, h_d_i_d, LUID)->cant_move)
