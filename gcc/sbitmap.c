...
void sbitmap_verify_popcount(const_sbitmap a) {
  unsigned ix;
...
sbitmap sbitmap_alloc_with_popcount(unsigned int n_elms) {
...
sbitmap sbitmap_resize(sbitmap bmap, unsigned int n_elms, int def) {
  ...
  if (n_elms > bmap->n_bits) {
    if (def) {
      memset(bmap->elms + bmap->size, -1, bytes - SBITMAP_SIZE_BYTES(bmap));
...
sbitmap *sbitmap_vector_alloc(unsigned int n_vecs, unsigned int n_elms) {
  ...
  bytes = size * sizeof(SBITMAP_ELT_TYPE);
  elm_bytes =
      (sizeof(struct simple_bitmap_def) + bytes - sizeof(SBITMAP_ELT_TYPE));
...
void sbitmap_copy(sbitmap dst, const_sbitmap src) {
...
void sbitmap_copy_n(sbitmap dst, const_sbitmap src, unsigned int n) {
...
/* Determine if a == b.  */
int sbitmap_equal(const_sbitmap a, const_sbitmap b) {
  return !memcmp(a->elms, b->elms, sizeof(SBITMAP_ELT_TYPE) * a->size);
}

/* Return true if the bitmap is empty.  */

bool sbitmap_empty_p(const_sbitmap bmap) {
  unsigned int i;
...
bool sbitmap_range_empty_p(const_sbitmap bmap, unsigned int start,
                           unsigned int n) {
...
void sbitmap_ones(sbitmap bmap) {
  ...
  if (last_bit) {
    bmap->elms[bmap->size - 1] =
        (SBITMAP_ELT_TYPE)-1 >> (SBITMAP_ELT_BITS - last_bit);
    if (bmap->popcount)
      bmap->popcount[bmap->size - 1] = do_popcount(bmap->elms[bmap->size - 1]);
  }
}
...
bool sbitmap_union_of_diff_cg(sbitmap dst, const_sbitmap a, const_sbitmap b,
                              const_sbitmap c) {
...
void sbitmap_union_of_diff(sbitmap dst, const_sbitmap a, const_sbitmap b,
                           const_sbitmap c) {
  unsigned int i, n = dst->size;
  sbitmap_ptr dstp = dst->elms;
  const_sbitmap_ptr ap = a->elms;
  ...
  gcc_assert(!dst->popcount && !a->popcount && !b->popcount && !c->popcount);
...
void sbitmap_not(sbitmap dst, const_sbitmap src) {
  unsigned int i, n = dst->size;
  sbitmap_ptr dstp = dst->elms;
...
void sbitmap_difference(sbitmap dst, const_sbitmap a, const_sbitmap b) {
...
bool sbitmap_any_common_bits(const_sbitmap a, const_sbitmap b) {
  const_sbitmap_ptr ap = a->elms;
  const_sbitmap_ptr bp = b->elms;
  unsigned int i, n;
...
bool sbitmap_a_and_b_cg(sbitmap dst, const_sbitmap a, const_sbitmap b) {
  unsigned int i, n = dst->size;
  sbitmap_ptr dstp = dst->elms;
  const_sbitmap_ptr ap = a->elms;
  const_sbitmap_ptr bp = b->elms;
...
void sbitmap_a_and_b(sbitmap dst, const_sbitmap a, const_sbitmap b) {
  unsigned int i, n = dst->size;
  sbitmap_ptr dstp = dst->elms;
  const_sbitmap_ptr ap = a->elms;
  const_sbitmap_ptr bp = b->elms;
...
bool sbitmap_a_xor_b_cg(sbitmap dst, const_sbitmap a, const_sbitmap b) {
  unsigned int i, n = dst->size;
  sbitmap_ptr dstp = dst->elms;
  const_sbitmap_ptr ap = a->elms;
  const_sbitmap_ptr bp = b->elms;
...
void sbitmap_a_xor_b(sbitmap dst, const_sbitmap a, const_sbitmap b) {
  unsigned int i, n = dst->size;
  sbitmap_ptr dstp = dst->elms;
  const_sbitmap_ptr ap = a->elms;
  const_sbitmap_ptr bp = b->elms;
...
bool sbitmap_a_or_b_cg(sbitmap dst, const_sbitmap a, const_sbitmap b) {
  unsigned int i, n = dst->size;
  sbitmap_ptr dstp = dst->elms;
  const_sbitmap_ptr ap = a->elms;
  const_sbitmap_ptr bp = b->elms;
...
void sbitmap_a_or_b(sbitmap dst, const_sbitmap a, const_sbitmap b) {
  unsigned int i, n = dst->size;
  sbitmap_ptr dstp = dst->elms;
  const_sbitmap_ptr ap = a->elms;
  const_sbitmap_ptr bp = b->elms;
...
bool sbitmap_a_subset_b_p(const_sbitmap a, const_sbitmap b) {
...
bool sbitmap_a_or_b_and_c_cg(sbitmap dst, const_sbitmap a, const_sbitmap b,
                             const_sbitmap c) {
  unsigned int i, n = dst->size;
  sbitmap_ptr dstp = dst->elms;
  const_sbitmap_ptr ap = a->elms;
...
void sbitmap_a_or_b_and_c(sbitmap dst, const_sbitmap a, const_sbitmap b,
                          const_sbitmap c) {
  unsigned int i, n = dst->size;
  sbitmap_ptr dstp = dst->elms;
  const_sbitmap_ptr ap = a->elms;
...
bool sbitmap_a_and_b_or_c_cg(sbitmap dst, const_sbitmap a, const_sbitmap b,
                             const_sbitmap c) {
  unsigned int i, n = dst->size;
  sbitmap_ptr dstp = dst->elms;
  const_sbitmap_ptr ap = a->elms;
...
void sbitmap_a_and_b_or_c(sbitmap dst, const_sbitmap a, const_sbitmap b,
                          const_sbitmap c) {
  unsigned int i, n = dst->size;
  sbitmap_ptr dstp = dst->elms;
  const_sbitmap_ptr ap = a->elms;
...
void sbitmap_intersection_of_succs(sbitmap dst, sbitmap *src, int bb) {
...
void sbitmap_intersection_of_preds(sbitmap dst, sbitmap *src, int bb) {
  basic_block b = BASIC_BLOCK(bb);
  unsigned int set_size = dst->size;
  edge e;
  unsigned ix;
...
void sbitmap_union_of_succs(sbitmap dst, sbitmap *src, int bb) {
  basic_block b = BASIC_BLOCK(bb);
  unsigned int set_size = dst->size;
  edge e;
  unsigned ix;
...
void sbitmap_union_of_preds(sbitmap dst, sbitmap *src, int bb) {
  basic_block b = BASIC_BLOCK(bb);
  unsigned int set_size = dst->size;
  edge e;
  unsigned ix;
...
int sbitmap_first_set_bit(const_sbitmap bmap) {
  unsigned int n = 0;
...
int sbitmap_last_set_bit(const_sbitmap bmap) {
  int i;
...
void dump_sbitmap(FILE *file, const_sbitmap bmap) {
  unsigned int i, n, j;
  ...
  for (i = n = 0; i < set_size && n < total_bits; i++)
    for (j = 0; j < SBITMAP_ELT_BITS && n < total_bits; j++, n++) {
      ...
      fprintf(file, "%d", (bmap->elms[i] & ((SBITMAP_ELT_TYPE)1 << j)) != 0);
    }

  fprintf(file, "\n");
}

void dump_sbitmap_file(FILE *file, const_sbitmap bmap) {
  unsigned int i, pos;
...
void dump_sbitmap_vector(FILE *file, const char *title, const char *subtitle,
...
static unsigned long sbitmap_elt_popcount(SBITMAP_ELT_TYPE a) {
  unsigned long ret = 0;
  unsigned i;
...
unsigned long sbitmap_popcount(const_sbitmap a, unsigned long maxbit) {
