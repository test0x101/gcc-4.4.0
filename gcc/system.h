...
#pragma GCC poison ASM_OPEN_PAREN ASM_CLOSE_PAREN FUNCTION_PROLOGUE            \
    FUNCTION_EPILOGUE FUNCTION_END_PROLOGUE FUNCTION_BEGIN_EPILOGUE            \
    ...
    ASM_OUTPUT_DESTRUCTOR SIGNED_CHAR_SPEC MAX_CHAR_TYPE_SIZE WCHAR_UNSIGNED   \
    UNIQUE_SECTION SELECT_SECTION SELECT_RTX_SECTION ENCODE_SECTION_INFO       \
    STRIP_NAME_ENCODING ASM_GLOBALIZE_LABEL ASM_OUTPUT_MI_THUNK CONST_COSTS    \
    RTX_COSTS DEFAULT_RTX_COSTS ADDRESS_COST MACHINE_DEPENDENT_REORG           \
    ASM_FILE_START ASM_FILE_END ASM_SIMPLIFY_DWARF_ADDR INIT_TARGET_OPTABS     \
    INIT_SUBTARGET_OPTABS INIT_GOFAST_OPTABS MULSI3_LIBCALL MULDI3_LIBCALL     \
    DIVSI3_LIBCALL DIVDI3_LIBCALL UDIVSI3_LIBCALL UDIVDI3_LIBCALL              \
    MODSI3_LIBCALL MODDI3_LIBCALL UMODSI3_LIBCALL UMODDI3_LIBCALL              \
    BUILD_VA_LIST_TYPE PRETEND_OUTGOING_VARARGS_NAMED                          \
    STRUCT_VALUE_INCOMING_REGNUM ASM_OUTPUT_SECTION_NAME PROMOTE_FUNCTION_ARGS \
    STRUCT_VALUE_INCOMING STRICT_ARGUMENT_NAMING PROMOTE_FUNCTION_RETURN       \
    PROMOTE_PROTOTYPES STRUCT_VALUE_REGNUM SETUP_INCOMING_VARARGS              \
    EXPAND_BUILTIN_SAVEREGS DEFAULT_SHORT_ENUMS SPLIT_COMPLEX_ARGS             \
    MD_ASM_CLOBBERS HANDLE_PRAGMA_REDEFINE_EXTNAME HANDLE_PRAGMA_EXTERN_PREFIX \
    MUST_PASS_IN_STACK FUNCTION_ARG_PASS_BY_REFERENCE VECTOR_MODE_SUPPORTED_P  \
    TARGET_SUPPORTS_HIDDEN FUNCTION_ARG_PARTIAL_NREGS ASM_OUTPUT_DWARF_DTPREL  \
...
#pragma GCC poison INT_ASM_OP ASM_OUTPUT_EH_REGION_BEG CPP_PREDEFINES          \
    ...
    OMIT_EH_TABLE EASY_DIV_EXPR IMPLICIT_FIX_EXPR LONGJMP_RESTORE_FROM_STACK   \
    MAX_INT_TYPE_SIZE ASM_IDENTIFY_GCC STDC_VALUE TRAMPOLINE_ALIGN             \
    ASM_IDENTIFY_GCC_AFTER_SOURCE SLOW_ZERO_EXTEND SUBREG_REGNO_OFFSET         \
    DWARF_LINE_MIN_INSTR_LENGTH TRADITIONAL_RETURN_FLOAT NO_BUILTIN_SIZE_TYPE  \
    NO_BUILTIN_PTRDIFF_TYPE NO_BUILTIN_WCHAR_TYPE NO_BUILTIN_WINT_TYPE         \
    BLOCK_PROFILER BLOCK_PROFILER_CODE FUNCTION_BLOCK_PROFILER                 \
    FUNCTION_BLOCK_PROFILER_EXIT MACHINE_STATE_SAVE MACHINE_STATE_RESTORE      \
    SCCS_DIRECTIVE SECTION_ASM_OP BYTEORDER                                    \
    ...
    INSN_CACHE_LINE_WIDTH INIT_SECTION_PREAMBLE NEED_ATEXIT ON_EXIT EXIT_BODY  \
    OBJECT_FORMAT_ROSE MULTIBYTE_CHARS MAP_CHARACTER LIBGCC_NEEDS_DOUBLE       \
    FINAL_PRESCAN_LABEL DEFAULT_CALLER_SAVES LOAD_ARGS_REVERSED                \
    MAX_INTEGER_COMPUTATION_MODE CONVERT_HARD_REGISTER_TO_SSA_P                \
    ASM_OUTPUT_MAIN_SOURCE_FILENAME FIRST_INSN_ADDRESS TEXT_SECTION            \
    SHARED_BSS_SECTION_ASM_OP PROMOTED_MODE EXPAND_BUILTIN_VA_END              \
    ...
    SUNOS4_SHARED_LIBRARIES PROMOTE_FOR_CALL_ONLY SPACE_AFTER_L_OPTION         \
    NO_RECURSIVE_FUNCTION_CSE DEFAULT_MAIN_RETURN TARGET_MEM_FUNCTIONS         \
    EXPAND_BUILTIN_VA_ARG COLLECT_PARSE_FLAG                                   \
    DWARF2_GENERATE_TEXT_SECTION_LABEL WINNING_GDB ASM_OUTPUT_FILENAME         \
    ASM_OUTPUT_SOURCE_LINE FILE_NAME_JOINER GDB_INV_REF_REGPARM_STABS_LETTER   \
    DBX_MEMPARM_STABS_LETTER PUT_SDB_SRC_FILE STABS_GCC_MARKER                 \
    DBX_OUTPUT_FUNCTION_END DBX_OUTPUT_GCC_MARKER DBX_FINISH_SYMBOL            \
    SDB_GENERATE_FAKE NON_SAVING_SETJMP TARGET_LATE_RTL_PROLOGUE_EPILOGUE      \
    CASE_DROPS_THROUGH TARGET_BELL TARGET_BS TARGET_CR TARGET_DIGIT0           \
    TARGET_ESC TARGET_FF TARGET_NEWLINE TARGET_TAB TARGET_VT                   \
    LINK_LIBGCC_SPECIAL DONT_ACCESS_GBLS_AFTER_EPILOGUE TARGET_OPTIONS         \
    TARGET_SWITCHES EXTRA_CC_MODES FINALIZE_PIC PREDICATE_CODES                \
    SPECIAL_MODE_PREDICATES HOST_PTR_PRINTF EXTRA_SECTIONS                     \
    EXTRA_SECTION_FUNCTIONS READONLY_DATA_SECTION TARGET_ASM_EXCEPTION_SECTION \
    TARGET_ASM_EH_FRAME_SECTION SMALL_ARG_MAX ASM_OUTPUT_SHARED_BSS            \
    ASM_OUTPUT_SHARED_COMMON ASM_OUTPUT_SHARED_LOCAL UNALIGNED_WORD_ASM_OP     \
...
#pragma GCC poison LANG_HOOKS_FUNCTION_MARK LANG_HOOKS_FUNCTION_FREE \
    ...
    LANG_HOOKS_SET_BLOCK LANG_HOOKS_MAYBE_BUILD_CLEANUP              \
