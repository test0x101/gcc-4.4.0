...
extern bool bitmap_ior_and_compl_into(bitmap DST, const_bitmap B,
                                      const_bitmap C);
...
static inline void bitmap_initialize_stat(
    bitmap head, bitmap_obstack *obstack MEM_STAT_DECL) {
