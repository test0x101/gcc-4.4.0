...
struct cgraph_edge *cgraph_create_edge(struct cgraph_node *,
                                       struct cgraph_node *, gimple, gcov_type,
                                       int, int);
...
struct cgraph_edge *cgraph_clone_edge(struct cgraph_edge *,
                                      struct cgraph_node *, gimple, gcov_type,
                                      int, int, bool);
struct cgraph_node *cgraph_clone_node(struct cgraph_node *, gcov_type, int, int,
                                      bool);
...
static inline struct varpool_node *varpool_first_static_initializer(void) {
...
static inline struct varpool_node *varpool_next_static_initializer(
    struct varpool_node *node) {
