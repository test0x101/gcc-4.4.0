...
lambda_trans_matrix lambda_trans_matrix_new(int colsize, int rowsize) {
...
bool lambda_trans_matrix_id_p(lambda_trans_matrix mat) {
...
lambda_trans_matrix lambda_trans_matrix_inverse(lambda_trans_matrix mat) {
...
void print_lambda_trans_matrix(FILE *outfile, lambda_trans_matrix mat) {
