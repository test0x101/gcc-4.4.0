...
#define CRT_CALL_STATIC_FUNCTION(SECTION_OP, FUNC)          \
  static void __attribute__((__used__)) call_##FUNC(void) { \
    asm(SECTION_OP);                                        \
    FUNC();                                                 \
...
#if defined(OBJECT_FORMAT_ELF) && !defined(OBJECT_FORMAT_FLAT) && \
    defined(HAVE_LD_EH_FRAME_HDR) && !defined(inhibit_libc) &&    \
    !defined(CRTSTUFFT_O) && defined(__GLIBC__) && __GLIBC__ >= 2
#include <link.h>
...
extern void __register_frame_info(const void *,
                                  struct object *) TARGET_ATTRIBUTE_WEAK;
extern void __register_frame_info_bases(const void *, struct object *, void *,
                                        void *) TARGET_ATTRIBUTE_WEAK;
extern void *__deregister_frame_info(const void *) TARGET_ATTRIBUTE_WEAK;
extern void *__deregister_frame_info_bases(const void *) TARGET_ATTRIBUTE_WEAK;
...
STATIC func_ptr __CTOR_LIST__[1]
    __attribute__((__unused__, aligned(sizeof(func_ptr)))) = {(func_ptr)(-1)};
#else
STATIC func_ptr __CTOR_LIST__[1]
    __attribute__((__unused__, section(".ctors"),
                   aligned(sizeof(func_ptr)))) = {(func_ptr)(-1)};
...
STATIC func_ptr __DTOR_LIST__[1]
    __attribute__((aligned(sizeof(func_ptr)))) = {(func_ptr)(-1)};
#else
STATIC func_ptr __DTOR_LIST__[1] __attribute__((
    section(".dtors"), aligned(sizeof(func_ptr)))) = {(func_ptr)(-1)};
...
static func_ptr __do_global_dtors_aux_fini_array_entry[] __attribute__((
    __unused__, section(".fini_array"))) = {__do_global_dtors_aux};
...
static func_ptr __frame_dummy_init_array_entry[]
    __attribute__((__unused__, section(".init_array"))) = {frame_dummy};
...
STATIC func_ptr __CTOR_END__[1]
    __attribute__((aligned(sizeof(func_ptr)))) = {(func_ptr)0};
#else
STATIC func_ptr __CTOR_END__[1] __attribute__((
    section(".ctors"), aligned(sizeof(func_ptr)))) = {(func_ptr)0};
#endif
...
asm(DTORS_SECTION_ASM_OP);
#endif
func_ptr __DTOR_END__[1] __attribute__((unused,
#ifndef DTORS_SECTION_ASM_OP
                                        section(".dtors"),
#endif
                                        aligned(sizeof(func_ptr)),
                                        visibility("hidden"))) = {(func_ptr)0};
#elif defined(DTORS_SECTION_ASM_OP)
asm(DTORS_SECTION_ASM_OP);
STATIC func_ptr __DTOR_END__[1]
    __attribute__((unused, aligned(sizeof(func_ptr)))) = {(func_ptr)0};
#else
STATIC func_ptr __DTOR_END__[1] __attribute__((
    unused, section(".dtors"), aligned(sizeof(func_ptr)))) = {(func_ptr)0};
#endif
...
#endif
STATIC EH_FRAME_SECTION_CONST int32 __FRAME_END__[] __attribute__((
    unused, section(EH_FRAME_SECTION_NAME), aligned(sizeof(int32)))) = {0};
#endif /* EH_FRAME_SECTION_NAME */

#ifdef JCR_SECTION_NAME
/* Null terminate the .jcr section array.  */
STATIC void *__JCR_END__[1] __attribute__((unused, section(JCR_SECTION_NAME),
                                           aligned(sizeof(void *)))) = {0};
#endif /* JCR_SECTION_NAME */
...
static void __do_global_ctors_aux(void) /* prologue goes in .text section */
{
