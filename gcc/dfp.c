...
static void decimal_from_decnumber(REAL_VALUE_TYPE *r, decNumber *dn,
                                   decContext *context) {
...
void encode_decimal32(const struct real_format *fmt ATTRIBUTE_UNUSED, long *buf,
...
void encode_decimal64(const struct real_format *fmt ATTRIBUTE_UNUSED, long *buf,
                      const REAL_VALUE_TYPE *r) {
  decNumber dn;
  decimal64 d64;
  decContext set;
...
static void decimal_to_binary(REAL_VALUE_TYPE *to, const REAL_VALUE_TYPE *from,
...
int decimal_do_compare(const REAL_VALUE_TYPE *a, const REAL_VALUE_TYPE *b,
                       int nan_result) {
  decContext set;
...
void decimal_real_convert(REAL_VALUE_TYPE *r, enum machine_mode mode,
...
void decimal_real_to_decimal(char *str, const REAL_VALUE_TYPE *r_orig,
                             size_t buf_size, size_t digits ATTRIBUTE_UNUSED,
...
static bool decimal_do_add(REAL_VALUE_TYPE *r, const REAL_VALUE_TYPE *op0,
...
static bool decimal_do_multiply(REAL_VALUE_TYPE *r, const REAL_VALUE_TYPE *op0,
...
static bool decimal_do_divide(REAL_VALUE_TYPE *r, const REAL_VALUE_TYPE *op0,
                              const REAL_VALUE_TYPE *op1) {
  decContext set;
  decNumber dn, dn2, dn3;
...
void decimal_real_to_integer2(HOST_WIDE_INT *plow, HOST_WIDE_INT *phigh,
                              const REAL_VALUE_TYPE *r) {
  decContext set;
  decNumber dn, dn2, dn3;
  REAL_VALUE_TYPE to;
...
bool decimal_real_arithmetic(REAL_VALUE_TYPE *r, enum tree_code code,
