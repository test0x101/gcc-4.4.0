...
extern type_p new_structure(const char *name, int isunion, struct fileloc *pos,
...
extern options_p create_nested_ptr_option(options_p, type_p t, const char *from,
                                          const char *to);
