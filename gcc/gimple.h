...
extern void gimple_check_failed(const_gimple, const char *, int, const char *,
                                enum gimple_code,
...
#define GIMPLE_CHECK(GS, CODE)                                                \
  do {                                                                        \
    ...
    if (gimple_code(__gs) != (CODE))                                          \
      gimple_check_failed(__gs, __FILE__, __LINE__, __FUNCTION__, (CODE), 0); \
  } while (0)
...
static inline gimple_seq_node gimple_seq_first(const_gimple_seq s) {
  return s ? s->first : NULL;
}

/* Return the first statement in GIMPLE sequence S.  */

static inline gimple gimple_seq_first_stmt(const_gimple_seq s) {
...
static inline gimple_seq_node gimple_seq_last(const_gimple_seq s) {
  return s ? s->last : NULL;
}

/* Return the last statement in GIMPLE sequence S.  */

static inline gimple gimple_seq_last_stmt(const_gimple_seq s) {
...
static inline void gimple_seq_set_last(gimple_seq s, gimple_seq_node last) {
  s->last = last;
}

/* Set the first node in GIMPLE sequence S to FIRST.  */

static inline void gimple_seq_set_first(gimple_seq s, gimple_seq_node first) {
  s->first = first;
}

/* Return true if GIMPLE sequence S is empty.  */

static inline bool gimple_seq_empty_p(const_gimple_seq s) {
...
union gimple_statement_d GTY((desc("gimple_statement_structure (&%h)"))) {
  ...
  struct gimple_statement_omp_continue GTY((tag("GSS_OMP_CONTINUE")))
      gimple_omp_continue;
  struct gimple_statement_omp_atomic_load GTY((tag("GSS_OMP_ATOMIC_LOAD")))
      gimple_omp_atomic_load;
  struct gimple_statement_omp_atomic_store GTY((tag("GSS_OMP_ATOMIC_STORE")))
      gimple_omp_atomic_store;
};
...
static inline struct basic_block_def *gimple_bb(const_gimple g) {
  return g->gsbase.bb;
}

/* Return the lexical scope block holding statement G.  */

static inline tree gimple_block(const_gimple g) {
...
static inline location_t gimple_location(const_gimple g) {
  return g->gsbase.location;
}

/* Return pointer to location information for statement G.  */

static inline const location_t *gimple_location_ptr(const_gimple g) {
  return &g->gsbase.location;
}
...
static inline bool gimple_has_location(const_gimple g) {
  return gimple_location(g) != UNKNOWN_LOCATION;
}

/* Return the file name of the location of STMT.  */

static inline const char *gimple_filename(const_gimple stmt) {
  return LOCATION_FILE(gimple_location(stmt));
}

/* Return the line number of the location of STMT.  */

static inline int gimple_lineno(const_gimple stmt) {
...
static inline bool gimple_no_warning_p(const_gimple stmt) {
...
static inline bool gimple_has_mem_ops(const_gimple g) {
  return gimple_code(g) >= GIMPLE_ASSIGN && gimple_code(g) <= GIMPLE_RETURN;
}

/* Return the set of addresses taken by statement G.  */

static inline bitmap gimple_addresses_taken(const_gimple g) {
  if (gimple_has_ops(g))
...
static inline bitmap *gimple_addresses_taken_ptr(gimple g) {
  if (gimple_has_ops(g))
    return &g->gsops.opbase.addresses_taken;
  else
    return NULL;
...
static inline void gimple_set_addresses_taken(gimple g, bitmap b) {
...
static inline void gimple_set_def_ops(gimple g, struct def_optype_d *def) {
  gcc_assert(gimple_has_ops(g));
...
static inline struct use_optype_d *gimple_use_ops(const_gimple g) {
  if (!gimple_has_ops(g))
    return NULL;
...
static inline struct voptype_d *gimple_vuse_ops(const_gimple g) {
...
static inline void gimple_set_vuse_ops(gimple g, struct voptype_d *ops) {
...
static inline struct voptype_d *gimple_vdef_ops(const_gimple g) {
  if (!gimple_has_mem_ops(g))
    return NULL;
...
static inline void gimple_set_vdef_ops(gimple g, struct voptype_d *ops) {
  gcc_assert(gimple_has_mem_ops(g));
...
static inline bitmap gimple_loaded_syms(const_gimple g) {
  if (!gimple_has_mem_ops(g))
    return NULL;
...
static inline bitmap gimple_stored_syms(const_gimple g) {
  if (!gimple_has_mem_ops(g))
    return NULL;
...
static inline bool gimple_modified_p(const_gimple g) {
...
static inline tree gimple_expr_type(const_gimple stmt) {
...
static inline enum tree_code gimple_expr_code(const_gimple stmt) {
  enum gimple_code code = gimple_code(stmt);
...
static inline bool gimple_has_volatile_ops(const_gimple stmt) {
...
static inline void gimple_set_references_memory(gimple stmt, bool mem_p) {
  if (gimple_has_mem_ops(stmt))
...
static inline unsigned gimple_omp_subcode(const_gimple s) {
...
static inline bool gimple_omp_return_nowait_p(const_gimple g) {
...
static inline bool gimple_omp_section_last_p(const_gimple g) {
...
static inline bool gimple_omp_parallel_combined_p(const_gimple g) {
...
static inline unsigned gimple_num_ops(const_gimple gs) {
...
static inline tree *gimple_op_ptr(const_gimple gs, unsigned i) {
  if (gimple_has_ops(gs)) {
    gcc_assert(i < gimple_num_ops(gs));
    return gimple_ops(CONST_CAST_GIMPLE(gs)) + i;
  } else
...
static inline bool is_gimple_assign(const_gimple gs) {
...
static inline tree gimple_assign_lhs(const_gimple gs) {
...
static inline tree *gimple_assign_lhs_ptr(const_gimple gs) {
  GIMPLE_CHECK(gs, GIMPLE_ASSIGN);
...
static inline tree gimple_assign_rhs1(const_gimple gs) {
  GIMPLE_CHECK(gs, GIMPLE_ASSIGN);
...
static inline tree *gimple_assign_rhs1_ptr(const_gimple gs) {
  GIMPLE_CHECK(gs, GIMPLE_ASSIGN);
...
static inline tree gimple_assign_rhs2(const_gimple gs) {
  GIMPLE_CHECK(gs, GIMPLE_ASSIGN);
...
static inline tree *gimple_assign_rhs2_ptr(const_gimple gs) {
  GIMPLE_CHECK(gs, GIMPLE_ASSIGN);
...
static inline bool gimple_assign_nontemporal_move_p(const_gimple gs) {
  GIMPLE_CHECK(gs, GIMPLE_ASSIGN);
...
static inline enum tree_code gimple_assign_rhs_code(const_gimple gs) {
  enum tree_code code;
  GIMPLE_CHECK(gs, GIMPLE_ASSIGN);
...
static inline enum gimple_rhs_class gimple_assign_rhs_class(const_gimple gs) {
  return get_gimple_rhs_class(gimple_assign_rhs_code(gs));
}

/* Return true if S is a type-cast assignment.  */

static inline bool gimple_assign_cast_p(gimple s) {
...
static inline bool is_gimple_call(const_gimple gs) {
...
static inline tree *gimple_call_lhs_ptr(const_gimple gs) {
  GIMPLE_CHECK(gs, GIMPLE_CALL);
  return gimple_op_ptr(gs, 0);
}
...
static inline tree gimple_call_fn(const_gimple gs) {
  GIMPLE_CHECK(gs, GIMPLE_CALL);
  return gimple_op(gs, 1);
}
...
static inline tree *gimple_call_fn_ptr(const_gimple gs) {
  GIMPLE_CHECK(gs, GIMPLE_CALL);
  return gimple_op_ptr(gs, 1);
}
...
static inline void gimple_call_set_fn(gimple gs, tree fn) {
  GIMPLE_CHECK(gs, GIMPLE_CALL);
...
static inline tree gimple_call_return_type(const_gimple gs) {
...
static inline tree gimple_call_chain(const_gimple gs) {
  GIMPLE_CHECK(gs, GIMPLE_CALL);
  return gimple_op(gs, 2);
}
...
static inline tree *gimple_call_chain_ptr(const_gimple gs) {
  GIMPLE_CHECK(gs, GIMPLE_CALL);
  return gimple_op_ptr(gs, 2);
}
...
static inline void gimple_call_set_chain(gimple gs, tree chain) {
  GIMPLE_CHECK(gs, GIMPLE_CALL);
  gcc_assert(chain == NULL || TREE_CODE(chain) == ADDR_EXPR ||
             SSA_VAR_P(chain));
...
static inline unsigned gimple_call_num_args(const_gimple gs) {
  unsigned num_ops;
  GIMPLE_CHECK(gs, GIMPLE_CALL);
...
static inline tree gimple_call_arg(const_gimple gs, unsigned index) {
  GIMPLE_CHECK(gs, GIMPLE_CALL);
...
static inline tree *gimple_call_arg_ptr(const_gimple gs, unsigned index) {
  GIMPLE_CHECK(gs, GIMPLE_CALL);
...
static inline void gimple_call_set_tail(gimple s, bool tail_p) {
...
static inline bool gimple_call_tail_p(gimple s) {
  GIMPLE_CHECK(s, GIMPLE_CALL);
...
static inline void gimple_call_set_cannot_inline(gimple s, bool inlinable_p) {
  GIMPLE_CHECK(s, GIMPLE_CALL);
  if (inlinable_p)
...
static inline bool gimple_call_cannot_inline_p(gimple s) {
  GIMPLE_CHECK(s, GIMPLE_CALL);
...
static inline void gimple_call_set_return_slot_opt(gimple s,
...
static inline bool gimple_call_return_slot_opt_p(gimple s) {
  GIMPLE_CHECK(s, GIMPLE_CALL);
...
static inline void gimple_call_set_from_thunk(gimple s, bool from_thunk_p) {
  GIMPLE_CHECK(s, GIMPLE_CALL);
  if (from_thunk_p)
...
static inline bool gimple_call_from_thunk_p(gimple s) {
  GIMPLE_CHECK(s, GIMPLE_CALL);
...
static inline void gimple_call_set_va_arg_pack(gimple s, bool pass_arg_pack_p) {
  GIMPLE_CHECK(s, GIMPLE_CALL);
  if (pass_arg_pack_p)
...
static inline bool gimple_call_va_arg_pack_p(gimple s) {
  GIMPLE_CHECK(s, GIMPLE_CALL);
...
static inline bool gimple_call_noreturn_p(gimple s) {
  GIMPLE_CHECK(s, GIMPLE_CALL);
...
static inline bool gimple_call_nothrow_p(gimple s) {
  GIMPLE_CHECK(s, GIMPLE_CALL);
...
static inline void gimple_call_copy_flags(gimple dest_call, gimple orig_call) {
...
static inline bool gimple_has_lhs(gimple stmt) {
  return (is_gimple_assign(stmt) ||
          (is_gimple_call(stmt) && gimple_call_lhs(stmt) != NULL_TREE));
}

/* Return the code of the predicate computed by conditional statement GS.  */

static inline enum tree_code gimple_cond_code(const_gimple gs) {
...
static inline void gimple_cond_set_code(gimple gs, enum tree_code code) {
  GIMPLE_CHECK(gs, GIMPLE_COND);
...
static inline tree gimple_cond_lhs(const_gimple gs) {
  GIMPLE_CHECK(gs, GIMPLE_COND);
  return gimple_op(gs, 0);
}
...
static inline tree *gimple_cond_lhs_ptr(const_gimple gs) {
  GIMPLE_CHECK(gs, GIMPLE_COND);
  return gimple_op_ptr(gs, 0);
}
...
static inline void gimple_cond_set_lhs(gimple gs, tree lhs) {
  GIMPLE_CHECK(gs, GIMPLE_COND);
  gcc_assert(is_gimple_operand(lhs));
  gimple_set_op(gs, 0, lhs);
}
...
static inline tree gimple_cond_rhs(const_gimple gs) {
  GIMPLE_CHECK(gs, GIMPLE_COND);
  return gimple_op(gs, 1);
}
...
static inline tree *gimple_cond_rhs_ptr(const_gimple gs) {
  GIMPLE_CHECK(gs, GIMPLE_COND);
  return gimple_op_ptr(gs, 1);
}
...
static inline void gimple_cond_set_rhs(gimple gs, tree rhs) {
  GIMPLE_CHECK(gs, GIMPLE_COND);
  gcc_assert(is_gimple_operand(rhs));
  gimple_set_op(gs, 1, rhs);
}
...
static inline tree gimple_cond_true_label(const_gimple gs) {
  GIMPLE_CHECK(gs, GIMPLE_COND);
  return gimple_op(gs, 2);
}
...
static inline void gimple_cond_set_true_label(gimple gs, tree label) {
  GIMPLE_CHECK(gs, GIMPLE_COND);
...
static inline void gimple_cond_set_false_label(gimple gs, tree label) {
  GIMPLE_CHECK(gs, GIMPLE_COND);
  gcc_assert(!label || TREE_CODE(label) == LABEL_DECL);
...
static inline tree gimple_cond_false_label(const_gimple gs) {
  GIMPLE_CHECK(gs, GIMPLE_COND);
...
static inline void gimple_cond_make_false(gimple gs) {
...
static inline void gimple_cond_make_true(gimple gs) {
  gimple_cond_set_lhs(gs, boolean_true_node);
...
static inline bool gimple_cond_true_p(const_gimple gs) {
...
static inline bool gimple_cond_false_p(const_gimple gs) {
  tree lhs = gimple_cond_lhs(gs);
  tree rhs = gimple_cond_rhs(gs);
  enum tree_code code = gimple_cond_code(gs);
...
static inline bool gimple_cond_single_var_p(gimple gs) {
...
static inline void gimple_cond_set_condition(gimple stmt, enum tree_code code,
                                             tree lhs, tree rhs) {
...
static inline tree gimple_label_label(const_gimple gs) {
...
static inline void gimple_label_set_label(gimple gs, tree label) {
  GIMPLE_CHECK(gs, GIMPLE_LABEL);
...
static inline tree gimple_goto_dest(const_gimple gs) {
...
static inline void gimple_goto_set_dest(gimple gs, tree dest) {
  GIMPLE_CHECK(gs, GIMPLE_GOTO);
...
static inline tree gimple_bind_vars(const_gimple gs) {
...
static inline void gimple_bind_set_vars(gimple gs, tree vars) {
  GIMPLE_CHECK(gs, GIMPLE_BIND);
...
static inline void gimple_bind_append_vars(gimple gs, tree vars) {
  GIMPLE_CHECK(gs, GIMPLE_BIND);
...
static inline gimple_seq gimple_bind_body(gimple gs) {
  GIMPLE_CHECK(gs, GIMPLE_BIND);
...
static inline void gimple_bind_set_body(gimple gs, gimple_seq seq) {
  GIMPLE_CHECK(gs, GIMPLE_BIND);
...
static inline void gimple_bind_add_stmt(gimple gs, gimple stmt) {
  GIMPLE_CHECK(gs, GIMPLE_BIND);
...
static inline void gimple_bind_add_seq(gimple gs, gimple_seq seq) {
  GIMPLE_CHECK(gs, GIMPLE_BIND);
...
static inline tree gimple_bind_block(const_gimple gs) {
  GIMPLE_CHECK(gs, GIMPLE_BIND);
...
static inline void gimple_bind_set_block(gimple gs, tree block) {
  GIMPLE_CHECK(gs, GIMPLE_BIND);
...
static inline unsigned gimple_asm_ninputs(const_gimple gs) {
...
static inline unsigned gimple_asm_noutputs(const_gimple gs) {
  GIMPLE_CHECK(gs, GIMPLE_ASM);
...
static inline unsigned gimple_asm_nclobbers(const_gimple gs) {
  GIMPLE_CHECK(gs, GIMPLE_ASM);
...
static inline tree gimple_asm_input_op(const_gimple gs, unsigned index) {
  GIMPLE_CHECK(gs, GIMPLE_ASM);
...
static inline tree *gimple_asm_input_op_ptr(const_gimple gs, unsigned index) {
  GIMPLE_CHECK(gs, GIMPLE_ASM);
  gcc_assert(index <= gs->gimple_asm.ni);
...
static inline void gimple_asm_set_input_op(gimple gs, unsigned index,
                                           tree in_op) {
  GIMPLE_CHECK(gs, GIMPLE_ASM);
  gcc_assert(index <= gs->gimple_asm.ni);
...
static inline tree gimple_asm_output_op(const_gimple gs, unsigned index) {
  GIMPLE_CHECK(gs, GIMPLE_ASM);
...
static inline tree *gimple_asm_output_op_ptr(const_gimple gs, unsigned index) {
  GIMPLE_CHECK(gs, GIMPLE_ASM);
  gcc_assert(index <= gs->gimple_asm.no);
...
static inline void gimple_asm_set_output_op(gimple gs, unsigned index,
                                            tree out_op) {
  GIMPLE_CHECK(gs, GIMPLE_ASM);
  gcc_assert(index <= gs->gimple_asm.no);
...
static inline tree gimple_asm_clobber_op(const_gimple gs, unsigned index) {
  GIMPLE_CHECK(gs, GIMPLE_ASM);
...
static inline void gimple_asm_set_clobber_op(gimple gs, unsigned index,
                                             tree clobber_op) {
  GIMPLE_CHECK(gs, GIMPLE_ASM);
  gcc_assert(index <= gs->gimple_asm.nc);
...
static inline const char *gimple_asm_string(const_gimple gs) {
  GIMPLE_CHECK(gs, GIMPLE_ASM);
...
static inline bool gimple_asm_volatile_p(const_gimple gs) {
  GIMPLE_CHECK(gs, GIMPLE_ASM);
...
static inline void gimple_asm_set_volatile(gimple gs, bool volatile_p) {
  GIMPLE_CHECK(gs, GIMPLE_ASM);
  if (volatile_p)
...
static inline void gimple_asm_set_input(gimple gs, bool input_p) {
  GIMPLE_CHECK(gs, GIMPLE_ASM);
  if (input_p)
...
static inline bool gimple_asm_input_p(const_gimple gs) {
  GIMPLE_CHECK(gs, GIMPLE_ASM);
...
static inline tree gimple_catch_types(const_gimple gs) {
...
static inline tree *gimple_catch_types_ptr(gimple gs) {
  GIMPLE_CHECK(gs, GIMPLE_CATCH);
  return &gs->gimple_catch.types;
}
...
static inline gimple_seq gimple_catch_handler(gimple gs) {
  GIMPLE_CHECK(gs, GIMPLE_CATCH);
...
static inline gimple_seq *gimple_catch_handler_ptr(gimple gs) {
  GIMPLE_CHECK(gs, GIMPLE_CATCH);
  return &gs->gimple_catch.handler;
}
...
static inline void gimple_catch_set_types(gimple gs, tree t) {
  GIMPLE_CHECK(gs, GIMPLE_CATCH);
...
static inline void gimple_catch_set_handler(gimple gs, gimple_seq handler) {
  GIMPLE_CHECK(gs, GIMPLE_CATCH);
...
static inline tree gimple_eh_filter_types(const_gimple gs) {
...
static inline void gimple_eh_filter_set_types(gimple gs, tree types) {
  GIMPLE_CHECK(gs, GIMPLE_EH_FILTER);
...
static inline void gimple_eh_filter_set_failure(gimple gs, gimple_seq failure) {
  GIMPLE_CHECK(gs, GIMPLE_EH_FILTER);
...
static inline void gimple_eh_filter_set_must_not_throw(gimple gs, bool mntp) {
  GIMPLE_CHECK(gs, GIMPLE_EH_FILTER);
...
static inline enum gimple_try_flags gimple_try_kind(const_gimple gs) {
...
static inline void gimple_try_set_kind(gimple gs, enum gimple_try_flags kind) {
  GIMPLE_CHECK(gs, GIMPLE_TRY);
...
static inline bool gimple_try_catch_is_cleanup(const_gimple gs) {
...
static inline void gimple_try_set_catch_is_cleanup(gimple g,
...
static inline void gimple_try_set_eval(gimple gs, gimple_seq eval) {
  GIMPLE_CHECK(gs, GIMPLE_TRY);
...
static inline void gimple_try_set_cleanup(gimple gs, gimple_seq cleanup) {
  GIMPLE_CHECK(gs, GIMPLE_TRY);
...
static inline bool gimple_wce_cleanup_eh_only(const_gimple gs) {
  GIMPLE_CHECK(gs, GIMPLE_WITH_CLEANUP_EXPR);
  return gs->gsbase.subcode != 0;
}
...
static inline unsigned gimple_phi_capacity(const_gimple gs) {
...
static inline unsigned gimple_phi_num_args(const_gimple gs) {
  GIMPLE_CHECK(gs, GIMPLE_PHI);
...
static inline tree gimple_phi_result(const_gimple gs) {
  GIMPLE_CHECK(gs, GIMPLE_PHI);
...
static inline void gimple_phi_set_result(gimple gs, tree result) {
  GIMPLE_CHECK(gs, GIMPLE_PHI);
...
static inline void gimple_phi_set_arg(gimple gs, unsigned index,
...
static inline int gimple_resx_region(const_gimple gs) {
...
static inline void gimple_resx_set_region(gimple gs, int region) {
  GIMPLE_CHECK(gs, GIMPLE_RESX);
...
static inline unsigned gimple_switch_num_labels(const_gimple gs) {
  unsigned num_ops;
...
static inline void gimple_switch_set_num_labels(gimple g, unsigned nlabels) {
...
static inline tree gimple_switch_index(const_gimple gs) {
  GIMPLE_CHECK(gs, GIMPLE_SWITCH);
  return gimple_op(gs, 0);
}
...
static inline tree *gimple_switch_index_ptr(const_gimple gs) {
  GIMPLE_CHECK(gs, GIMPLE_SWITCH);
  return gimple_op_ptr(gs, 0);
}
...
static inline void gimple_switch_set_index(gimple gs, tree index) {
  GIMPLE_CHECK(gs, GIMPLE_SWITCH);
...
static inline tree gimple_switch_label(const_gimple gs, unsigned index) {
  GIMPLE_CHECK(gs, GIMPLE_SWITCH);
...
static inline void gimple_switch_set_label(gimple gs, unsigned index,
                                           tree label) {
  GIMPLE_CHECK(gs, GIMPLE_SWITCH);
  gcc_assert(gimple_num_ops(gs) > index + 1);
...
static inline tree gimple_switch_default_label(const_gimple gs) {
  return gimple_switch_label(gs, 0);
}

/* Set the default label for a switch statement.  */

static inline void gimple_switch_set_default_label(gimple gs, tree label) {
...
static inline tree gimple_omp_critical_name(const_gimple gs) {
...
static inline tree *gimple_omp_critical_name_ptr(gimple gs) {
  GIMPLE_CHECK(gs, GIMPLE_OMP_CRITICAL);
  return &gs->gimple_omp_critical.name;
}
...
static inline void gimple_omp_critical_set_name(gimple gs, tree name) {
  GIMPLE_CHECK(gs, GIMPLE_OMP_CRITICAL);
...
static inline tree gimple_omp_for_clauses(const_gimple gs) {
...
static inline tree gimple_omp_for_index(const_gimple gs, size_t i) {
  GIMPLE_CHECK(gs, GIMPLE_OMP_FOR);
...
static inline tree gimple_omp_for_initial(const_gimple gs, size_t i) {
  GIMPLE_CHECK(gs, GIMPLE_OMP_FOR);
  gcc_assert(i < gs->gimple_omp_for.collapse);
...
static inline tree gimple_omp_for_final(const_gimple gs, size_t i) {
  GIMPLE_CHECK(gs, GIMPLE_OMP_FOR);
  gcc_assert(i < gs->gimple_omp_for.collapse);
...
static inline tree gimple_omp_for_incr(const_gimple gs, size_t i) {
  GIMPLE_CHECK(gs, GIMPLE_OMP_FOR);
  gcc_assert(i < gs->gimple_omp_for.collapse);
...
static inline tree gimple_omp_parallel_clauses(const_gimple gs) {
...
static inline tree *gimple_omp_parallel_clauses_ptr(gimple gs) {
  GIMPLE_CHECK(gs, GIMPLE_OMP_PARALLEL);
  return &gs->gimple_omp_parallel.clauses;
}
...
static inline void gimple_omp_parallel_set_clauses(gimple gs, tree clauses) {
  GIMPLE_CHECK(gs, GIMPLE_OMP_PARALLEL);
...
static inline tree gimple_omp_parallel_child_fn(const_gimple gs) {
  GIMPLE_CHECK(gs, GIMPLE_OMP_PARALLEL);
...
static inline tree *gimple_omp_parallel_child_fn_ptr(gimple gs) {
  GIMPLE_CHECK(gs, GIMPLE_OMP_PARALLEL);
  return &gs->gimple_omp_parallel.child_fn;
}
...
static inline void gimple_omp_parallel_set_child_fn(gimple gs, tree child_fn) {
  GIMPLE_CHECK(gs, GIMPLE_OMP_PARALLEL);
...
static inline tree gimple_omp_parallel_data_arg(const_gimple gs) {
  GIMPLE_CHECK(gs, GIMPLE_OMP_PARALLEL);
...
static inline tree *gimple_omp_parallel_data_arg_ptr(gimple gs) {
  GIMPLE_CHECK(gs, GIMPLE_OMP_PARALLEL);
  return &gs->gimple_omp_parallel.data_arg;
}
...
static inline void gimple_omp_parallel_set_data_arg(gimple gs, tree data_arg) {
  GIMPLE_CHECK(gs, GIMPLE_OMP_PARALLEL);
...
static inline tree gimple_omp_task_clauses(const_gimple gs) {
...
static inline tree gimple_omp_task_child_fn(const_gimple gs) {
  GIMPLE_CHECK(gs, GIMPLE_OMP_TASK);
  return gs->gimple_omp_parallel.child_fn;
}
...
static inline tree gimple_omp_task_data_arg(const_gimple gs) {
  GIMPLE_CHECK(gs, GIMPLE_OMP_TASK);
  return gs->gimple_omp_parallel.data_arg;
}
...
static inline tree gimple_omp_taskreg_clauses(const_gimple gs) {
...
static inline tree gimple_omp_taskreg_child_fn(const_gimple gs) {
  if (gimple_code(gs) != GIMPLE_OMP_PARALLEL)
    GIMPLE_CHECK(gs, GIMPLE_OMP_TASK);
  return gs->gimple_omp_parallel.child_fn;
}
...
static inline tree gimple_omp_taskreg_data_arg(const_gimple gs) {
  if (gimple_code(gs) != GIMPLE_OMP_PARALLEL)
    GIMPLE_CHECK(gs, GIMPLE_OMP_TASK);
  return gs->gimple_omp_parallel.data_arg;
}
...
static inline tree gimple_omp_task_copy_fn(const_gimple gs) {
  GIMPLE_CHECK(gs, GIMPLE_OMP_TASK);
...
static inline tree gimple_omp_task_arg_size(const_gimple gs) {
  GIMPLE_CHECK(gs, GIMPLE_OMP_TASK);
...
static inline tree gimple_omp_task_arg_align(const_gimple gs) {
  GIMPLE_CHECK(gs, GIMPLE_OMP_TASK);
...
static inline tree gimple_omp_single_clauses(const_gimple gs) {
...
static inline void gimple_omp_single_set_clauses(gimple gs, tree clauses) {
  GIMPLE_CHECK(gs, GIMPLE_OMP_SINGLE);
...
static inline tree gimple_omp_sections_clauses(const_gimple gs) {
...
static inline tree gimple_omp_sections_control(const_gimple gs) {
  GIMPLE_CHECK(gs, GIMPLE_OMP_SECTIONS);
...
static inline enum tree_code gimple_omp_for_cond(const_gimple gs, size_t i) {
  GIMPLE_CHECK(gs, GIMPLE_OMP_FOR);
  gcc_assert(i < gs->gimple_omp_for.collapse);
...
static inline void gimple_omp_atomic_store_set_val(gimple g, tree val) {
...
static inline tree gimple_omp_atomic_store_val(const_gimple g) {
  GIMPLE_CHECK(g, GIMPLE_OMP_ATOMIC_STORE);
...
static inline tree *gimple_omp_atomic_store_val_ptr(gimple g) {
  GIMPLE_CHECK(g, GIMPLE_OMP_ATOMIC_STORE);
  return &g->gimple_omp_atomic_store.val;
}
...
static inline void gimple_omp_atomic_load_set_lhs(gimple g, tree lhs) {
...
static inline tree gimple_omp_atomic_load_lhs(const_gimple g) {
  GIMPLE_CHECK(g, GIMPLE_OMP_ATOMIC_LOAD);
...
static inline tree *gimple_omp_atomic_load_lhs_ptr(gimple g) {
  GIMPLE_CHECK(g, GIMPLE_OMP_ATOMIC_LOAD);
  return &g->gimple_omp_atomic_load.lhs;
}
...
static inline void gimple_omp_atomic_load_set_rhs(gimple g, tree rhs) {
  GIMPLE_CHECK(g, GIMPLE_OMP_ATOMIC_LOAD);
...
static inline tree gimple_omp_atomic_load_rhs(const_gimple g) {
  GIMPLE_CHECK(g, GIMPLE_OMP_ATOMIC_LOAD);
...
static inline tree *gimple_omp_atomic_load_rhs_ptr(gimple g) {
  GIMPLE_CHECK(g, GIMPLE_OMP_ATOMIC_LOAD);
  return &g->gimple_omp_atomic_load.rhs;
}
...
static inline tree gimple_omp_continue_control_def(const_gimple g) {
...
static inline tree *gimple_omp_continue_control_def_ptr(gimple g) {
  GIMPLE_CHECK(g, GIMPLE_OMP_CONTINUE);
  return &g->gimple_omp_continue.control_def;
}
...
static inline void gimple_omp_continue_set_control_def(gimple g, tree def) {
  GIMPLE_CHECK(g, GIMPLE_OMP_CONTINUE);
...
static inline tree gimple_omp_continue_control_use(const_gimple g) {
  GIMPLE_CHECK(g, GIMPLE_OMP_CONTINUE);
...
static inline tree *gimple_omp_continue_control_use_ptr(gimple g) {
  GIMPLE_CHECK(g, GIMPLE_OMP_CONTINUE);
  return &g->gimple_omp_continue.control_use;
}
...
static inline void gimple_omp_continue_set_control_use(gimple g, tree use) {
  GIMPLE_CHECK(g, GIMPLE_OMP_CONTINUE);
...
static inline tree *gimple_return_retval_ptr(const_gimple gs) {
...
static inline tree gimple_return_retval(const_gimple gs) {
  GIMPLE_CHECK(gs, GIMPLE_RETURN);
  gcc_assert(gimple_num_ops(gs) == 1);
  return gimple_op(gs, 0);
}
...
static inline void gimple_return_set_retval(gimple gs, tree retval) {
  GIMPLE_CHECK(gs, GIMPLE_RETURN);
  gcc_assert(gimple_num_ops(gs) == 1);
  gcc_assert(retval == NULL_TREE || TREE_CODE(retval) == RESULT_DECL ||
...
static inline bool gimple_nop_p(const_gimple g) {
  return gimple_code(g) == GIMPLE_NOP;
}

/* Return the new type set by GIMPLE_CHANGE_DYNAMIC_TYPE statement GS.  */

static inline tree gimple_cdt_new_type(gimple gs) {
...
static inline tree *gimple_cdt_new_type_ptr(gimple gs) {
  GIMPLE_CHECK(gs, GIMPLE_CHANGE_DYNAMIC_TYPE);
  return gimple_op_ptr(gs, 1);
}
...
static inline void gimple_cdt_set_new_type(gimple gs, tree new_type) {
  GIMPLE_CHECK(gs, GIMPLE_CHANGE_DYNAMIC_TYPE);
...
static inline tree gimple_cdt_location(gimple gs) {
  GIMPLE_CHECK(gs, GIMPLE_CHANGE_DYNAMIC_TYPE);
  return gimple_op(gs, 0);
}
...
static inline tree *gimple_cdt_location_ptr(gimple gs) {
  GIMPLE_CHECK(gs, GIMPLE_CHANGE_DYNAMIC_TYPE);
  return gimple_op_ptr(gs, 0);
}
...
static inline void gimple_cdt_set_location(gimple gs, tree ptr) {
  GIMPLE_CHECK(gs, GIMPLE_CHANGE_DYNAMIC_TYPE);
...
static inline void gimple_predict_set_predictor(gimple gs,
  ...
  GIMPLE_CHECK(gs, GIMPLE_PREDICT);
  gs->gsbase.subcode =
      (gs->gsbase.subcode & GF_PREDICT_TAKEN) | (unsigned)predictor;
}
