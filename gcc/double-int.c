...
double_int double_int_mask(unsigned prec) {
...
double_int double_int_ext(double_int cst, unsigned prec, bool uns) {
  if (uns)
...
double_int double_int_zext(double_int cst, unsigned prec) {
...
double_int double_int_sext(double_int cst, unsigned prec) {
  double_int mask = double_int_mask(prec);
  double_int r;
...
double_int tree_to_double_int(const_tree cst) {
...
bool double_int_fits_in_uhwi_p(double_int cst) {
  return cst.high == 0;
}

/* Returns true if CST fits in signed HOST_WIDE_INT.  */

bool double_int_fits_in_shwi_p(double_int cst) {
  if (cst.high == 0)
...
bool double_int_fits_in_hwi_p(double_int cst, bool uns) {
  if (uns)
...
unsigned HOST_WIDE_INT double_int_to_uhwi(double_int cst) {
  return cst.low;
}

/* Returns A * B.  */

double_int double_int_mul(double_int a, double_int b) {
  double_int ret;
...
double_int double_int_add(double_int a, double_int b) {
  double_int ret;
...
double_int double_int_neg(double_int a) {
  double_int ret;
...
double_int double_int_divmod(double_int a, double_int b, bool uns,
                             unsigned code, double_int *mod) {
  double_int ret;

  div_and_round_double(code, uns, a.low, a.high, b.low, b.high, &ret.low,
                       &ret.high, &mod->low, &mod->high);
  return ret;
}

/* The same as double_int_divmod with UNS = false.  */

double_int double_int_sdivmod(double_int a, double_int b, unsigned code,
                              double_int *mod) {
...
double_int double_int_udivmod(double_int a, double_int b, unsigned code,
                              double_int *mod) {
...
double_int double_int_div(double_int a, double_int b, bool uns, unsigned code) {
  double_int mod;
...
double_int double_int_sdiv(double_int a, double_int b, unsigned code) {
  return double_int_div(a, b, false, code);
}

/* The same as double_int_div with UNS = true.  */

double_int double_int_udiv(double_int a, double_int b, unsigned code) {
...
double_int double_int_mod(double_int a, double_int b, bool uns, unsigned code) {
  double_int mod;
...
double_int double_int_smod(double_int a, double_int b, unsigned code) {
  return double_int_mod(a, b, false, code);
}

/* The same as double_int_mod with UNS = true.  */

double_int double_int_umod(double_int a, double_int b, unsigned code) {
...
bool double_int_fits_to_tree_p(const_tree type, double_int cst) {
  double_int ext =
      double_int_ext(cst, TYPE_PRECISION(type), TYPE_UNSIGNED(type));
...
bool double_int_negative_p(double_int cst) {
  return cst.high < 0;
}
...
int double_int_cmp(double_int a, double_int b, bool uns) {
  if (uns)
...
int double_int_ucmp(double_int a, double_int b) {
...
int double_int_scmp(double_int a, double_int b) {
  if (a.high < b.high)
    return -1;
  if (a.high > b.high)
    return 1;
