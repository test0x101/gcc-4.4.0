...
Inc. Contributed by Dorit Naishlos <dorit@il.ibm.com>
...
typedef struct _loop_vec_info {
  ...
  /* All SLP instances in the loop. This is a subset of the set of
     STRIDED_STORES of the loop.  */
...
#define NITERS_KNOWN_P(n) (host_integerp((n), 0) && TREE_INT_CST_LOW((n)) > 0)
...
static inline void stmt_vinfo_set_inside_of_loop_cost(stmt_vec_info stmt_info,
                                                      slp_tree slp_node,
                                                      int cost) {
  if (slp_node)
...
static inline void stmt_vinfo_set_outside_of_loop_cost(stmt_vec_info stmt_info,
                                                       slp_tree slp_node,
                                                       int cost) {
  if (slp_node)
...
extern struct loop *slpeel_tree_peel_loop_to_edge(struct loop *, edge, tree,
                                                  tree, bool, unsigned int,
                                                  bool);
extern void set_prologue_iterations(basic_block, tree, struct loop *,
                                    unsigned int);
...
extern bool supportable_widening_operation(enum tree_code, gimple, tree, tree *,
                                           ...
                                           enum tree_code *, int *,
                                           VEC(tree, heap) **);
extern bool supportable_narrowing_operation(enum tree_code, const_gimple, tree,
                                            enum tree_code *, int *,
                                            VEC(tree, heap) **);
...
extern bool vectorizable_type_promotion(gimple, gimple_stmt_iterator *,
                                        gimple *, slp_tree);
extern bool vectorizable_type_demotion(gimple, gimple_stmt_iterator *, gimple *,
                                       slp_tree);
