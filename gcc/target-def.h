...
#define TARGET_ASM_OUT                                                        \
  {                                                                           \
    TARGET_ASM_OPEN_PAREN, TARGET_ASM_CLOSE_PAREN, TARGET_ASM_BYTE_OP,        \
        TARGET_ASM_ALIGNED_INT_OP, TARGET_ASM_UNALIGNED_INT_OP,               \
        TARGET_ASM_INTEGER, TARGET_ASM_GLOBALIZE_LABEL,                       \
        TARGET_ASM_GLOBALIZE_DECL_NAME, TARGET_ASM_EMIT_UNWIND_LABEL,         \
        TARGET_ASM_EMIT_EXCEPT_TABLE_LABEL, TARGET_UNWIND_EMIT,               \
        TARGET_ASM_INTERNAL_LABEL, TARGET_ASM_TTYPE,                          \
        TARGET_ASM_ASSEMBLE_VISIBILITY, TARGET_ASM_FUNCTION_PROLOGUE,         \
        TARGET_ASM_FUNCTION_END_PROLOGUE, TARGET_ASM_FUNCTION_BEGIN_EPILOGUE, \
        TARGET_ASM_FUNCTION_EPILOGUE, TARGET_ASM_INIT_SECTIONS,               \
        TARGET_ASM_NAMED_SECTION, TARGET_ASM_RELOC_RW_MASK,                   \
        ...
        TARGET_ASM_OUTPUT_MI_THUNK, TARGET_ASM_CAN_OUTPUT_MI_THUNK,           \
...
#define TARGET_SCHED                                                           \
  {                                                                            \
    TARGET_SCHED_ADJUST_COST, TARGET_SCHED_ADJUST_PRIORITY,                    \
        ...
        TARGET_SCHED_REORDER2, TARGET_SCHED_DEPENDENCIES_EVALUATION_HOOK,      \
        TARGET_SCHED_INIT_DFA_PRE_CYCLE_INSN, TARGET_SCHED_DFA_PRE_CYCLE_INSN, \
        TARGET_SCHED_INIT_DFA_POST_CYCLE_INSN,                                 \
        TARGET_SCHED_DFA_POST_CYCLE_INSN, TARGET_SCHED_DFA_PRE_ADVANCE_CYCLE,  \
        TARGET_SCHED_DFA_POST_ADVANCE_CYCLE,                                   \
        TARGET_SCHED_FIRST_CYCLE_MULTIPASS_DFA_LOOKAHEAD,                      \
        TARGET_SCHED_FIRST_CYCLE_MULTIPASS_DFA_LOOKAHEAD_GUARD,                \
        TARGET_SCHED_DFA_NEW_CYCLE, TARGET_SCHED_IS_COSTLY_DEPENDENCE,         \
        TARGET_SCHED_ADJUST_COST_2, TARGET_SCHED_H_I_D_EXTENDED,               \
        ...
        TARGET_SCHED_FREE_SCHED_CONTEXT, TARGET_SCHED_SPECULATE_INSN,          \
        TARGET_SCHED_NEEDS_BLOCK_P, TARGET_SCHED_GEN_SPEC_CHECK,               \
...
#define TARGET_VECTORIZE                                                     \
  {                                                                          \
    TARGET_VECTORIZE_BUILTIN_MASK_FOR_LOAD,                                  \
        ...
        TARGET_VECTOR_ALIGNMENT_REACHABLE, TARGET_VECTORIZE_BUILTIN_VEC_PERM \
  }
...
#define TARGET_CALLS                                                      \
  {                                                                       \
    TARGET_PROMOTE_FUNCTION_ARGS, TARGET_PROMOTE_FUNCTION_RETURN,         \
        ...
        TARGET_UPDATE_STACK_BOUNDARY, TARGET_GET_DRAP_RTX,                \
...
#define TARGET_CXX                                                           \
  {                                                                          \
    TARGET_CXX_GUARD_TYPE, TARGET_CXX_GUARD_MASK_BIT,                        \
        ...
        TARGET_CXX_CLASS_DATA_ALWAYS_COMDAT, TARGET_CXX_LIBRARY_RTTI_COMDAT, \
...
#define TARGET_EMUTLS                                                       \
  {                                                                         \
    TARGET_EMUTLS_GET_ADDRESS, TARGET_EMUTLS_REGISTER_COMMON,               \
        ...
        TARGET_EMUTLS_VAR_ALIGN_FIXED, TARGET_EMUTLS_DEBUG_FORM_TLS_ADDRESS \
  }
...
#define TARGET_OPTION_HOOKS                                     \
  {                                                             \
    TARGET_OPTION_VALID_ATTRIBUTE_P, TARGET_OPTION_SAVE,        \
        ...
        TARGET_OPTION_PRAGMA_PARSE, TARGET_OPTION_CAN_INLINE_P, \
  }

/* The whole shebang.  */
#define TARGET_INITIALIZER                                                     \
  {                                                                            \
    TARGET_ASM_OUT, TARGET_SCHED, TARGET_VECTORIZE,                            \
        TARGET_DEFAULT_TARGET_FLAGS, TARGET_HANDLE_OPTION, TARGET_HELP,        \
        ...
        TARGET_SET_DEFAULT_TYPE_ATTRIBUTES, TARGET_INSERT_ATTRIBUTES,          \
        TARGET_FUNCTION_ATTRIBUTE_INLINABLE_P, TARGET_MS_BITFIELD_LAYOUT_P,    \
        ...
        TARGET_BUILTIN_RECIPROCAL, TARGET_MANGLE_TYPE, TARGET_INIT_LIBFUNCS,   \
        TARGET_SECTION_TYPE_FLAGS, TARGET_CANNOT_MODIFY_JUMPS_P,               \
        TARGET_BRANCH_TARGET_REGISTER_CLASS,                                   \
        TARGET_BRANCH_TARGET_REGISTER_CALLEE_SAVED,                            \
        TARGET_CANNOT_FORCE_CONST_MEM, TARGET_CANNOT_COPY_INSN_P,              \
        TARGET_COMMUTATIVE_P, TARGET_DELEGITIMIZE_ADDRESS,                     \
        TARGET_USE_BLOCKS_FOR_CONSTANT_P, TARGET_MIN_ANCHOR_OFFSET,            \
        TARGET_MAX_ANCHOR_OFFSET, TARGET_USE_ANCHORS_FOR_SYMBOL_P,             \
        TARGET_FUNCTION_OK_FOR_SIBCALL, TARGET_SET_CURRENT_FUNCTION,           \
        TARGET_IN_SMALL_DATA_P, TARGET_BINDS_LOCAL_P,                          \
        TARGET_MANGLE_DECL_ASSEMBLER_NAME, TARGET_ENCODE_SECTION_INFO,         \
        TARGET_STRIP_NAME_ENCODING, TARGET_SHIFT_TRUNCATION_MASK,              \
        TARGET_MIN_DIVISIONS_FOR_RECIP_MUL, TARGET_MODE_REP_EXTENDED,          \
        TARGET_VALID_POINTER_MODE, TARGET_SCALAR_MODE_SUPPORTED_P,             \
        TARGET_VECTOR_MODE_SUPPORTED_P, TARGET_VECTOR_OPAQUE_P,                \
        TARGET_RTX_COSTS, TARGET_ADDRESS_COST, TARGET_ALLOCATE_INITIAL_VALUE,  \
        TARGET_UNSPEC_MAY_TRAP_P, TARGET_DWARF_REGISTER_SPAN,                  \
        TARGET_INIT_DWARF_REG_SIZES_EXTRA, TARGET_FIXED_CONDITION_CODE_REGS,   \
        TARGET_CC_MODES_COMPATIBLE, TARGET_MACHINE_DEPENDENT_REORG,            \
        TARGET_BUILD_BUILTIN_VA_LIST, TARGET_FN_ABI_VA_LIST,                   \
        TARGET_CANONICAL_VA_LIST_TYPE, TARGET_EXPAND_BUILTIN_VA_START,         \
        TARGET_GIMPLIFY_VA_ARG_EXPR, TARGET_GET_PCH_VALIDITY,                  \
        TARGET_PCH_VALID_P, TARGET_CHECK_PCH_TARGET_FLAGS,                     \
        TARGET_DEFAULT_SHORT_ENUMS, TARGET_BUILTIN_SETJMP_FRAME_VALUE,         \
        TARGET_MD_ASM_CLOBBERS, TARGET_DWARF_CALLING_CONVENTION,               \
        TARGET_DWARF_HANDLE_FRAME_UNSPEC, TARGET_STDARG_OPTIMIZE_HOOK,         \
        TARGET_STACK_PROTECT_GUARD, TARGET_STACK_PROTECT_FAIL,                 \
        TARGET_INVALID_WITHIN_DOLOOP, TARGET_VALID_DLLIMPORT_ATTRIBUTE_P,      \
        TARGET_CALLS, TARGET_INVALID_CONVERSION, TARGET_INVALID_UNARY_OP,      \
        TARGET_INVALID_BINARY_OP, TARGET_IRA_COVER_CLASSES,                    \
        TARGET_SECONDARY_RELOAD, TARGET_EXPAND_TO_RTL_HOOK,                    \
        TARGET_INSTANTIATE_DECLS, TARGET_HARD_REGNO_SCRATCH_OK, TARGET_C,      \
        TARGET_CXX, TARGET_EMUTLS, TARGET_OPTION_HOOKS,                        \
        TARGET_EXTRA_LIVE_ON_ENTRY, TARGET_UNWIND_TABLES_DEFAULT,              \
        TARGET_HAVE_NAMED_SECTIONS, TARGET_HAVE_SWITCHABLE_BSS_SECTIONS,       \
        TARGET_HAVE_CTORS_DTORS, TARGET_HAVE_TLS, TARGET_HAVE_SRODATA_SECTION, \
        TARGET_TERMINATE_DW2_EH_FRAME_INFO, TARGET_ASM_FILE_START_APP_OFF,     \
        TARGET_ASM_FILE_START_FILE_DIRECTIVE,                                  \
        TARGET_HANDLE_PRAGMA_REDEFINE_EXTNAME,                                 \
        TARGET_HANDLE_PRAGMA_EXTERN_PREFIX, TARGET_RELAXED_ORDERING,           \
