...
#define DEFAULT_SWITCH_TAKES_ARG(CHAR)                                 \
  ((CHAR) == 'D' || (CHAR) == 'U' || (CHAR) == 'o' || (CHAR) == 'e' || \
   (CHAR) == 'T' || (CHAR) == 'u' || (CHAR) == 'I' || (CHAR) == 'J' || \
   (CHAR) == 'm' || (CHAR) == 'x' || (CHAR) == 'L' || (CHAR) == 'A' || \
   (CHAR) == 'V' || (CHAR) == 'B' || (CHAR) == 'b')

/* This defines which multi-letter switches take arguments.  */

#define DEFAULT_WORD_SWITCH_TAKES_ARG(STR)                                   \
  (!strcmp(STR, "Tdata") || !strcmp(STR, "Ttext") || !strcmp(STR, "Tbss") || \
   !strcmp(STR, "include") || !strcmp(STR, "imacros") ||                     \
   !strcmp(STR, "aux-info") || !strcmp(STR, "idirafter") ||                  \
   !strcmp(STR, "iprefix") || !strcmp(STR, "iwithprefix") ||                 \
   !strcmp(STR, "iwithprefixbefore") || !strcmp(STR, "iquote") ||            \
   !strcmp(STR, "isystem") || !strcmp(STR, "isysroot") ||                    \
   !strcmp(STR, "-param") || !strcmp(STR, "specs") || !strcmp(STR, "MF") ||  \
   !strcmp(STR, "MT") || !strcmp(STR, "MQ") ||                               \
