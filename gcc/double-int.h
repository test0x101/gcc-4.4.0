...
static inline double_int shwi_to_double_int(HOST_WIDE_INT cst) {
  double_int r;
...
static inline double_int uhwi_to_double_int(unsigned HOST_WIDE_INT cst) {
  double_int r;
...
double_int double_int_divmod(double_int, double_int, bool, unsigned,
                             double_int *);
...
static inline bool double_int_zero_p(double_int cst) {
  return cst.low == 0 && cst.high == 0;
}

/* Returns true if CST is one.  */

static inline bool double_int_one_p(double_int cst) {
  return cst.low == 1 && cst.high == 0;
}

/* Returns true if CST is minus one.  */

static inline bool double_int_minus_one_p(double_int cst) {
  return (cst.low == ALL_ONES && cst.high == -1);
}

/* Returns true if CST1 == CST2.  */

static inline bool double_int_equal_p(double_int cst1, double_int cst2) {
