...
#define pp_ptr_operator(PP, D) pp_c_base(PP)->ptr_operator(pp_c_base(PP), D)
...
#define pp_constant(PP, E)      pp_c_base(PP)->constant(pp_c_base(PP), E)
#define pp_id_expression(PP, E) pp_c_base(PP)->id_expression(pp_c_base(PP), E)
...
#define pp_expression(PP, E) pp_c_base(PP)->expression(pp_c_base(PP), E)
