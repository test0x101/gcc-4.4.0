...
static void print_prefix(const char *filename, unsigned depth,
...
static void tag_function(const char *filename ATTRIBUTE_UNUSED,
...
static void tag_blocks(const char *filename ATTRIBUTE_UNUSED,
                       unsigned tag ATTRIBUTE_UNUSED,
                       unsigned length ATTRIBUTE_UNUSED) {
...
static void tag_arcs(const char *filename ATTRIBUTE_UNUSED,
                     unsigned tag ATTRIBUTE_UNUSED,
                     unsigned length ATTRIBUTE_UNUSED) {
...
static void tag_lines(const char *filename ATTRIBUTE_UNUSED,
                      unsigned tag ATTRIBUTE_UNUSED,
                      unsigned length ATTRIBUTE_UNUSED) {
  if (flag_dump_contents) {
    unsigned blockno = gcov_read_unsigned();
...
static void tag_counters(const char *filename ATTRIBUTE_UNUSED,
                         unsigned tag ATTRIBUTE_UNUSED,
                         unsigned length ATTRIBUTE_UNUSED) {
...
static void tag_summary(const char *filename ATTRIBUTE_UNUSED,
                        unsigned tag ATTRIBUTE_UNUSED,
                        unsigned length ATTRIBUTE_UNUSED) {
  ...
  for (ix = 0; ix != GCOV_COUNTERS_SUMMABLE; ix++) {
    ...
    printf("\t\tcounts=%u, runs=%u", summary.ctrs[ix].num,
