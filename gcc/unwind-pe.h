...
static _Unwind_Ptr base_of_encoded_value(unsigned char encoding,
...
static const unsigned char *read_encoded_value_with_base(unsigned char encoding,
                                                         _Unwind_Ptr base,
  ...
  if (encoding == DW_EH_PE_aligned) {
    ...
    if (result != 0) {
      result += ((encoding & 0x70) == DW_EH_PE_pcrel ? (_Unwind_Internal_Ptr)u
                                                     : base);
...
static inline const unsigned char *read_encoded_value(
