...
extern _Unwind_Reason_Code __libunwind_Unwind_Backtrace(_Unwind_Trace_Fn,
                                                        void *);
...
_Unwind_Reason_Code LIBGCC2_UNWIND_ATTRIBUTE _Unwind_ForcedUnwind(
    struct _Unwind_Exception *exc, _Unwind_Stop_Fn stop, void *stop_argument) {
...
#else
extern _Unwind_Ptr __libunwind_Unwind_GetDataRelBase(struct _Unwind_Context *);
...
extern _Unwind_Ptr __libunwind_Unwind_GetTextRelBase(struct _Unwind_Context *);
...
extern _Unwind_Ptr __libunwind_Unwind_GetRegionStart(struct _Unwind_Context *);
...
extern void __libunwind_Unwind_SetGR(struct _Unwind_Context *, int,
                                     _Unwind_Word);
