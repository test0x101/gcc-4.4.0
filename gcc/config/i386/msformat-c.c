...
static const format_flag_pair ms_scanf_flag_pairs[] = {{'*', 'L', 0, 0},
                                                       {0, 0, 0, 0}};
...
static const format_flag_pair ms_strftime_flag_pairs[] = {{0, 0, 0, 0}};
...
static const format_char_info ms_print_char_table[] = {
    ...
    {"di",
     0,
     STD_C89,
     {T89_I, BADLEN, T89_S, T89_L, T9L_LL, T99_SST, BADLEN, BADLEN, BADLEN,
    ...
    {"oxX",
     0,
     STD_C89,
     {T89_UI, BADLEN, T89_US, T89_UL, T9L_ULL, T99_ST, BADLEN, BADLEN, BADLEN,
      BADLEN, BADLEN, BADLEN},
     "-wp0#",
     "i",
     NULL},
    ...
    {"fgG",
     0,
     STD_C89,
     {T89_D, BADLEN, BADLEN, T99_D, BADLEN, BADLEN, BADLEN, BADLEN, BADLEN,
      BADLEN, BADLEN, BADLEN},
     "-wp0 +#'",
     "",
     NULL},
    ...
    {"c",
     0,
     STD_C89,
     {T89_I, BADLEN, T89_S, T94_WI, BADLEN, BADLEN, BADLEN, BADLEN, BADLEN,
      BADLEN, BADLEN, BADLEN},
     "-w",
     "",
     NULL},
    {"s",
     1,
     STD_C89,
     {T89_C, BADLEN, T89_S, T94_W, BADLEN, BADLEN, BADLEN, BADLEN, BADLEN,
      BADLEN, BADLEN, BADLEN},
     "-wp",
     "cR",
     NULL},
    ...
    {"n",
     1,
     STD_C89,
     {T89_I, BADLEN, T89_S, T89_L, T9L_LL, BADLEN, BADLEN, BADLEN, T99_IM,
      BADLEN, BADLEN, BADLEN},
     "",
     "W",
     NULL},
    ...
    {"C",
     0,
     STD_EXT,
     {TEX_WI, BADLEN, T89_S, BADLEN, BADLEN, BADLEN, BADLEN, BADLEN, BADLEN,
      BADLEN, BADLEN, BADLEN},
     "-w",
     "",
     NULL},
    {"S",
     1,
     STD_EXT,
     {TEX_W, BADLEN, T89_S, BADLEN, BADLEN, BADLEN, BADLEN, BADLEN, BADLEN,
      BADLEN, BADLEN, BADLEN},
     "-wp",
     "R",
     NULL},
...
static const format_char_info ms_scan_char_table[] = {
    ...
    {"efgEG",
     1,
     STD_C89,
     {T89_F, BADLEN, BADLEN, T89_D, BADLEN, BADLEN, BADLEN, BADLEN, BADLEN,
      BADLEN, BADLEN, BADLEN},
     "*w'",
     "W",
     NULL},
    ...
    {"n",
     1,
     STD_C89,
     {T89_I, BADLEN, T89_S, T89_L, T9L_LL, BADLEN, BADLEN, BADLEN, BADLEN,
      BADLEN, BADLEN, BADLEN},
     "",
     "W",
     NULL},
...
const format_kind_info mingw_format_attributes[3] = {
    ...
    {"ms_scanf", ms_printf_length_specs, ms_scan_char_table, "*'", NULL,
     ...
     'w', 0, 0, '*', 'L', 0, NULL, NULL},
    {"ms_strftime", NULL, ms_time_char_table, "", "#", ms_strftime_flag_specs,
     ms_strftime_flag_pairs, FMT_FLAG_FANCY_PERCENT_OK, 0, 0, 0, 0, 0, 0, NULL,
     NULL}};
...
void TARGET_OVERRIDES_FORMAT_INIT(void) {
