...
const struct processor_costs ix86_size_cost = {
...
/* Processor costs (relative to an add) */
static const struct processor_costs i386_cost = {
    /* 386 specific costs */
    ...
    {{rep_prefix_1_byte, {{-1, rep_prefix_1_byte}}}, DUMMY_STRINGOP_ALGS},
    {{rep_prefix_1_byte, {{-1, rep_prefix_1_byte}}}, DUMMY_STRINGOP_ALGS},
    1, /* scalar_stmt_cost.  */
    1, /* scalar load_cost.  */
    1, /* scalar_store_cost.  */
...
static const struct processor_costs i486_cost = {
    /* 486 specific costs */
    COSTS_N_INSNS(1),    /* cost of an add instruction */
    COSTS_N_INSNS(1),    /* cost of a lea instruction */
    COSTS_N_INSNS(3),    /* variable shift costs */
    ...
    {{rep_prefix_4_byte, {{-1, rep_prefix_4_byte}}}, DUMMY_STRINGOP_ALGS},
    {{rep_prefix_4_byte, {{-1, rep_prefix_4_byte}}}, DUMMY_STRINGOP_ALGS},
    1, /* scalar_stmt_cost.  */
    1, /* scalar load_cost.  */
    1, /* scalar_store_cost.  */
...
static const struct processor_costs pentium_cost = {
    ...
    {{libcall, {{256, rep_prefix_4_byte}, {-1, libcall}}}, DUMMY_STRINGOP_ALGS},
    {{libcall, {{-1, rep_prefix_4_byte}}}, DUMMY_STRINGOP_ALGS},
    1, /* scalar_stmt_cost.  */
    1, /* scalar load_cost.  */
    1, /* scalar_store_cost.  */
    1, /* vec_stmt_cost.  */
...
static const struct processor_costs pentiumpro_cost = {
    ...
    /* PentiumPro has optimized rep instructions for blocks aligned by 8 bytes
       ...
       noticeable win, for bigger blocks either rep movsl or rep movsb is way to
       go.  Rep movsb has apparently more expensive startup time in CPU, but
       after 4K the difference is down in the noise.
     */
    {{rep_prefix_4_byte,
      {{128, loop},
       {1024, unrolled_loop},
     ...
     DUMMY_STRINGOP_ALGS},
    {{rep_prefix_4_byte,
      {{1024, unrolled_loop}, {8192, rep_prefix_4_byte}, {-1, libcall}}},
     DUMMY_STRINGOP_ALGS},
    1, /* scalar_stmt_cost.  */
    1, /* scalar load_cost.  */
    1, /* scalar_store_cost.  */
...
static const struct processor_costs geode_cost = {
    COSTS_N_INSNS(1),    /* cost of an add instruction */
    COSTS_N_INSNS(1),    /* cost of a lea instruction */
...
static const struct processor_costs k8_cost = {
    ...
    /* K8 has optimized REP instruction for medium sized blocks, but for very
       small blocks it is better to use loop. For large blocks, libcall can do
    ...
    {{libcall,
      {{8, loop},
       ...
       {-1, libcall}}},
     {libcall,
      {{48, unrolled_loop}, {8192, rep_prefix_8_byte}, {-1, libcall}}}},
    4, /* scalar_stmt_cost.  */
    2, /* scalar load_cost.  */
    2, /* scalar_store_cost.  */
    5, /* vec_stmt_cost.  */
...
static const struct processor_costs nocona_cost = {
    COSTS_N_INSNS(1),    /* cost of an add instruction */
    COSTS_N_INSNS(1),    /* cost of a lea instruction */
    COSTS_N_INSNS(1),    /* variable shift costs */
    COSTS_N_INSNS(1),    /* constant shift costs */
...
static const struct processor_costs core2_cost = {
    COSTS_N_INSNS(1),     /* cost of an add instruction */
...
static const struct processor_costs generic64_cost = {
    COSTS_N_INSNS(1), /* cost of an add instruction */
...
/* Generic32 should produce code tuned for Athlon, PPro, Pentium4, Nocona and
 * K8.  */
static const struct processor_costs generic32_cost = {
    COSTS_N_INSNS(1),     /* cost of an add instruction */
    COSTS_N_INSNS(1) + 1, /* cost of a lea instruction */
    COSTS_N_INSNS(1),     /* variable shift costs */
    COSTS_N_INSNS(1),     /* constant shift costs */
...
static unsigned int initial_ix86_tune_features[X86_TUNE_LAST] = {
    ...
    m_386 | m_K6_GEODE | m_AMD_MULTIPLE | m_PENT4 | m_NOCONA | m_CORE2 |
        m_GENERIC,
    ...
    /* X86_TUNE_USE_SAHF */
    m_PPRO | m_K6_GEODE | m_K8 | m_AMDFAM10 | m_PENT4 | m_NOCONA | m_CORE2 |
        m_GENERIC,
    ...
    /* X86_TUNE_ADD_ESP_8 */
    m_AMD_MULTIPLE | m_PPRO | m_K6_GEODE | m_386 | m_486 | m_PENT4 | m_NOCONA |
        m_CORE2 | m_GENERIC,
    ...
    /* X86_TUNE_SUB_ESP_8 */
    m_AMD_MULTIPLE | m_PPRO | m_386 | m_486 | m_PENT4 | m_NOCONA | m_CORE2 |
        m_GENERIC,
    ...
    m_K6_GEODE | m_ATHLON_K8 | m_PENT4 | m_NOCONA | m_PPRO | m_CORE2 |
        m_GENERIC,
...
static const unsigned int x86_arch_always_fancy_math_387 =
    m_PENT | m_PPRO | m_AMD_MULTIPLE | m_PENT4 | m_NOCONA | m_CORE2 | m_GENERIC;
...
static int const x86_64_int_parameter_registers[6] = {DI_REG, SI_REG, DX_REG,
                                                      CX_REG, R8_REG, R9_REG};

static int const x86_64_ms_abi_int_parameter_registers[4] = {CX_REG, DX_REG,
                                                             R8_REG, R9_REG};

static int const x86_64_int_return_registers[4] = {AX_REG, DX_REG, DI_REG,
                                                   SI_REG};
...
static bool ix86_expand_vector_init_one_nonzero(bool, enum machine_mode, rtx,
                                                rtx, int);
...
#define OPTION_MASK_ISA_SSE3_UNSET                      \
  (OPTION_MASK_ISA_SSE3 | OPTION_MASK_ISA_SSSE3_UNSET | \
...
static const char *const cpu_names[TARGET_CPU_DEFAULT_max] = {
    "generic",    "i386",     "i486",     "pentium",  "pentium-mmx",
    "pentiumpro", "pentium2", "pentium3", "pentium4", "pentium-m",
    "prescott",   "nocona",   "core2",    "geode",    "k6",
    "k6-2",       "k6-3",     "athlon",   "athlon-4", "k8",
    "amdfam10"};

/* Implement TARGET_HANDLE_OPTION.  */

static bool ix86_handle_option(size_t code, const char *arg ATTRIBUTE_UNUSED,
                               int value) {
  switch (code) {
    case OPT_mmmx:
      if (value) {
...
static char *ix86_target_string(int isa, int flags, const char *arch,
                                const char *tune, const char *fpmath,
                                bool add_nl_p) {
...
/* Function that is callable from the debugger to print the current
   options.  */
void ix86_debug_options(void) {
  char *opts =
      ix86_target_string(ix86_isa_flags, target_flags, ix86_arch_string,
                         ix86_tune_string, ix86_fpmath_string, true);
...
void override_options(bool main_args_p) {
  int i;
...
#define MAX_CODE_ALIGN 16
  ...
  static struct pta {
    ...
    const unsigned /*enum pta_flags*/ flags;
      ...
      {"pentium3", PROCESSOR_PENTIUMPRO, CPU_PENTIUMPRO, PTA_MMX | PTA_SSE},
      {"pentium3m", PROCESSOR_PENTIUMPRO, CPU_PENTIUMPRO, PTA_MMX | PTA_SSE},
      {"pentium-m", PROCESSOR_PENTIUMPRO, CPU_PENTIUMPRO,
       PTA_MMX | PTA_SSE | PTA_SSE2},
      {"pentium4", PROCESSOR_PENTIUM4, CPU_NONE, PTA_MMX | PTA_SSE | PTA_SSE2},
      {"pentium4m", PROCESSOR_PENTIUM4, CPU_NONE, PTA_MMX | PTA_SSE | PTA_SSE2},
      {"prescott", PROCESSOR_NOCONA, CPU_NONE,
       PTA_MMX | PTA_SSE | PTA_SSE2 | PTA_SSE3},
      {"nocona", PROCESSOR_NOCONA, CPU_NONE,
       PTA_64BIT | PTA_MMX | PTA_SSE | PTA_SSE2 | PTA_SSE3 | PTA_CX16 |
           PTA_NO_SAHF},
      ...
      {"amdfam10", PROCESSOR_AMDFAM10, CPU_AMDFAM10,
       PTA_64BIT | PTA_MMX | PTA_3DNOW | PTA_3DNOW_A | PTA_SSE | PTA_SSE2 |
           PTA_SSE3 | PTA_SSE4A | PTA_CX16 | PTA_ABM},
  ...
  if (ix86_tune_string) {
    ...
    else if (!main_args_p && (!strcmp(ix86_tune_string, "generic32") ||
                              !strcmp(ix86_tune_string, "generic64")))
      ;
    else if (!strncmp(ix86_tune_string, "generic", 7))
      error("bad value (%s) for %stune=%s %s", ix86_tune_string, prefix, suffix,
            sw);
  } else {
    if (ix86_arch_string)
  ...
  if (ix86_stringop_string) {
    ...
    else if (!strcmp(ix86_stringop_string, "rep_8byte") && TARGET_64BIT)
  ...
  if (!strcmp(ix86_arch_string, "generic"))
    error("generic CPU can be used only for %stune=%s %s", prefix, suffix, sw);
  if (!strncmp(ix86_arch_string, "generic", 7))
    error("bad value (%s) for %sarch=%s %s", ix86_arch_string, prefix, suffix,
          sw);
  ...
  if (ix86_cmodel_string != 0) {
    if (!strcmp(ix86_cmodel_string, "small"))
      ...
      error("bad value (%s) for %scmodel=%s %s", ix86_cmodel_string, prefix,
            suffix, sw);
  } else {
  ...
  if (ix86_asm_string != 0) {
    if (!TARGET_MACHO && !strcmp(ix86_asm_string, "intel"))
      ix86_asm_dialect = ASM_INTEL;
    else if (!strcmp(ix86_asm_string, "att"))
      ix86_asm_dialect = ASM_ATT;
    else
      error("bad value (%s) for %sasm=%s %s", ix86_asm_string, prefix, suffix,
            sw);
  }
  if ((TARGET_64BIT == 0) != (ix86_cmodel == CM_32))
    error("code model %qs not supported in the %s bit mode", ix86_cmodel_string,
          TARGET_64BIT ? "64" : "32");
  ...
  for (i = 0; i < pta_size; i++)
    if (!strcmp(ix86_arch_string, processor_alias_table[i].name)) {
      ...
      if (TARGET_64BIT && !(processor_alias_table[i].flags & PTA_64BIT))
        error(
            "CPU you selected does not support x86-64 "
            "instruction set");
  ...
  if (ix86_regparm_string) {
    ...
    if (i < 0 || i > REGPARM_MAX)
      error("%sregparm=%d%s is not between 0 and %d", prefix, i, suffix,
            REGPARM_MAX);
    else
      ix86_regparm = i;
  }
  ...
  if (ix86_align_loops_string) {
    warning(0, "%salign-loops%s is obsolete, use -falign-loops%s", prefix,
            suffix, suffix);
    if (align_loops == 0) {
      i = atoi(ix86_align_loops_string);
      if (i < 0 || i > MAX_CODE_ALIGN)
        error("%salign-loops=%d%s is not between 0 and %d", prefix, i, suffix,
              MAX_CODE_ALIGN);
      else
        align_loops = 1 << i;
    }
  ...
  if (ix86_align_jumps_string) {
    warning(0, "%salign-jumps%s is obsolete, use -falign-jumps%s", prefix,
            suffix, suffix);
    if (align_jumps == 0) {
  ...
  if (ix86_tls_dialect_string) {
    if (strcmp(ix86_tls_dialect_string, "gnu") == 0)
      ...
      error("bad value (%s) for %stls-dialect=%s %s", ix86_tls_dialect_string,
            prefix, suffix, sw);
  }
  ...
  if (ix86_preferred_stack_boundary_string) {
    ...
    if (i < (TARGET_64BIT ? 4 : 2) || i > 12)
      error("%spreferred-stack-boundary=%d%s is not between %d and 12", prefix,
            i, suffix, TARGET_64BIT ? 4 : 2);
    else
  ...
  if (ix86_incoming_stack_boundary_string) {
    ...
    if (i < (TARGET_64BIT ? 4 : 2) || i > 12)
      error("-mincoming-stack-boundary=%d is not between %d and 12", i,
            TARGET_64BIT ? 4 : 2);
    else {
      ix86_user_incoming_stack_boundary = (1 << i) * BITS_PER_UNIT;
      ix86_incoming_stack_boundary = ix86_user_incoming_stack_boundary;
    }
  }

  /* Accept -msseregparm only if at least SSE support is enabled.  */
  if (TARGET_SSEREGPARM && !TARGET_SSE)
  ...
  if (ix86_fpmath_string != 0) {
    if (!strcmp(ix86_fpmath_string, "387"))
      ...
      error("bad value (%s) for %sfpmath=%s %s", ix86_fpmath_string, prefix,
            suffix, sw);
  }
  ...
  if (ix86_veclibabi_string) {
    if (strcmp(ix86_veclibabi_string, "svml") == 0)
      ...
      error(
          "unknown vectorization library ABI type (%s) for "
          "%sveclibabi=%s %s",
          ix86_veclibabi_string, prefix, suffix, sw);
  }
  ...
  if (TARGET_STACK_PROBE && !(target_flags & MASK_ACCUMULATE_OUTGOING_ARGS)) {
    if (target_flags_explicit & MASK_ACCUMULATE_OUTGOING_ARGS)
      warning(0,
              "stack probing requires %saccumulate-outgoing-args%s "
              "for correctness",
              prefix, suffix);
    target_flags |= MASK_ACCUMULATE_OUTGOING_ARGS;
  }
...
static void ix86_function_specific_save(struct cl_target_option *ptr) {
...
static void ix86_function_specific_restore(struct cl_target_option *ptr) {
...
static void ix86_function_specific_print(FILE *file, int indent,
                                         struct cl_target_option *ptr) {
  char *target_string = ix86_target_string(
      ptr->ix86_isa_flags, ptr->target_flags, NULL, NULL, NULL, false);

  fprintf(file, "%*sarch = %d (%s)\n", indent, "", ptr->arch,
          ((ptr->arch < TARGET_CPU_DEFAULT_max) ? cpu_names[ptr->arch]
                                                : "<unknown>"));

  fprintf(file, "%*stune = %d (%s)\n", indent, "", ptr->tune,
          ((ptr->tune < TARGET_CPU_DEFAULT_max) ? cpu_names[ptr->tune]
                                                : "<unknown>"));
...
static bool ix86_valid_target_attribute_inner_p(tree args, char *p_strings[]) {
  char *next_optstr;
  bool ret = true;

#define IX86_ATTR_ISA(S, O) \
  { S, sizeof(S) - 1, ix86_opt_isa, O, 0 }
#define IX86_ATTR_STR(S, O) \
  { S, sizeof(S) - 1, ix86_opt_str, O, 0 }
#define IX86_ATTR_YES(S, O, M) \
  { S, sizeof(S) - 1, ix86_opt_yes, O, M }
#define IX86_ATTR_NO(S, O, M) \
  { S, sizeof(S) - 1, ix86_opt_no, O, M }
  ...
  static const struct {
    ...
    int mask;
      ...
      /* flag options */
      IX86_ATTR_YES("cld", OPT_mcld, MASK_CLD),

      IX86_ATTR_NO("fancy-math-387", OPT_mfancy_math_387,
                   MASK_NO_FANCY_MATH_387),

      IX86_ATTR_NO("fused-madd", OPT_mfused_madd, MASK_NO_FUSED_MADD),

      IX86_ATTR_YES("ieee-fp", OPT_mieee_fp, MASK_IEEE_FP),

      IX86_ATTR_YES("inline-all-stringops", OPT_minline_all_stringops,
      ...
      IX86_ATTR_NO("align-stringops", OPT_mno_align_stringops,
                   MASK_NO_ALIGN_STRINGOPS),

      IX86_ATTR_YES("recip", OPT_mrecip, MASK_RECIP),
...
tree ix86_valid_target_attribute_tree(tree args) {
  ...
  tree t = NULL_TREE;
  int i;
  struct cl_target_option *def = TREE_TARGET_OPTION(target_option_default_node);
  ...
  /* If the changed options are different from the default, rerun
     override_options, and then save the options away.  The string options are
     are attribute options, and will be undone when we copy the save structure.
   */
...
static bool ix86_valid_target_attribute_p(tree fndecl, tree ARG_UNUSED(name),
...
static bool ix86_can_inline_p(tree caller, tree callee) {
  bool ret = false;
  ...
  /* If caller has no option attributes, but callee does then it is not ok to
    ...
    /* Callee's isa options should a subset of the caller's, i.e. a SSE5
       function can inline a SSE2 function but a SSE2 function can't inline a
       SSE5 function.  */
...
static void ix86_set_current_function(tree fndecl) {
  ...
  if (fndecl && fndecl != ix86_previous_fndecl) {
    ...
    tree new_tree =
        (fndecl ? DECL_FUNCTION_SPECIFIC_TARGET(fndecl) : NULL_TREE);
...
static bool ix86_in_large_data_p(tree exp) {
  ...
  if (TREE_CODE(exp) == VAR_DECL && DECL_SECTION_NAME(exp)) {
    ...
    if (strcmp(section, ".ldata") == 0 || strcmp(section, ".lbss") == 0)
      return true;
    return false;
  } else {
...
static void ATTRIBUTE_UNUSED x86_64_elf_unique_section(tree decl, int reloc) {
  if ((ix86_cmodel == CM_MEDIUM || ix86_cmodel == CM_MEDIUM_PIC) &&
      ix86_in_large_data_p(decl)) {
...
/* This says how to output assembler code to declare an
   ...
   large objects.  */
void x86_elf_aligned_common(FILE *file, const char *name,
...
void x86_output_aligned_bss(FILE *file, tree decl ATTRIBUTE_UNUSED,
...
void optimization_options(int level, int size ATTRIBUTE_UNUSED) {
...
static bool ix86_function_ok_for_sibcall(tree decl, tree exp) {
  tree func;
  rtx a, b;
  ...
  b = ix86_function_value(TREE_TYPE(DECL_RESULT(cfun->decl)), cfun->decl,
                          false);
  ...
  if (TARGET_DLLIMPORT_DECL_ATTRIBUTES && !TARGET_64BIT && decl &&
...
static tree ix86_handle_cconv_attribute(tree *node, tree name, tree args,
...
static int ix86_comp_type_attributes(const_tree type1, const_tree type2) {
...
static int ix86_function_regparm(const_tree type, const_tree decl) {
  tree attr;
  int regparm;
  ...
  if (TARGET_64BIT)
    return (ix86_function_type_abi(type) == SYSV_ABI ? X86_64_REGPARM_MAX
                                                     : X64_REGPARM_MAX);
  ...
  if (attr) {
    ...
    if (decl && TREE_CODE(decl) == FUNCTION_DECL) {
      ...
      if (!error_issued && regparm == 3 && decl_function_context(decl) &&
  ...
  if (decl && TREE_CODE(decl) == FUNCTION_DECL && optimize && !profile_flag) {
    ...
    if (i && i->local) {
      ...
      if (local_regparm == 3 && decl_function_context(decl) &&
          !DECL_NO_STATIC_CHAIN(decl))
        local_regparm = 2;
      ...
      local_regparm = globals < local_regparm ? local_regparm - globals : 0;
...
static int ix86_function_sseregparm(const_tree type, const_tree decl,
                                    bool warn) {
...
static bool ix86_eax_live_at_start_p(void) {
...
int ix86_return_pops_args(tree fundecl, tree funtype, int size) {
  int rtd;
...
bool ix86_function_arg_regno_p(int regno) {
  int i;
  const int *parm_regs;
  ...
  for (i = 0;
       i < (DEFAULT_ABI == MS_ABI ? X64_REGPARM_MAX : X86_64_REGPARM_MAX); i++)
...
static bool ix86_must_pass_in_stack(enum machine_mode mode, const_tree type) {
...
/* It returns the size, in bytes, of the area reserved for arguments passed
   ...
   abi format.  */
int ix86_reg_parm_stack_space(const_tree fndecl) {
...
/* Returns value SYSV_ABI, MS_ABI dependent on fntype, specifying the
   call abi used.  */
int ix86_function_type_abi(const_tree fntype) {
  if (TARGET_64BIT && fntype != NULL) {
    int abi;
    if (DEFAULT_ABI == SYSV_ABI)
      abi = lookup_attribute("ms_abi", TYPE_ATTRIBUTES(fntype)) ? MS_ABI
                                                                : SYSV_ABI;
    else
      abi = lookup_attribute("sysv_abi", TYPE_ATTRIBUTES(fntype)) ? SYSV_ABI
                                                                  : MS_ABI;
...
int ix86_function_abi(const_tree fndecl) {
  if (!fndecl)
    return DEFAULT_ABI;
...
/* Implementation of call abi switching target hook. Specific to FNDECL
   ...
   for more details.  */
void ix86_call_abi_override(const_tree fndecl) {
  if (fndecl == NULL_TREE)
...
static void ix86_maybe_switch_abi(void) {
  if (TARGET_64BIT &&
...
void init_cumulative_args(
  ...
  if (TARGET_64BIT) {
    if (cum->call_abi != DEFAULT_ABI)
      cum->nregs =
          DEFAULT_ABI != SYSV_ABI ? X86_64_REGPARM_MAX : X64_REGPARM_MAX;
  }
  if (TARGET_SSE) {
  ...
  cum->maybe_vaarg =
      (fntype ? (!prototype_p(fntype) || stdarg_p(fntype)) : !libname);
...
static enum machine_mode type_natural_mode(const_tree type,
                                           CUMULATIVE_ARGS *cum) {
      ...
      for (; mode != VOIDmode; mode = GET_MODE_WIDER_MODE(mode))
        if (GET_MODE_NUNITS(mode) == TYPE_VECTOR_SUBPARTS(type) &&
          ...
          if (size == 32 && !TARGET_AVX) {
            ...
            if (cum && !warnedavx && cum->warn_avx) {
              warnedavx = true;
              warning(0,
                      "AVX vector argument without AVX "
...
static rtx gen_reg_or_parallel(enum machine_mode mode,
...
static int classify_argument(enum machine_mode mode, const_tree type,
  ...
  if (type && AGGREGATE_TYPE_P(type)) {
    ...
    switch (TREE_CODE(type)) {
            ...
            if (DECL_BIT_FIELD(field)) {
              for (i = (int_bit_position(field) + (bit_offset % 64)) / 8 / 8;
                   i < ((int_bit_position(field) + (bit_offset % 64)) +
                        tree_low_cst(DECL_SIZE(field), 0) + 63) /
                           8 / 8;
                   i++)
                classes[i] = merge_classes(X86_64_INTEGER_CLASS, classes[i]);
            } else {
              type = TREE_TYPE(field);

              /* Flexible array member is ignored.  */
              if (TYPE_MODE(type) == BLKmode && TREE_CODE(type) == ARRAY_TYPE &&
              ...
              num = classify_argument(
                  TYPE_MODE(type), type, subclasses,
                  (int_bit_position(field) + bit_offset) % 256);
              if (!num)
                return 0;
              for (i = 0; i < num; i++) {
                int pos = (int_bit_position(field) + (bit_offset % 64)) / 8 / 8;
                classes[i + pos] =
      ...
      case ARRAY_TYPE:
        ...
        {
          int num;
          num = classify_argument(TYPE_MODE(TREE_TYPE(type)), TREE_TYPE(type),
        ...
        for (field = TYPE_FIELDS(type); field; field = TREE_CHAIN(field)) {
          if (TREE_CODE(field) == FIELD_DECL) {
            ...
            num = classify_argument(TYPE_MODE(TREE_TYPE(field)),
                                    TREE_TYPE(field), subclasses, bit_offset);
            if (!num)
              return 0;
            for (i = 0; i < num; i++)
...
static int examine_argument(enum machine_mode mode, const_tree type,
                            int in_return, int *int_nregs, int *sse_nregs) {
...
static rtx construct_container(enum machine_mode mode,
                               enum machine_mode orig_mode, const_tree type,
                               int in_return, int nintregs, int nsseregs,
  ...
  if (n == 4 && regclass[0] == X86_64_SSE_CLASS &&
      regclass[1] == X86_64_SSEUP_CLASS && regclass[2] == X86_64_SSEUP_CLASS &&
      regclass[3] == X86_64_SSEUP_CLASS && mode != BLKmode)
    return gen_rtx_REG(mode, SSE_REGNO(sse_regno));

  if (n == 2 && regclass[0] == X86_64_X87_CLASS &&
  ...
  for (i = 0; i < n; i++) {
    ...
    switch (regclass[i]) {
      ...
      case X86_64_INTEGERSI_CLASS:
        ...
        if (tmpmode == BLKmode)
          tmpmode = DImode;
        exp[nexps++] = gen_rtx_EXPR_LIST(
            VOIDmode, gen_rtx_REG(tmpmode, *intreg), GEN_INT(i * 8));
        intreg++;
        break;
      case X86_64_SSESF_CLASS:
        exp[nexps++] = gen_rtx_EXPR_LIST(
            VOIDmode, gen_rtx_REG(SFmode, SSE_REGNO(sse_regno)),
            GEN_INT(i * 8));
        sse_regno++;
        break;
      case X86_64_SSEDF_CLASS:
        exp[nexps++] = gen_rtx_EXPR_LIST(
            VOIDmode, gen_rtx_REG(DFmode, SSE_REGNO(sse_regno)),
            GEN_INT(i * 8));
        sse_regno++;
        break;
      case X86_64_SSE_CLASS:
        ...
        switch (n) {
          ...
          case 2:
            ...
            break;
          case 4:
            gcc_assert(i == 0 && regclass[1] == X86_64_SSEUP_CLASS &&
        ...
        exp[nexps++] = gen_rtx_EXPR_LIST(
            VOIDmode, gen_rtx_REG(tmpmode, SSE_REGNO(sse_regno)),
            GEN_INT(pos * 8));
        sse_regno++;
        break;
      default:
...
static void function_arg_advance_32(CUMULATIVE_ARGS *cum,
...
static void function_arg_advance_64(CUMULATIVE_ARGS *cum,
                                    enum machine_mode mode, tree type,
                                    HOST_WIDE_INT words, int named) {
...
static void function_arg_advance_ms_64(CUMULATIVE_ARGS *cum,
                                       HOST_WIDE_INT bytes,
                                       HOST_WIDE_INT words) {
...
void function_arg_advance(CUMULATIVE_ARGS *cum, enum machine_mode mode,
                          tree type, int named) {
...
static rtx function_arg_32(CUMULATIVE_ARGS *cum, enum machine_mode mode,
    ...
    case V1DImode:
      if (!type || !AGGREGATE_TYPE_P(type)) {
        if (!TARGET_MMX && !warnedmmx && cum->warn_mmx) {
          warnedmmx = true;
          warning(0,
                  "MMX vector argument without MMX enabled "
                  "changes the ABI");
        }
        if (cum->mmx_nregs)
          return gen_reg_or_parallel(mode, orig_mode,
...
static rtx function_arg_64(CUMULATIVE_ARGS *cum, enum machine_mode mode,
  ...
  return construct_container(
      mode, orig_mode, type, 0, cum->nregs, cum->sse_nregs,
      &x86_64_int_parameter_registers[cum->regno], cum->sse_regno);
}

static rtx function_arg_ms_64(CUMULATIVE_ARGS *cum, enum machine_mode mode,
...
rtx function_arg(CUMULATIVE_ARGS *cum, enum machine_mode omode, tree type,
                 int named) {
...
static bool ix86_pass_by_reference(CUMULATIVE_ARGS *cum ATTRIBUTE_UNUSED,
...
/* Return true when TYPE should be 128bit aligned for 32bit argument passing
   ABI.  */
static bool contains_aligned_value_p(tree type) {
  enum machine_mode mode = TYPE_MODE(type);
...
int ix86_function_arg_boundary(enum machine_mode mode, tree type) {
  int align;
  if (type) {
...
bool ix86_function_value_regno_p(int regno) {
  switch (regno) {
    case 0:
      return true;
...
static rtx function_value_32(enum machine_mode orig_mode,
                             enum machine_mode mode, const_tree fntype,
                             const_tree fn) {
  unsigned int regno;
  ...
  else if (mode == TImode || (VECTOR_MODE_P(mode) && GET_MODE_SIZE(mode) == 16))
...
static rtx function_value_64(enum machine_mode orig_mode,
                             enum machine_mode mode, const_tree valtype) {
  rtx ret;
  ...
  ret = construct_container(mode, orig_mode, valtype, 1, X86_64_REGPARM_MAX,
                            X86_64_SSE_REGPARM_MAX, x86_64_int_return_registers,
                            0);
...
static rtx function_value_ms_64(enum machine_mode orig_mode,
...
static rtx ix86_function_value_1(const_tree valtype, const_tree fntype_or_decl,
                                 enum machine_mode orig_mode,
                                 enum machine_mode mode) {
...
static rtx ix86_function_value(const_tree valtype, const_tree fntype_or_decl,
...
rtx ix86_libcall_value(enum machine_mode mode) {
  return ix86_function_value_1(NULL, NULL, mode, mode);
}

/* Return true iff type is returned in memory.  */

static int ATTRIBUTE_UNUSED return_in_memory_32(const_tree type,
                                                enum machine_mode mode) {
  HOST_WIDE_INT size;
...
static int ATTRIBUTE_UNUSED return_in_memory_64(const_tree type,
                                                enum machine_mode mode) {
  int needed_intregs, needed_sseregs;
  return !examine_argument(mode, type, 1, &needed_intregs, &needed_sseregs);
}

static int ATTRIBUTE_UNUSED return_in_memory_ms_64(const_tree type,
                                                   enum machine_mode mode) {
  HOST_WIDE_INT size = int_size_in_bytes(type);
...
static bool ix86_return_in_memory(const_tree type,
...
bool ix86_sol10_return_in_memory(const_tree type,
                                 const_tree fntype ATTRIBUTE_UNUSED) {
  int size;
...
static rtx ix86_struct_value_rtx(tree type, int incoming ATTRIBUTE_UNUSED) {
  static bool warnedsse, warnedmmx;
  ...
  if (!TARGET_64BIT && type) {
    ...
    if (!TARGET_MMX && !warnedmmx) {
      if (VECTOR_MODE_P(mode) && GET_MODE_SIZE(mode) == 8) {
        warnedmmx = true;
        warning(0,
                "MMX vector return without MMX enabled "
                "changes the ABI");
      }
    }
  }
...
static tree ix86_build_builtin_va_list_abi(enum calling_abi abi) {
  ...
  f_gpr =
      build_decl(FIELD_DECL, get_identifier("gp_offset"), unsigned_type_node);
  f_fpr =
      build_decl(FIELD_DECL, get_identifier("fp_offset"), unsigned_type_node);
  f_ovf = build_decl(FIELD_DECL, get_identifier("overflow_arg_area"),
                     ptr_type_node);
  f_sav =
      build_decl(FIELD_DECL, get_identifier("reg_save_area"), ptr_type_node);
...
static void setup_incoming_varargs_64(CUMULATIVE_ARGS *cum) {
  rtx save_area, mem;
  rtx label;
  rtx label_ref;
  rtx tmp_reg;
  ...
  for (i = cum->regno;
       i < regparm && i < cum->regno + cfun->va_list_gpr_size / UNITS_PER_WORD;
       i++) {
    mem = gen_rtx_MEM(Pmode, plus_constant(save_area, i * UNITS_PER_WORD));
    MEM_NOTRAP_P(mem) = 1;
    set_mem_alias_set(mem, set);
    emit_move_insn(mem, gen_rtx_REG(Pmode, x86_64_int_parameter_registers[i]));
  }
  ...
  if (ix86_varargs_fpr_size) {
    ...
    if (TARGET_AVX)
      emit_insn(gen_rtx_SET(VOIDmode, tmp_reg,
                            gen_rtx_PLUS(Pmode, tmp_reg, nsse_reg)));

    if (cum->sse_regno)
      emit_move_insn(
          nsse_reg,
          gen_rtx_CONST(DImode, gen_rtx_PLUS(DImode, label_ref,
    ...
    tmp_reg = gen_reg_rtx(Pmode);
    emit_insn(
        gen_rtx_SET(VOIDmode, tmp_reg,
                    plus_constant(save_area, ix86_varargs_gpr_size + 127)));
    ...
    emit_insn(
        gen_sse_prologue_save(mem, nsse_reg, GEN_INT(cum->sse_regno), label));
  }
}

static void setup_incoming_varargs_ms_64(CUMULATIVE_ARGS *cum) {
  ...
  for (i = cum->regno; i < X64_REGPARM_MAX; i++) {
    ...
    mem = gen_rtx_MEM(
        Pmode, plus_constant(virtual_incoming_args_rtx, i * UNITS_PER_WORD));
    MEM_NOTRAP_P(mem) = 1;
    set_mem_alias_set(mem, set);
...
static void ix86_setup_incoming_varargs(CUMULATIVE_ARGS *cum,
                                        enum machine_mode mode, tree type,
...
static bool is_va_list_char_pointer(tree type) {
  tree canonic;
...
static void ix86_va_start(tree valist, rtx nextarg) {
  ...
  if (cfun->va_list_gpr_size) {
    type = TREE_TYPE(gpr);
    t = build2(MODIFY_EXPR, type, gpr, build_int_cst(type, n_gpr * 8));
  ...
  if (words != 0)
    t = build2(POINTER_PLUS_EXPR, type, t, size_int(words * UNITS_PER_WORD));
  ...
  if (ix86_varargs_gpr_size || ix86_varargs_fpr_size) {
    ...
    if (!ix86_varargs_gpr_size)
      t = build2(POINTER_PLUS_EXPR, type, t, size_int(-8 * X86_64_REGPARM_MAX));
...
static tree ix86_gimplify_va_arg(tree valist, tree type, gimple_seq *pre_p,
                                 gimple_seq *post_p) {
  ...
  if (container) {
    ...
    need_temp =
        (!REG_P(container) &&
         ((needed_intregs && TYPE_ALIGN(type) > 64) || TYPE_ALIGN(type) > 128));
    ...
    if (need_temp) {
      ...
      for (i = 0; i < XVECLEN(container, 0); i++) {
        ...
        tree daddr_type =
            build_pointer_type_for_mode(piece_type, ptr_mode, true);
        tree src_addr, src;
        int src_offset;
        tree dest_addr, dest;
  ...
  if (arg_boundary <= 64 || integer_zerop(TYPE_SIZE(type)))
    t = ovf;
  else {
    HOST_WIDE_INT align = arg_boundary / 8;
    t = build2(POINTER_PLUS_EXPR, TREE_TYPE(ovf), ovf, size_int(align - 1));
    t = fold_convert(sizetype, t);
    t = build2(BIT_AND_EXPR, TREE_TYPE(t), t, size_int(-align));
...
int ix86_check_movabs(rtx insn, int opnum) {
  rtx set, mem;
...
int standard_80387_constant_p(rtx x) {
...
const char *standard_80387_constant_opcode(rtx x) {
...
rtx standard_80387_constant_rtx(int idx) {
  int i;
...
static int standard_sse_mode_p(enum machine_mode mode) {
  switch (mode) {
    case V16QImode:
    case V8HImode:
    case V4SImode:
...
int standard_sse_constant_p(rtx x) {
  enum machine_mode mode = GET_MODE(x);
...
const char *standard_sse_constant_opcode(rtx insn, rtx x) {
...
int symbolic_reference_mentioned_p(rtx op) {
  const char *fmt;
  int i;
...
int ix86_can_use_return_insn_p(void) {
...
int ix86_frame_pointer_required(void) {
  ...
  if (TARGET_OMIT_LEAF_FRAME_POINTER &&
      (!current_function_is_leaf || ix86_current_function_calls_tls_descriptor))
    return 1;
...
static void get_pc_thunk_name(char name[32], unsigned int regno) {
  gcc_assert(!TARGET_64BIT);
...
void ix86_file_end(void) {
  ...
  for (regno = 0; regno < 8; ++regno) {
    ...
    if (TARGET_MACHO) {
      ...
      decl = build_decl(FUNCTION_DECL, get_identifier(name), error_mark_node);
      TREE_PUBLIC(decl) = 1;
      TREE_STATIC(decl) = 1;
...
const char *output_set_got(rtx dest, rtx label ATTRIBUTE_UNUSED) {
  rtx xops[3];
  ...
  if (TARGET_VXWORKS_RTP && flag_pic) {
    ...
    xops[2] = gen_rtx_MEM(Pmode, gen_rtx_SYMBOL_REF(Pmode, VXWORKS_GOTT_BASE));
...
static rtx gen_push(rtx arg) {
  return gen_rtx_SET(
      VOIDmode, gen_rtx_MEM(Pmode, gen_rtx_PRE_DEC(Pmode, stack_pointer_rtx)),
      arg);
}
...
static int ix86_save_reg(unsigned int regno, int maybe_eh_return) {
  if (pic_offset_table_rtx && regno == REAL_PIC_OFFSET_TABLE_REGNUM &&
      (df_regs_ever_live_p(REAL_PIC_OFFSET_TABLE_REGNUM) || crtl->profile ||
       crtl->calls_eh_return || crtl->uses_const_pool)) {
...
static int ix86_nsaved_sseregs(void) {
  int nregs = 0;
  int regno;
...
int ix86_can_eliminate(int from, int to) {
  if (stack_realign_fp)
...
static rtx ix86_builtin_setjmp_frame_value(void) {
  return stack_realign_fp ? hard_frame_pointer_rtx : virtual_stack_vars_rtx;
}

/* Fill structure ix86_frame about frame of currently computed function.  */

static void ix86_compute_frame_layout(struct ix86_frame *frame) {
  ...
  if (!optimize_function_for_size_p(cfun) &&
    ...
    if (cfun->function_frequency < FUNCTION_FREQUENCY_NORMAL ||
      ...
      cfun->machine->use_fast_prologue_epilogue = !expensive_function_p(count);
  }
  ...
  frame->padding1 =
      ((offset + stack_alignment_needed - 1) & -stack_alignment_needed) -
      offset;
  ...
  if (!current_function_is_leaf || cfun->calls_alloca ||
      ix86_current_function_calls_tls_descriptor)
    frame->padding2 =
        ((offset + preferred_alignment - 1) & -preferred_alignment) - offset;
  else
    frame->padding2 = 0;
  ...
  frame->to_allocate = (size + frame->padding1 + frame->padding2 +
  ...
  if (!TARGET_64BIT_MS_ABI && TARGET_RED_ZONE &&
      current_function_sp_is_unchanging && current_function_is_leaf &&
      !ix86_current_function_calls_tls_descriptor) {
...
static void ix86_emit_save_regs_using_mov(rtx pointer, HOST_WIDE_INT offset) {
  unsigned int regno;
  rtx insn;
  ...
  for (regno = 0; regno < FIRST_PSEUDO_REGISTER; regno++)
    if (!SSE_REGNO_P(regno) && ix86_save_reg(regno, true)) {
      insn = emit_move_insn(
          adjust_address(gen_rtx_MEM(Pmode, pointer), Pmode, offset),
...
/* Emit code to save registers using MOV insns.  First register
   is restored from POINTER + OFFSET.  */
static void ix86_emit_save_sse_regs_using_mov(rtx pointer,
                                              HOST_WIDE_INT offset) {
  unsigned int regno;
  rtx insn;
  rtx mem;
...
static void pro_epilogue_adjust_stack(rtx dest, rtx src, rtx offset,
                                      int style) {
  rtx insn;
  ...
  if (!TARGET_64BIT)
    ...
    if (style < 0)
      RTX_FRAME_RELATED_P(insn) = 1;
    insn = emit_insn(
        gen_pro_epilogue_adjust_stack_rex64_2(dest, src, r11, offset));
  }
  if (style < 0)
    RTX_FRAME_RELATED_P(insn) = 1;
}
...
static unsigned int find_drap_reg(void) {
  tree decl = cfun->decl;
  ...
  if (TARGET_64BIT) {
    ...
    if ((decl_function_context(decl) && !DECL_NO_STATIC_CHAIN(decl)) ||
        crtl->tail_call_emit)
      return R13_REG;
...
static void ix86_update_stack_boundary(void) {
  ...
  /* x86_64 vararg needs 16byte stack alignment for register save
     area.  */
  if (TARGET_64BIT && cfun->stdarg && crtl->stack_alignment_estimated < 128)
...
static rtx ix86_get_drap_rtx(void) {
...
static void ix86_dwarf_handle_frame_unspec(const char *label, rtx pattern,
                                           int index) {
  ...
  switch (index) {
    case UNSPEC_REG_SAVE:
      dwarf2out_reg_save_reg(label, XVECEXP(unspec, 0, 0), SET_DEST(pattern));
      break;
    case UNSPEC_DEF_CFA:
...
static void ix86_finalize_stack_realign_flags(void) {
  /* Check if stack realign is really needed after reload, and
     stores result in cfun */
  unsigned int incoming_stack_boundary =
      (crtl->parm_stack_boundary > ix86_incoming_stack_boundary
           ? crtl->parm_stack_boundary
           : ix86_incoming_stack_boundary);
  unsigned int stack_realign =
      (incoming_stack_boundary < (current_function_is_leaf
...
void ix86_expand_prologue(void) {
  ...
  if (crtl->drap_reg && crtl->stack_realign_needed) {
    ...
    int param_ptr_offset =
        (call_used_regs[REGNO(crtl->drap_reg)] ? 0 : UNITS_PER_WORD);

    gcc_assert(stack_realign_drap);

    /* Grab the argument pointer.  */
    x = plus_constant(stack_pointer_rtx, (UNITS_PER_WORD + param_ptr_offset));
    y = crtl->drap_reg;
    ...
    x = crtl->drap_reg;
    x = gen_frame_mem(Pmode, plus_constant(x, -UNITS_PER_WORD));
  ...
  if (allocate == 0)
    ...
    REG_NOTES(insn) =
        gen_rtx_EXPR_LIST(REG_FRAME_RELATED_EXPR, t, REG_NOTES(insn));

    if (eax_live) {
      if (frame_pointer_needed)
        t = plus_constant(
            hard_frame_pointer_rtx,
            allocate - frame.to_allocate - frame.nregs * UNITS_PER_WORD);
      else
  ...
  if (frame.save_regs_using_mov &&
    ...
    if (!frame_pointer_needed || !frame.to_allocate ||
      ...
      ix86_emit_save_regs_using_mov(
          stack_pointer_rtx,
          frame.to_allocate + frame.nsseregs * 16 + frame.padding0);
    else
      ix86_emit_save_regs_using_mov(hard_frame_pointer_rtx,
                                    -frame.nregs * UNITS_PER_WORD);
  }
  if (!frame_pointer_needed || !frame.to_allocate || crtl->stack_realign_needed)
    ix86_emit_save_sse_regs_using_mov(stack_pointer_rtx, frame.to_allocate);
  else
    ix86_emit_save_sse_regs_using_mov(
        hard_frame_pointer_rtx,
        -frame.nregs * UNITS_PER_WORD - frame.nsseregs * 16 - frame.padding0);
  ...
  if (pic_reg_used) {
    if (TARGET_64BIT) {
      if (ix86_cmodel == CM_LARGE_PIC) {
        ...
        insn = emit_insn(
            gen_adddi3(pic_offset_table_rtx, pic_offset_table_rtx, tmp_reg));
      } else
...
/* Emit code to restore saved registers using MOV insns.  First register
   is restored from POINTER + OFFSET.  */
static void ix86_emit_restore_regs_using_mov(rtx pointer, HOST_WIDE_INT offset,
                                             int maybe_eh_return) {
  int regno;
...
/* Emit code to restore saved registers using MOV insns.  First register
   is restored from POINTER + OFFSET.  */
static void ix86_emit_restore_sse_regs_using_mov(rtx pointer,
                                                 HOST_WIDE_INT offset,
                                                 int maybe_eh_return) {
  int regno;
...
void ix86_expand_epilogue(int style) {
  int regno;
  int sp_valid;
  struct ix86_frame frame;
  HOST_WIDE_INT offset;
  ...
  if ((!sp_valid && (frame.nregs + frame.nsseregs) <= 1) ||
    ...
    if (!frame_pointer_needed || (sp_valid && !frame.to_allocate) ||
        stack_realign_fp) {
      ix86_emit_restore_sse_regs_using_mov(stack_pointer_rtx, frame.to_allocate,
                                           style == 2);
      ix86_emit_restore_regs_using_mov(
          stack_pointer_rtx,
          frame.to_allocate + frame.nsseregs * 16 + frame.padding0, style == 2);
    } else {
      ix86_emit_restore_sse_regs_using_mov(hard_frame_pointer_rtx, offset,
                                           style == 2);
      ix86_emit_restore_regs_using_mov(
          hard_frame_pointer_rtx, offset + frame.nsseregs * 16 + frame.padding0,
          style == 2);
    }
    ...
    if (style == 2) {
      ...
      if (frame_pointer_needed) {
        ...
        pro_epilogue_adjust_stack(stack_pointer_rtx, sa, const0_rtx, style);
      } else {
      ...
      pro_epilogue_adjust_stack(
          ...
          GEN_INT(frame.to_allocate + frame.nregs * UNITS_PER_WORD +
                  frame.nsseregs * 16 + frame.padding0),
          style);
    ...
    if (!sp_valid) {
      ...
      pro_epilogue_adjust_stack(
          stack_pointer_rtx, stack_pointer_rtx,
          GEN_INT(frame.to_allocate + frame.nsseregs * 16 + frame.padding0),
          style);
    }
  ...
  if (crtl->drap_reg && crtl->stack_realign_needed) {
    int param_ptr_offset =
        (call_used_regs[REGNO(crtl->drap_reg)] ? 0 : UNITS_PER_WORD);
    gcc_assert(stack_realign_drap);
    emit_insn((*ix86_gen_add3)(stack_pointer_rtx, crtl->drap_reg,
                               GEN_INT(-(UNITS_PER_WORD + param_ptr_offset))));
    if (!call_used_regs[REGNO(crtl->drap_reg)])
...
static void ix86_output_function_epilogue(FILE *file ATTRIBUTE_UNUSED,
     ...
     it looks like we might want one, insert a NOP.  */
  {
    ...
    while (insn && NOTE_P(insn) && NOTE_KIND(insn) != NOTE_INSN_DELETED_LABEL)
      insn = PREV_INSN(insn);
    if (insn && (LABEL_P(insn) ||
                 (NOTE_P(insn) && NOTE_KIND(insn) == NOTE_INSN_DELETED_LABEL)))
      fputs("\tnop\n", file);
  }
#endif
}
...
int ix86_decompose_address(rtx addr, struct ix86_address *out) {
  ...
  if (REG_P(addr) || GET_CODE(addr) == SUBREG)
    ...
    for (i = n; i >= 0; --i) {
      ...
      switch (GET_CODE(op)) {
        ...
        case UNSPEC:
          if (XINT(op, 1) == UNSPEC_TP && TARGET_TLS_DIRECT_SEG_REFS &&
              seg == SEG_DEFAULT)
  ...
  if (base_reg && index_reg && scale == 1 &&
      (index_reg == arg_pointer_rtx || index_reg == frame_pointer_rtx ||
  ...
  if ((base_reg == hard_frame_pointer_rtx || base_reg == frame_pointer_rtx ||
  ...
  if (TARGET_K6 && cfun && optimize_function_for_speed_p(cfun) && base_reg &&
      !index_reg && !disp && REG_P(base_reg) &&
...
/* Return cost of the memory address x.
   ...
   lifetimes.  */
static int ix86_address_cost(rtx x, bool speed ATTRIBUTE_UNUSED) {
...
static bool darwin_local_data_pic(rtx disp) {
  return (GET_CODE(disp) == UNSPEC && XINT(disp, 1) == UNSPEC_MACHOPIC_OFFSET);
}

/* Determine if a given RTX is a valid constant.  We already know this
   satisfies CONSTANT_P.  */

bool legitimate_constant_p(rtx x) {
  switch (GET_CODE(x)) {
    case CONST:
      x = XEXP(x, 0);
    ...
    case SYMBOL_REF:
      ...
      if (TARGET_DLLIMPORT_DECL_ATTRIBUTES && SYMBOL_REF_DLLIMPORT_P(x))
        return false;
      break;

    case CONST_DOUBLE:
      if (GET_MODE(x) == TImode && x != CONST0_RTX(TImode) && !TARGET_64BIT)
        return false;
      break;
...
static bool ix86_cannot_force_const_mem(rtx x) {
...
bool legitimate_pic_operand_p(rtx x) {
  ...
  switch (GET_CODE(x)) {
    case CONST:
      inner = XEXP(x, 0);
      if (GET_CODE(inner) == PLUS && CONST_INT_P(XEXP(inner, 1)))
        inner = XEXP(inner, 0);
...
int legitimate_pic_address_disp_p(rtx disp) {
  bool saw_plus;
  ...
  if (TARGET_64BIT) {
    ...
    switch (GET_CODE(disp)) {
      ...
      case CONST:
        ...
        if (!CONST_INT_P(op1) || INTVAL(op1) >= 16 * 1024 * 1024 ||
  ...
  if (TARGET_64BIT) {
    ...
    if (GET_CODE(disp) != UNSPEC ||
        (XINT(disp, 1) != UNSPEC_GOTPCREL && XINT(disp, 1) != UNSPEC_GOTOFF &&
...
int legitimate_address_p(enum machine_mode mode ATTRIBUTE_UNUSED, rtx addr,
                         int strict) {
  struct ix86_address parts;
  rtx base, index, disp;
  HOST_WIDE_INT scale;
  ...
  if (disp) {
    ...
    } else if (GET_CODE(disp) != LABEL_REF && !CONST_INT_P(disp) &&
               (GET_CODE(disp) != CONST || !legitimate_constant_p(disp)) &&
               (GET_CODE(disp) != SYMBOL_REF || !legitimate_constant_p(disp))) {
      reason = "displacement is not constant";
      goto report_error;
    } else if (TARGET_64BIT && !x86_64_immediate_operand(disp, VOIDmode)) {
...
static alias_set_type ix86_GOT_alias_set(void) {
...
static rtx legitimize_pic_address(rtx orig, rtx reg) {
  rtx addr = orig;
  rtx new_rtx = orig;
  rtx base;
  ...
  if (TARGET_64BIT && legitimate_pic_address_disp_p(addr))
    ...
    if (GET_CODE(addr) == PLUS) {
      new_rtx =
          gen_rtx_UNSPEC(Pmode, gen_rtvec(1, XEXP(addr, 0)), UNSPEC_GOTOFF);
    ...
    if (CONST_INT_P(addr) && !x86_64_immediate_operand(addr, VOIDmode)) {
      if (reg) {
      ...
      if (GET_CODE(addr) == UNSPEC ||
          (GET_CODE(addr) == PLUS && GET_CODE(XEXP(addr, 0)) == UNSPEC))
        return orig;
    ...
    if (GET_CODE(addr) == PLUS) {
      ...
      /* Check first to see if this is a constant offset from a @GOTOFF
         symbol reference.  */
      if (gotoff_operand(op0, Pmode) && CONST_INT_P(op1)) {
        if (!TARGET_64BIT) {
          if (reload_in_progress)
            df_set_regs_ever_live(PIC_OFFSET_TABLE_REGNUM, true);
          new_rtx = gen_rtx_UNSPEC(Pmode, gen_rtvec(1, op0), UNSPEC_GOTOFF);
        ...
        new_rtx =
            legitimize_pic_address(XEXP(addr, 1), base == reg ? NULL_RTX : reg);
...
static rtx get_thread_pointer(int to_reg) {
  rtx tp, reg, insn;
...
static rtx legitimize_tls_address(rtx x, enum tls_model model, int for_mov) {
  ...
  switch (model) {
    ...
    case TLS_MODEL_LOCAL_EXEC:
      off = gen_rtx_UNSPEC(
          Pmode, gen_rtvec(1, x),
          (TARGET_64BIT || TARGET_ANY_GNU_TLS) ? UNSPEC_NTPOFF : UNSPEC_TPOFF);
      off = gen_rtx_CONST(Pmode, off);
...
static GTY((if_marked("tree_map_marked_p"),
            param_is(struct tree_map))) htab_t dllimport_map;

static tree get_dllimport_decl(tree decl) {
  ...
  *loc = h = GGC_NEW(struct tree_map);
  ...
  name = IDENTIFIER_POINTER(DECL_ASSEMBLER_NAME(decl));
  name = targetm.strip_name_encoding(name);
  prefix = name[0] == FASTCALL_PREFIX || user_label_prefix[0] == 0 ? "*__imp_"
                                                                   : "*__imp__";
  namelen = strlen(name);
...
static rtx legitimize_dllimport_symbol(rtx symbol, bool want_reg) {
  tree imp_decl;
  rtx x;
...
rtx legitimize_address(rtx x, rtx oldx ATTRIBUTE_UNUSED,
                       enum machine_mode mode) {
  int changed = 0;
  unsigned log;
  ...
  if (GET_CODE(x) == CONST && GET_CODE(XEXP(x, 0)) == PLUS &&
    ...
    rtx t =
        legitimize_tls_address(XEXP(XEXP(x, 0), 0), (enum tls_model)log, false);
  ...
  if (GET_CODE(x) == ASHIFT && CONST_INT_P(XEXP(x, 1)) &&
    ...
    changed = 1;
    log = INTVAL(XEXP(x, 1));
    x = gen_rtx_MULT(Pmode, force_reg(Pmode, XEXP(x, 0)), GEN_INT(1 << log));
  }

  if (GET_CODE(x) == PLUS) {
    /* Canonicalize shifts by 0, 1, 2, 3 into multiply.  */

    if (GET_CODE(XEXP(x, 0)) == ASHIFT && CONST_INT_P(XEXP(XEXP(x, 0), 1)) &&
        (unsigned HOST_WIDE_INT)INTVAL(XEXP(XEXP(x, 0), 1)) < 4) {
      changed = 1;
      log = INTVAL(XEXP(XEXP(x, 0), 1));
      XEXP(x, 0) = gen_rtx_MULT(Pmode, force_reg(Pmode, XEXP(XEXP(x, 0), 0)),
                                GEN_INT(1 << log));
    }

    if (GET_CODE(XEXP(x, 1)) == ASHIFT && CONST_INT_P(XEXP(XEXP(x, 1), 1)) &&
        (unsigned HOST_WIDE_INT)INTVAL(XEXP(XEXP(x, 1), 1)) < 4) {
      changed = 1;
      log = INTVAL(XEXP(XEXP(x, 1), 1));
      XEXP(x, 1) = gen_rtx_MULT(Pmode, force_reg(Pmode, XEXP(XEXP(x, 1), 0)),
                                GEN_INT(1 << log));
    }
    ...
    /* Canonicalize
       ...
       into (plus (plus (mult (reg) (const)) (reg)) (const)).  */
             ...
             GET_CODE(XEXP(XEXP(x, 0), 1)) == PLUS && CONSTANT_P(XEXP(x, 1))) {
      rtx constant;
      rtx other = NULL_RTX;
    ...
    if (changed && REG_P(XEXP(x, 1)) && REG_P(XEXP(x, 0)))
      return x;
...
static void output_pic_addr_const(FILE *file, rtx x, int code) {
  char buf[256];
    ...
    case CONST_DOUBLE:
      if (GET_MODE(x) == VOIDmode) {
        ...
        if (CONST_DOUBLE_HIGH(x) || CONST_DOUBLE_LOW(x) < 0)
          fprintf(file, "0x%lx%08lx", (unsigned long)CONST_DOUBLE_HIGH(x),
    ...
    case UNSPEC:
      ...
      switch (XINT(x, 1)) {
        ...
        case UNSPEC_PLTOFF:
          ...
          break;
        case UNSPEC_GOTPCREL:
          fputs(ASSEMBLER_DIALECT == ASM_ATT ? "@GOTPCREL(%rip)"
                                             : "@GOTPCREL[rip]",
                file);
          break;
        case UNSPEC_GOTTPOFF:
        ...
        case UNSPEC_GOTNTPOFF:
          if (TARGET_64BIT)
            fputs(ASSEMBLER_DIALECT == ASM_ATT ? "@GOTTPOFF(%rip)"
                                               : "@GOTTPOFF[rip]",
                  file);
          else
...
static void ATTRIBUTE_UNUSED i386_output_dwarf_dtprel(FILE *file, int size,
                                                      rtx x) {
  fputs(ASM_LONG, file);
  output_addr_const(file, x);
  fputs("@DTPOFF", file);
...
static bool ix86_pic_register_p(rtx x) {
  if (GET_CODE(x) == VALUE)
...
static rtx ix86_delegitimize_address(rtx orig_x) {
  rtx x = orig_x;
  ...
  if (TARGET_64BIT) {
    if (GET_CODE(x) != CONST || GET_CODE(XEXP(x, 0)) != UNSPEC ||
        XINT(XEXP(x, 0), 1) != UNSPEC_GOTPCREL || !MEM_P(orig_x))
      return orig_x;
  ...
  if (ix86_pic_register_p(XEXP(x, 0)))
    ...
    if (ix86_pic_register_p(XEXP(reg_addend, 0)))
      ...
      return orig_x;
    if (!REG_P(reg_addend) && GET_CODE(reg_addend) != MULT &&
  ...
  if (TARGET_MACHO && darwin_local_data_pic(x) && !MEM_P(orig_x))
    result = XVECEXP(x, 0, 0);
...
rtx ix86_find_base_term(rtx x) {
  ...
  if (TARGET_64BIT) {
    ...
    if (GET_CODE(term) == PLUS &&
        (CONST_INT_P(XEXP(term, 1)) || GET_CODE(XEXP(term, 1)) == CONST_DOUBLE))
      term = XEXP(term, 0);
...
static void put_condition_code(enum rtx_code code, enum machine_mode mode,
                               int reverse, int fp, FILE *file) {
  const char *suffix;
...
void print_reg(rtx x, int code, FILE *file) {
  ...
  gcc_assert(x == pc_rtx ||
             (REGNO(x) != ARG_POINTER_REGNUM &&
              REGNO(x) != FRAME_POINTER_REGNUM && REGNO(x) != FLAGS_REG &&
              REGNO(x) != FPSR_REG && REGNO(x) != FPCR_REG));
...
static int get_some_local_dynamic_name_1(rtx *px, void *data ATTRIBUTE_UNUSED) {
  rtx x = *px;
...
void print_operand(FILE *file, rtx x, int code) {
  ...
  if (REG_P(x))
    ...
    if (CONSTANT_ADDRESS_P(x) && code == 'P' && !CONST_INT_P(x))
      output_addr_const(file, x);
...
void print_operand_address(FILE *file, rtx addr) {
  ...
  if (TARGET_64BIT && !base && !index) {
    ...
    if (GET_CODE(symbol) == LABEL_REF ||
        (GET_CODE(symbol) == SYMBOL_REF && SYMBOL_REF_TLS_MODEL(symbol) == 0))
      base = pc_rtx;
  }
  if (!base && !index) {
...
bool output_addr_const_extra(FILE *file, rtx x) {
  ...
  switch (XINT(x, 1)) {
    ...
    case UNSPEC_GOTNTPOFF:
      ...
      if (TARGET_64BIT)
        fputs(
            ASSEMBLER_DIALECT == ASM_ATT ? "@GOTTPOFF(%rip)" : "@GOTTPOFF[rip]",
            file);
      else
        fputs("@GOTNTPOFF", file);
      break;
...
void split_di(rtx operands[], int num, rtx lo_half[], rtx hi_half[]) {
  while (num--) {
    rtx op = operands[num];
    ...
    if (MEM_P(op)) {
      ...
      lo_half[num] = simplify_gen_subreg(
          SImode, op, GET_MODE(op) == VOIDmode ? DImode : GET_MODE(op), 0);
      hi_half[num] = simplify_gen_subreg(
          SImode, op, GET_MODE(op) == VOIDmode ? DImode : GET_MODE(op), 4);
    }
  }
}
...
void split_ti(rtx operands[], int num, rtx lo_half[], rtx hi_half[]) {
  while (num--) {
    rtx op = operands[num];
...
const char *output_387_binary_op(rtx insn, rtx *operands) {
  static char buf[40];
  const char *p;
  const char *ssep;
...
int ix86_mode_needed(int entity, rtx insn) {
  ...
  if (CALL_P(insn) ||
      (NONJUMP_INSN_P(insn) && (asm_noperands(PATTERN(insn)) >= 0 ||
...
void emit_i387_cw_initialization(int mode) {
...
const char *output_fix_trunc(rtx insn, rtx *operands, int fisttp) {
...
static const char *output_387_ffreep(rtx *operands ATTRIBUTE_UNUSED, int opno) {
...
const char *output_fp_compare(rtx insn, rtx *operands, int eflags_p,
                              int unordered_p) {
  int stack_top_dies;
  rtx cmp_op0, cmp_op1;
  int is_sse = SSE_REG_P(operands[0]) || SSE_REG_P(operands[1]);
  ...
  if (STACK_REG_P(cmp_op1) && stack_top_dies &&
    ...
    static const char *const alt[16] = {"fcom%z2\t%y2\n\tfnstsw\t%0",
                                        "fcomp%z2\t%y2\n\tfnstsw\t%0",
                                        "fucom%z2\t%y2\n\tfnstsw\t%0",
                                        "fucomp%z2\t%y2\n\tfnstsw\t%0",
...
void ix86_output_addr_vec_elt(FILE *file, int value) {
...
void ix86_output_addr_diff_elt(FILE *file, int value, int rel) {
  const char *directive = ASM_LONG;
  ...
  if (TARGET_64BIT || TARGET_VXWORKS_RTP)
    ...
    asm_fprintf(file, "%s%U%s+[.-%s%d]\n", ASM_LONG, GOT_SYMBOL_NAME, LPREFIX,
                value);
}
...
void ix86_expand_clear(rtx dest) {
  rtx tmp;
...
rtx maybe_get_pool_constant(rtx x) {
...
void ix86_expand_move(enum machine_mode mode, rtx operands[]) {
  rtx op0, op1;
  ...
  if (GET_CODE(op1) == SYMBOL_REF) {
    ...
    if (model) {
      ...
      if (op1 == op0)
        return;
    } else if (TARGET_DLLIMPORT_DECL_ATTRIBUTES && SYMBOL_REF_DLLIMPORT_P(op1))
      op1 = legitimize_dllimport_symbol(op1, false);
  } else if (GET_CODE(op1) == CONST && GET_CODE(XEXP(op1, 0)) == PLUS &&
    ...
    else if (TARGET_DLLIMPORT_DECL_ATTRIBUTES && SYMBOL_REF_DLLIMPORT_P(symbol))
  ...
  if (flag_pic && mode == Pmode && symbolic_operand(op1, Pmode)) {
    if (TARGET_MACHO && !TARGET_64BIT) {
      ...
      if (MACHOPIC_PURE) {
        rtx temp =
            ((reload_in_progress || ((op0 && REG_P(op0)) && mode == Pmode))
                 ? op0
                 : gen_reg_rtx(Pmode));
        op1 = machopic_indirect_data_reference(op1, temp);
        op1 =
            machopic_legitimize_pic_address(op1, mode, temp == op1 ? 0 : temp);
    ...
    /* Force large constants in 64bit compilation into register
       to get them CSEed.  */
    if (can_create_pseudo_p() && (mode == DImode) && TARGET_64BIT &&
        immediate_operand(op1, mode) &&
        !x86_64_zext_immediate_operand(op1, VOIDmode) &&
        !register_operand(op0, mode) && optimize)
      op1 = copy_to_mode_reg(mode, op1);
...
void ix86_expand_vector_move(enum machine_mode mode, rtx operands[]) {
  ...
  if (can_create_pseudo_p() && register_operand(op0, mode) &&
      (CONSTANT_P(op1) ||
       (GET_CODE(op1) == SUBREG && CONSTANT_P(SUBREG_REG(op1)))) &&
      standard_sse_constant_p(op1) <= 0)
    op1 = validize_mem(force_const_mem(mode, op1));

  /* We need to check memory alignment for SSE mode since attribute
     can make operands unaligned.  */
  if (can_create_pseudo_p() && SSE_REG_MODE_P(mode) &&
...
void ix86_expand_vector_move_misalign(enum machine_mode mode, rtx operands[]) {
  rtx op0, op1, m;
...
void ix86_expand_push(enum machine_mode mode, rtx x) {
  rtx tmp;

  tmp = expand_simple_binop(Pmode, PLUS, stack_pointer_rtx,
                            GEN_INT(-GET_MODE_SIZE(mode)), stack_pointer_rtx, 1,
                            OPTAB_DIRECT);
...
static bool ix86_swap_binary_operands_p(enum rtx_code code,
                                        enum machine_mode mode,
                                        rtx operands[]) {
  rtx dst = operands[0];
  rtx src1 = operands[1];
...
rtx ix86_fixup_binary_operands(enum rtx_code code, enum machine_mode mode,
                               rtx operands[]) {
  rtx dst = operands[0];
  rtx src1 = operands[1];
  rtx src2 = operands[2];
...
void ix86_fixup_binary_operands_no_copy(enum rtx_code code,
                                        enum machine_mode mode,
                                        rtx operands[]) {
...
void ix86_expand_binary_operator(enum rtx_code code, enum machine_mode mode,
                                 rtx operands[]) {
...
int ix86_binary_operator_ok(enum rtx_code code, enum machine_mode mode,
                            rtx operands[3]) {
  rtx dst = operands[0];
  rtx src1 = operands[1];
  rtx src2 = operands[2];
...
void ix86_expand_unary_operator(enum rtx_code code, enum machine_mode mode,
                                rtx operands[]) {
  int matching_memory;
  rtx src, dst, op, clob;
...
int ix86_unary_operator_ok(enum rtx_code code ATTRIBUTE_UNUSED,
                           enum machine_mode mode ATTRIBUTE_UNUSED,
...
void ix86_split_convert_uns_si_sse(rtx operands[]) {
...
void ix86_expand_convert_uns_didf_sse(rtx target, rtx input) {
  ...
  x = gen_rtx_CONST_VECTOR(
      V4SImode, gen_rtvec(4, GEN_INT(0x43300000UL), GEN_INT(0x45300000UL),
...
void ix86_expand_convert_uns_sixf_sse(rtx target ATTRIBUTE_UNUSED,
...
void ix86_expand_convert_uns_sidf_sse(rtx target, rtx input) {
  REAL_VALUE_TYPE TWO31r;
  rtx x, fp;

  x = expand_simple_binop(SImode, PLUS, input, GEN_INT(-2147483647 - 1), NULL,
                          1, OPTAB_DIRECT);
...
void ix86_expand_convert_sign_didf_sse(rtx target, rtx input) {
  ...
  x = expand_simple_binop(DFmode, PLUS, fp_hi, fp_lo, target, 0, OPTAB_DIRECT);
  if (x != target)
    emit_move_insn(target, x);
}
...
void ix86_expand_convert_uns_sisf_sse(rtx target, rtx input) {
  ...
  int_lo = expand_simple_binop(SImode, AND, input, GEN_INT(0xffff), NULL, 0,
                               OPTAB_DIRECT);
  int_hi = expand_simple_binop(SImode, LSHIFTRT, input, GEN_INT(16), NULL, 0,
                               OPTAB_DIRECT);
  ...
  fp_hi = expand_simple_binop(SFmode, MULT, fp_hi, x, fp_hi, 0, OPTAB_DIRECT);
  fp_hi =
      expand_simple_binop(SFmode, PLUS, fp_hi, fp_lo, target, 0, OPTAB_DIRECT);
...
rtx ix86_build_const_vector(enum machine_mode mode, bool vect, rtx value) {
  rtvec v;
  switch (mode) {
    case SImode:
      gcc_assert(vect);
    ...
    case SFmode:
      if (vect)
        ...
        v = gen_rtvec(4, value, CONST0_RTX(SFmode), CONST0_RTX(SFmode),
                      CONST0_RTX(SFmode));
...
rtx ix86_build_signbit_mask(enum machine_mode mode, bool vect, bool invert) {
...
void ix86_expand_fp_absneg_operator(enum rtx_code code, enum machine_mode mode,
                                    rtx operands[]) {
...
void ix86_expand_copysign(rtx operands[]) {
  enum machine_mode mode;
  ...
  if (GET_CODE(op0) == CONST_DOUBLE) {
    ...
    if (mode == SFmode || mode == DFmode) {
      ...
      if (op0 == CONST0_RTX(mode))
        ...
        if (mode == SFmode)
          v = gen_rtvec(4, op0, CONST0_RTX(SFmode), CONST0_RTX(SFmode),
                        CONST0_RTX(SFmode));
        else
...
void ix86_split_copysign_const(rtx operands[]) {
...
void ix86_split_copysign_var(rtx operands[]) {
  enum machine_mode mode, vmode;
...
int ix86_match_ccmode(rtx insn, enum machine_mode req_mode) {
  rtx set;
...
enum machine_mode ix86_fp_compare_mode(enum rtx_code code ATTRIBUTE_UNUSED) {
...
enum machine_mode ix86_cc_mode(enum rtx_code code, rtx op0, rtx op1) {
  ...
  switch (code) {
    ...
    case LTU: /* CF=1 */
      ...
      if (GET_CODE(op0) == PLUS && rtx_equal_p(op1, XEXP(op0, 0)))
        return CCCmode;
      else
        return CCmode;
    case GTU: /* CF=0 & ZF=0 */
    case LEU: /* CF=1 | ZF=1 */
      /* Detect overflow checks.  They need just the carry flag.  */
      if (GET_CODE(op0) == MINUS && rtx_equal_p(op1, XEXP(op0, 0)))
        return CCCmode;
      else
        return CCmode;
...
static bool ix86_fixed_condition_code_regs(unsigned int *p1, unsigned int *p2) {
  *p1 = FLAGS_REG;
  *p2 = FPSR_REG;
  return true;
}
...
static enum machine_mode ix86_cc_modes_compatible(enum machine_mode m1,
...
void ix86_fp_comparison_codes(enum rtx_code code, enum rtx_code *bypass_code,
...
int ix86_use_fcomi_compare(enum rtx_code code ATTRIBUTE_UNUSED) {
  enum rtx_code swapped_code = swap_condition(code);

  return (
      (ix86_fp_comparison_cost(code) == ix86_fp_comparison_fcomi_cost(code)) ||
...
static enum rtx_code ix86_prepare_fp_compare_args(enum rtx_code code, rtx *pop0,
                                                  rtx *pop1) {
  ...
  if (!is_sse && (fpcmp_mode == CCFPUmode ||
                  (op_mode == XFmode &&
    ...
    if (standard_80387_constant_p(op0) == 0 ||
        (MEM_P(op0) && !(standard_80387_constant_p(op1) == 0 || MEM_P(op1)))) {
      rtx tmp;
...
enum rtx_code ix86_fp_compare_code_to_integer(enum rtx_code code) {
  switch (code) {
    case GT:
      return GTU;
    case GE:
...
static rtx ix86_expand_fp_compare(enum rtx_code code, rtx op0, rtx op1,
                                  rtx scratch, rtx *second_test,
                                  rtx *bypass_test) {
  ...
  if (ix86_fp_comparison_arithmetics_cost(code) > cost &&
    ...
    if (bypass_code != UNKNOWN)
      *bypass_test =
          gen_rtx_fmt_ee(bypass_code, VOIDmode,
                         gen_rtx_REG(intcmp_mode, FLAGS_REG), const0_rtx);
    if (second_code != UNKNOWN)
      *second_test =
          gen_rtx_fmt_ee(second_code, VOIDmode,
                         gen_rtx_REG(intcmp_mode, FLAGS_REG), const0_rtx);
  } else {
  ...
  /* Return the test that should be put into the flags user, i.e.
     the bcc, scc, or cmov instruction.  */
  return gen_rtx_fmt_ee(code, VOIDmode, gen_rtx_REG(intcmp_mode, FLAGS_REG),
                        const0_rtx);
}

rtx ix86_expand_compare(enum rtx_code code, rtx *second_test,
                        rtx *bypass_test) {
  rtx op0, op1, ret;
...
bool ix86_fp_jump_nontrivial_p(enum rtx_code code) {
  enum rtx_code bypass_code, first_code, second_code;
  if (!TARGET_CMOVE)
    return true;
  ix86_fp_comparison_codes(code, &bypass_code, &first_code, &second_code);
...
void ix86_expand_branch(enum rtx_code code, rtx label) {
  rtx tmp;
  ...
  switch (GET_MODE(ix86_compare_op0)) {
    ...
    case XFmode: {
      ...
      if (bypass_code == UNKNOWN && second_code == UNKNOWN) {
        ...
        tmp =
            gen_rtx_fmt_ee(code, VOIDmode, ix86_compare_op0, ix86_compare_op1);
        tmp = gen_rtx_IF_THEN_ELSE(VOIDmode, tmp,
                                   gen_rtx_LABEL_REF(VOIDmode, label), pc_rtx);
    ...
    case TImode:
      /* Expand DImode branch into multiple compare+branch.  */
      {
        ...
        if ((code == EQ || code == NE) &&
            (!optimize_insn_for_size_p() || hi[1] == const0_rtx ||
             lo[1] == const0_rtx)) {
          rtx xor0, xor1;

          xor1 = hi[0];
          if (hi[1] != const0_rtx)
            xor1 = expand_binop(submode, xor_optab, xor1, hi[1], NULL_RTX, 0,
                                OPTAB_WIDEN);

          xor0 = lo[0];
          if (lo[1] != const0_rtx)
            xor0 = expand_binop(submode, xor_optab, xor0, lo[1], NULL_RTX, 0,
                                OPTAB_WIDEN);

          tmp = expand_binop(submode, ior_optab, xor1, xor0, NULL_RTX, 0,
                             OPTAB_WIDEN);
...
void ix86_split_fp_branch(enum rtx_code code, rtx op1, rtx op2, rtx target1,
                          rtx target2, rtx tmp, rtx pushed) {
  rtx second, bypass;
  rtx label = NULL_RTX;
  rtx condition;
  ...
  if (bypass != NULL_RTX) {
    ...
    i = emit_jump_insn(gen_rtx_SET(
        VOIDmode, pc_rtx,
        gen_rtx_IF_THEN_ELSE(VOIDmode, bypass,
                             gen_rtx_LABEL_REF(VOIDmode, label), pc_rtx)));
    if (bypass_probability >= 0)
      REG_NOTES(i) = gen_rtx_EXPR_LIST(REG_BR_PROB, GEN_INT(bypass_probability),
                                       REG_NOTES(i));
  }
  i = emit_jump_insn(
      gen_rtx_SET(VOIDmode, pc_rtx,
                  gen_rtx_IF_THEN_ELSE(VOIDmode, condition, target1, target2)));
  if (probability >= 0)
    REG_NOTES(i) =
  ...
  if (second != NULL_RTX) {
    ...
    if (second_probability >= 0)
      REG_NOTES(i) = gen_rtx_EXPR_LIST(REG_BR_PROB, GEN_INT(second_probability),
                                       REG_NOTES(i));
  }
  if (label != NULL_RTX)
    emit_label(label);
...
int ix86_expand_setcc(enum rtx_code code, rtx dest) {
  ...
  if (ix86_compare_op0 && ix86_compare_op1) {
    equiv = simplify_gen_relational(code, QImode, GET_MODE(ix86_compare_op0),
                                    ix86_compare_op0, ix86_compare_op1);
...
static bool ix86_expand_carry_flag_compare(enum rtx_code code, rtx op0, rtx op1,
                                           rtx *pop) {
  enum machine_mode mode =
  ...
  if (SCALAR_FLOAT_MODE_P(mode)) {
    ...
    /* Try to expand the comparison and verify that we end up with
       ...
       too common scenario.  */
    start_sequence();
    compare_op = ix86_expand_fp_compare(code, op0, op1, NULL_RTX, &second_test,
                                        &bypass_test);
  ...
  switch (code) {
    ...
    case LEU:
      if (CONST_INT_P(op1)) {
        ...
        if (op1 == const0_rtx || !x86_64_immediate_operand(op1, GET_MODE(op1)))
          return false;
...
int ix86_expand_int_movcc(rtx operands[]) {
  ...
  if ((mode != HImode || TARGET_FAST_PREFIX) &&
      (mode != (TARGET_64BIT ? TImode : DImode)) && CONST_INT_P(operands[2]) &&
    ...
    if (sign_bit_compare_p ||
        ix86_expand_carry_flag_compare(code, ix86_compare_op0, ix86_compare_op1,
                                       &compare_op)) {
      ...
      if (!sign_bit_compare_p) {
        ...
        tmp = emit_store_flag(tmp, code, ix86_compare_op0, ix86_compare_op1,
                              VOIDmode, 0, -1);
      }
      ...
      if (diff == 1) {
         ...
         */
        if (ct)
          tmp = expand_simple_binop(mode, PLUS, tmp, GEN_INT(ct), copy_rtx(tmp),
                                    1, OPTAB_DIRECT);
      } else if (cf == -1) {
        /*
         * cmpl op0,op1
         ...
         * Size 8.
         */
        tmp = expand_simple_binop(mode, IOR, tmp, GEN_INT(ct), copy_rtx(tmp), 1,
                                  OPTAB_DIRECT);
      } else if (diff == -1 && ct) {
        /*
         * cmpl op0,op1
        ...
        if (cf)
          tmp = expand_simple_binop(mode, PLUS, copy_rtx(tmp), GEN_INT(cf),
        ...
        tmp = expand_simple_binop(mode, AND, copy_rtx(tmp),
                                  gen_int_mode(cf - ct, mode), copy_rtx(tmp), 1,
                                  OPTAB_DIRECT);
        if (ct)
          tmp = expand_simple_binop(mode, PLUS, copy_rtx(tmp), GEN_INT(ct),
                                    copy_rtx(tmp), 1, OPTAB_DIRECT);
      }
    ...
    if (compare_code != UNKNOWN &&
        GET_MODE(ix86_compare_op0) == GET_MODE(out) && (cf == -1 || ct == -1)) {
      /* If lea code below could be used, only optimize
         if it results in a 2 insn sequence.  */

      if (!(diff == 1 || diff == 2 || diff == 4 || diff == 8 || diff == 3 ||
            diff == 5 || diff == 9) ||
        ...
        out = emit_store_flag(out, code, ix86_compare_op0, ix86_compare_op1,
                              VOIDmode, 0, -1);

        out = expand_simple_binop(mode, IOR, out, GEN_INT(cf), out, 1,
                                  OPTAB_DIRECT);
        if (out != operands[0])
    ...
    if ((diff == 1 || diff == 2 || diff == 4 || diff == 8 || diff == 3 ||
        ...
        (mode != DImode || x86_64_immediate_operand(GEN_INT(cf), VOIDmode))) {
      /*
       * xorl dest,dest
       * cmpl op1,op2
       * setcc dest
    ...
    if ((!TARGET_CMOVE || (mode == QImode && TARGET_PARTIAL_REG_STALL)) &&
      ...
      out = expand_simple_binop(mode, AND, copy_rtx(out),
                                gen_int_mode(cf - ct, mode), copy_rtx(out), 1,
                                OPTAB_DIRECT);
      if (ct)
  ...
  emit_insn(gen_rtx_SET(
      VOIDmode, operands[0],
      gen_rtx_IF_THEN_ELSE(mode, compare_op, operands[2], operands[3])));
  if (bypass_test)
    emit_insn(gen_rtx_SET(
        VOIDmode, copy_rtx(operands[0]),
        gen_rtx_IF_THEN_ELSE(mode, bypass_test, copy_rtx(operands[3]),
                             copy_rtx(operands[0]))));
  if (second_test)
    emit_insn(gen_rtx_SET(
        VOIDmode, copy_rtx(operands[0]),
        gen_rtx_IF_THEN_ELSE(mode, second_test, copy_rtx(operands[2]),
                             copy_rtx(operands[0]))));
...
static enum rtx_code ix86_prepare_sse_fp_compare_args(rtx dest,
                                                      enum rtx_code code,
                                                      rtx *pop0, rtx *pop1) {
  rtx tmp;
...
static bool ix86_expand_sse_fp_minmax(rtx dest, enum rtx_code code, rtx cmp_op0,
...
static rtx ix86_expand_sse_cmp(rtx dest, enum rtx_code code, rtx cmp_op0,
  ...
  if (optimize || reg_overlap_mentioned_p(dest, op_true) ||
...
static void ix86_expand_sse_movcc(rtx dest, rtx cmp, rtx op_true,
                                  rtx op_false) {
  enum machine_mode mode = GET_MODE(dest);
  rtx t2, t3, x;
  ...
  if (op_false == CONST0_RTX(mode)) {
    ...
    rtx pcmov = gen_rtx_SET(mode, dest,
                            gen_rtx_IF_THEN_ELSE(mode, cmp, op_true, op_false));
    emit_insn(pcmov);
  } else {
    op_true = force_reg(mode, op_true);
    op_false = force_reg(mode, op_false);
...
int ix86_expand_fp_movcc(rtx operands[]) {
  enum machine_mode mode = GET_MODE(operands[0]);
  ...
  if (TARGET_SSE_MATH && SSE_FLOAT_MODE_P(mode)) {
    ...
    code = ix86_prepare_sse_fp_compare_args(
        operands[0], code, &ix86_compare_op0, &ix86_compare_op1);
    if (code == UNKNOWN)
      return 0;
  ...
  if (bypass_test)
    emit_insn(gen_rtx_SET(
        VOIDmode, operands[0],
        gen_rtx_IF_THEN_ELSE(mode, bypass_test, operands[3], operands[0])));
  if (second_test)
    emit_insn(gen_rtx_SET(
        VOIDmode, operands[0],
        gen_rtx_IF_THEN_ELSE(mode, second_test, operands[2], operands[0])));
...
bool ix86_expand_fp_vcond(rtx operands[]) {
  enum rtx_code code = GET_CODE(operands[3]);
  rtx cmp;

  code = ix86_prepare_sse_fp_compare_args(operands[0], code, &operands[4],
                                          &operands[5]);
  if (code == UNKNOWN)
    return false;

  if (ix86_expand_sse_fp_minmax(operands[0], code, operands[4], operands[5],
...
bool ix86_expand_int_vcond(rtx operands[]) {
  enum machine_mode mode = GET_MODE(operands[0]);
  enum rtx_code code = GET_CODE(operands[3]);
  bool negate = false;
  rtx x, cop0, cop1;
    ...
    if (code == GTU) {
      ...
      switch (mode) {
        ...
        case V2DImode: {
          ...
          t1 = gen_reg_rtx(mode);
          emit_insn(
              (mode == V4SImode ? gen_subv4si3 : gen_subv2di3)(t1, cop0, cop1));

          /* Extract the original sign bit of op0.  */
          mask = ix86_build_signbit_mask(GET_MODE_INNER(mode), true, false);
          t2 = gen_reg_rtx(mode);
          emit_insn(
              (mode == V4SImode ? gen_andv4si3 : gen_andv2di3)(t2, cop0, mask));

          /* XOR it back into the result of the subtraction.  This results
             in the sign bit set iff we saw unsigned underflow.  */
          x = gen_reg_rtx(mode);
          emit_insn(
              (mode == V4SImode ? gen_xorv4si3 : gen_xorv2di3)(x, t1, t2));
        ...
        case V8HImode:
          ...
          x = gen_reg_rtx(mode);
          emit_insn(
              gen_rtx_SET(VOIDmode, x, gen_rtx_US_MINUS(mode, cop0, cop1)));
  ...
  x = ix86_expand_sse_cmp(operands[0], code, cop0, cop1, operands[1 + negate],
                          operands[2 - negate]);
...
void ix86_expand_sse_unpack(rtx operands[2], bool unsigned_p, bool high_p) {
...
void ix86_expand_sse4_unpack(rtx operands[2], bool unsigned_p, bool high_p) {
  enum machine_mode imode = GET_MODE(operands[1]);
  rtx (*unpack)(rtx, rtx);
  rtx src, dest;
  ...
  if (high_p) {
    ...
    emit_insn(gen_sse2_lshrti3(gen_lowpart(TImode, src),
                               gen_lowpart(TImode, operands[1]), GEN_INT(64)));
  } else
    src = operands[1];
...
void ix86_expand_sse5_unpack(rtx operands[2], bool unsigned_p, bool high_p) {
  enum machine_mode imode = GET_MODE(operands[1]);
  int pperm_bytes[16];
  int i;
  int h = (high_p) ? 8 : 0;
  ...
  switch (imode) {
    case V16QImode:
      ...
      for (i = 0; i < 8; i++) {
        ...
        pperm_bytes[2 * i + 1] =
            ((unsigned_p) ? PPERM_ZERO : PPERM_SIGN | PPERM_SRC2 | i | h);
      }
...
void ix86_expand_sse5_pack(rtx operands[3]) {
...
int ix86_expand_int_addcc(rtx operands[]) {
  enum rtx_code code = GET_CODE(operands[1]);
  rtx compare_op;
  rtx val = const0_rtx;
  bool fpcmp = false;
  ...
  if (operands[3] != const1_rtx && operands[3] != constm1_rtx)
    return 0;
  if (!ix86_expand_carry_flag_compare(code, ix86_compare_op0, ix86_compare_op1,
                                      &compare_op))
    return 0;
  code = GET_CODE(compare_op);
  ...
  if ((code == LTU) == (operands[3] == constm1_rtx)) {
    switch (GET_MODE(operands[0])) {
      ...
      case DImode:
        emit_insn(
            gen_subdi3_carry_rex64(operands[0], operands[2], val, compare_op));
        break;
      default:
        gcc_unreachable();
    }
    ...
    switch (GET_MODE(operands[0])) {
      ...
      case DImode:
        emit_insn(
            gen_adddi3_carry_rex64(operands[0], operands[2], val, compare_op));
        break;
      default:
        gcc_unreachable();
    }
...
static int ix86_split_to_parts(rtx operand, rtx *parts,
                               enum machine_mode mode) {
  int size;
  ...
  if (!TARGET_64BIT) {
    ...
    if (mode == XFmode || mode == TFmode) {
      ...
      if (REG_P(operand)) {
        ...
        if (HOST_BITS_PER_WIDE_INT >= 64)
          parts[0] = gen_int_mode((l[0] & (((HOST_WIDE_INT)2 << 31) - 1)) +
        ...
        if (upper_mode == SImode)
          ...
          parts[1] = gen_int_mode((l[2] & (((HOST_WIDE_INT)2 << 31) - 1)) +
...
void ix86_split_long_move(rtx operands[]) {
  rtx part[2][4];
  int nparts, i, j;
  int push = 0;
  int collisions = 0;
  ...
  if (push_operand(operands[0], VOIDmode))
    ...
    gcc_assert(!MEM_P(operands[0]) || offsettable_memref_p(operands[0]));
  ...
  if (push && MEM_P(operands[1]) &&
    ...
    for (i = 0; i < nparts - 1; i++)
      part[1][i] = change_address(part[1][i], GET_MODE(part[1][i]),
                                  XEXP(part[1][i + 1], 0));
    ...
    if (!TARGET_64BIT) {
      if (nparts == 3) {
        if (TARGET_128BIT_LONG_DOUBLE && mode == XFmode)
          emit_insn(
              gen_addsi3(stack_pointer_rtx, stack_pointer_rtx, GEN_INT(-4)));
  ...
  if ((REG_P(part[0][0]) && REG_P(part[1][1]) &&
       (REGNO(part[0][0]) == REGNO(part[1][1]) ||
        (nparts == 3 && REGNO(part[0][0]) == REGNO(part[1][2])) ||
        (nparts == 4 && REGNO(part[0][0]) == REGNO(part[1][3])))) ||
      (collisions > 0 &&
  ...
  if (optimize_insn_for_size_p()) {
    for (j = 0; j < nparts - 1; j++)
      if (CONST_INT_P(operands[6 + j]) && operands[6 + j] != const0_rtx &&
          REG_P(operands[2 + j]))
...
static void ix86_expand_ashl_const(rtx operand, int count,
                                   enum machine_mode mode) {
  if (count == 1) {
    emit_insn(
        (mode == DImode ? gen_addsi3 : gen_adddi3)(operand, operand, operand));
  } else if (!optimize_insn_for_size_p() &&
             count * ix86_cost->add <= ix86_cost->shift_const) {
    int i;
    for (i = 0; i < count; i++) {
      emit_insn((mode == DImode ? gen_addsi3 : gen_adddi3)(operand, operand,
                                                           operand));
    }
  } else
    emit_insn((mode == DImode ? gen_ashlsi3 : gen_ashldi3)(operand, operand,
                                                           GEN_INT(count)));
}

void ix86_split_ashl(rtx *operands, rtx scratch, enum machine_mode mode) {
  rtx low[2], high[2];
  int count;
  ...
  if (CONST_INT_P(operands[2])) {
    ...
    if (count >= single_width) {
      ...
      if (!rtx_equal_p(operands[0], operands[1]))
        emit_move_insn(operands[0], operands[1]);
      emit_insn((mode == DImode ? gen_x86_shld : gen_x86_64_shld)(
          high[0], low[0], GEN_INT(count)));
  ...
  if (operands[1] == const1_rtx) {
    ...
    /* Otherwise, we can get the same results by manually performing
      ...
      emit_insn((mode == DImode ? gen_lshrsi3 : gen_lshrdi3)(
          high[0], high[0], GEN_INT(mode == DImode ? 5 : 6)));
      emit_insn((mode == DImode ? gen_andsi3 : gen_anddi3)(high[0], high[0],
                                                           GEN_INT(1)));
      emit_move_insn(low[0], high[0]);
      emit_insn((mode == DImode ? gen_xorsi3 : gen_xordi3)(low[0], low[0],
                                                           GEN_INT(1)));
    }

    emit_insn((mode == DImode ? gen_ashlsi3 : gen_ashldi3)(low[0], low[0],
                                                           operands[2]));
    emit_insn((mode == DImode ? gen_ashlsi3 : gen_ashldi3)(high[0], high[0],
                                                           operands[2]));
    return;
  }
  ...
  if (operands[1] == constm1_rtx) {
    ...
    (mode == DImode ? split_di : split_ti)(operands, 1, low, high);
    emit_insn((mode == DImode ? gen_x86_shld : gen_x86_64_shld)(high[0], low[0],
                                                                operands[2]));
  }
  ...
  if (TARGET_CMOVE && scratch) {
    ...
    emit_insn((mode == DImode ? gen_x86_shift_adj_1 : gen_x86_64_shift_adj_1)(
        high[0], low[0], operands[2], scratch));
  } else
    emit_insn((mode == DImode ? gen_x86_shift_adj_2 : gen_x86_64_shift_adj_2)(
        high[0], low[0], operands[2]));
}

void ix86_split_ashr(rtx *operands, rtx scratch, enum machine_mode mode) {
  rtx low[2], high[2];
  int count;
  const int single_width = mode == DImode ? 32 : 64;
  ...
  if (CONST_INT_P(operands[2])) {
    ...
    if (count == single_width * 2 - 1) {
      ...
      emit_insn((mode == DImode ? gen_ashrsi3 : gen_ashrdi3)(
          high[0], high[0], GEN_INT(single_width - 1)));
      emit_move_insn(low[0], high[0]);
      ...
      if (count > single_width)
        emit_insn((mode == DImode ? gen_ashrsi3 : gen_ashrdi3)(
            low[0], low[0], GEN_INT(count - single_width)));
    } else {
      if (!rtx_equal_p(operands[0], operands[1]))
        emit_move_insn(operands[0], operands[1]);
      emit_insn((mode == DImode ? gen_x86_shrd : gen_x86_64_shrd)(
          low[0], high[0], GEN_INT(count)));
      emit_insn((mode == DImode ? gen_ashrsi3 : gen_ashrdi3)(high[0], high[0],
                                                             GEN_INT(count)));
    }
  } else {
    if (!rtx_equal_p(operands[0], operands[1]))
    ...
    emit_insn((mode == DImode ? gen_x86_shrd : gen_x86_64_shrd)(low[0], high[0],
                                                                operands[2]));
    emit_insn((mode == DImode ? gen_ashrsi3 : gen_ashrdi3)(high[0], high[0],
                                                           operands[2]));
    ...
    if (TARGET_CMOVE && scratch) {
      ...
      emit_insn((mode == DImode ? gen_ashrsi3 : gen_ashrdi3)(
          scratch, scratch, GEN_INT(single_width - 1)));
      emit_insn((mode == DImode ? gen_x86_shift_adj_1 : gen_x86_64_shift_adj_1)(
          low[0], high[0], operands[2], scratch));
    } else
      emit_insn((mode == DImode ? gen_x86_shift_adj_3 : gen_x86_64_shift_adj_3)(
          low[0], high[0], operands[2]));
  }
}

void ix86_split_lshr(rtx *operands, rtx scratch, enum machine_mode mode) {
  rtx low[2], high[2];
  int count;
  const int single_width = mode == DImode ? 32 : 64;
  ...
  if (CONST_INT_P(operands[2])) {
    ...
    if (count >= single_width) {
      ...
      emit_insn((mode == DImode ? gen_x86_shrd : gen_x86_64_shrd)(
          low[0], high[0], GEN_INT(count)));
      emit_insn((mode == DImode ? gen_lshrsi3 : gen_lshrdi3)(high[0], high[0],
                                                             GEN_INT(count)));
    }
  } else {
    if (!rtx_equal_p(operands[0], operands[1]))
...
static void predict_jump(int prob) {
  rtx insn = get_last_insn();
  gcc_assert(JUMP_P(insn));
  REG_NOTES(insn) =
      gen_rtx_EXPR_LIST(REG_BR_PROB, GEN_INT(prob), REG_NOTES(insn));
}

/* Helper function for the string operations below.  Dest VARIABLE whether
   it is aligned to VALUE bytes.  If true, jump to the label.  */
static rtx ix86_expand_aligntest(rtx variable, int value, bool epilogue) {
  rtx label = gen_label_rtx();
  ...
  emit_cmp_and_jump_insns(tmpcount, const0_rtx, EQ, 0, GET_MODE(variable), 1,
                          label);
  if (epilogue)
...
static void ix86_adjust_counter(rtx countreg, HOST_WIDE_INT value) {
...
rtx ix86_zero_extend_to_Pmode(rtx exp) {
  rtx r;
...
static rtx scale_counter(rtx countreg, int scale) {
  rtx sc;
  rtx piece_size_mask;
  ...
  sc = expand_simple_binop(GET_MODE(countreg), LSHIFTRT, countreg,
                           GEN_INT(exact_log2(scale)), NULL, 1, OPTAB_DIRECT);
  return sc;
}
...
static enum machine_mode counter_mode(rtx count_exp) {
...
static void expand_set_or_movmem_via_loop(rtx destmem, rtx srcmem, rtx destptr,
                                          rtx srcptr, rtx value, rtx count,
  ...
  size = expand_simple_binop(iter_mode, AND, count, piece_size_mask, NULL, 1,
                             OPTAB_DIRECT);
  /* Those two should combine.  */
  if (piece_size == const1_rtx) {
    emit_cmp_and_jump_insns(size, const0_rtx, EQ, NULL_RTX, iter_mode, true,
                            out_label);
  ...
  if (srcmem) {
    ...
    if (!TARGET_64BIT && 0) {
      for (i = 0; i < unroll; i++) {
        if (i) {
          ...
          srcmem = adjust_address(copy_rtx(srcmem), mode, GET_MODE_SIZE(mode));
        }
    ...
    for (i = 0; i < unroll; i++) {
      if (i)
        destmem = adjust_address(copy_rtx(destmem), mode, GET_MODE_SIZE(mode));
      emit_move_insn(destmem, value);
    }

  tmp = expand_simple_binop(iter_mode, PLUS, iter, piece_size, iter, true,
                            OPTAB_LIB_WIDEN);
  if (tmp != iter)
    emit_move_insn(iter, tmp);

  emit_cmp_and_jump_insns(iter, size, LT, NULL_RTX, iter_mode, true, top_label);
  if (expected_size != -1) {
  ...
  tmp = expand_simple_binop(Pmode, PLUS, destptr, iter, destptr, true,
                            OPTAB_LIB_WIDEN);
  if (tmp != destptr)
    emit_move_insn(destptr, tmp);
  if (srcptr) {
    tmp = expand_simple_binop(Pmode, PLUS, srcptr, iter, srcptr, true,
                              OPTAB_LIB_WIDEN);
    if (tmp != srcptr)
...
static void expand_movmem_via_rep_mov(rtx destmem, rtx srcmem, rtx destptr,
                                      rtx srcptr, rtx count,
                                      enum machine_mode mode) {
  rtx destexp;
  rtx srcexp;
  rtx countreg;
  ...
  countreg =
      ix86_zero_extend_to_Pmode(scale_counter(count, GET_MODE_SIZE(mode)));
  if (mode != QImode) {
  ...
  if (CONST_INT_P(count)) {
    count = GEN_INT(INTVAL(count) & ~((HOST_WIDE_INT)GET_MODE_SIZE(mode) - 1));
  ...
  emit_insn(
      gen_rep_mov(destptr, destmem, srcptr, srcmem, countreg, destexp, srcexp));
}

/* Output "rep; stos" instruction.
   Arguments have same meaning as for previous function */
static void expand_setmem_via_rep_stos(rtx destmem, rtx destptr, rtx value,
...
static void emit_strmov(rtx destmem, rtx srcmem, rtx destptr, rtx srcptr,
                        enum machine_mode mode, int offset) {
...
static void expand_movmem_epilogue(rtx destmem, rtx srcmem, rtx destptr,
                                   rtx srcptr, rtx count, int max_size) {
  rtx src, dest;
  if (CONST_INT_P(count)) {
  ...
  if (max_size > 8) {
    ...
    expand_set_or_movmem_via_loop(destmem, srcmem, destptr, srcptr, NULL, count,
                                  QImode, 1, 4);
    return;
  }
  ...
  if (TARGET_SINGLE_STRINGOP) {
    ...
    if (max_size > 4) {
      ...
      tmp = expand_simple_binop(Pmode, PLUS, offset, GEN_INT(4), NULL, true,
                                OPTAB_LIB_WIDEN);
      if (tmp != offset)
    ...
    if (max_size > 2) {
      ...
      emit_move_insn(dest, src);
      tmp = expand_simple_binop(Pmode, PLUS, offset, GEN_INT(2), tmp, true,
                                OPTAB_LIB_WIDEN);
      if (tmp != offset)
        emit_move_insn(offset, tmp);
      emit_label(label);
...
static void expand_setmem_epilogue_via_loop(rtx destmem, rtx destptr, rtx value,
  ...
  expand_set_or_movmem_via_loop(destmem, NULL, destptr, NULL,
                                gen_lowpart(QImode, value), count, QImode, 1,
                                max_size / 2);
}

/* Output code to set at most count & (max_size - 1) bytes starting by DEST.  */
static void expand_setmem_epilogue(rtx destmem, rtx destptr, rtx value,
                                   rtx count, int max_size) {
  rtx dest;
  ...
  if (CONST_INT_P(count)) {
    ...
    if ((countval & 0x10) && max_size > 16) {
      if (TARGET_64BIT) {
        ...
        dest =
            adjust_automodify_address_nv(destmem, DImode, destptr, offset + 8);
        emit_insn(gen_strset(destptr, dest, value));
      } else
        gcc_unreachable();
      offset += 16;
    ...
    if ((countval & 0x08) && max_size > 8) {
      if (TARGET_64BIT) {
        ...
        emit_insn(gen_strset(destptr, dest, value));
        dest =
            adjust_automodify_address_nv(destmem, SImode, destptr, offset + 4);
        emit_insn(gen_strset(destptr, dest, value));
      }
      offset += 8;
    }
...
/* Copy enough from DEST to SRC to align DEST known to by aligned by ALIGN to
   DESIRED_ALIGNMENT.  */
static void expand_movmem_prologue(rtx destmem, rtx srcmem, rtx destptr,
                                   rtx srcptr, rtx count, int align,
...
static rtx expand_constant_movmem_prologue(rtx dst, rtx *srcp, rtx destreg,
                                           rtx srcreg, int desired_align,
                                           int align_bytes) {
  rtx src = *srcp;
  rtx src_size, dst_size;
  int off = 0;
  int src_align_bytes =
      get_mem_align_offset(src, desired_align * BITS_PER_UNIT);
  ...
  if (align_bytes & 2) {
    ...
    if (src_align_bytes >= 0 && (src_align_bytes & 1) == (align_bytes & 1) &&
...
/* Set enough from DEST to align DEST known to by aligned by ALIGN to
   DESIRED_ALIGNMENT.  */
static void expand_setmem_prologue(rtx destmem, rtx destptr, rtx value,
                                   rtx count, int align,
                                   int desired_alignment) {
  if (align <= 1 && desired_alignment > 1) {
    rtx label = ix86_expand_aligntest(destptr, 1, false);
...
static rtx expand_constant_setmem_prologue(rtx dst, rtx destreg, rtx value,
  ...
  if (align_bytes & 1) {
    dst = adjust_automodify_address_nv(dst, QImode, destreg, 0);
    off = 1;
    emit_insn(gen_strset(destreg, dst, gen_lowpart(QImode, value)));
  }
  if (align_bytes & 2) {
    dst = adjust_automodify_address_nv(dst, HImode, destreg, off);
    if (MEM_ALIGN(dst) < 2 * BITS_PER_UNIT)
      set_mem_align(dst, 2 * BITS_PER_UNIT);
    off = 2;
    emit_insn(gen_strset(destreg, dst, gen_lowpart(HImode, value)));
  }
  if (align_bytes & 4) {
    dst = adjust_automodify_address_nv(dst, SImode, destreg, off);
    if (MEM_ALIGN(dst) < 4 * BITS_PER_UNIT)
      set_mem_align(dst, 4 * BITS_PER_UNIT);
    off = 4;
    emit_insn(gen_strset(destreg, dst, gen_lowpart(SImode, value)));
  }
  dst = adjust_automodify_address_nv(dst, BLKmode, destreg, off);
  if (MEM_ALIGN(dst) < (unsigned int)desired_align * BITS_PER_UNIT)
    set_mem_align(dst, desired_align * BITS_PER_UNIT);
...
static enum stringop_alg decide_alg(HOST_WIDE_INT count,
                                    HOST_WIDE_INT expected_size, bool memset,
                                    int *dynamic_check) {
  ...
  bool rep_prefix_usable =
      !(fixed_regs[CX_REG] || fixed_regs[DI_REG] ||
        (memset ? fixed_regs[AX_REG] : fixed_regs[SI_REG]));

#define ALG_USABLE_P(alg)                                   \
  (rep_prefix_usable ||                                     \
   (alg != rep_prefix_1_byte && alg != rep_prefix_4_byte && \
  ...
  if (optimize_function_for_size_p(cfun) ||
      (optimize_insn_for_size_p() && expected_size != -1 &&
       expected_size < 256))
  ...
  *dynamic_check = -1;
  ...
  if ((TARGET_INLINE_ALL_STRINGOPS || TARGET_INLINE_STRINGOPS_DYNAMICALLY) &&
    ...
    for (i = 0; i < NAX_STRINGOP_ALGS; i++) {
      ...
      if (candidate != libcall && candidate && ALG_USABLE_P(candidate))
        max = algs->size[i].max;
    }
 ...
 */
static int decide_alignment(int align, enum stringop_alg alg,
                            int expected_size) {
  int desired_align = 0;
  switch (alg) {
    case no_stringop:
...
static int smallest_pow2_greater_than(int val) {
  int ret = 1;
  while (ret <= val)
    ret <<= 1;
  return ret;
...
int ix86_expand_movmem(rtx dst, rtx src, rtx count_exp, rtx align_exp,
  ...
  if (CONST_INT_P(expected_align_exp) && INTVAL(expected_align_exp) > align)
  ...
  if (CONST_INT_P(count_exp) && desired_align > align) {
    if (INTVAL(count_exp) > desired_align && INTVAL(count_exp) > size_needed) {
      align_bytes = get_mem_align_offset(dst, desired_align * BITS_PER_UNIT);
      if (align_bytes <= 0)
        align_bytes = 0;
      else
  ...
  if (size_needed > 1 || (desired_align > 1 && desired_align > align)) {
    ...
    if (count) {
      ...
      label = gen_label_rtx();
      emit_cmp_and_jump_insns(count_exp, GEN_INT(epilogue_size_needed), LTU, 0,
                              counter_mode(count_exp), 1, label);
  ...
  if (dynamic_check != -1) {
    if (CONST_INT_P(count_exp)) {
      ...
      emit_cmp_and_jump_insns(count_exp, GEN_INT(dynamic_check - 1), LEU, 0,
                              GET_MODE(count_exp), 1, hot_label);
      predict_jump(REG_BR_PROB_BASE * 90 / 100);
      emit_block_move_via_libcall(dst, src, count_exp, false);
  ...
  if (desired_align > align) {
    ...
    if (need_zero_guard &&
        (count < (unsigned HOST_WIDE_INT)size_needed ||
         (align_bytes == 0 && count < ((unsigned HOST_WIDE_INT)size_needed +
                                       desired_align - align)))) {
      ...
      if (label == NULL_RTX)
        label = gen_label_rtx();
      emit_cmp_and_jump_insns(count_exp, GEN_INT(size_needed), LTU, 0,
                              counter_mode(count_exp), 1, label);
      if (expected_size == -1 ||
  ...
  switch (alg) {
    ...
    case no_stringop:
      gcc_unreachable();
    case loop_1_byte:
      expand_set_or_movmem_via_loop(dst, src, destreg, srcreg, NULL, count_exp,
                                    QImode, 1, expected_size);
      break;
    case loop:
      expand_set_or_movmem_via_loop(dst, src, destreg, srcreg, NULL, count_exp,
                                    Pmode, 1, expected_size);
      break;
    case unrolled_loop:
      /* Unroll only by factor of 2 in 32bit mode, since we don't have enough
         registers for 4 temporaries anyway.  */
      expand_set_or_movmem_via_loop(dst, src, destreg, srcreg, NULL, count_exp,
                                    Pmode, TARGET_64BIT ? 4 : 2, expected_size);
      break;
    case rep_prefix_8_byte:
      expand_movmem_via_rep_mov(dst, src, destreg, srcreg, count_exp, DImode);
      break;
    case rep_prefix_4_byte:
      expand_movmem_via_rep_mov(dst, src, destreg, srcreg, count_exp, SImode);
      break;
    case rep_prefix_1_byte:
      expand_movmem_via_rep_mov(dst, src, destreg, srcreg, count_exp, QImode);
      break;
  }
...
/* Helper function for memcpy.  For QImode value 0xXY produce
   ...
   slow multiply.  */
static rtx promote_duplicated_reg(enum machine_mode mode, rtx val) {
  ...
  if (ix86_cost->mult_init[mode == DImode ? 3 : 2] +
    ...
    return expand_simple_binop(mode, MULT, reg, tmp, NULL, 1, OPTAB_DIRECT);
  } else {
    rtx reg = convert_modes(mode, QImode, val, true);
    ...
    if (!TARGET_PARTIAL_REG_STALL)
      ...
      tmp = expand_simple_binop(mode, ASHIFT, reg, GEN_INT(8), NULL, 1,
                                OPTAB_DIRECT);
      reg = expand_simple_binop(mode, IOR, reg, tmp, reg, 1, OPTAB_DIRECT);
    }
    tmp = expand_simple_binop(mode, ASHIFT, reg, GEN_INT(16), NULL, 1,
                              OPTAB_DIRECT);
    reg = expand_simple_binop(mode, IOR, reg, tmp, reg, 1, OPTAB_DIRECT);
    if (mode == SImode)
      return reg;
    tmp = expand_simple_binop(mode, ASHIFT, reg, GEN_INT(32), NULL, 1,
                              OPTAB_DIRECT);
    reg = expand_simple_binop(mode, IOR, reg, tmp, reg, 1, OPTAB_DIRECT);
    return reg;
  }
...
static rtx promote_duplicated_reg_to_size(rtx val, int size_needed,
                                          int desired_align, int align) {
  rtx promoted_val;
...
/* Expand string clear operation (bzero).  Use i386 string operations when
   ...
   steps performed.  */
int ix86_expand_setmem(rtx dst, rtx count_exp, rtx val_exp, rtx align_exp,
                       rtx expected_align_exp, rtx expected_size_exp) {
  rtx destreg;
  rtx label = NULL;
  rtx tmp;
  ...
  if (dynamic_check != -1) {
    ...
    jump_around_label = gen_label_rtx();
    emit_cmp_and_jump_insns(count_exp, GEN_INT(dynamic_check - 1), LEU, 0,
                            counter_mode(count_exp), 1, hot_label);
    predict_jump(REG_BR_PROB_BASE * 90 / 100);
  ...
  switch (alg) {
    ...
    case unrolled_loop:
      ...
      break;
    case rep_prefix_8_byte:
      expand_setmem_via_rep_stos(dst, destreg, promoted_val, count_exp, DImode,
                                 val_exp);
      break;
    case rep_prefix_4_byte:
      expand_setmem_via_rep_stos(dst, destreg, promoted_val, count_exp, SImode,
                                 val_exp);
      break;
    case rep_prefix_1_byte:
      expand_setmem_via_rep_stos(dst, destreg, promoted_val, count_exp, QImode,
                                 val_exp);
      break;
  }
  /* Adjust properly the offset of src and dest memory for aliasing.  */
...
static void ix86_expand_strlensi_unroll_1(rtx out, rtx src, rtx align_rtx) {
  int align;
  rtx tmp;
  ...
  if (align < 4) {
    ...
    if (align != 2) {
      ...
      align_rtx = expand_binop(Pmode, and_optab, scratch1, GEN_INT(3), NULL_RTX,
                               0, OPTAB_WIDEN);

      emit_cmp_and_jump_insns(align_rtx, const0_rtx, EQ, NULL, Pmode, 1,
                              align_4_label);
      emit_cmp_and_jump_insns(align_rtx, const2_rtx, EQ, NULL, Pmode, 1,
                              align_2_label);
      emit_cmp_and_jump_insns(align_rtx, const2_rtx, GTU, NULL, Pmode, 1,
                              align_3_label);
    } else {
      /* Since the alignment is 2, we have to check 2 or 0 bytes;
         check if is aligned to 4 - byte.  */

      align_rtx = expand_binop(Pmode, and_optab, scratch1, const2_rtx, NULL_RTX,
                               0, OPTAB_WIDEN);
    ...
    emit_cmp_and_jump_insns(mem, const0_rtx, EQ, NULL, QImode, 1, end_0_label);
  ...
  emit_cmp_and_jump_insns(tmpreg, const0_rtx, EQ, 0, SImode, 1, align_4_label);
  ...
  if (TARGET_CMOVE) {
    ...
    emit_insn(gen_rtx_SET(VOIDmode, tmpreg,
                          gen_rtx_IF_THEN_ELSE(SImode, tmp, reg, tmpreg)));
    /* Emit lea manually to avoid clobbering of flags.  */
    emit_insn(gen_rtx_SET(SImode, reg2, gen_rtx_PLUS(Pmode, out, const2_rtx)));
    ...
    tmp = gen_rtx_IF_THEN_ELSE(
        VOIDmode, tmp, gen_rtx_LABEL_REF(VOIDmode, end_2_label), pc_rtx);
...
int ix86_expand_strlen(rtx out, rtx src, rtx eoschar, rtx align) {
  ...
  if (TARGET_UNROLL_STRLEN && eoschar == const0_rtx && optimize > 1 &&
      !TARGET_INLINE_ALL_STRINGOPS && !optimize_insn_for_size_p() &&
  ...
  if (TARGET_UNROLL_STRLEN && eoschar == const0_rtx && optimize > 1 &&
    ...
    unspec = gen_rtx_UNSPEC(Pmode, gen_rtvec(4, src, eoschar, align, scratch4),
                            UNSPEC_SCAS);
...
rtx construct_plt_address(rtx symbol) {
...
void ix86_expand_call(rtx retval, rtx fnaddr, rtx callarg1, rtx callarg2,
                      rtx pop, int sibcall) {
  rtx use = NULL, call;
  ...
  if (ix86_cmodel == CM_LARGE_PIC && GET_CODE(fnaddr) == MEM &&
      GET_CODE(XEXP(fnaddr, 0)) == SYMBOL_REF &&
  ...
  if (TARGET_64BIT && ix86_cfun_abi() == MS_ABI &&
    ...
    static int clobbered_registers[] = {
        ...
        XMM12_REG, XMM13_REG, XMM14_REG, XMM15_REG, SI_REG,    DI_REG};
    unsigned int i;
    ...
    for (i = 0; i < ARRAY_SIZE(clobbered_registers); i++)
      vec[i + 2] = gen_rtx_CLOBBER(
          SSE_REGNO_P(clobbered_registers[i]) ? TImode : DImode,
          gen_rtx_REG(SSE_REGNO_P(clobbered_registers[i]) ? TImode : DImode,
                      clobbered_registers[i]));

    call = gen_rtx_PARALLEL(
        VOIDmode, gen_rtvec_v(ARRAY_SIZE(clobbered_registers) + 2, vec));
  }
...
rtx assign_386_stack_local(enum machine_mode mode, enum ix86_stack_slot n) {
  ...
  s = (struct stack_local_entry *)ggc_alloc(sizeof(struct stack_local_entry));
  s->n = n;
  s->mode = mode;
...
rtx ix86_tls_get_addr(void) {
  if (!ix86_tls_symbol) {
    ix86_tls_symbol = gen_rtx_SYMBOL_REF(
        Pmode, (TARGET_ANY_GNU_TLS && !TARGET_64BIT) ? "___tls_get_addr"
                                                     : "__tls_get_addr");
  }
...
rtx ix86_tls_module_base(void) {
  if (!ix86_tls_module_base_symbol) {
    ix86_tls_module_base_symbol =
        gen_rtx_SYMBOL_REF(Pmode, "_TLS_MODULE_BASE_");
    SYMBOL_REF_FLAGS(ix86_tls_module_base_symbol) |= TLS_MODEL_GLOBAL_DYNAMIC
...
int memory_address_length(rtx addr) {
  struct ix86_address parts;
  rtx base, index, disp;
  int len;
  int ok;
  ...
  if (base && !index && !disp) {
    ...
    if (addr == stack_pointer_rtx || addr == arg_pointer_rtx ||
  ...
  /* Direct Addressing.  */
    ...
    if (index
        ...
        || base == stack_pointer_rtx || base == arg_pointer_rtx ||
...
int ix86_attr_length_immediate_default(rtx insn, int shortform) {
  int len = 0;
  int i;
      ...
      if (shortform && satisfies_constraint_K(recog_data.operand[i]))
        ...
        switch (get_attr_mode(insn)) {
          ...
          case MODE_SI:
            len += 4;
            break;
          /* Immediates for DImode instructions are encoded as 32bit sign
           * extended values.  */
          case MODE_DI:
            len += 4;
            break;
...
int ix86_attr_length_address_default(rtx insn) {
  int i;
...
int ix86_attr_length_vex_default(rtx insn, int has_0f_opcode, int has_vex_w) {
  int i;
...
static int ix86_flags_dependent(rtx insn, rtx dep_insn,
                                enum attr_type insn_type) {
  rtx set, set2;

  /* Simplify the test for uninteresting insns.  */
  if (insn_type != TYPE_SETCC && insn_type != TYPE_ICMOV &&
...
static int ix86_agi_dependent(rtx insn, rtx dep_insn,
                              enum attr_type insn_type) {
  rtx addr;
...
static int ix86_adjust_cost(rtx insn, rtx link, rtx dep_insn, int cost) {
  ...
  switch (ix86_tune) {
    case PROCESSOR_PENTIUM:
      ...
      if (insn_type == TYPE_FMOV && get_attr_memory(insn) == MEMORY_STORE &&
    ...
    case PROCESSOR_PENTIUMPRO:
      ...
      if (insn_type == TYPE_FMOV && (set = single_set(dep_insn)) != NULL_RTX &&
          (set2 = single_set(insn)) != NULL_RTX &&
          rtx_equal_p(SET_DEST(set), SET_SRC(set2)) && MEM_P(SET_DEST(set2)))
        cost += 1;
...
int ix86_constant_alignment(tree exp, int align) {
...
int ix86_data_alignment(tree type, int align) {
  ...
  if (TREE_CODE(type) == ARRAY_TYPE) {
    ...
    if (TYPE_MODE(type) == DCmode && align < 64)
      return 64;
    if ((TYPE_MODE(type) == XCmode || TYPE_MODE(type) == TCmode) && align < 128)
      return 128;
...
unsigned int ix86_local_alignment(tree exp, enum machine_mode mode,
                                  unsigned int align) {
  tree type, decl;
  ...
  if (!TARGET_64BIT && align == 64 && ix86_preferred_stack_boundary < 64 &&
      ...
      (!type || !TYPE_USER_ALIGN(type)) && (!decl || !DECL_USER_ALIGN(decl)))
    align = 32;
...
void x86_initialize_trampoline(rtx tramp, rtx fnaddr, rtx cxt) {
  if (!TARGET_64BIT) {
    /* Compute offset from the end of the jmp to the target function.  */
    rtx disp = expand_binop(SImode, sub_optab, fnaddr, plus_constant(tramp, 10),
                            NULL_RTX, 1, OPTAB_DIRECT);
    emit_move_insn(gen_rtx_MEM(QImode, tramp), gen_int_mode(0xb9, QImode));
    ...
    emit_move_insn(gen_rtx_MEM(DImode, plus_constant(tramp, offset + 2)), cxt);
    offset += 10;
    /* Jump to the r11 */
    emit_move_insn(gen_rtx_MEM(HImode, plus_constant(tramp, offset)),
...
static inline tree def_builtin(int mask, const char *name, tree type,
  ...
  if (!(mask & OPTION_MASK_ISA_64BIT) || TARGET_64BIT) {
    ...
    if ((mask & ix86_isa_flags) != 0 ||
        (lang_hooks.builtin_function == lang_hooks.builtin_function_ext_scope))
...
static inline tree def_builtin_const(int mask, const char *name, tree type,
                                     enum ix86_builtins code) {
...
static void ix86_add_new_builtins(int isa) {
  int i;
  tree decl;
...
static const struct builtin_description bdesc_comi[] = {
    ...
    {OPTION_MASK_ISA_SSE, CODE_FOR_sse_comi, "__builtin_ia32_comilt",
     IX86_BUILTIN_COMILTSS, UNLT, 0},
    {OPTION_MASK_ISA_SSE, CODE_FOR_sse_comi, "__builtin_ia32_comile",
     IX86_BUILTIN_COMILESS, UNLE, 0},
    {OPTION_MASK_ISA_SSE, CODE_FOR_sse_comi, "__builtin_ia32_comigt",
     IX86_BUILTIN_COMIGTSS, GT, 0},
    {OPTION_MASK_ISA_SSE, CODE_FOR_sse_comi, "__builtin_ia32_comige",
     IX86_BUILTIN_COMIGESS, GE, 0},
    {OPTION_MASK_ISA_SSE, CODE_FOR_sse_comi, "__builtin_ia32_comineq",
     IX86_BUILTIN_COMINEQSS, LTGT, 0},
    {OPTION_MASK_ISA_SSE, CODE_FOR_sse_ucomi, "__builtin_ia32_ucomieq",
     IX86_BUILTIN_UCOMIEQSS, UNEQ, 0},
    {OPTION_MASK_ISA_SSE, CODE_FOR_sse_ucomi, "__builtin_ia32_ucomilt",
     IX86_BUILTIN_UCOMILTSS, UNLT, 0},
    {OPTION_MASK_ISA_SSE, CODE_FOR_sse_ucomi, "__builtin_ia32_ucomile",
     IX86_BUILTIN_UCOMILESS, UNLE, 0},
    {OPTION_MASK_ISA_SSE, CODE_FOR_sse_ucomi, "__builtin_ia32_ucomigt",
     IX86_BUILTIN_UCOMIGTSS, GT, 0},
    {OPTION_MASK_ISA_SSE, CODE_FOR_sse_ucomi, "__builtin_ia32_ucomige",
     IX86_BUILTIN_UCOMIGESS, GE, 0},
    {OPTION_MASK_ISA_SSE, CODE_FOR_sse_ucomi, "__builtin_ia32_ucomineq",
     IX86_BUILTIN_UCOMINEQSS, LTGT, 0},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_comi, "__builtin_ia32_comisdeq",
     IX86_BUILTIN_COMIEQSD, UNEQ, 0},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_comi, "__builtin_ia32_comisdlt",
     IX86_BUILTIN_COMILTSD, UNLT, 0},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_comi, "__builtin_ia32_comisdle",
     IX86_BUILTIN_COMILESD, UNLE, 0},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_comi, "__builtin_ia32_comisdgt",
     IX86_BUILTIN_COMIGTSD, GT, 0},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_comi, "__builtin_ia32_comisdge",
     IX86_BUILTIN_COMIGESD, GE, 0},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_comi, "__builtin_ia32_comisdneq",
     IX86_BUILTIN_COMINEQSD, LTGT, 0},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_ucomi, "__builtin_ia32_ucomisdeq",
     IX86_BUILTIN_UCOMIEQSD, UNEQ, 0},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_ucomi, "__builtin_ia32_ucomisdlt",
     IX86_BUILTIN_UCOMILTSD, UNLT, 0},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_ucomi, "__builtin_ia32_ucomisdle",
     IX86_BUILTIN_UCOMILESD, UNLE, 0},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_ucomi, "__builtin_ia32_ucomisdgt",
     IX86_BUILTIN_UCOMIGTSD, GT, 0},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_ucomi, "__builtin_ia32_ucomisdge",
     IX86_BUILTIN_UCOMIGESD, GE, 0},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_ucomi, "__builtin_ia32_ucomisdneq",
...
static const struct builtin_description bdesc_pcmpestr[] = {
    ...
    {OPTION_MASK_ISA_SSE4_2, CODE_FOR_sse4_2_pcmpestr,
     "__builtin_ia32_pcmpestria128", IX86_BUILTIN_PCMPESTRA128, UNKNOWN,
     (int)CCAmode},
    {OPTION_MASK_ISA_SSE4_2, CODE_FOR_sse4_2_pcmpestr,
     "__builtin_ia32_pcmpestric128", IX86_BUILTIN_PCMPESTRC128, UNKNOWN,
     (int)CCCmode},
    {OPTION_MASK_ISA_SSE4_2, CODE_FOR_sse4_2_pcmpestr,
     "__builtin_ia32_pcmpestrio128", IX86_BUILTIN_PCMPESTRO128, UNKNOWN,
     (int)CCOmode},
    {OPTION_MASK_ISA_SSE4_2, CODE_FOR_sse4_2_pcmpestr,
     "__builtin_ia32_pcmpestris128", IX86_BUILTIN_PCMPESTRS128, UNKNOWN,
     (int)CCSmode},
    {OPTION_MASK_ISA_SSE4_2, CODE_FOR_sse4_2_pcmpestr,
     "__builtin_ia32_pcmpestriz128", IX86_BUILTIN_PCMPESTRZ128, UNKNOWN,
     (int)CCZmode},
};
...
static const struct builtin_description bdesc_pcmpistr[] = {
    ...
    {OPTION_MASK_ISA_SSE4_2, CODE_FOR_sse4_2_pcmpistr,
     "__builtin_ia32_pcmpistria128", IX86_BUILTIN_PCMPISTRA128, UNKNOWN,
     (int)CCAmode},
    {OPTION_MASK_ISA_SSE4_2, CODE_FOR_sse4_2_pcmpistr,
     "__builtin_ia32_pcmpistric128", IX86_BUILTIN_PCMPISTRC128, UNKNOWN,
     (int)CCCmode},
    {OPTION_MASK_ISA_SSE4_2, CODE_FOR_sse4_2_pcmpistr,
     "__builtin_ia32_pcmpistrio128", IX86_BUILTIN_PCMPISTRO128, UNKNOWN,
     (int)CCOmode},
    {OPTION_MASK_ISA_SSE4_2, CODE_FOR_sse4_2_pcmpistr,
     "__builtin_ia32_pcmpistris128", IX86_BUILTIN_PCMPISTRS128, UNKNOWN,
     (int)CCSmode},
    {OPTION_MASK_ISA_SSE4_2, CODE_FOR_sse4_2_pcmpistr,
     "__builtin_ia32_pcmpistriz128", IX86_BUILTIN_PCMPISTRZ128, UNKNOWN,
     (int)CCZmode},
};
...
static const struct builtin_description bdesc_special_args[] = {
    /* MMX */
    {OPTION_MASK_ISA_MMX, CODE_FOR_mmx_emms, "__builtin_ia32_emms",
    ...
    {OPTION_MASK_ISA_SSE, CODE_FOR_sse_storehps, "__builtin_ia32_storehps",
     IX86_BUILTIN_STOREHPS, UNKNOWN, (int)VOID_FTYPE_PV2SF_V4SF},
    {OPTION_MASK_ISA_SSE, CODE_FOR_sse_storelps, "__builtin_ia32_storelps",
     IX86_BUILTIN_STORELPS, UNKNOWN, (int)VOID_FTYPE_PV2SF_V4SF},

    /* SSE or 3DNow!A  */
    {OPTION_MASK_ISA_SSE | OPTION_MASK_ISA_3DNOW_A, CODE_FOR_sse_sfence,
     "__builtin_ia32_sfence", IX86_BUILTIN_SFENCE, UNKNOWN,
     (int)VOID_FTYPE_VOID},
    {OPTION_MASK_ISA_SSE | OPTION_MASK_ISA_3DNOW_A, CODE_FOR_sse_movntdi,
     "__builtin_ia32_movntq", IX86_BUILTIN_MOVNTQ, UNKNOWN,
    ...
    /* SSE3 */
    {OPTION_MASK_ISA_SSE3, CODE_FOR_sse3_lddqu, "__builtin_ia32_lddqu",
     IX86_BUILTIN_LDDQU, UNKNOWN, (int)V16QI_FTYPE_PCCHAR},

    /* SSE4.1 */
    {OPTION_MASK_ISA_SSE4_1, CODE_FOR_sse4_1_movntdqa,
     "__builtin_ia32_movntdqa", IX86_BUILTIN_MOVNTDQA, UNKNOWN,
     (int)V2DI_FTYPE_PV2DI},

    /* SSE4A */
    {OPTION_MASK_ISA_SSE4A, CODE_FOR_sse4a_vmmovntv2df,
     "__builtin_ia32_movntsd", IX86_BUILTIN_MOVNTSD, UNKNOWN,
     (int)VOID_FTYPE_PDOUBLE_V2DF},
    {OPTION_MASK_ISA_SSE4A, CODE_FOR_sse4a_vmmovntv4sf,
     "__builtin_ia32_movntss", IX86_BUILTIN_MOVNTSS, UNKNOWN,
     (int)VOID_FTYPE_PFLOAT_V4SF},

    /* AVX */
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_vzeroall, "__builtin_ia32_vzeroall",
     IX86_BUILTIN_VZEROALL, UNKNOWN, (int)VOID_FTYPE_VOID},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_vzeroupper, 0, IX86_BUILTIN_VZEROUPPER,
     UNKNOWN, (int)VOID_FTYPE_VOID},
    {OPTION_MASK_ISA_AVX | OPTION_MASK_ISA_64BIT, CODE_FOR_avx_vzeroupper_rex64,
     0, IX86_BUILTIN_VZEROUPPER_REX64, UNKNOWN, (int)VOID_FTYPE_VOID},

    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_vbroadcastss,
     "__builtin_ia32_vbroadcastss", IX86_BUILTIN_VBROADCASTSS, UNKNOWN,
     (int)V4SF_FTYPE_PCFLOAT},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_vbroadcastsd256,
     "__builtin_ia32_vbroadcastsd256", IX86_BUILTIN_VBROADCASTSD256, UNKNOWN,
     (int)V4DF_FTYPE_PCDOUBLE},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_vbroadcastss256,
     "__builtin_ia32_vbroadcastss256", IX86_BUILTIN_VBROADCASTSS256, UNKNOWN,
     (int)V8SF_FTYPE_PCFLOAT},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_vbroadcastf128_pd256,
     "__builtin_ia32_vbroadcastf128_pd256", IX86_BUILTIN_VBROADCASTPD256,
     UNKNOWN, (int)V4DF_FTYPE_PCV2DF},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_vbroadcastf128_ps256,
     "__builtin_ia32_vbroadcastf128_ps256", IX86_BUILTIN_VBROADCASTPS256,
     UNKNOWN, (int)V8SF_FTYPE_PCV4SF},
    ...
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_movntv4df, "__builtin_ia32_movntpd256",
     IX86_BUILTIN_MOVNTPD256, UNKNOWN, (int)VOID_FTYPE_PDOUBLE_V4DF},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_movntv8sf, "__builtin_ia32_movntps256",
     IX86_BUILTIN_MOVNTPS256, UNKNOWN, (int)VOID_FTYPE_PFLOAT_V8SF},

    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_maskloadpd, "__builtin_ia32_maskloadpd",
     IX86_BUILTIN_MASKLOADPD, UNKNOWN, (int)V2DF_FTYPE_PCV2DF_V2DF},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_maskloadps, "__builtin_ia32_maskloadps",
     IX86_BUILTIN_MASKLOADPS, UNKNOWN, (int)V4SF_FTYPE_PCV4SF_V4SF},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_maskloadpd256,
     "__builtin_ia32_maskloadpd256", IX86_BUILTIN_MASKLOADPD256, UNKNOWN,
     (int)V4DF_FTYPE_PCV4DF_V4DF},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_maskloadps256,
     "__builtin_ia32_maskloadps256", IX86_BUILTIN_MASKLOADPS256, UNKNOWN,
     (int)V8SF_FTYPE_PCV8SF_V8SF},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_maskstorepd,
     "__builtin_ia32_maskstorepd", IX86_BUILTIN_MASKSTOREPD, UNKNOWN,
     (int)VOID_FTYPE_PV2DF_V2DF_V2DF},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_maskstoreps,
     "__builtin_ia32_maskstoreps", IX86_BUILTIN_MASKSTOREPS, UNKNOWN,
     (int)VOID_FTYPE_PV4SF_V4SF_V4SF},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_maskstorepd256,
     "__builtin_ia32_maskstorepd256", IX86_BUILTIN_MASKSTOREPD256, UNKNOWN,
     (int)VOID_FTYPE_PV4DF_V4DF_V4DF},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_maskstoreps256,
     "__builtin_ia32_maskstoreps256", IX86_BUILTIN_MASKSTOREPS256, UNKNOWN,
...
static const struct builtin_description bdesc_args[] = {
    /* MMX */
    {OPTION_MASK_ISA_MMX, CODE_FOR_mmx_addv8qi3, "__builtin_ia32_paddb",
     IX86_BUILTIN_PADDB, UNKNOWN, (int)V8QI_FTYPE_V8QI_V8QI},
    {OPTION_MASK_ISA_MMX, CODE_FOR_mmx_addv4hi3, "__builtin_ia32_paddw",
     IX86_BUILTIN_PADDW, UNKNOWN, (int)V4HI_FTYPE_V4HI_V4HI},
    {OPTION_MASK_ISA_MMX, CODE_FOR_mmx_addv2si3, "__builtin_ia32_paddd",
     IX86_BUILTIN_PADDD, UNKNOWN, (int)V2SI_FTYPE_V2SI_V2SI},
    {OPTION_MASK_ISA_MMX, CODE_FOR_mmx_subv8qi3, "__builtin_ia32_psubb",
     IX86_BUILTIN_PSUBB, UNKNOWN, (int)V8QI_FTYPE_V8QI_V8QI},
    {OPTION_MASK_ISA_MMX, CODE_FOR_mmx_subv4hi3, "__builtin_ia32_psubw",
     IX86_BUILTIN_PSUBW, UNKNOWN, (int)V4HI_FTYPE_V4HI_V4HI},
    {OPTION_MASK_ISA_MMX, CODE_FOR_mmx_subv2si3, "__builtin_ia32_psubd",
     IX86_BUILTIN_PSUBD, UNKNOWN, (int)V2SI_FTYPE_V2SI_V2SI},

    {OPTION_MASK_ISA_MMX, CODE_FOR_mmx_ssaddv8qi3, "__builtin_ia32_paddsb",
     IX86_BUILTIN_PADDSB, UNKNOWN, (int)V8QI_FTYPE_V8QI_V8QI},
    {OPTION_MASK_ISA_MMX, CODE_FOR_mmx_ssaddv4hi3, "__builtin_ia32_paddsw",
     IX86_BUILTIN_PADDSW, UNKNOWN, (int)V4HI_FTYPE_V4HI_V4HI},
    {OPTION_MASK_ISA_MMX, CODE_FOR_mmx_sssubv8qi3, "__builtin_ia32_psubsb",
     IX86_BUILTIN_PSUBSB, UNKNOWN, (int)V8QI_FTYPE_V8QI_V8QI},
    {OPTION_MASK_ISA_MMX, CODE_FOR_mmx_sssubv4hi3, "__builtin_ia32_psubsw",
     IX86_BUILTIN_PSUBSW, UNKNOWN, (int)V4HI_FTYPE_V4HI_V4HI},
    {OPTION_MASK_ISA_MMX, CODE_FOR_mmx_usaddv8qi3, "__builtin_ia32_paddusb",
     IX86_BUILTIN_PADDUSB, UNKNOWN, (int)V8QI_FTYPE_V8QI_V8QI},
    {OPTION_MASK_ISA_MMX, CODE_FOR_mmx_usaddv4hi3, "__builtin_ia32_paddusw",
     IX86_BUILTIN_PADDUSW, UNKNOWN, (int)V4HI_FTYPE_V4HI_V4HI},
    {OPTION_MASK_ISA_MMX, CODE_FOR_mmx_ussubv8qi3, "__builtin_ia32_psubusb",
     IX86_BUILTIN_PSUBUSB, UNKNOWN, (int)V8QI_FTYPE_V8QI_V8QI},
    {OPTION_MASK_ISA_MMX, CODE_FOR_mmx_ussubv4hi3, "__builtin_ia32_psubusw",
     IX86_BUILTIN_PSUBUSW, UNKNOWN, (int)V4HI_FTYPE_V4HI_V4HI},

    {OPTION_MASK_ISA_MMX, CODE_FOR_mmx_mulv4hi3, "__builtin_ia32_pmullw",
     IX86_BUILTIN_PMULLW, UNKNOWN, (int)V4HI_FTYPE_V4HI_V4HI},
    {OPTION_MASK_ISA_MMX, CODE_FOR_mmx_smulv4hi3_highpart,
     "__builtin_ia32_pmulhw", IX86_BUILTIN_PMULHW, UNKNOWN,
     (int)V4HI_FTYPE_V4HI_V4HI},

    {OPTION_MASK_ISA_MMX, CODE_FOR_mmx_andv2si3, "__builtin_ia32_pand",
     IX86_BUILTIN_PAND, UNKNOWN, (int)V2SI_FTYPE_V2SI_V2SI},
    {OPTION_MASK_ISA_MMX, CODE_FOR_mmx_andnotv2si3, "__builtin_ia32_pandn",
     IX86_BUILTIN_PANDN, UNKNOWN, (int)V2SI_FTYPE_V2SI_V2SI},
    {OPTION_MASK_ISA_MMX, CODE_FOR_mmx_iorv2si3, "__builtin_ia32_por",
     IX86_BUILTIN_POR, UNKNOWN, (int)V2SI_FTYPE_V2SI_V2SI},
    {OPTION_MASK_ISA_MMX, CODE_FOR_mmx_xorv2si3, "__builtin_ia32_pxor",
     IX86_BUILTIN_PXOR, UNKNOWN, (int)V2SI_FTYPE_V2SI_V2SI},

    {OPTION_MASK_ISA_MMX, CODE_FOR_mmx_eqv8qi3, "__builtin_ia32_pcmpeqb",
     IX86_BUILTIN_PCMPEQB, UNKNOWN, (int)V8QI_FTYPE_V8QI_V8QI},
    {OPTION_MASK_ISA_MMX, CODE_FOR_mmx_eqv4hi3, "__builtin_ia32_pcmpeqw",
     IX86_BUILTIN_PCMPEQW, UNKNOWN, (int)V4HI_FTYPE_V4HI_V4HI},
    {OPTION_MASK_ISA_MMX, CODE_FOR_mmx_eqv2si3, "__builtin_ia32_pcmpeqd",
     IX86_BUILTIN_PCMPEQD, UNKNOWN, (int)V2SI_FTYPE_V2SI_V2SI},
    {OPTION_MASK_ISA_MMX, CODE_FOR_mmx_gtv8qi3, "__builtin_ia32_pcmpgtb",
     IX86_BUILTIN_PCMPGTB, UNKNOWN, (int)V8QI_FTYPE_V8QI_V8QI},
    {OPTION_MASK_ISA_MMX, CODE_FOR_mmx_gtv4hi3, "__builtin_ia32_pcmpgtw",
     IX86_BUILTIN_PCMPGTW, UNKNOWN, (int)V4HI_FTYPE_V4HI_V4HI},
    {OPTION_MASK_ISA_MMX, CODE_FOR_mmx_gtv2si3, "__builtin_ia32_pcmpgtd",
     IX86_BUILTIN_PCMPGTD, UNKNOWN, (int)V2SI_FTYPE_V2SI_V2SI},

    {OPTION_MASK_ISA_MMX, CODE_FOR_mmx_punpckhbw, "__builtin_ia32_punpckhbw",
     IX86_BUILTIN_PUNPCKHBW, UNKNOWN, (int)V8QI_FTYPE_V8QI_V8QI},
    {OPTION_MASK_ISA_MMX, CODE_FOR_mmx_punpckhwd, "__builtin_ia32_punpckhwd",
     IX86_BUILTIN_PUNPCKHWD, UNKNOWN, (int)V4HI_FTYPE_V4HI_V4HI},
    {OPTION_MASK_ISA_MMX, CODE_FOR_mmx_punpckhdq, "__builtin_ia32_punpckhdq",
     IX86_BUILTIN_PUNPCKHDQ, UNKNOWN, (int)V2SI_FTYPE_V2SI_V2SI},
    {OPTION_MASK_ISA_MMX, CODE_FOR_mmx_punpcklbw, "__builtin_ia32_punpcklbw",
     IX86_BUILTIN_PUNPCKLBW, UNKNOWN, (int)V8QI_FTYPE_V8QI_V8QI},
    {OPTION_MASK_ISA_MMX, CODE_FOR_mmx_punpcklwd, "__builtin_ia32_punpcklwd",
     IX86_BUILTIN_PUNPCKLWD, UNKNOWN, (int)V4HI_FTYPE_V4HI_V4HI},
    {OPTION_MASK_ISA_MMX, CODE_FOR_mmx_punpckldq, "__builtin_ia32_punpckldq",
     IX86_BUILTIN_PUNPCKLDQ, UNKNOWN, (int)V2SI_FTYPE_V2SI_V2SI},

    {OPTION_MASK_ISA_MMX, CODE_FOR_mmx_packsswb, "__builtin_ia32_packsswb",
     IX86_BUILTIN_PACKSSWB, UNKNOWN, (int)V8QI_FTYPE_V4HI_V4HI},
    {OPTION_MASK_ISA_MMX, CODE_FOR_mmx_packssdw, "__builtin_ia32_packssdw",
     IX86_BUILTIN_PACKSSDW, UNKNOWN, (int)V4HI_FTYPE_V2SI_V2SI},
    {OPTION_MASK_ISA_MMX, CODE_FOR_mmx_packuswb, "__builtin_ia32_packuswb",
     IX86_BUILTIN_PACKUSWB, UNKNOWN, (int)V8QI_FTYPE_V4HI_V4HI},

    {OPTION_MASK_ISA_MMX, CODE_FOR_mmx_pmaddwd, "__builtin_ia32_pmaddwd",
     IX86_BUILTIN_PMADDWD, UNKNOWN, (int)V2SI_FTYPE_V4HI_V4HI},

    {OPTION_MASK_ISA_MMX, CODE_FOR_mmx_ashlv4hi3, "__builtin_ia32_psllwi",
     IX86_BUILTIN_PSLLWI, UNKNOWN, (int)V4HI_FTYPE_V4HI_SI_COUNT},
    {OPTION_MASK_ISA_MMX, CODE_FOR_mmx_ashlv2si3, "__builtin_ia32_pslldi",
     IX86_BUILTIN_PSLLDI, UNKNOWN, (int)V2SI_FTYPE_V2SI_SI_COUNT},
    {OPTION_MASK_ISA_MMX, CODE_FOR_mmx_ashlv1di3, "__builtin_ia32_psllqi",
     IX86_BUILTIN_PSLLQI, UNKNOWN, (int)V1DI_FTYPE_V1DI_SI_COUNT},
    {OPTION_MASK_ISA_MMX, CODE_FOR_mmx_ashlv4hi3, "__builtin_ia32_psllw",
     IX86_BUILTIN_PSLLW, UNKNOWN, (int)V4HI_FTYPE_V4HI_V4HI_COUNT},
    {OPTION_MASK_ISA_MMX, CODE_FOR_mmx_ashlv2si3, "__builtin_ia32_pslld",
     IX86_BUILTIN_PSLLD, UNKNOWN, (int)V2SI_FTYPE_V2SI_V2SI_COUNT},
    {OPTION_MASK_ISA_MMX, CODE_FOR_mmx_ashlv1di3, "__builtin_ia32_psllq",
     IX86_BUILTIN_PSLLQ, UNKNOWN, (int)V1DI_FTYPE_V1DI_V1DI_COUNT},

    {OPTION_MASK_ISA_MMX, CODE_FOR_mmx_lshrv4hi3, "__builtin_ia32_psrlwi",
     IX86_BUILTIN_PSRLWI, UNKNOWN, (int)V4HI_FTYPE_V4HI_SI_COUNT},
    {OPTION_MASK_ISA_MMX, CODE_FOR_mmx_lshrv2si3, "__builtin_ia32_psrldi",
     IX86_BUILTIN_PSRLDI, UNKNOWN, (int)V2SI_FTYPE_V2SI_SI_COUNT},
    {OPTION_MASK_ISA_MMX, CODE_FOR_mmx_lshrv1di3, "__builtin_ia32_psrlqi",
     IX86_BUILTIN_PSRLQI, UNKNOWN, (int)V1DI_FTYPE_V1DI_SI_COUNT},
    {OPTION_MASK_ISA_MMX, CODE_FOR_mmx_lshrv4hi3, "__builtin_ia32_psrlw",
     IX86_BUILTIN_PSRLW, UNKNOWN, (int)V4HI_FTYPE_V4HI_V4HI_COUNT},
    {OPTION_MASK_ISA_MMX, CODE_FOR_mmx_lshrv2si3, "__builtin_ia32_psrld",
     IX86_BUILTIN_PSRLD, UNKNOWN, (int)V2SI_FTYPE_V2SI_V2SI_COUNT},
    {OPTION_MASK_ISA_MMX, CODE_FOR_mmx_lshrv1di3, "__builtin_ia32_psrlq",
     IX86_BUILTIN_PSRLQ, UNKNOWN, (int)V1DI_FTYPE_V1DI_V1DI_COUNT},

    {OPTION_MASK_ISA_MMX, CODE_FOR_mmx_ashrv4hi3, "__builtin_ia32_psrawi",
     IX86_BUILTIN_PSRAWI, UNKNOWN, (int)V4HI_FTYPE_V4HI_SI_COUNT},
    {OPTION_MASK_ISA_MMX, CODE_FOR_mmx_ashrv2si3, "__builtin_ia32_psradi",
     IX86_BUILTIN_PSRADI, UNKNOWN, (int)V2SI_FTYPE_V2SI_SI_COUNT},
    {OPTION_MASK_ISA_MMX, CODE_FOR_mmx_ashrv4hi3, "__builtin_ia32_psraw",
     IX86_BUILTIN_PSRAW, UNKNOWN, (int)V4HI_FTYPE_V4HI_V4HI_COUNT},
    {OPTION_MASK_ISA_MMX, CODE_FOR_mmx_ashrv2si3, "__builtin_ia32_psrad",
     IX86_BUILTIN_PSRAD, UNKNOWN, (int)V2SI_FTYPE_V2SI_V2SI_COUNT},

    /* 3DNow! */
    {OPTION_MASK_ISA_3DNOW, CODE_FOR_mmx_pf2id, "__builtin_ia32_pf2id",
     IX86_BUILTIN_PF2ID, UNKNOWN, (int)V2SI_FTYPE_V2SF},
    {OPTION_MASK_ISA_3DNOW, CODE_FOR_mmx_floatv2si2, "__builtin_ia32_pi2fd",
     IX86_BUILTIN_PI2FD, UNKNOWN, (int)V2SF_FTYPE_V2SI},
    {OPTION_MASK_ISA_3DNOW, CODE_FOR_mmx_rcpv2sf2, "__builtin_ia32_pfrcp",
     IX86_BUILTIN_PFRCP, UNKNOWN, (int)V2SF_FTYPE_V2SF},
    {OPTION_MASK_ISA_3DNOW, CODE_FOR_mmx_rsqrtv2sf2, "__builtin_ia32_pfrsqrt",
     IX86_BUILTIN_PFRSQRT, UNKNOWN, (int)V2SF_FTYPE_V2SF},

    {OPTION_MASK_ISA_3DNOW, CODE_FOR_mmx_uavgv8qi3, "__builtin_ia32_pavgusb",
     IX86_BUILTIN_PAVGUSB, UNKNOWN, (int)V8QI_FTYPE_V8QI_V8QI},
    {OPTION_MASK_ISA_3DNOW, CODE_FOR_mmx_haddv2sf3, "__builtin_ia32_pfacc",
     IX86_BUILTIN_PFACC, UNKNOWN, (int)V2SF_FTYPE_V2SF_V2SF},
    {OPTION_MASK_ISA_3DNOW, CODE_FOR_mmx_addv2sf3, "__builtin_ia32_pfadd",
     IX86_BUILTIN_PFADD, UNKNOWN, (int)V2SF_FTYPE_V2SF_V2SF},
    {OPTION_MASK_ISA_3DNOW, CODE_FOR_mmx_eqv2sf3, "__builtin_ia32_pfcmpeq",
     IX86_BUILTIN_PFCMPEQ, UNKNOWN, (int)V2SI_FTYPE_V2SF_V2SF},
    {OPTION_MASK_ISA_3DNOW, CODE_FOR_mmx_gev2sf3, "__builtin_ia32_pfcmpge",
     IX86_BUILTIN_PFCMPGE, UNKNOWN, (int)V2SI_FTYPE_V2SF_V2SF},
    {OPTION_MASK_ISA_3DNOW, CODE_FOR_mmx_gtv2sf3, "__builtin_ia32_pfcmpgt",
     IX86_BUILTIN_PFCMPGT, UNKNOWN, (int)V2SI_FTYPE_V2SF_V2SF},
    {OPTION_MASK_ISA_3DNOW, CODE_FOR_mmx_smaxv2sf3, "__builtin_ia32_pfmax",
     IX86_BUILTIN_PFMAX, UNKNOWN, (int)V2SF_FTYPE_V2SF_V2SF},
    {OPTION_MASK_ISA_3DNOW, CODE_FOR_mmx_sminv2sf3, "__builtin_ia32_pfmin",
     IX86_BUILTIN_PFMIN, UNKNOWN, (int)V2SF_FTYPE_V2SF_V2SF},
    {OPTION_MASK_ISA_3DNOW, CODE_FOR_mmx_mulv2sf3, "__builtin_ia32_pfmul",
     IX86_BUILTIN_PFMUL, UNKNOWN, (int)V2SF_FTYPE_V2SF_V2SF},
    {OPTION_MASK_ISA_3DNOW, CODE_FOR_mmx_rcpit1v2sf3, "__builtin_ia32_pfrcpit1",
     IX86_BUILTIN_PFRCPIT1, UNKNOWN, (int)V2SF_FTYPE_V2SF_V2SF},
    {OPTION_MASK_ISA_3DNOW, CODE_FOR_mmx_rcpit2v2sf3, "__builtin_ia32_pfrcpit2",
     IX86_BUILTIN_PFRCPIT2, UNKNOWN, (int)V2SF_FTYPE_V2SF_V2SF},
    {OPTION_MASK_ISA_3DNOW, CODE_FOR_mmx_rsqit1v2sf3, "__builtin_ia32_pfrsqit1",
     IX86_BUILTIN_PFRSQIT1, UNKNOWN, (int)V2SF_FTYPE_V2SF_V2SF},
    {OPTION_MASK_ISA_3DNOW, CODE_FOR_mmx_subv2sf3, "__builtin_ia32_pfsub",
     IX86_BUILTIN_PFSUB, UNKNOWN, (int)V2SF_FTYPE_V2SF_V2SF},
    {OPTION_MASK_ISA_3DNOW, CODE_FOR_mmx_subrv2sf3, "__builtin_ia32_pfsubr",
     IX86_BUILTIN_PFSUBR, UNKNOWN, (int)V2SF_FTYPE_V2SF_V2SF},
    {OPTION_MASK_ISA_3DNOW, CODE_FOR_mmx_pmulhrwv4hi3, "__builtin_ia32_pmulhrw",
     IX86_BUILTIN_PMULHRW, UNKNOWN, (int)V4HI_FTYPE_V4HI_V4HI},

    /* 3DNow!A */
    {OPTION_MASK_ISA_3DNOW_A, CODE_FOR_mmx_pf2iw, "__builtin_ia32_pf2iw",
     IX86_BUILTIN_PF2IW, UNKNOWN, (int)V2SI_FTYPE_V2SF},
    {OPTION_MASK_ISA_3DNOW_A, CODE_FOR_mmx_pi2fw, "__builtin_ia32_pi2fw",
     IX86_BUILTIN_PI2FW, UNKNOWN, (int)V2SF_FTYPE_V2SI},
    {OPTION_MASK_ISA_3DNOW_A, CODE_FOR_mmx_pswapdv2si2,
     "__builtin_ia32_pswapdsi", IX86_BUILTIN_PSWAPDSI, UNKNOWN,
     (int)V2SI_FTYPE_V2SI},
    {OPTION_MASK_ISA_3DNOW_A, CODE_FOR_mmx_pswapdv2sf2,
     "__builtin_ia32_pswapdsf", IX86_BUILTIN_PSWAPDSF, UNKNOWN,
     (int)V2SF_FTYPE_V2SF},
    {OPTION_MASK_ISA_3DNOW_A, CODE_FOR_mmx_hsubv2sf3, "__builtin_ia32_pfnacc",
     IX86_BUILTIN_PFNACC, UNKNOWN, (int)V2SF_FTYPE_V2SF_V2SF},
    {OPTION_MASK_ISA_3DNOW_A, CODE_FOR_mmx_addsubv2sf3,
     "__builtin_ia32_pfpnacc", IX86_BUILTIN_PFPNACC, UNKNOWN,
     (int)V2SF_FTYPE_V2SF_V2SF},

    /* SSE */
    {OPTION_MASK_ISA_SSE, CODE_FOR_sse_movmskps, "__builtin_ia32_movmskps",
     IX86_BUILTIN_MOVMSKPS, UNKNOWN, (int)INT_FTYPE_V4SF},
    {OPTION_MASK_ISA_SSE, CODE_FOR_sse_sqrtv4sf2, "__builtin_ia32_sqrtps",
     IX86_BUILTIN_SQRTPS, UNKNOWN, (int)V4SF_FTYPE_V4SF},
    {OPTION_MASK_ISA_SSE, CODE_FOR_sqrtv4sf2, "__builtin_ia32_sqrtps_nr",
     IX86_BUILTIN_SQRTPS_NR, UNKNOWN, (int)V4SF_FTYPE_V4SF},
    {OPTION_MASK_ISA_SSE, CODE_FOR_sse_rsqrtv4sf2, "__builtin_ia32_rsqrtps",
     IX86_BUILTIN_RSQRTPS, UNKNOWN, (int)V4SF_FTYPE_V4SF},
    {OPTION_MASK_ISA_SSE, CODE_FOR_rsqrtv4sf2, "__builtin_ia32_rsqrtps_nr",
     IX86_BUILTIN_RSQRTPS_NR, UNKNOWN, (int)V4SF_FTYPE_V4SF},
    {OPTION_MASK_ISA_SSE, CODE_FOR_sse_rcpv4sf2, "__builtin_ia32_rcpps",
     IX86_BUILTIN_RCPPS, UNKNOWN, (int)V4SF_FTYPE_V4SF},
    {OPTION_MASK_ISA_SSE, CODE_FOR_sse_cvtps2pi, "__builtin_ia32_cvtps2pi",
     IX86_BUILTIN_CVTPS2PI, UNKNOWN, (int)V2SI_FTYPE_V4SF},
    {OPTION_MASK_ISA_SSE, CODE_FOR_sse_cvtss2si, "__builtin_ia32_cvtss2si",
     IX86_BUILTIN_CVTSS2SI, UNKNOWN, (int)INT_FTYPE_V4SF},
    {OPTION_MASK_ISA_SSE | OPTION_MASK_ISA_64BIT, CODE_FOR_sse_cvtss2siq,
     "__builtin_ia32_cvtss2si64", IX86_BUILTIN_CVTSS2SI64, UNKNOWN,
    ...
    {OPTION_MASK_ISA_SSE | OPTION_MASK_ISA_64BIT, CODE_FOR_sse_cvttss2siq,
     "__builtin_ia32_cvttss2si64", IX86_BUILTIN_CVTTSS2SI64, UNKNOWN,
     (int)INT64_FTYPE_V4SF},
    ...
    {OPTION_MASK_ISA_SSE, CODE_FOR_sse_maskcmpv4sf3,
     "__builtin_ia32_cmpunordps", IX86_BUILTIN_CMPUNORDPS, UNORDERED,
    ...
    {OPTION_MASK_ISA_SSE, CODE_FOR_sse_maskcmpv4sf3, "__builtin_ia32_cmpnltps",
     IX86_BUILTIN_CMPNLTPS, UNGE, (int)V4SF_FTYPE_V4SF_V4SF},
    {OPTION_MASK_ISA_SSE, CODE_FOR_sse_maskcmpv4sf3, "__builtin_ia32_cmpnleps",
     IX86_BUILTIN_CMPNLEPS, UNGT, (int)V4SF_FTYPE_V4SF_V4SF},
    {OPTION_MASK_ISA_SSE, CODE_FOR_sse_maskcmpv4sf3, "__builtin_ia32_cmpngtps",
     IX86_BUILTIN_CMPNGTPS, UNGE, (int)V4SF_FTYPE_V4SF_V4SF_SWAP},
    {OPTION_MASK_ISA_SSE, CODE_FOR_sse_maskcmpv4sf3, "__builtin_ia32_cmpngeps",
     IX86_BUILTIN_CMPNGEPS, UNGT, (int)V4SF_FTYPE_V4SF_V4SF_SWAP},
    {OPTION_MASK_ISA_SSE, CODE_FOR_sse_maskcmpv4sf3, "__builtin_ia32_cmpordps",
     IX86_BUILTIN_CMPORDPS, ORDERED, (int)V4SF_FTYPE_V4SF_V4SF},
    {OPTION_MASK_ISA_SSE, CODE_FOR_sse_vmmaskcmpv4sf3, "__builtin_ia32_cmpeqss",
     IX86_BUILTIN_CMPEQSS, EQ, (int)V4SF_FTYPE_V4SF_V4SF},
    {OPTION_MASK_ISA_SSE, CODE_FOR_sse_vmmaskcmpv4sf3, "__builtin_ia32_cmpltss",
     IX86_BUILTIN_CMPLTSS, LT, (int)V4SF_FTYPE_V4SF_V4SF},
    {OPTION_MASK_ISA_SSE, CODE_FOR_sse_vmmaskcmpv4sf3, "__builtin_ia32_cmpless",
     IX86_BUILTIN_CMPLESS, LE, (int)V4SF_FTYPE_V4SF_V4SF},
    {OPTION_MASK_ISA_SSE, CODE_FOR_sse_vmmaskcmpv4sf3,
     "__builtin_ia32_cmpunordss", IX86_BUILTIN_CMPUNORDSS, UNORDERED,
     (int)V4SF_FTYPE_V4SF_V4SF},
    {OPTION_MASK_ISA_SSE, CODE_FOR_sse_vmmaskcmpv4sf3,
     "__builtin_ia32_cmpneqss", IX86_BUILTIN_CMPNEQSS, NE,
     (int)V4SF_FTYPE_V4SF_V4SF},
    {OPTION_MASK_ISA_SSE, CODE_FOR_sse_vmmaskcmpv4sf3,
     "__builtin_ia32_cmpnltss", IX86_BUILTIN_CMPNLTSS, UNGE,
     (int)V4SF_FTYPE_V4SF_V4SF},
    {OPTION_MASK_ISA_SSE, CODE_FOR_sse_vmmaskcmpv4sf3,
     "__builtin_ia32_cmpnless", IX86_BUILTIN_CMPNLESS, UNGT,
     (int)V4SF_FTYPE_V4SF_V4SF},
    {OPTION_MASK_ISA_SSE, CODE_FOR_sse_vmmaskcmpv4sf3,
     "__builtin_ia32_cmpngtss", IX86_BUILTIN_CMPNGTSS, UNGE,
     (int)V4SF_FTYPE_V4SF_V4SF_SWAP},
    {OPTION_MASK_ISA_SSE, CODE_FOR_sse_vmmaskcmpv4sf3,
     "__builtin_ia32_cmpngess", IX86_BUILTIN_CMPNGESS, UNGT,
     (int)V4SF_FTYPE_V4SF_V4SF_SWAP},
    {OPTION_MASK_ISA_SSE, CODE_FOR_sse_vmmaskcmpv4sf3,
     "__builtin_ia32_cmpordss", IX86_BUILTIN_CMPORDSS, ORDERED,
     (int)V4SF_FTYPE_V4SF_V4SF},

    {OPTION_MASK_ISA_SSE, CODE_FOR_sminv4sf3, "__builtin_ia32_minps",
     IX86_BUILTIN_MINPS, UNKNOWN, (int)V4SF_FTYPE_V4SF_V4SF},
    {OPTION_MASK_ISA_SSE, CODE_FOR_smaxv4sf3, "__builtin_ia32_maxps",
     IX86_BUILTIN_MAXPS, UNKNOWN, (int)V4SF_FTYPE_V4SF_V4SF},
    {OPTION_MASK_ISA_SSE, CODE_FOR_sse_vmsminv4sf3, "__builtin_ia32_minss",
     IX86_BUILTIN_MINSS, UNKNOWN, (int)V4SF_FTYPE_V4SF_V4SF},
    {OPTION_MASK_ISA_SSE, CODE_FOR_sse_vmsmaxv4sf3, "__builtin_ia32_maxss",
     IX86_BUILTIN_MAXSS, UNKNOWN, (int)V4SF_FTYPE_V4SF_V4SF},

    {OPTION_MASK_ISA_SSE, CODE_FOR_andv4sf3, "__builtin_ia32_andps",
     IX86_BUILTIN_ANDPS, UNKNOWN, (int)V4SF_FTYPE_V4SF_V4SF},
    {OPTION_MASK_ISA_SSE, CODE_FOR_sse_andnotv4sf3, "__builtin_ia32_andnps",
     IX86_BUILTIN_ANDNPS, UNKNOWN, (int)V4SF_FTYPE_V4SF_V4SF},
    {OPTION_MASK_ISA_SSE, CODE_FOR_iorv4sf3, "__builtin_ia32_orps",
     IX86_BUILTIN_ORPS, UNKNOWN, (int)V4SF_FTYPE_V4SF_V4SF},
    {OPTION_MASK_ISA_SSE, CODE_FOR_xorv4sf3, "__builtin_ia32_xorps",
     IX86_BUILTIN_XORPS, UNKNOWN, (int)V4SF_FTYPE_V4SF_V4SF},

    {OPTION_MASK_ISA_SSE, CODE_FOR_sse_movss, "__builtin_ia32_movss",
     IX86_BUILTIN_MOVSS, UNKNOWN, (int)V4SF_FTYPE_V4SF_V4SF},
    {OPTION_MASK_ISA_SSE, CODE_FOR_sse_movhlps_exp, "__builtin_ia32_movhlps",
     IX86_BUILTIN_MOVHLPS, UNKNOWN, (int)V4SF_FTYPE_V4SF_V4SF},
    {OPTION_MASK_ISA_SSE, CODE_FOR_sse_movlhps_exp, "__builtin_ia32_movlhps",
     IX86_BUILTIN_MOVLHPS, UNKNOWN, (int)V4SF_FTYPE_V4SF_V4SF},
    {OPTION_MASK_ISA_SSE, CODE_FOR_sse_unpckhps, "__builtin_ia32_unpckhps",
     IX86_BUILTIN_UNPCKHPS, UNKNOWN, (int)V4SF_FTYPE_V4SF_V4SF},
    {OPTION_MASK_ISA_SSE, CODE_FOR_sse_unpcklps, "__builtin_ia32_unpcklps",
     IX86_BUILTIN_UNPCKLPS, UNKNOWN, (int)V4SF_FTYPE_V4SF_V4SF},

    {OPTION_MASK_ISA_SSE, CODE_FOR_sse_cvtpi2ps, "__builtin_ia32_cvtpi2ps",
     IX86_BUILTIN_CVTPI2PS, UNKNOWN, (int)V4SF_FTYPE_V4SF_V2SI},
    {OPTION_MASK_ISA_SSE, CODE_FOR_sse_cvtsi2ss, "__builtin_ia32_cvtsi2ss",
     IX86_BUILTIN_CVTSI2SS, UNKNOWN, (int)V4SF_FTYPE_V4SF_SI},
    {OPTION_MASK_ISA_SSE | OPTION_MASK_ISA_64BIT, CODE_FOR_sse_cvtsi2ssq,
     "__builtin_ia32_cvtsi642ss", IX86_BUILTIN_CVTSI642SS, UNKNOWN,
     V4SF_FTYPE_V4SF_DI},

    {OPTION_MASK_ISA_SSE, CODE_FOR_rsqrtsf2, "__builtin_ia32_rsqrtf",
     IX86_BUILTIN_RSQRTF, UNKNOWN, (int)FLOAT_FTYPE_FLOAT},

    {OPTION_MASK_ISA_SSE, CODE_FOR_sse_vmsqrtv4sf2, "__builtin_ia32_sqrtss",
     IX86_BUILTIN_SQRTSS, UNKNOWN, (int)V4SF_FTYPE_V4SF_VEC_MERGE},
    ...
    {OPTION_MASK_ISA_SSE | OPTION_MASK_ISA_3DNOW_A, CODE_FOR_mmx_uavgv8qi3,
     "__builtin_ia32_pavgb", IX86_BUILTIN_PAVGB, UNKNOWN,
     (int)V8QI_FTYPE_V8QI_V8QI},
    {OPTION_MASK_ISA_SSE | OPTION_MASK_ISA_3DNOW_A, CODE_FOR_mmx_uavgv4hi3,
     "__builtin_ia32_pavgw", IX86_BUILTIN_PAVGW, UNKNOWN,
     (int)V4HI_FTYPE_V4HI_V4HI},
    {OPTION_MASK_ISA_SSE | OPTION_MASK_ISA_3DNOW_A,
     CODE_FOR_mmx_umulv4hi3_highpart, "__builtin_ia32_pmulhuw",
     IX86_BUILTIN_PMULHUW, UNKNOWN, (int)V4HI_FTYPE_V4HI_V4HI},

    {OPTION_MASK_ISA_SSE | OPTION_MASK_ISA_3DNOW_A, CODE_FOR_mmx_umaxv8qi3,
     "__builtin_ia32_pmaxub", IX86_BUILTIN_PMAXUB, UNKNOWN,
     (int)V8QI_FTYPE_V8QI_V8QI},
    {OPTION_MASK_ISA_SSE | OPTION_MASK_ISA_3DNOW_A, CODE_FOR_mmx_smaxv4hi3,
     "__builtin_ia32_pmaxsw", IX86_BUILTIN_PMAXSW, UNKNOWN,
     (int)V4HI_FTYPE_V4HI_V4HI},
    {OPTION_MASK_ISA_SSE | OPTION_MASK_ISA_3DNOW_A, CODE_FOR_mmx_uminv8qi3,
     "__builtin_ia32_pminub", IX86_BUILTIN_PMINUB, UNKNOWN,
     (int)V8QI_FTYPE_V8QI_V8QI},
    {OPTION_MASK_ISA_SSE | OPTION_MASK_ISA_3DNOW_A, CODE_FOR_mmx_sminv4hi3,
     "__builtin_ia32_pminsw", IX86_BUILTIN_PMINSW, UNKNOWN,
     (int)V4HI_FTYPE_V4HI_V4HI},

    {OPTION_MASK_ISA_SSE | OPTION_MASK_ISA_3DNOW_A, CODE_FOR_mmx_psadbw,
     "__builtin_ia32_psadbw", IX86_BUILTIN_PSADBW, UNKNOWN,
     (int)V1DI_FTYPE_V8QI_V8QI},
    {OPTION_MASK_ISA_SSE | OPTION_MASK_ISA_3DNOW_A, CODE_FOR_mmx_pmovmskb,
     "__builtin_ia32_pmovmskb", IX86_BUILTIN_PMOVMSKB, UNKNOWN,
     (int)INT_FTYPE_V8QI},

    {OPTION_MASK_ISA_SSE | OPTION_MASK_ISA_3DNOW_A, CODE_FOR_mmx_pshufw,
     "__builtin_ia32_pshufw", IX86_BUILTIN_PSHUFW, UNKNOWN,
    ...
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_pmovmskb, "__builtin_ia32_pmovmskb128",
    ...
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_cvtpd2ps, "__builtin_ia32_cvtpd2ps",
     IX86_BUILTIN_CVTPD2PS, UNKNOWN, (int)V4SF_FTYPE_V2DF},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_cvttpd2dq, "__builtin_ia32_cvttpd2dq",
     IX86_BUILTIN_CVTTPD2DQ, UNKNOWN, (int)V4SI_FTYPE_V2DF},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_cvttpd2pi, "__builtin_ia32_cvttpd2pi",
     IX86_BUILTIN_CVTTPD2PI, UNKNOWN, (int)V2SI_FTYPE_V2DF},

    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_cvtpi2pd, "__builtin_ia32_cvtpi2pd",
     IX86_BUILTIN_CVTPI2PD, UNKNOWN, (int)V2DF_FTYPE_V2SI},

    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_cvtsd2si, "__builtin_ia32_cvtsd2si",
     IX86_BUILTIN_CVTSD2SI, UNKNOWN, (int)INT_FTYPE_V2DF},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_cvttsd2si, "__builtin_ia32_cvttsd2si",
     IX86_BUILTIN_CVTTSD2SI, UNKNOWN, (int)INT_FTYPE_V2DF},
    {OPTION_MASK_ISA_SSE2 | OPTION_MASK_ISA_64BIT, CODE_FOR_sse2_cvtsd2siq,
     "__builtin_ia32_cvtsd2si64", IX86_BUILTIN_CVTSD2SI64, UNKNOWN,
     (int)INT64_FTYPE_V2DF},
    {OPTION_MASK_ISA_SSE2 | OPTION_MASK_ISA_64BIT, CODE_FOR_sse2_cvttsd2siq,
     "__builtin_ia32_cvttsd2si64", IX86_BUILTIN_CVTTSD2SI64, UNKNOWN,
     (int)INT64_FTYPE_V2DF},
    ...
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_maskcmpv2df3, "__builtin_ia32_cmpeqpd",
     IX86_BUILTIN_CMPEQPD, EQ, (int)V2DF_FTYPE_V2DF_V2DF},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_maskcmpv2df3, "__builtin_ia32_cmpltpd",
     IX86_BUILTIN_CMPLTPD, LT, (int)V2DF_FTYPE_V2DF_V2DF},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_maskcmpv2df3, "__builtin_ia32_cmplepd",
     IX86_BUILTIN_CMPLEPD, LE, (int)V2DF_FTYPE_V2DF_V2DF},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_maskcmpv2df3, "__builtin_ia32_cmpgtpd",
     IX86_BUILTIN_CMPGTPD, LT, (int)V2DF_FTYPE_V2DF_V2DF_SWAP},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_maskcmpv2df3, "__builtin_ia32_cmpgepd",
     IX86_BUILTIN_CMPGEPD, LE, (int)V2DF_FTYPE_V2DF_V2DF_SWAP},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_maskcmpv2df3,
     "__builtin_ia32_cmpunordpd", IX86_BUILTIN_CMPUNORDPD, UNORDERED,
     (int)V2DF_FTYPE_V2DF_V2DF},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_maskcmpv2df3,
     "__builtin_ia32_cmpneqpd", IX86_BUILTIN_CMPNEQPD, NE,
     (int)V2DF_FTYPE_V2DF_V2DF},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_maskcmpv2df3,
     "__builtin_ia32_cmpnltpd", IX86_BUILTIN_CMPNLTPD, UNGE,
     (int)V2DF_FTYPE_V2DF_V2DF},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_maskcmpv2df3,
     "__builtin_ia32_cmpnlepd", IX86_BUILTIN_CMPNLEPD, UNGT,
     (int)V2DF_FTYPE_V2DF_V2DF},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_maskcmpv2df3,
     "__builtin_ia32_cmpngtpd", IX86_BUILTIN_CMPNGTPD, UNGE,
     (int)V2DF_FTYPE_V2DF_V2DF_SWAP},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_maskcmpv2df3,
     "__builtin_ia32_cmpngepd", IX86_BUILTIN_CMPNGEPD, UNGT,
     (int)V2DF_FTYPE_V2DF_V2DF_SWAP},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_maskcmpv2df3,
     "__builtin_ia32_cmpordpd", IX86_BUILTIN_CMPORDPD, ORDERED,
     (int)V2DF_FTYPE_V2DF_V2DF},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_vmmaskcmpv2df3,
     "__builtin_ia32_cmpeqsd", IX86_BUILTIN_CMPEQSD, EQ,
     (int)V2DF_FTYPE_V2DF_V2DF},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_vmmaskcmpv2df3,
     "__builtin_ia32_cmpltsd", IX86_BUILTIN_CMPLTSD, LT,
     (int)V2DF_FTYPE_V2DF_V2DF},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_vmmaskcmpv2df3,
     "__builtin_ia32_cmplesd", IX86_BUILTIN_CMPLESD, LE,
     (int)V2DF_FTYPE_V2DF_V2DF},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_vmmaskcmpv2df3,
     "__builtin_ia32_cmpunordsd", IX86_BUILTIN_CMPUNORDSD, UNORDERED,
     (int)V2DF_FTYPE_V2DF_V2DF},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_vmmaskcmpv2df3,
     "__builtin_ia32_cmpneqsd", IX86_BUILTIN_CMPNEQSD, NE,
     (int)V2DF_FTYPE_V2DF_V2DF},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_vmmaskcmpv2df3,
     "__builtin_ia32_cmpnltsd", IX86_BUILTIN_CMPNLTSD, UNGE,
     (int)V2DF_FTYPE_V2DF_V2DF},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_vmmaskcmpv2df3,
     "__builtin_ia32_cmpnlesd", IX86_BUILTIN_CMPNLESD, UNGT,
     (int)V2DF_FTYPE_V2DF_V2DF},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_vmmaskcmpv2df3,
     "__builtin_ia32_cmpordsd", IX86_BUILTIN_CMPORDSD, ORDERED,
     (int)V2DF_FTYPE_V2DF_V2DF},
    ...
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_andnotv2df3, "__builtin_ia32_andnpd",
     IX86_BUILTIN_ANDNPD, UNKNOWN, (int)V2DF_FTYPE_V2DF_V2DF},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_iorv2df3, "__builtin_ia32_orpd",
     IX86_BUILTIN_ORPD, UNKNOWN, (int)V2DF_FTYPE_V2DF_V2DF},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_xorv2df3, "__builtin_ia32_xorpd",
     IX86_BUILTIN_XORPD, UNKNOWN, (int)V2DF_FTYPE_V2DF_V2DF},

    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_movsd, "__builtin_ia32_movsd",
     IX86_BUILTIN_MOVSD, UNKNOWN, (int)V2DF_FTYPE_V2DF_V2DF},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_unpckhpd_exp,
     "__builtin_ia32_unpckhpd", IX86_BUILTIN_UNPCKHPD, UNKNOWN,
     (int)V2DF_FTYPE_V2DF_V2DF},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_unpcklpd_exp,
     "__builtin_ia32_unpcklpd", IX86_BUILTIN_UNPCKLPD, UNKNOWN,
     (int)V2DF_FTYPE_V2DF_V2DF},

    {OPTION_MASK_ISA_SSE2, CODE_FOR_vec_pack_sfix_v2df,
     "__builtin_ia32_vec_pack_sfix", IX86_BUILTIN_VEC_PACK_SFIX, UNKNOWN,
     (int)V4SI_FTYPE_V2DF_V2DF},

    {OPTION_MASK_ISA_SSE2, CODE_FOR_addv16qi3, "__builtin_ia32_paddb128",
     IX86_BUILTIN_PADDB128, UNKNOWN, (int)V16QI_FTYPE_V16QI_V16QI},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_addv8hi3, "__builtin_ia32_paddw128",
     IX86_BUILTIN_PADDW128, UNKNOWN, (int)V8HI_FTYPE_V8HI_V8HI},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_addv4si3, "__builtin_ia32_paddd128",
     IX86_BUILTIN_PADDD128, UNKNOWN, (int)V4SI_FTYPE_V4SI_V4SI},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_addv2di3, "__builtin_ia32_paddq128",
     IX86_BUILTIN_PADDQ128, UNKNOWN, (int)V2DI_FTYPE_V2DI_V2DI},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_subv16qi3, "__builtin_ia32_psubb128",
     IX86_BUILTIN_PSUBB128, UNKNOWN, (int)V16QI_FTYPE_V16QI_V16QI},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_subv8hi3, "__builtin_ia32_psubw128",
     IX86_BUILTIN_PSUBW128, UNKNOWN, (int)V8HI_FTYPE_V8HI_V8HI},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_subv4si3, "__builtin_ia32_psubd128",
     IX86_BUILTIN_PSUBD128, UNKNOWN, (int)V4SI_FTYPE_V4SI_V4SI},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_subv2di3, "__builtin_ia32_psubq128",
     IX86_BUILTIN_PSUBQ128, UNKNOWN, (int)V2DI_FTYPE_V2DI_V2DI},

    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_ssaddv16qi3,
     "__builtin_ia32_paddsb128", IX86_BUILTIN_PADDSB128, UNKNOWN,
     (int)V16QI_FTYPE_V16QI_V16QI},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_ssaddv8hi3, "__builtin_ia32_paddsw128",
     IX86_BUILTIN_PADDSW128, UNKNOWN, (int)V8HI_FTYPE_V8HI_V8HI},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_sssubv16qi3,
     "__builtin_ia32_psubsb128", IX86_BUILTIN_PSUBSB128, UNKNOWN,
     (int)V16QI_FTYPE_V16QI_V16QI},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_sssubv8hi3, "__builtin_ia32_psubsw128",
     IX86_BUILTIN_PSUBSW128, UNKNOWN, (int)V8HI_FTYPE_V8HI_V8HI},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_usaddv16qi3,
     "__builtin_ia32_paddusb128", IX86_BUILTIN_PADDUSB128, UNKNOWN,
     (int)V16QI_FTYPE_V16QI_V16QI},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_usaddv8hi3,
     "__builtin_ia32_paddusw128", IX86_BUILTIN_PADDUSW128, UNKNOWN,
     (int)V8HI_FTYPE_V8HI_V8HI},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_ussubv16qi3,
     "__builtin_ia32_psubusb128", IX86_BUILTIN_PSUBUSB128, UNKNOWN,
     (int)V16QI_FTYPE_V16QI_V16QI},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_ussubv8hi3,
     "__builtin_ia32_psubusw128", IX86_BUILTIN_PSUBUSW128, UNKNOWN,
     (int)V8HI_FTYPE_V8HI_V8HI},

    {OPTION_MASK_ISA_SSE2, CODE_FOR_mulv8hi3, "__builtin_ia32_pmullw128",
     IX86_BUILTIN_PMULLW128, UNKNOWN, (int)V8HI_FTYPE_V8HI_V8HI},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_smulv8hi3_highpart,
     "__builtin_ia32_pmulhw128", IX86_BUILTIN_PMULHW128, UNKNOWN,
     (int)V8HI_FTYPE_V8HI_V8HI},

    {OPTION_MASK_ISA_SSE2, CODE_FOR_andv2di3, "__builtin_ia32_pand128",
     IX86_BUILTIN_PAND128, UNKNOWN, (int)V2DI_FTYPE_V2DI_V2DI},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_andnotv2di3, "__builtin_ia32_pandn128",
     IX86_BUILTIN_PANDN128, UNKNOWN, (int)V2DI_FTYPE_V2DI_V2DI},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_iorv2di3, "__builtin_ia32_por128",
     IX86_BUILTIN_POR128, UNKNOWN, (int)V2DI_FTYPE_V2DI_V2DI},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_xorv2di3, "__builtin_ia32_pxor128",
     IX86_BUILTIN_PXOR128, UNKNOWN, (int)V2DI_FTYPE_V2DI_V2DI},

    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_uavgv16qi3, "__builtin_ia32_pavgb128",
     IX86_BUILTIN_PAVGB128, UNKNOWN, (int)V16QI_FTYPE_V16QI_V16QI},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_uavgv8hi3, "__builtin_ia32_pavgw128",
     IX86_BUILTIN_PAVGW128, UNKNOWN, (int)V8HI_FTYPE_V8HI_V8HI},

    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_eqv16qi3, "__builtin_ia32_pcmpeqb128",
     IX86_BUILTIN_PCMPEQB128, UNKNOWN, (int)V16QI_FTYPE_V16QI_V16QI},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_eqv8hi3, "__builtin_ia32_pcmpeqw128",
     IX86_BUILTIN_PCMPEQW128, UNKNOWN, (int)V8HI_FTYPE_V8HI_V8HI},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_eqv4si3, "__builtin_ia32_pcmpeqd128",
     IX86_BUILTIN_PCMPEQD128, UNKNOWN, (int)V4SI_FTYPE_V4SI_V4SI},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_gtv16qi3, "__builtin_ia32_pcmpgtb128",
     IX86_BUILTIN_PCMPGTB128, UNKNOWN, (int)V16QI_FTYPE_V16QI_V16QI},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_gtv8hi3, "__builtin_ia32_pcmpgtw128",
     IX86_BUILTIN_PCMPGTW128, UNKNOWN, (int)V8HI_FTYPE_V8HI_V8HI},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_gtv4si3, "__builtin_ia32_pcmpgtd128",
     IX86_BUILTIN_PCMPGTD128, UNKNOWN, (int)V4SI_FTYPE_V4SI_V4SI},

    {OPTION_MASK_ISA_SSE2, CODE_FOR_umaxv16qi3, "__builtin_ia32_pmaxub128",
     IX86_BUILTIN_PMAXUB128, UNKNOWN, (int)V16QI_FTYPE_V16QI_V16QI},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_smaxv8hi3, "__builtin_ia32_pmaxsw128",
     IX86_BUILTIN_PMAXSW128, UNKNOWN, (int)V8HI_FTYPE_V8HI_V8HI},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_uminv16qi3, "__builtin_ia32_pminub128",
     IX86_BUILTIN_PMINUB128, UNKNOWN, (int)V16QI_FTYPE_V16QI_V16QI},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sminv8hi3, "__builtin_ia32_pminsw128",
     IX86_BUILTIN_PMINSW128, UNKNOWN, (int)V8HI_FTYPE_V8HI_V8HI},

    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_punpckhbw,
     "__builtin_ia32_punpckhbw128", IX86_BUILTIN_PUNPCKHBW128, UNKNOWN,
     (int)V16QI_FTYPE_V16QI_V16QI},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_punpckhwd,
     "__builtin_ia32_punpckhwd128", IX86_BUILTIN_PUNPCKHWD128, UNKNOWN,
     (int)V8HI_FTYPE_V8HI_V8HI},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_punpckhdq,
     "__builtin_ia32_punpckhdq128", IX86_BUILTIN_PUNPCKHDQ128, UNKNOWN,
     (int)V4SI_FTYPE_V4SI_V4SI},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_punpckhqdq,
     "__builtin_ia32_punpckhqdq128", IX86_BUILTIN_PUNPCKHQDQ128, UNKNOWN,
     (int)V2DI_FTYPE_V2DI_V2DI},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_punpcklbw,
     "__builtin_ia32_punpcklbw128", IX86_BUILTIN_PUNPCKLBW128, UNKNOWN,
     (int)V16QI_FTYPE_V16QI_V16QI},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_punpcklwd,
     "__builtin_ia32_punpcklwd128", IX86_BUILTIN_PUNPCKLWD128, UNKNOWN,
     (int)V8HI_FTYPE_V8HI_V8HI},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_punpckldq,
     "__builtin_ia32_punpckldq128", IX86_BUILTIN_PUNPCKLDQ128, UNKNOWN,
     (int)V4SI_FTYPE_V4SI_V4SI},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_punpcklqdq,
     "__builtin_ia32_punpcklqdq128", IX86_BUILTIN_PUNPCKLQDQ128, UNKNOWN,
     (int)V2DI_FTYPE_V2DI_V2DI},

    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_packsswb, "__builtin_ia32_packsswb128",
     IX86_BUILTIN_PACKSSWB128, UNKNOWN, (int)V16QI_FTYPE_V8HI_V8HI},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_packssdw, "__builtin_ia32_packssdw128",
     IX86_BUILTIN_PACKSSDW128, UNKNOWN, (int)V8HI_FTYPE_V4SI_V4SI},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_packuswb, "__builtin_ia32_packuswb128",
     IX86_BUILTIN_PACKUSWB128, UNKNOWN, (int)V16QI_FTYPE_V8HI_V8HI},

    {OPTION_MASK_ISA_SSE2, CODE_FOR_umulv8hi3_highpart,
     "__builtin_ia32_pmulhuw128", IX86_BUILTIN_PMULHUW128, UNKNOWN,
     (int)V8HI_FTYPE_V8HI_V8HI},
    ...
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_umulv1siv1di3,
     "__builtin_ia32_pmuludq", IX86_BUILTIN_PMULUDQ, UNKNOWN,
     (int)V1DI_FTYPE_V2SI_V2SI},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_umulv2siv2di3,
     "__builtin_ia32_pmuludq128", IX86_BUILTIN_PMULUDQ128, UNKNOWN,
    ...
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_cvtsi2sd, "__builtin_ia32_cvtsi2sd",
     IX86_BUILTIN_CVTSI2SD, UNKNOWN, (int)V2DF_FTYPE_V2DF_SI},
    {OPTION_MASK_ISA_SSE2 | OPTION_MASK_ISA_64BIT, CODE_FOR_sse2_cvtsi2sdq,
     "__builtin_ia32_cvtsi642sd", IX86_BUILTIN_CVTSI642SD, UNKNOWN,
     (int)V2DF_FTYPE_V2DF_DI},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_cvtsd2ss, "__builtin_ia32_cvtsd2ss",
     IX86_BUILTIN_CVTSD2SS, UNKNOWN, (int)V4SF_FTYPE_V4SF_V2DF},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_cvtss2sd, "__builtin_ia32_cvtss2sd",
     IX86_BUILTIN_CVTSS2SD, UNKNOWN, (int)V2DF_FTYPE_V2DF_V4SF},

    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_ashlti3, "__builtin_ia32_pslldqi128",
     IX86_BUILTIN_PSLLDQI128, UNKNOWN, (int)V2DI2TI_FTYPE_V2DI_INT},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_ashlv8hi3, "__builtin_ia32_psllwi128",
     IX86_BUILTIN_PSLLWI128, UNKNOWN, (int)V8HI_FTYPE_V8HI_SI_COUNT},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_ashlv4si3, "__builtin_ia32_pslldi128",
     IX86_BUILTIN_PSLLDI128, UNKNOWN, (int)V4SI_FTYPE_V4SI_SI_COUNT},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_ashlv2di3, "__builtin_ia32_psllqi128",
     IX86_BUILTIN_PSLLQI128, UNKNOWN, (int)V2DI_FTYPE_V2DI_SI_COUNT},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_ashlv8hi3, "__builtin_ia32_psllw128",
     IX86_BUILTIN_PSLLW128, UNKNOWN, (int)V8HI_FTYPE_V8HI_V8HI_COUNT},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_ashlv4si3, "__builtin_ia32_pslld128",
     IX86_BUILTIN_PSLLD128, UNKNOWN, (int)V4SI_FTYPE_V4SI_V4SI_COUNT},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_ashlv2di3, "__builtin_ia32_psllq128",
     IX86_BUILTIN_PSLLQ128, UNKNOWN, (int)V2DI_FTYPE_V2DI_V2DI_COUNT},

    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_lshrti3, "__builtin_ia32_psrldqi128",
     IX86_BUILTIN_PSRLDQI128, UNKNOWN, (int)V2DI2TI_FTYPE_V2DI_INT},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_lshrv8hi3, "__builtin_ia32_psrlwi128",
     IX86_BUILTIN_PSRLWI128, UNKNOWN, (int)V8HI_FTYPE_V8HI_SI_COUNT},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_lshrv4si3, "__builtin_ia32_psrldi128",
     IX86_BUILTIN_PSRLDI128, UNKNOWN, (int)V4SI_FTYPE_V4SI_SI_COUNT},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_lshrv2di3, "__builtin_ia32_psrlqi128",
     IX86_BUILTIN_PSRLQI128, UNKNOWN, (int)V2DI_FTYPE_V2DI_SI_COUNT},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_lshrv8hi3, "__builtin_ia32_psrlw128",
     IX86_BUILTIN_PSRLW128, UNKNOWN, (int)V8HI_FTYPE_V8HI_V8HI_COUNT},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_lshrv4si3, "__builtin_ia32_psrld128",
     IX86_BUILTIN_PSRLD128, UNKNOWN, (int)V4SI_FTYPE_V4SI_V4SI_COUNT},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_lshrv2di3, "__builtin_ia32_psrlq128",
     IX86_BUILTIN_PSRLQ128, UNKNOWN, (int)V2DI_FTYPE_V2DI_V2DI_COUNT},

    {OPTION_MASK_ISA_SSE2, CODE_FOR_ashrv8hi3, "__builtin_ia32_psrawi128",
     IX86_BUILTIN_PSRAWI128, UNKNOWN, (int)V8HI_FTYPE_V8HI_SI_COUNT},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_ashrv4si3, "__builtin_ia32_psradi128",
     IX86_BUILTIN_PSRADI128, UNKNOWN, (int)V4SI_FTYPE_V4SI_SI_COUNT},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_ashrv8hi3, "__builtin_ia32_psraw128",
     IX86_BUILTIN_PSRAW128, UNKNOWN, (int)V8HI_FTYPE_V8HI_V8HI_COUNT},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_ashrv4si3, "__builtin_ia32_psrad128",
     IX86_BUILTIN_PSRAD128, UNKNOWN, (int)V4SI_FTYPE_V4SI_V4SI_COUNT},

    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_pshufd, "__builtin_ia32_pshufd",
     IX86_BUILTIN_PSHUFD, UNKNOWN, (int)V4SI_FTYPE_V4SI_INT},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_pshuflw, "__builtin_ia32_pshuflw",
     IX86_BUILTIN_PSHUFLW, UNKNOWN, (int)V8HI_FTYPE_V8HI_INT},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_sse2_pshufhw, "__builtin_ia32_pshufhw",
     IX86_BUILTIN_PSHUFHW, UNKNOWN, (int)V8HI_FTYPE_V8HI_INT},
    ...
    /* SSE2 MMX */
    {OPTION_MASK_ISA_SSE2, CODE_FOR_mmx_addv1di3, "__builtin_ia32_paddq",
     IX86_BUILTIN_PADDQ, UNKNOWN, (int)V1DI_FTYPE_V1DI_V1DI},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_mmx_subv1di3, "__builtin_ia32_psubq",
     IX86_BUILTIN_PSUBQ, UNKNOWN, (int)V1DI_FTYPE_V1DI_V1DI},

    /* SSE3 */
    {OPTION_MASK_ISA_SSE3, CODE_FOR_sse3_movshdup, "__builtin_ia32_movshdup",
     IX86_BUILTIN_MOVSHDUP, UNKNOWN, (int)V4SF_FTYPE_V4SF},
    {OPTION_MASK_ISA_SSE3, CODE_FOR_sse3_movsldup, "__builtin_ia32_movsldup",
     IX86_BUILTIN_MOVSLDUP, UNKNOWN, (int)V4SF_FTYPE_V4SF},

    {OPTION_MASK_ISA_SSE3, CODE_FOR_sse3_addsubv4sf3, "__builtin_ia32_addsubps",
     IX86_BUILTIN_ADDSUBPS, UNKNOWN, (int)V4SF_FTYPE_V4SF_V4SF},
    {OPTION_MASK_ISA_SSE3, CODE_FOR_sse3_addsubv2df3, "__builtin_ia32_addsubpd",
     IX86_BUILTIN_ADDSUBPD, UNKNOWN, (int)V2DF_FTYPE_V2DF_V2DF},
    {OPTION_MASK_ISA_SSE3, CODE_FOR_sse3_haddv4sf3, "__builtin_ia32_haddps",
     IX86_BUILTIN_HADDPS, UNKNOWN, (int)V4SF_FTYPE_V4SF_V4SF},
    {OPTION_MASK_ISA_SSE3, CODE_FOR_sse3_haddv2df3, "__builtin_ia32_haddpd",
     IX86_BUILTIN_HADDPD, UNKNOWN, (int)V2DF_FTYPE_V2DF_V2DF},
    {OPTION_MASK_ISA_SSE3, CODE_FOR_sse3_hsubv4sf3, "__builtin_ia32_hsubps",
     IX86_BUILTIN_HSUBPS, UNKNOWN, (int)V4SF_FTYPE_V4SF_V4SF},
    {OPTION_MASK_ISA_SSE3, CODE_FOR_sse3_hsubv2df3, "__builtin_ia32_hsubpd",
     IX86_BUILTIN_HSUBPD, UNKNOWN, (int)V2DF_FTYPE_V2DF_V2DF},

    /* SSSE3 */
    {OPTION_MASK_ISA_SSSE3, CODE_FOR_absv16qi2, "__builtin_ia32_pabsb128",
     IX86_BUILTIN_PABSB128, UNKNOWN, (int)V16QI_FTYPE_V16QI},
    {OPTION_MASK_ISA_SSSE3, CODE_FOR_absv8qi2, "__builtin_ia32_pabsb",
    ...
    {OPTION_MASK_ISA_SSSE3, CODE_FOR_absv4hi2, "__builtin_ia32_pabsw",
     IX86_BUILTIN_PABSW, UNKNOWN, (int)V4HI_FTYPE_V4HI},
    {OPTION_MASK_ISA_SSSE3, CODE_FOR_absv4si2, "__builtin_ia32_pabsd128",
     IX86_BUILTIN_PABSD128, UNKNOWN, (int)V4SI_FTYPE_V4SI},
    {OPTION_MASK_ISA_SSSE3, CODE_FOR_absv2si2, "__builtin_ia32_pabsd",
     IX86_BUILTIN_PABSD, UNKNOWN, (int)V2SI_FTYPE_V2SI},

    {OPTION_MASK_ISA_SSSE3, CODE_FOR_ssse3_phaddwv8hi3,
     "__builtin_ia32_phaddw128", IX86_BUILTIN_PHADDW128, UNKNOWN,
     (int)V8HI_FTYPE_V8HI_V8HI},
    {OPTION_MASK_ISA_SSSE3, CODE_FOR_ssse3_phaddwv4hi3, "__builtin_ia32_phaddw",
     IX86_BUILTIN_PHADDW, UNKNOWN, (int)V4HI_FTYPE_V4HI_V4HI},
    {OPTION_MASK_ISA_SSSE3, CODE_FOR_ssse3_phadddv4si3,
     "__builtin_ia32_phaddd128", IX86_BUILTIN_PHADDD128, UNKNOWN,
     (int)V4SI_FTYPE_V4SI_V4SI},
    {OPTION_MASK_ISA_SSSE3, CODE_FOR_ssse3_phadddv2si3, "__builtin_ia32_phaddd",
     IX86_BUILTIN_PHADDD, UNKNOWN, (int)V2SI_FTYPE_V2SI_V2SI},
    {OPTION_MASK_ISA_SSSE3, CODE_FOR_ssse3_phaddswv8hi3,
     "__builtin_ia32_phaddsw128", IX86_BUILTIN_PHADDSW128, UNKNOWN,
     (int)V8HI_FTYPE_V8HI_V8HI},
    {OPTION_MASK_ISA_SSSE3, CODE_FOR_ssse3_phaddswv4hi3,
     "__builtin_ia32_phaddsw", IX86_BUILTIN_PHADDSW, UNKNOWN,
     (int)V4HI_FTYPE_V4HI_V4HI},
    {OPTION_MASK_ISA_SSSE3, CODE_FOR_ssse3_phsubwv8hi3,
     "__builtin_ia32_phsubw128", IX86_BUILTIN_PHSUBW128, UNKNOWN,
     (int)V8HI_FTYPE_V8HI_V8HI},
    {OPTION_MASK_ISA_SSSE3, CODE_FOR_ssse3_phsubwv4hi3, "__builtin_ia32_phsubw",
     IX86_BUILTIN_PHSUBW, UNKNOWN, (int)V4HI_FTYPE_V4HI_V4HI},
    {OPTION_MASK_ISA_SSSE3, CODE_FOR_ssse3_phsubdv4si3,
     "__builtin_ia32_phsubd128", IX86_BUILTIN_PHSUBD128, UNKNOWN,
     (int)V4SI_FTYPE_V4SI_V4SI},
    {OPTION_MASK_ISA_SSSE3, CODE_FOR_ssse3_phsubdv2si3, "__builtin_ia32_phsubd",
     IX86_BUILTIN_PHSUBD, UNKNOWN, (int)V2SI_FTYPE_V2SI_V2SI},
    {OPTION_MASK_ISA_SSSE3, CODE_FOR_ssse3_phsubswv8hi3,
     "__builtin_ia32_phsubsw128", IX86_BUILTIN_PHSUBSW128, UNKNOWN,
     (int)V8HI_FTYPE_V8HI_V8HI},
    {OPTION_MASK_ISA_SSSE3, CODE_FOR_ssse3_phsubswv4hi3,
     "__builtin_ia32_phsubsw", IX86_BUILTIN_PHSUBSW, UNKNOWN,
     (int)V4HI_FTYPE_V4HI_V4HI},
    {OPTION_MASK_ISA_SSSE3, CODE_FOR_ssse3_pmaddubsw128,
     "__builtin_ia32_pmaddubsw128", IX86_BUILTIN_PMADDUBSW128, UNKNOWN,
     (int)V8HI_FTYPE_V16QI_V16QI},
    {OPTION_MASK_ISA_SSSE3, CODE_FOR_ssse3_pmaddubsw,
     "__builtin_ia32_pmaddubsw", IX86_BUILTIN_PMADDUBSW, UNKNOWN,
     (int)V4HI_FTYPE_V8QI_V8QI},
    {OPTION_MASK_ISA_SSSE3, CODE_FOR_ssse3_pmulhrswv8hi3,
     "__builtin_ia32_pmulhrsw128", IX86_BUILTIN_PMULHRSW128, UNKNOWN,
     (int)V8HI_FTYPE_V8HI_V8HI},
    {OPTION_MASK_ISA_SSSE3, CODE_FOR_ssse3_pmulhrswv4hi3,
     "__builtin_ia32_pmulhrsw", IX86_BUILTIN_PMULHRSW, UNKNOWN,
     (int)V4HI_FTYPE_V4HI_V4HI},
    {OPTION_MASK_ISA_SSSE3, CODE_FOR_ssse3_pshufbv16qi3,
     "__builtin_ia32_pshufb128", IX86_BUILTIN_PSHUFB128, UNKNOWN,
     (int)V16QI_FTYPE_V16QI_V16QI},
    {OPTION_MASK_ISA_SSSE3, CODE_FOR_ssse3_pshufbv8qi3, "__builtin_ia32_pshufb",
     IX86_BUILTIN_PSHUFB, UNKNOWN, (int)V8QI_FTYPE_V8QI_V8QI},
    {OPTION_MASK_ISA_SSSE3, CODE_FOR_ssse3_psignv16qi3,
     "__builtin_ia32_psignb128", IX86_BUILTIN_PSIGNB128, UNKNOWN,
     (int)V16QI_FTYPE_V16QI_V16QI},
    {OPTION_MASK_ISA_SSSE3, CODE_FOR_ssse3_psignv8qi3, "__builtin_ia32_psignb",
     IX86_BUILTIN_PSIGNB, UNKNOWN, (int)V8QI_FTYPE_V8QI_V8QI},
    {OPTION_MASK_ISA_SSSE3, CODE_FOR_ssse3_psignv8hi3,
     "__builtin_ia32_psignw128", IX86_BUILTIN_PSIGNW128, UNKNOWN,
     (int)V8HI_FTYPE_V8HI_V8HI},
    {OPTION_MASK_ISA_SSSE3, CODE_FOR_ssse3_psignv4hi3, "__builtin_ia32_psignw",
     IX86_BUILTIN_PSIGNW, UNKNOWN, (int)V4HI_FTYPE_V4HI_V4HI},
    {OPTION_MASK_ISA_SSSE3, CODE_FOR_ssse3_psignv4si3,
     "__builtin_ia32_psignd128", IX86_BUILTIN_PSIGND128, UNKNOWN,
     (int)V4SI_FTYPE_V4SI_V4SI},
    {OPTION_MASK_ISA_SSSE3, CODE_FOR_ssse3_psignv2si3, "__builtin_ia32_psignd",
     IX86_BUILTIN_PSIGND, UNKNOWN, (int)V2SI_FTYPE_V2SI_V2SI},

    /* SSSE3.  */
    {OPTION_MASK_ISA_SSSE3, CODE_FOR_ssse3_palignrti,
     "__builtin_ia32_palignr128", IX86_BUILTIN_PALIGNR128, UNKNOWN,
     (int)V2DI2TI_FTYPE_V2DI_V2DI_INT},
    {OPTION_MASK_ISA_SSSE3, CODE_FOR_ssse3_palignrdi, "__builtin_ia32_palignr",
     IX86_BUILTIN_PALIGNR, UNKNOWN, (int)V1DI2DI_FTYPE_V1DI_V1DI_INT},

    /* SSE4.1 */
    {OPTION_MASK_ISA_SSE4_1, CODE_FOR_sse4_1_blendpd, "__builtin_ia32_blendpd",
     IX86_BUILTIN_BLENDPD, UNKNOWN, (int)V2DF_FTYPE_V2DF_V2DF_INT},
    {OPTION_MASK_ISA_SSE4_1, CODE_FOR_sse4_1_blendps, "__builtin_ia32_blendps",
     IX86_BUILTIN_BLENDPS, UNKNOWN, (int)V4SF_FTYPE_V4SF_V4SF_INT},
    {OPTION_MASK_ISA_SSE4_1, CODE_FOR_sse4_1_blendvpd,
     "__builtin_ia32_blendvpd", IX86_BUILTIN_BLENDVPD, UNKNOWN,
     (int)V2DF_FTYPE_V2DF_V2DF_V2DF},
    {OPTION_MASK_ISA_SSE4_1, CODE_FOR_sse4_1_blendvps,
     "__builtin_ia32_blendvps", IX86_BUILTIN_BLENDVPS, UNKNOWN,
     (int)V4SF_FTYPE_V4SF_V4SF_V4SF},
    {OPTION_MASK_ISA_SSE4_1, CODE_FOR_sse4_1_dppd, "__builtin_ia32_dppd",
     IX86_BUILTIN_DPPD, UNKNOWN, (int)V2DF_FTYPE_V2DF_V2DF_INT},
    {OPTION_MASK_ISA_SSE4_1, CODE_FOR_sse4_1_dpps, "__builtin_ia32_dpps",
     IX86_BUILTIN_DPPS, UNKNOWN, (int)V4SF_FTYPE_V4SF_V4SF_INT},
    {OPTION_MASK_ISA_SSE4_1, CODE_FOR_sse4_1_insertps,
     "__builtin_ia32_insertps128", IX86_BUILTIN_INSERTPS128, UNKNOWN,
     (int)V4SF_FTYPE_V4SF_V4SF_INT},
    {OPTION_MASK_ISA_SSE4_1, CODE_FOR_sse4_1_mpsadbw,
     "__builtin_ia32_mpsadbw128", IX86_BUILTIN_MPSADBW128, UNKNOWN,
     (int)V16QI_FTYPE_V16QI_V16QI_INT},
    {OPTION_MASK_ISA_SSE4_1, CODE_FOR_sse4_1_pblendvb,
     "__builtin_ia32_pblendvb128", IX86_BUILTIN_PBLENDVB128, UNKNOWN,
     (int)V16QI_FTYPE_V16QI_V16QI_V16QI},
    {OPTION_MASK_ISA_SSE4_1, CODE_FOR_sse4_1_pblendw,
     "__builtin_ia32_pblendw128", IX86_BUILTIN_PBLENDW128, UNKNOWN,
     (int)V8HI_FTYPE_V8HI_V8HI_INT},

    {OPTION_MASK_ISA_SSE4_1, CODE_FOR_sse4_1_extendv8qiv8hi2,
     "__builtin_ia32_pmovsxbw128", IX86_BUILTIN_PMOVSXBW128, UNKNOWN,
     (int)V8HI_FTYPE_V16QI},
    {OPTION_MASK_ISA_SSE4_1, CODE_FOR_sse4_1_extendv4qiv4si2,
     "__builtin_ia32_pmovsxbd128", IX86_BUILTIN_PMOVSXBD128, UNKNOWN,
     (int)V4SI_FTYPE_V16QI},
    {OPTION_MASK_ISA_SSE4_1, CODE_FOR_sse4_1_extendv2qiv2di2,
     "__builtin_ia32_pmovsxbq128", IX86_BUILTIN_PMOVSXBQ128, UNKNOWN,
     (int)V2DI_FTYPE_V16QI},
    {OPTION_MASK_ISA_SSE4_1, CODE_FOR_sse4_1_extendv4hiv4si2,
     "__builtin_ia32_pmovsxwd128", IX86_BUILTIN_PMOVSXWD128, UNKNOWN,
     (int)V4SI_FTYPE_V8HI},
    {OPTION_MASK_ISA_SSE4_1, CODE_FOR_sse4_1_extendv2hiv2di2,
     "__builtin_ia32_pmovsxwq128", IX86_BUILTIN_PMOVSXWQ128, UNKNOWN,
     (int)V2DI_FTYPE_V8HI},
    {OPTION_MASK_ISA_SSE4_1, CODE_FOR_sse4_1_extendv2siv2di2,
     "__builtin_ia32_pmovsxdq128", IX86_BUILTIN_PMOVSXDQ128, UNKNOWN,
     (int)V2DI_FTYPE_V4SI},
    {OPTION_MASK_ISA_SSE4_1, CODE_FOR_sse4_1_zero_extendv8qiv8hi2,
     "__builtin_ia32_pmovzxbw128", IX86_BUILTIN_PMOVZXBW128, UNKNOWN,
     (int)V8HI_FTYPE_V16QI},
    {OPTION_MASK_ISA_SSE4_1, CODE_FOR_sse4_1_zero_extendv4qiv4si2,
     "__builtin_ia32_pmovzxbd128", IX86_BUILTIN_PMOVZXBD128, UNKNOWN,
     (int)V4SI_FTYPE_V16QI},
    {OPTION_MASK_ISA_SSE4_1, CODE_FOR_sse4_1_zero_extendv2qiv2di2,
     "__builtin_ia32_pmovzxbq128", IX86_BUILTIN_PMOVZXBQ128, UNKNOWN,
     (int)V2DI_FTYPE_V16QI},
    {OPTION_MASK_ISA_SSE4_1, CODE_FOR_sse4_1_zero_extendv4hiv4si2,
     "__builtin_ia32_pmovzxwd128", IX86_BUILTIN_PMOVZXWD128, UNKNOWN,
     (int)V4SI_FTYPE_V8HI},
    {OPTION_MASK_ISA_SSE4_1, CODE_FOR_sse4_1_zero_extendv2hiv2di2,
     "__builtin_ia32_pmovzxwq128", IX86_BUILTIN_PMOVZXWQ128, UNKNOWN,
     (int)V2DI_FTYPE_V8HI},
    {OPTION_MASK_ISA_SSE4_1, CODE_FOR_sse4_1_zero_extendv2siv2di2,
     "__builtin_ia32_pmovzxdq128", IX86_BUILTIN_PMOVZXDQ128, UNKNOWN,
     (int)V2DI_FTYPE_V4SI},
    {OPTION_MASK_ISA_SSE4_1, CODE_FOR_sse4_1_phminposuw,
     "__builtin_ia32_phminposuw128", IX86_BUILTIN_PHMINPOSUW128, UNKNOWN,
     (int)V8HI_FTYPE_V8HI},

    {OPTION_MASK_ISA_SSE4_1, CODE_FOR_sse4_1_packusdw,
     "__builtin_ia32_packusdw128", IX86_BUILTIN_PACKUSDW128, UNKNOWN,
     (int)V8HI_FTYPE_V4SI_V4SI},
    {OPTION_MASK_ISA_SSE4_1, CODE_FOR_sse4_1_eqv2di3, "__builtin_ia32_pcmpeqq",
     IX86_BUILTIN_PCMPEQQ, UNKNOWN, (int)V2DI_FTYPE_V2DI_V2DI},
    {OPTION_MASK_ISA_SSE4_1, CODE_FOR_smaxv16qi3, "__builtin_ia32_pmaxsb128",
     IX86_BUILTIN_PMAXSB128, UNKNOWN, (int)V16QI_FTYPE_V16QI_V16QI},
    {OPTION_MASK_ISA_SSE4_1, CODE_FOR_smaxv4si3, "__builtin_ia32_pmaxsd128",
     IX86_BUILTIN_PMAXSD128, UNKNOWN, (int)V4SI_FTYPE_V4SI_V4SI},
    {OPTION_MASK_ISA_SSE4_1, CODE_FOR_umaxv4si3, "__builtin_ia32_pmaxud128",
     IX86_BUILTIN_PMAXUD128, UNKNOWN, (int)V4SI_FTYPE_V4SI_V4SI},
    {OPTION_MASK_ISA_SSE4_1, CODE_FOR_umaxv8hi3, "__builtin_ia32_pmaxuw128",
     IX86_BUILTIN_PMAXUW128, UNKNOWN, (int)V8HI_FTYPE_V8HI_V8HI},
    {OPTION_MASK_ISA_SSE4_1, CODE_FOR_sminv16qi3, "__builtin_ia32_pminsb128",
     IX86_BUILTIN_PMINSB128, UNKNOWN, (int)V16QI_FTYPE_V16QI_V16QI},
    {OPTION_MASK_ISA_SSE4_1, CODE_FOR_sminv4si3, "__builtin_ia32_pminsd128",
     IX86_BUILTIN_PMINSD128, UNKNOWN, (int)V4SI_FTYPE_V4SI_V4SI},
    ...
    {OPTION_MASK_ISA_SSE4_1, CODE_FOR_sse4_1_mulv2siv2di3,
     "__builtin_ia32_pmuldq128", IX86_BUILTIN_PMULDQ128, UNKNOWN,
     (int)V2DI_FTYPE_V4SI_V4SI},
    ...
    {OPTION_MASK_ISA_ROUND, CODE_FOR_sse4_1_roundsd, "__builtin_ia32_roundsd",
     IX86_BUILTIN_ROUNDSD, UNKNOWN, (int)V2DF_FTYPE_V2DF_V2DF_INT},
    {OPTION_MASK_ISA_ROUND, CODE_FOR_sse4_1_roundss, "__builtin_ia32_roundss",
     IX86_BUILTIN_ROUNDSS, UNKNOWN, (int)V4SF_FTYPE_V4SF_V4SF_INT},
    ...
    {OPTION_MASK_ISA_ROUND, CODE_FOR_sse4_1_ptest, "__builtin_ia32_ptestnzc128",
     IX86_BUILTIN_PTESTNZC, GTU, (int)INT_FTYPE_V2DI_V2DI_PTEST},
    ...
    {OPTION_MASK_ISA_SSE4_2, CODE_FOR_sse4_2_crc32qi, "__builtin_ia32_crc32qi",
     IX86_BUILTIN_CRC32QI, UNKNOWN, (int)UINT_FTYPE_UINT_UCHAR},
    {OPTION_MASK_ISA_SSE4_2, CODE_FOR_sse4_2_crc32hi, "__builtin_ia32_crc32hi",
     IX86_BUILTIN_CRC32HI, UNKNOWN, (int)UINT_FTYPE_UINT_USHORT},
    {OPTION_MASK_ISA_SSE4_2, CODE_FOR_sse4_2_crc32si, "__builtin_ia32_crc32si",
     IX86_BUILTIN_CRC32SI, UNKNOWN, (int)UINT_FTYPE_UINT_UINT},
    {OPTION_MASK_ISA_SSE4_2 | OPTION_MASK_ISA_64BIT, CODE_FOR_sse4_2_crc32di,
     "__builtin_ia32_crc32di", IX86_BUILTIN_CRC32DI, UNKNOWN,
     (int)UINT64_FTYPE_UINT64_UINT64},

    /* SSE4A */
    {OPTION_MASK_ISA_SSE4A, CODE_FOR_sse4a_extrqi, "__builtin_ia32_extrqi",
     IX86_BUILTIN_EXTRQI, UNKNOWN, (int)V2DI_FTYPE_V2DI_UINT_UINT},
    {OPTION_MASK_ISA_SSE4A, CODE_FOR_sse4a_extrq, "__builtin_ia32_extrq",
     IX86_BUILTIN_EXTRQ, UNKNOWN, (int)V2DI_FTYPE_V2DI_V16QI},
    {OPTION_MASK_ISA_SSE4A, CODE_FOR_sse4a_insertqi, "__builtin_ia32_insertqi",
     IX86_BUILTIN_INSERTQI, UNKNOWN, (int)V2DI_FTYPE_V2DI_V2DI_UINT_UINT},
    {OPTION_MASK_ISA_SSE4A, CODE_FOR_sse4a_insertq, "__builtin_ia32_insertq",
     IX86_BUILTIN_INSERTQ, UNKNOWN, (int)V2DI_FTYPE_V2DI_V2DI},

    /* AES */
    {OPTION_MASK_ISA_SSE2, CODE_FOR_aeskeygenassist, 0,
     IX86_BUILTIN_AESKEYGENASSIST128, UNKNOWN, (int)V2DI_FTYPE_V2DI_INT},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_aesimc, 0, IX86_BUILTIN_AESIMC128, UNKNOWN,
     (int)V2DI_FTYPE_V2DI},

    {OPTION_MASK_ISA_SSE2, CODE_FOR_aesenc, 0, IX86_BUILTIN_AESENC128, UNKNOWN,
     (int)V2DI_FTYPE_V2DI_V2DI},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_aesenclast, 0, IX86_BUILTIN_AESENCLAST128,
     UNKNOWN, (int)V2DI_FTYPE_V2DI_V2DI},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_aesdec, 0, IX86_BUILTIN_AESDEC128, UNKNOWN,
     (int)V2DI_FTYPE_V2DI_V2DI},
    {OPTION_MASK_ISA_SSE2, CODE_FOR_aesdeclast, 0, IX86_BUILTIN_AESDECLAST128,
     UNKNOWN, (int)V2DI_FTYPE_V2DI_V2DI},

    /* PCLMUL */
    {OPTION_MASK_ISA_SSE2, CODE_FOR_pclmulqdq, 0, IX86_BUILTIN_PCLMULQDQ128,
     UNKNOWN, (int)V2DI_FTYPE_V2DI_V2DI_INT},

    /* AVX */
    {OPTION_MASK_ISA_AVX, CODE_FOR_addv4df3, "__builtin_ia32_addpd256",
     IX86_BUILTIN_ADDPD256, UNKNOWN, (int)V4DF_FTYPE_V4DF_V4DF},
    {OPTION_MASK_ISA_AVX, CODE_FOR_addv8sf3, "__builtin_ia32_addps256",
     IX86_BUILTIN_ADDPS256, UNKNOWN, (int)V8SF_FTYPE_V8SF_V8SF},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_addsubv4df3,
     "__builtin_ia32_addsubpd256", IX86_BUILTIN_ADDSUBPD256, UNKNOWN,
     (int)V4DF_FTYPE_V4DF_V4DF},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_addsubv8sf3,
     "__builtin_ia32_addsubps256", IX86_BUILTIN_ADDSUBPS256, UNKNOWN,
     (int)V8SF_FTYPE_V8SF_V8SF},
    {OPTION_MASK_ISA_AVX, CODE_FOR_andv4df3, "__builtin_ia32_andpd256",
     IX86_BUILTIN_ANDPD256, UNKNOWN, (int)V4DF_FTYPE_V4DF_V4DF},
    {OPTION_MASK_ISA_AVX, CODE_FOR_andv8sf3, "__builtin_ia32_andps256",
     IX86_BUILTIN_ANDPS256, UNKNOWN, (int)V8SF_FTYPE_V8SF_V8SF},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_andnotv4df3, "__builtin_ia32_andnpd256",
     IX86_BUILTIN_ANDNPD256, UNKNOWN, (int)V4DF_FTYPE_V4DF_V4DF},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_andnotv8sf3, "__builtin_ia32_andnps256",
     IX86_BUILTIN_ANDNPS256, UNKNOWN, (int)V8SF_FTYPE_V8SF_V8SF},
    {OPTION_MASK_ISA_AVX, CODE_FOR_divv4df3, "__builtin_ia32_divpd256",
     IX86_BUILTIN_DIVPD256, UNKNOWN, (int)V4DF_FTYPE_V4DF_V4DF},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_divv8sf3, "__builtin_ia32_divps256",
     IX86_BUILTIN_DIVPS256, UNKNOWN, (int)V8SF_FTYPE_V8SF_V8SF},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_haddv4df3, "__builtin_ia32_haddpd256",
     IX86_BUILTIN_HADDPD256, UNKNOWN, (int)V4DF_FTYPE_V4DF_V4DF},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_hsubv8sf3, "__builtin_ia32_hsubps256",
     IX86_BUILTIN_HSUBPS256, UNKNOWN, (int)V8SF_FTYPE_V8SF_V8SF},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_hsubv4df3, "__builtin_ia32_hsubpd256",
     IX86_BUILTIN_HSUBPD256, UNKNOWN, (int)V4DF_FTYPE_V4DF_V4DF},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_haddv8sf3, "__builtin_ia32_haddps256",
     IX86_BUILTIN_HADDPS256, UNKNOWN, (int)V8SF_FTYPE_V8SF_V8SF},
    {OPTION_MASK_ISA_AVX, CODE_FOR_smaxv4df3, "__builtin_ia32_maxpd256",
     IX86_BUILTIN_MAXPD256, UNKNOWN, (int)V4DF_FTYPE_V4DF_V4DF},
    {OPTION_MASK_ISA_AVX, CODE_FOR_smaxv8sf3, "__builtin_ia32_maxps256",
     IX86_BUILTIN_MAXPS256, UNKNOWN, (int)V8SF_FTYPE_V8SF_V8SF},
    {OPTION_MASK_ISA_AVX, CODE_FOR_sminv4df3, "__builtin_ia32_minpd256",
     IX86_BUILTIN_MINPD256, UNKNOWN, (int)V4DF_FTYPE_V4DF_V4DF},
    {OPTION_MASK_ISA_AVX, CODE_FOR_sminv8sf3, "__builtin_ia32_minps256",
     IX86_BUILTIN_MINPS256, UNKNOWN, (int)V8SF_FTYPE_V8SF_V8SF},
    {OPTION_MASK_ISA_AVX, CODE_FOR_mulv4df3, "__builtin_ia32_mulpd256",
     IX86_BUILTIN_MULPD256, UNKNOWN, (int)V4DF_FTYPE_V4DF_V4DF},
    {OPTION_MASK_ISA_AVX, CODE_FOR_mulv8sf3, "__builtin_ia32_mulps256",
     IX86_BUILTIN_MULPS256, UNKNOWN, (int)V8SF_FTYPE_V8SF_V8SF},
    {OPTION_MASK_ISA_AVX, CODE_FOR_iorv4df3, "__builtin_ia32_orpd256",
     IX86_BUILTIN_ORPD256, UNKNOWN, (int)V4DF_FTYPE_V4DF_V4DF},
    {OPTION_MASK_ISA_AVX, CODE_FOR_iorv8sf3, "__builtin_ia32_orps256",
     IX86_BUILTIN_ORPS256, UNKNOWN, (int)V8SF_FTYPE_V8SF_V8SF},
    {OPTION_MASK_ISA_AVX, CODE_FOR_subv4df3, "__builtin_ia32_subpd256",
     IX86_BUILTIN_SUBPD256, UNKNOWN, (int)V4DF_FTYPE_V4DF_V4DF},
    {OPTION_MASK_ISA_AVX, CODE_FOR_subv8sf3, "__builtin_ia32_subps256",
     IX86_BUILTIN_SUBPS256, UNKNOWN, (int)V8SF_FTYPE_V8SF_V8SF},
    {OPTION_MASK_ISA_AVX, CODE_FOR_xorv4df3, "__builtin_ia32_xorpd256",
     IX86_BUILTIN_XORPD256, UNKNOWN, (int)V4DF_FTYPE_V4DF_V4DF},
    {OPTION_MASK_ISA_AVX, CODE_FOR_xorv8sf3, "__builtin_ia32_xorps256",
     IX86_BUILTIN_XORPS256, UNKNOWN, (int)V8SF_FTYPE_V8SF_V8SF},

    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_vpermilvarv2df3,
     "__builtin_ia32_vpermilvarpd", IX86_BUILTIN_VPERMILVARPD, UNKNOWN,
     (int)V2DF_FTYPE_V2DF_V2DI},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_vpermilvarv4sf3,
     "__builtin_ia32_vpermilvarps", IX86_BUILTIN_VPERMILVARPS, UNKNOWN,
     (int)V4SF_FTYPE_V4SF_V4SI},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_vpermilvarv4df3,
     "__builtin_ia32_vpermilvarpd256", IX86_BUILTIN_VPERMILVARPD256, UNKNOWN,
     (int)V4DF_FTYPE_V4DF_V4DI},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_vpermilvarv8sf3,
     "__builtin_ia32_vpermilvarps256", IX86_BUILTIN_VPERMILVARPS256, UNKNOWN,
     (int)V8SF_FTYPE_V8SF_V8SI},

    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_blendpd256, "__builtin_ia32_blendpd256",
     IX86_BUILTIN_BLENDPD256, UNKNOWN, (int)V4DF_FTYPE_V4DF_V4DF_INT},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_blendps256, "__builtin_ia32_blendps256",
     IX86_BUILTIN_BLENDPS256, UNKNOWN, (int)V8SF_FTYPE_V8SF_V8SF_INT},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_blendvpd256,
     "__builtin_ia32_blendvpd256", IX86_BUILTIN_BLENDVPD256, UNKNOWN,
     (int)V4DF_FTYPE_V4DF_V4DF_V4DF},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_blendvps256,
     "__builtin_ia32_blendvps256", IX86_BUILTIN_BLENDVPS256, UNKNOWN,
     (int)V8SF_FTYPE_V8SF_V8SF_V8SF},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_dpps256, "__builtin_ia32_dpps256",
     IX86_BUILTIN_DPPS256, UNKNOWN, (int)V8SF_FTYPE_V8SF_V8SF_INT},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_shufpd256, "__builtin_ia32_shufpd256",
     IX86_BUILTIN_SHUFPD256, UNKNOWN, (int)V4DF_FTYPE_V4DF_V4DF_INT},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_shufps256, "__builtin_ia32_shufps256",
     IX86_BUILTIN_SHUFPS256, UNKNOWN, (int)V8SF_FTYPE_V8SF_V8SF_INT},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_cmpsdv2df3, "__builtin_ia32_cmpsd",
     IX86_BUILTIN_CMPSD, UNKNOWN, (int)V2DF_FTYPE_V2DF_V2DF_INT},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_cmpssv4sf3, "__builtin_ia32_cmpss",
     IX86_BUILTIN_CMPSS, UNKNOWN, (int)V4SF_FTYPE_V4SF_V4SF_INT},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_cmppdv2df3, "__builtin_ia32_cmppd",
    ...
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_cmppdv4df3, "__builtin_ia32_cmppd256",
     IX86_BUILTIN_CMPPD256, UNKNOWN, (int)V4DF_FTYPE_V4DF_V4DF_INT},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_cmppsv8sf3, "__builtin_ia32_cmpps256",
     IX86_BUILTIN_CMPPS256, UNKNOWN, (int)V8SF_FTYPE_V8SF_V8SF_INT},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_vextractf128v4df,
     "__builtin_ia32_vextractf128_pd256", IX86_BUILTIN_EXTRACTF128PD256,
     UNKNOWN, (int)V2DF_FTYPE_V4DF_INT},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_vextractf128v8sf,
     "__builtin_ia32_vextractf128_ps256", IX86_BUILTIN_EXTRACTF128PS256,
     UNKNOWN, (int)V4SF_FTYPE_V8SF_INT},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_vextractf128v8si,
     "__builtin_ia32_vextractf128_si256", IX86_BUILTIN_EXTRACTF128SI256,
     UNKNOWN, (int)V4SI_FTYPE_V8SI_INT},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_cvtdq2pd256,
     "__builtin_ia32_cvtdq2pd256", IX86_BUILTIN_CVTDQ2PD256, UNKNOWN,
     (int)V4DF_FTYPE_V4SI},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_cvtdq2ps256,
     "__builtin_ia32_cvtdq2ps256", IX86_BUILTIN_CVTDQ2PS256, UNKNOWN,
     (int)V8SF_FTYPE_V8SI},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_cvtpd2ps256,
     "__builtin_ia32_cvtpd2ps256", IX86_BUILTIN_CVTPD2PS256, UNKNOWN,
     (int)V4SF_FTYPE_V4DF},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_cvtps2dq256,
     "__builtin_ia32_cvtps2dq256", IX86_BUILTIN_CVTPS2DQ256, UNKNOWN,
     (int)V8SI_FTYPE_V8SF},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_cvtps2pd256,
     "__builtin_ia32_cvtps2pd256", IX86_BUILTIN_CVTPS2PD256, UNKNOWN,
     (int)V4DF_FTYPE_V4SF},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_cvttpd2dq256,
     "__builtin_ia32_cvttpd2dq256", IX86_BUILTIN_CVTTPD2DQ256, UNKNOWN,
     (int)V4SI_FTYPE_V4DF},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_cvtpd2dq256,
     "__builtin_ia32_cvtpd2dq256", IX86_BUILTIN_CVTPD2DQ256, UNKNOWN,
     (int)V4SI_FTYPE_V4DF},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_cvttps2dq256,
     "__builtin_ia32_cvttps2dq256", IX86_BUILTIN_CVTTPS2DQ256, UNKNOWN,
     (int)V8SI_FTYPE_V8SF},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_vperm2f128v4df3,
     "__builtin_ia32_vperm2f128_pd256", IX86_BUILTIN_VPERM2F128PD256, UNKNOWN,
     (int)V4DF_FTYPE_V4DF_V4DF_INT},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_vperm2f128v8sf3,
     "__builtin_ia32_vperm2f128_ps256", IX86_BUILTIN_VPERM2F128PS256, UNKNOWN,
     (int)V8SF_FTYPE_V8SF_V8SF_INT},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_vperm2f128v8si3,
     "__builtin_ia32_vperm2f128_si256", IX86_BUILTIN_VPERM2F128SI256, UNKNOWN,
     (int)V8SI_FTYPE_V8SI_V8SI_INT},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_vpermilv2df, "__builtin_ia32_vpermilpd",
     IX86_BUILTIN_VPERMILPD, UNKNOWN, (int)V2DF_FTYPE_V2DF_INT},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_vpermilv4sf, "__builtin_ia32_vpermilps",
     IX86_BUILTIN_VPERMILPS, UNKNOWN, (int)V4SF_FTYPE_V4SF_INT},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_vpermilv4df,
     "__builtin_ia32_vpermilpd256", IX86_BUILTIN_VPERMILPD256, UNKNOWN,
     (int)V4DF_FTYPE_V4DF_INT},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_vpermilv8sf,
     "__builtin_ia32_vpermilps256", IX86_BUILTIN_VPERMILPS256, UNKNOWN,
     (int)V8SF_FTYPE_V8SF_INT},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_vinsertf128v4df,
     "__builtin_ia32_vinsertf128_pd256", IX86_BUILTIN_VINSERTF128PD256, UNKNOWN,
     (int)V4DF_FTYPE_V4DF_V2DF_INT},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_vinsertf128v8sf,
     "__builtin_ia32_vinsertf128_ps256", IX86_BUILTIN_VINSERTF128PS256, UNKNOWN,
     (int)V8SF_FTYPE_V8SF_V4SF_INT},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_vinsertf128v8si,
     "__builtin_ia32_vinsertf128_si256", IX86_BUILTIN_VINSERTF128SI256, UNKNOWN,
     (int)V8SI_FTYPE_V8SI_V4SI_INT},

    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_movshdup256,
     "__builtin_ia32_movshdup256", IX86_BUILTIN_MOVSHDUP256, UNKNOWN,
     (int)V8SF_FTYPE_V8SF},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_movsldup256,
     "__builtin_ia32_movsldup256", IX86_BUILTIN_MOVSLDUP256, UNKNOWN,
     (int)V8SF_FTYPE_V8SF},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_movddup256, "__builtin_ia32_movddup256",
     IX86_BUILTIN_MOVDDUP256, UNKNOWN, (int)V4DF_FTYPE_V4DF},

    {OPTION_MASK_ISA_AVX, CODE_FOR_sqrtv4df2, "__builtin_ia32_sqrtpd256",
     IX86_BUILTIN_SQRTPD256, UNKNOWN, (int)V4DF_FTYPE_V4DF},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_sqrtv8sf2, "__builtin_ia32_sqrtps256",
     IX86_BUILTIN_SQRTPS256, UNKNOWN, (int)V8SF_FTYPE_V8SF},
    {OPTION_MASK_ISA_AVX, CODE_FOR_sqrtv8sf2, "__builtin_ia32_sqrtps_nr256",
     IX86_BUILTIN_SQRTPS_NR256, UNKNOWN, (int)V8SF_FTYPE_V8SF},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_rsqrtv8sf2, "__builtin_ia32_rsqrtps256",
     IX86_BUILTIN_RSQRTPS256, UNKNOWN, (int)V8SF_FTYPE_V8SF},
    {OPTION_MASK_ISA_AVX, CODE_FOR_rsqrtv8sf2, "__builtin_ia32_rsqrtps_nr256",
     IX86_BUILTIN_RSQRTPS_NR256, UNKNOWN, (int)V8SF_FTYPE_V8SF},

    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_rcpv8sf2, "__builtin_ia32_rcpps256",
     IX86_BUILTIN_RCPPS256, UNKNOWN, (int)V8SF_FTYPE_V8SF},

    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_roundpd256, "__builtin_ia32_roundpd256",
     IX86_BUILTIN_ROUNDPD256, UNKNOWN, (int)V4DF_FTYPE_V4DF_INT},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_roundps256, "__builtin_ia32_roundps256",
     IX86_BUILTIN_ROUNDPS256, UNKNOWN, (int)V8SF_FTYPE_V8SF_INT},

    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_unpckhpd256,
     "__builtin_ia32_unpckhpd256", IX86_BUILTIN_UNPCKHPD256, UNKNOWN,
     (int)V4DF_FTYPE_V4DF_V4DF},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_unpcklpd256,
     "__builtin_ia32_unpcklpd256", IX86_BUILTIN_UNPCKLPD256, UNKNOWN,
     (int)V4DF_FTYPE_V4DF_V4DF},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_unpckhps256,
     "__builtin_ia32_unpckhps256", IX86_BUILTIN_UNPCKHPS256, UNKNOWN,
     (int)V8SF_FTYPE_V8SF_V8SF},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_unpcklps256,
     "__builtin_ia32_unpcklps256", IX86_BUILTIN_UNPCKLPS256, UNKNOWN,
     (int)V8SF_FTYPE_V8SF_V8SF},
    ...
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_si_si256, "__builtin_ia32_si_si256",
     IX86_BUILTIN_SI_SI256, UNKNOWN, (int)V4SI_FTYPE_V8SI},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_ps_ps256, "__builtin_ia32_ps_ps256",
     IX86_BUILTIN_PS_PS256, UNKNOWN, (int)V4SF_FTYPE_V8SF},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_pd_pd256, "__builtin_ia32_pd_pd256",
     IX86_BUILTIN_PD_PD256, UNKNOWN, (int)V2DF_FTYPE_V4DF},
    ...
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_vtestpd256, "__builtin_ia32_vtestzpd256",
     IX86_BUILTIN_VTESTZPD256, EQ, (int)INT_FTYPE_V4DF_V4DF_PTEST},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_vtestpd256, "__builtin_ia32_vtestcpd256",
     IX86_BUILTIN_VTESTCPD256, LTU, (int)INT_FTYPE_V4DF_V4DF_PTEST},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_vtestpd256,
     "__builtin_ia32_vtestnzcpd256", IX86_BUILTIN_VTESTNZCPD256, GTU,
     (int)INT_FTYPE_V4DF_V4DF_PTEST},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_vtestps256, "__builtin_ia32_vtestzps256",
     IX86_BUILTIN_VTESTZPS256, EQ, (int)INT_FTYPE_V8SF_V8SF_PTEST},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_vtestps256, "__builtin_ia32_vtestcps256",
     IX86_BUILTIN_VTESTCPS256, LTU, (int)INT_FTYPE_V8SF_V8SF_PTEST},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_vtestps256,
     "__builtin_ia32_vtestnzcps256", IX86_BUILTIN_VTESTNZCPS256, GTU,
    ...
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_movmskpd256,
     "__builtin_ia32_movmskpd256", IX86_BUILTIN_MOVMSKPD256, UNKNOWN,
     (int)INT_FTYPE_V4DF},
    {OPTION_MASK_ISA_AVX, CODE_FOR_avx_movmskps256,
     "__builtin_ia32_movmskps256", IX86_BUILTIN_MOVMSKPS256, UNKNOWN,
     (int)INT_FTYPE_V8SF},
};
...
static const struct builtin_description bdesc_multi_arg[] = {
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5i_vmfmaddv4sf4,
     "__builtin_ia32_fmaddss", IX86_BUILTIN_FMADDSS, 0, (int)MULTI_ARG_3_SF},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5i_vmfmaddv2df4,
     "__builtin_ia32_fmaddsd", IX86_BUILTIN_FMADDSD, 0, (int)MULTI_ARG_3_DF},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5i_fmaddv4sf4, "__builtin_ia32_fmaddps",
     IX86_BUILTIN_FMADDPS, 0, (int)MULTI_ARG_3_SF},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5i_fmaddv2df4, "__builtin_ia32_fmaddpd",
     IX86_BUILTIN_FMADDPD, 0, (int)MULTI_ARG_3_DF},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5i_vmfmsubv4sf4,
     "__builtin_ia32_fmsubss", IX86_BUILTIN_FMSUBSS, 0, (int)MULTI_ARG_3_SF},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5i_vmfmsubv2df4,
     "__builtin_ia32_fmsubsd", IX86_BUILTIN_FMSUBSD, 0, (int)MULTI_ARG_3_DF},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5i_fmsubv4sf4, "__builtin_ia32_fmsubps",
     IX86_BUILTIN_FMSUBPS, 0, (int)MULTI_ARG_3_SF},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5i_fmsubv2df4, "__builtin_ia32_fmsubpd",
     IX86_BUILTIN_FMSUBPD, 0, (int)MULTI_ARG_3_DF},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5i_vmfnmaddv4sf4,
     "__builtin_ia32_fnmaddss", IX86_BUILTIN_FNMADDSS, 0, (int)MULTI_ARG_3_SF},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5i_vmfnmaddv2df4,
     "__builtin_ia32_fnmaddsd", IX86_BUILTIN_FNMADDSD, 0, (int)MULTI_ARG_3_DF},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5i_fnmaddv4sf4,
     "__builtin_ia32_fnmaddps", IX86_BUILTIN_FNMADDPS, 0, (int)MULTI_ARG_3_SF},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5i_fnmaddv2df4,
     "__builtin_ia32_fnmaddpd", IX86_BUILTIN_FNMADDPD, 0, (int)MULTI_ARG_3_DF},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5i_vmfnmsubv4sf4,
     "__builtin_ia32_fnmsubss", IX86_BUILTIN_FNMSUBSS, 0, (int)MULTI_ARG_3_SF},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5i_vmfnmsubv2df4,
     "__builtin_ia32_fnmsubsd", IX86_BUILTIN_FNMSUBSD, 0, (int)MULTI_ARG_3_DF},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5i_fnmsubv4sf4,
     "__builtin_ia32_fnmsubps", IX86_BUILTIN_FNMSUBPS, 0, (int)MULTI_ARG_3_SF},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5i_fnmsubv2df4,
     "__builtin_ia32_fnmsubpd", IX86_BUILTIN_FNMSUBPD, 0, (int)MULTI_ARG_3_DF},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_pcmov_v2di, "__builtin_ia32_pcmov",
     IX86_BUILTIN_PCMOV, 0, (int)MULTI_ARG_3_DI},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_pcmov_v2di,
     "__builtin_ia32_pcmov_v2di", IX86_BUILTIN_PCMOV_V2DI, 0,
     (int)MULTI_ARG_3_DI},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_pcmov_v4si,
     "__builtin_ia32_pcmov_v4si", IX86_BUILTIN_PCMOV_V4SI, 0,
     (int)MULTI_ARG_3_SI},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_pcmov_v8hi,
     "__builtin_ia32_pcmov_v8hi", IX86_BUILTIN_PCMOV_V8HI, 0,
     (int)MULTI_ARG_3_HI},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_pcmov_v16qi,
     "__builtin_ia32_pcmov_v16qi", IX86_BUILTIN_PCMOV_V16QI, 0,
     (int)MULTI_ARG_3_QI},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_pcmov_v2df,
     "__builtin_ia32_pcmov_v2df", IX86_BUILTIN_PCMOV_V2DF, 0,
     (int)MULTI_ARG_3_DF},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_pcmov_v4sf,
     "__builtin_ia32_pcmov_v4sf", IX86_BUILTIN_PCMOV_V4SF, 0,
     (int)MULTI_ARG_3_SF},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_pperm, "__builtin_ia32_pperm",
     IX86_BUILTIN_PPERM, 0, (int)MULTI_ARG_3_QI},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_permv4sf, "__builtin_ia32_permps",
     IX86_BUILTIN_PERMPS, 0, (int)MULTI_ARG_3_PERMPS},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_permv2df, "__builtin_ia32_permpd",
     IX86_BUILTIN_PERMPD, 0, (int)MULTI_ARG_3_PERMPD},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_pmacssww, "__builtin_ia32_pmacssww",
     IX86_BUILTIN_PMACSSWW, 0, (int)MULTI_ARG_3_HI},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_pmacsww, "__builtin_ia32_pmacsww",
     IX86_BUILTIN_PMACSWW, 0, (int)MULTI_ARG_3_HI},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_pmacsswd, "__builtin_ia32_pmacsswd",
     IX86_BUILTIN_PMACSSWD, 0, (int)MULTI_ARG_3_HI_SI},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_pmacswd, "__builtin_ia32_pmacswd",
     IX86_BUILTIN_PMACSWD, 0, (int)MULTI_ARG_3_HI_SI},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_pmacssdd, "__builtin_ia32_pmacssdd",
     IX86_BUILTIN_PMACSSDD, 0, (int)MULTI_ARG_3_SI},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_pmacsdd, "__builtin_ia32_pmacsdd",
     IX86_BUILTIN_PMACSDD, 0, (int)MULTI_ARG_3_SI},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_pmacssdql, "__builtin_ia32_pmacssdql",
     IX86_BUILTIN_PMACSSDQL, 0, (int)MULTI_ARG_3_SI_DI},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_pmacssdqh, "__builtin_ia32_pmacssdqh",
     IX86_BUILTIN_PMACSSDQH, 0, (int)MULTI_ARG_3_SI_DI},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_pmacsdql, "__builtin_ia32_pmacsdql",
     IX86_BUILTIN_PMACSDQL, 0, (int)MULTI_ARG_3_SI_DI},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_pmacsdqh, "__builtin_ia32_pmacsdqh",
     IX86_BUILTIN_PMACSDQH, 0, (int)MULTI_ARG_3_SI_DI},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_pmadcsswd, "__builtin_ia32_pmadcsswd",
     IX86_BUILTIN_PMADCSSWD, 0, (int)MULTI_ARG_3_HI_SI},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_pmadcswd, "__builtin_ia32_pmadcswd",
     IX86_BUILTIN_PMADCSWD, 0, (int)MULTI_ARG_3_HI_SI},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_vrotlv2di3, "__builtin_ia32_protq",
     IX86_BUILTIN_PROTQ, 0, (int)MULTI_ARG_2_DI},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_vrotlv4si3, "__builtin_ia32_protd",
     IX86_BUILTIN_PROTD, 0, (int)MULTI_ARG_2_SI},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_vrotlv8hi3, "__builtin_ia32_protw",
     IX86_BUILTIN_PROTW, 0, (int)MULTI_ARG_2_HI},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_vrotlv16qi3, "__builtin_ia32_protb",
     IX86_BUILTIN_PROTB, 0, (int)MULTI_ARG_2_QI},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_rotlv2di3, "__builtin_ia32_protqi",
     IX86_BUILTIN_PROTQ_IMM, 0, (int)MULTI_ARG_2_DI_IMM},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_rotlv4si3, "__builtin_ia32_protdi",
     IX86_BUILTIN_PROTD_IMM, 0, (int)MULTI_ARG_2_SI_IMM},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_rotlv8hi3, "__builtin_ia32_protwi",
     IX86_BUILTIN_PROTW_IMM, 0, (int)MULTI_ARG_2_HI_IMM},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_rotlv16qi3, "__builtin_ia32_protbi",
     IX86_BUILTIN_PROTB_IMM, 0, (int)MULTI_ARG_2_QI_IMM},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_ashlv2di3, "__builtin_ia32_pshaq",
     IX86_BUILTIN_PSHAQ, 0, (int)MULTI_ARG_2_DI},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_ashlv4si3, "__builtin_ia32_pshad",
     IX86_BUILTIN_PSHAD, 0, (int)MULTI_ARG_2_SI},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_ashlv8hi3, "__builtin_ia32_pshaw",
     IX86_BUILTIN_PSHAW, 0, (int)MULTI_ARG_2_HI},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_ashlv16qi3, "__builtin_ia32_pshab",
     IX86_BUILTIN_PSHAB, 0, (int)MULTI_ARG_2_QI},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_lshlv2di3, "__builtin_ia32_pshlq",
     IX86_BUILTIN_PSHLQ, 0, (int)MULTI_ARG_2_DI},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_lshlv4si3, "__builtin_ia32_pshld",
     IX86_BUILTIN_PSHLD, 0, (int)MULTI_ARG_2_SI},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_lshlv8hi3, "__builtin_ia32_pshlw",
     IX86_BUILTIN_PSHLW, 0, (int)MULTI_ARG_2_HI},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_lshlv16qi3, "__builtin_ia32_pshlb",
     IX86_BUILTIN_PSHLB, 0, (int)MULTI_ARG_2_QI},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_vmfrczv4sf2, "__builtin_ia32_frczss",
     IX86_BUILTIN_FRCZSS, 0, (int)MULTI_ARG_2_SF},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_vmfrczv2df2, "__builtin_ia32_frczsd",
     IX86_BUILTIN_FRCZSD, 0, (int)MULTI_ARG_2_DF},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_frczv4sf2, "__builtin_ia32_frczps",
     IX86_BUILTIN_FRCZPS, 0, (int)MULTI_ARG_1_SF},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_frczv2df2, "__builtin_ia32_frczpd",
     IX86_BUILTIN_FRCZPD, 0, (int)MULTI_ARG_1_DF},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_cvtph2ps, "__builtin_ia32_cvtph2ps",
     IX86_BUILTIN_CVTPH2PS, 0, (int)MULTI_ARG_1_PH2PS},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_cvtps2ph, "__builtin_ia32_cvtps2ph",
     IX86_BUILTIN_CVTPS2PH, 0, (int)MULTI_ARG_1_PS2PH},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_phaddbw, "__builtin_ia32_phaddbw",
     IX86_BUILTIN_PHADDBW, 0, (int)MULTI_ARG_1_QI_HI},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_phaddbd, "__builtin_ia32_phaddbd",
     IX86_BUILTIN_PHADDBD, 0, (int)MULTI_ARG_1_QI_SI},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_phaddbq, "__builtin_ia32_phaddbq",
     IX86_BUILTIN_PHADDBQ, 0, (int)MULTI_ARG_1_QI_DI},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_phaddwd, "__builtin_ia32_phaddwd",
     IX86_BUILTIN_PHADDWD, 0, (int)MULTI_ARG_1_HI_SI},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_phaddwq, "__builtin_ia32_phaddwq",
     IX86_BUILTIN_PHADDWQ, 0, (int)MULTI_ARG_1_HI_DI},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_phadddq, "__builtin_ia32_phadddq",
     IX86_BUILTIN_PHADDDQ, 0, (int)MULTI_ARG_1_SI_DI},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_phaddubw, "__builtin_ia32_phaddubw",
     IX86_BUILTIN_PHADDUBW, 0, (int)MULTI_ARG_1_QI_HI},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_phaddubd, "__builtin_ia32_phaddubd",
     IX86_BUILTIN_PHADDUBD, 0, (int)MULTI_ARG_1_QI_SI},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_phaddubq, "__builtin_ia32_phaddubq",
     IX86_BUILTIN_PHADDUBQ, 0, (int)MULTI_ARG_1_QI_DI},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_phadduwd, "__builtin_ia32_phadduwd",
     IX86_BUILTIN_PHADDUWD, 0, (int)MULTI_ARG_1_HI_SI},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_phadduwq, "__builtin_ia32_phadduwq",
     IX86_BUILTIN_PHADDUWQ, 0, (int)MULTI_ARG_1_HI_DI},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_phaddudq, "__builtin_ia32_phaddudq",
     IX86_BUILTIN_PHADDUDQ, 0, (int)MULTI_ARG_1_SI_DI},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_phsubbw, "__builtin_ia32_phsubbw",
     IX86_BUILTIN_PHSUBBW, 0, (int)MULTI_ARG_1_QI_HI},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_phsubwd, "__builtin_ia32_phsubwd",
     IX86_BUILTIN_PHSUBWD, 0, (int)MULTI_ARG_1_HI_SI},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_phsubdq, "__builtin_ia32_phsubdq",
     IX86_BUILTIN_PHSUBDQ, 0, (int)MULTI_ARG_1_SI_DI},

    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_vmmaskcmpv4sf3,
     "__builtin_ia32_comeqss", IX86_BUILTIN_COMEQSS, EQ,
     (int)MULTI_ARG_2_SF_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_vmmaskcmpv4sf3,
     "__builtin_ia32_comness", IX86_BUILTIN_COMNESS, NE,
     (int)MULTI_ARG_2_SF_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_vmmaskcmpv4sf3,
     "__builtin_ia32_comneqss", IX86_BUILTIN_COMNESS, NE,
     (int)MULTI_ARG_2_SF_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_vmmaskcmpv4sf3,
     "__builtin_ia32_comltss", IX86_BUILTIN_COMLTSS, LT,
     (int)MULTI_ARG_2_SF_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_vmmaskcmpv4sf3,
     "__builtin_ia32_comless", IX86_BUILTIN_COMLESS, LE,
     (int)MULTI_ARG_2_SF_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_vmmaskcmpv4sf3,
     "__builtin_ia32_comgtss", IX86_BUILTIN_COMGTSS, GT,
     (int)MULTI_ARG_2_SF_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_vmmaskcmpv4sf3,
     "__builtin_ia32_comgess", IX86_BUILTIN_COMGESS, GE,
     (int)MULTI_ARG_2_SF_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_vmmaskcmpv4sf3,
     "__builtin_ia32_comueqss", IX86_BUILTIN_COMUEQSS, UNEQ,
     (int)MULTI_ARG_2_SF_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_vmmaskcmpv4sf3,
     "__builtin_ia32_comuness", IX86_BUILTIN_COMUNESS, LTGT,
     (int)MULTI_ARG_2_SF_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_vmmaskcmpv4sf3,
     "__builtin_ia32_comuneqss", IX86_BUILTIN_COMUNESS, LTGT,
     (int)MULTI_ARG_2_SF_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_vmmaskcmpv4sf3,
     "__builtin_ia32_comunltss", IX86_BUILTIN_COMULTSS, UNLT,
     (int)MULTI_ARG_2_SF_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_vmmaskcmpv4sf3,
     "__builtin_ia32_comunless", IX86_BUILTIN_COMULESS, UNLE,
     (int)MULTI_ARG_2_SF_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_vmmaskcmpv4sf3,
     "__builtin_ia32_comungtss", IX86_BUILTIN_COMUGTSS, UNGT,
     (int)MULTI_ARG_2_SF_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_vmmaskcmpv4sf3,
     "__builtin_ia32_comungess", IX86_BUILTIN_COMUGESS, UNGE,
     (int)MULTI_ARG_2_SF_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_vmmaskcmpv4sf3,
     "__builtin_ia32_comordss", IX86_BUILTIN_COMORDSS, ORDERED,
     (int)MULTI_ARG_2_SF_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_vmmaskcmpv4sf3,
     "__builtin_ia32_comunordss", IX86_BUILTIN_COMUNORDSS, UNORDERED,
     (int)MULTI_ARG_2_SF_CMP},

    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_vmmaskcmpv2df3,
     "__builtin_ia32_comeqsd", IX86_BUILTIN_COMEQSD, EQ,
     (int)MULTI_ARG_2_DF_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_vmmaskcmpv2df3,
     "__builtin_ia32_comnesd", IX86_BUILTIN_COMNESD, NE,
     (int)MULTI_ARG_2_DF_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_vmmaskcmpv2df3,
     "__builtin_ia32_comneqsd", IX86_BUILTIN_COMNESD, NE,
     (int)MULTI_ARG_2_DF_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_vmmaskcmpv2df3,
     "__builtin_ia32_comltsd", IX86_BUILTIN_COMLTSD, LT,
     (int)MULTI_ARG_2_DF_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_vmmaskcmpv2df3,
     "__builtin_ia32_comlesd", IX86_BUILTIN_COMLESD, LE,
     (int)MULTI_ARG_2_DF_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_vmmaskcmpv2df3,
     "__builtin_ia32_comgtsd", IX86_BUILTIN_COMGTSD, GT,
     (int)MULTI_ARG_2_DF_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_vmmaskcmpv2df3,
     "__builtin_ia32_comgesd", IX86_BUILTIN_COMGESD, GE,
     (int)MULTI_ARG_2_DF_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_vmmaskcmpv2df3,
     "__builtin_ia32_comueqsd", IX86_BUILTIN_COMUEQSD, UNEQ,
     (int)MULTI_ARG_2_DF_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_vmmaskcmpv2df3,
     "__builtin_ia32_comunesd", IX86_BUILTIN_COMUNESD, LTGT,
     (int)MULTI_ARG_2_DF_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_vmmaskcmpv2df3,
     "__builtin_ia32_comuneqsd", IX86_BUILTIN_COMUNESD, LTGT,
     (int)MULTI_ARG_2_DF_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_vmmaskcmpv2df3,
     "__builtin_ia32_comunltsd", IX86_BUILTIN_COMULTSD, UNLT,
     (int)MULTI_ARG_2_DF_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_vmmaskcmpv2df3,
     "__builtin_ia32_comunlesd", IX86_BUILTIN_COMULESD, UNLE,
     (int)MULTI_ARG_2_DF_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_vmmaskcmpv2df3,
     "__builtin_ia32_comungtsd", IX86_BUILTIN_COMUGTSD, UNGT,
     (int)MULTI_ARG_2_DF_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_vmmaskcmpv2df3,
     "__builtin_ia32_comungesd", IX86_BUILTIN_COMUGESD, UNGE,
     (int)MULTI_ARG_2_DF_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_vmmaskcmpv2df3,
     "__builtin_ia32_comordsd", IX86_BUILTIN_COMORDSD, ORDERED,
     (int)MULTI_ARG_2_DF_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_vmmaskcmpv2df3,
     "__builtin_ia32_comunordsd", IX86_BUILTIN_COMUNORDSD, UNORDERED,
     (int)MULTI_ARG_2_DF_CMP},

    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmpv4sf3, "__builtin_ia32_comeqps",
     IX86_BUILTIN_COMEQPS, EQ, (int)MULTI_ARG_2_SF_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmpv4sf3, "__builtin_ia32_comneps",
     IX86_BUILTIN_COMNEPS, NE, (int)MULTI_ARG_2_SF_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmpv4sf3,
     "__builtin_ia32_comneqps", IX86_BUILTIN_COMNEPS, NE,
     (int)MULTI_ARG_2_SF_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmpv4sf3, "__builtin_ia32_comltps",
     IX86_BUILTIN_COMLTPS, LT, (int)MULTI_ARG_2_SF_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmpv4sf3, "__builtin_ia32_comleps",
     IX86_BUILTIN_COMLEPS, LE, (int)MULTI_ARG_2_SF_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmpv4sf3, "__builtin_ia32_comgtps",
     IX86_BUILTIN_COMGTPS, GT, (int)MULTI_ARG_2_SF_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmpv4sf3, "__builtin_ia32_comgeps",
     IX86_BUILTIN_COMGEPS, GE, (int)MULTI_ARG_2_SF_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmpv4sf3,
     "__builtin_ia32_comueqps", IX86_BUILTIN_COMUEQPS, UNEQ,
     (int)MULTI_ARG_2_SF_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmpv4sf3,
     "__builtin_ia32_comuneps", IX86_BUILTIN_COMUNEPS, LTGT,
     (int)MULTI_ARG_2_SF_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmpv4sf3,
     "__builtin_ia32_comuneqps", IX86_BUILTIN_COMUNEPS, LTGT,
     (int)MULTI_ARG_2_SF_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmpv4sf3,
     "__builtin_ia32_comunltps", IX86_BUILTIN_COMULTPS, UNLT,
     (int)MULTI_ARG_2_SF_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmpv4sf3,
     "__builtin_ia32_comunleps", IX86_BUILTIN_COMULEPS, UNLE,
     (int)MULTI_ARG_2_SF_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmpv4sf3,
     "__builtin_ia32_comungtps", IX86_BUILTIN_COMUGTPS, UNGT,
     (int)MULTI_ARG_2_SF_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmpv4sf3,
     "__builtin_ia32_comungeps", IX86_BUILTIN_COMUGEPS, UNGE,
     (int)MULTI_ARG_2_SF_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmpv4sf3,
     "__builtin_ia32_comordps", IX86_BUILTIN_COMORDPS, ORDERED,
     (int)MULTI_ARG_2_SF_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmpv4sf3,
     "__builtin_ia32_comunordps", IX86_BUILTIN_COMUNORDPS, UNORDERED,
     (int)MULTI_ARG_2_SF_CMP},

    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmpv2df3, "__builtin_ia32_comeqpd",
     IX86_BUILTIN_COMEQPD, EQ, (int)MULTI_ARG_2_DF_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmpv2df3, "__builtin_ia32_comnepd",
     IX86_BUILTIN_COMNEPD, NE, (int)MULTI_ARG_2_DF_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmpv2df3,
     "__builtin_ia32_comneqpd", IX86_BUILTIN_COMNEPD, NE,
     (int)MULTI_ARG_2_DF_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmpv2df3, "__builtin_ia32_comltpd",
     IX86_BUILTIN_COMLTPD, LT, (int)MULTI_ARG_2_DF_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmpv2df3, "__builtin_ia32_comlepd",
     IX86_BUILTIN_COMLEPD, LE, (int)MULTI_ARG_2_DF_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmpv2df3, "__builtin_ia32_comgtpd",
     IX86_BUILTIN_COMGTPD, GT, (int)MULTI_ARG_2_DF_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmpv2df3, "__builtin_ia32_comgepd",
     IX86_BUILTIN_COMGEPD, GE, (int)MULTI_ARG_2_DF_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmpv2df3,
     "__builtin_ia32_comueqpd", IX86_BUILTIN_COMUEQPD, UNEQ,
     (int)MULTI_ARG_2_DF_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmpv2df3,
     "__builtin_ia32_comunepd", IX86_BUILTIN_COMUNEPD, LTGT,
     (int)MULTI_ARG_2_DF_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmpv2df3,
     "__builtin_ia32_comuneqpd", IX86_BUILTIN_COMUNEPD, LTGT,
     (int)MULTI_ARG_2_DF_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmpv2df3,
     "__builtin_ia32_comunltpd", IX86_BUILTIN_COMULTPD, UNLT,
     (int)MULTI_ARG_2_DF_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmpv2df3,
     "__builtin_ia32_comunlepd", IX86_BUILTIN_COMULEPD, UNLE,
     (int)MULTI_ARG_2_DF_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmpv2df3,
     "__builtin_ia32_comungtpd", IX86_BUILTIN_COMUGTPD, UNGT,
     (int)MULTI_ARG_2_DF_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmpv2df3,
     "__builtin_ia32_comungepd", IX86_BUILTIN_COMUGEPD, UNGE,
     (int)MULTI_ARG_2_DF_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmpv2df3,
     "__builtin_ia32_comordpd", IX86_BUILTIN_COMORDPD, ORDERED,
     (int)MULTI_ARG_2_DF_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmpv2df3,
     "__builtin_ia32_comunordpd", IX86_BUILTIN_COMUNORDPD, UNORDERED,
     (int)MULTI_ARG_2_DF_CMP},

    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmpv16qi3,
     "__builtin_ia32_pcomeqb", IX86_BUILTIN_PCOMEQB, EQ,
     (int)MULTI_ARG_2_QI_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmpv16qi3,
     "__builtin_ia32_pcomneb", IX86_BUILTIN_PCOMNEB, NE,
     (int)MULTI_ARG_2_QI_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmpv16qi3,
     "__builtin_ia32_pcomneqb", IX86_BUILTIN_PCOMNEB, NE,
     (int)MULTI_ARG_2_QI_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmpv16qi3,
     "__builtin_ia32_pcomltb", IX86_BUILTIN_PCOMLTB, LT,
     (int)MULTI_ARG_2_QI_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmpv16qi3,
     "__builtin_ia32_pcomleb", IX86_BUILTIN_PCOMLEB, LE,
     (int)MULTI_ARG_2_QI_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmpv16qi3,
     "__builtin_ia32_pcomgtb", IX86_BUILTIN_PCOMGTB, GT,
     (int)MULTI_ARG_2_QI_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmpv16qi3,
     "__builtin_ia32_pcomgeb", IX86_BUILTIN_PCOMGEB, GE,
     (int)MULTI_ARG_2_QI_CMP},

    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmpv8hi3, "__builtin_ia32_pcomeqw",
     IX86_BUILTIN_PCOMEQW, EQ, (int)MULTI_ARG_2_HI_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmpv8hi3, "__builtin_ia32_pcomnew",
     IX86_BUILTIN_PCOMNEW, NE, (int)MULTI_ARG_2_HI_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmpv8hi3,
     "__builtin_ia32_pcomneqw", IX86_BUILTIN_PCOMNEW, NE,
     (int)MULTI_ARG_2_HI_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmpv8hi3, "__builtin_ia32_pcomltw",
     IX86_BUILTIN_PCOMLTW, LT, (int)MULTI_ARG_2_HI_CMP},
    ...
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmpv4si3, "__builtin_ia32_pcomeqd",
     IX86_BUILTIN_PCOMEQD, EQ, (int)MULTI_ARG_2_SI_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmpv4si3, "__builtin_ia32_pcomned",
     IX86_BUILTIN_PCOMNED, NE, (int)MULTI_ARG_2_SI_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmpv4si3,
     "__builtin_ia32_pcomneqd", IX86_BUILTIN_PCOMNED, NE,
     (int)MULTI_ARG_2_SI_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmpv4si3, "__builtin_ia32_pcomltd",
     IX86_BUILTIN_PCOMLTD, LT, (int)MULTI_ARG_2_SI_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmpv4si3, "__builtin_ia32_pcomled",
     IX86_BUILTIN_PCOMLED, LE, (int)MULTI_ARG_2_SI_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmpv4si3, "__builtin_ia32_pcomgtd",
     IX86_BUILTIN_PCOMGTD, GT, (int)MULTI_ARG_2_SI_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmpv4si3, "__builtin_ia32_pcomged",
     IX86_BUILTIN_PCOMGED, GE, (int)MULTI_ARG_2_SI_CMP},

    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmpv2di3, "__builtin_ia32_pcomeqq",
     IX86_BUILTIN_PCOMEQQ, EQ, (int)MULTI_ARG_2_DI_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmpv2di3, "__builtin_ia32_pcomneq",
     IX86_BUILTIN_PCOMNEQ, NE, (int)MULTI_ARG_2_DI_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmpv2di3,
     "__builtin_ia32_pcomneqq", IX86_BUILTIN_PCOMNEQ, NE,
     (int)MULTI_ARG_2_DI_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmpv2di3, "__builtin_ia32_pcomltq",
     IX86_BUILTIN_PCOMLTQ, LT, (int)MULTI_ARG_2_DI_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmpv2di3, "__builtin_ia32_pcomleq",
     IX86_BUILTIN_PCOMLEQ, LE, (int)MULTI_ARG_2_DI_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmpv2di3, "__builtin_ia32_pcomgtq",
     IX86_BUILTIN_PCOMGTQ, GT, (int)MULTI_ARG_2_DI_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmpv2di3, "__builtin_ia32_pcomgeq",
     IX86_BUILTIN_PCOMGEQ, GE, (int)MULTI_ARG_2_DI_CMP},

    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmp_uns2v16qi3,
     "__builtin_ia32_pcomequb", IX86_BUILTIN_PCOMEQUB, EQ,
     (int)MULTI_ARG_2_QI_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmp_uns2v16qi3,
     "__builtin_ia32_pcomneub", IX86_BUILTIN_PCOMNEUB, NE,
     (int)MULTI_ARG_2_QI_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmp_uns2v16qi3,
     "__builtin_ia32_pcomnequb", IX86_BUILTIN_PCOMNEUB, NE,
     (int)MULTI_ARG_2_QI_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmp_unsv16qi3,
     "__builtin_ia32_pcomltub", IX86_BUILTIN_PCOMLTUB, LTU,
     (int)MULTI_ARG_2_QI_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmp_unsv16qi3,
     "__builtin_ia32_pcomleub", IX86_BUILTIN_PCOMLEUB, LEU,
     (int)MULTI_ARG_2_QI_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmp_unsv16qi3,
     "__builtin_ia32_pcomgtub", IX86_BUILTIN_PCOMGTUB, GTU,
     (int)MULTI_ARG_2_QI_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmp_unsv16qi3,
     "__builtin_ia32_pcomgeub", IX86_BUILTIN_PCOMGEUB, GEU,
     (int)MULTI_ARG_2_QI_CMP},

    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmp_uns2v8hi3,
     "__builtin_ia32_pcomequw", IX86_BUILTIN_PCOMEQUW, EQ,
     (int)MULTI_ARG_2_HI_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmp_uns2v8hi3,
     "__builtin_ia32_pcomneuw", IX86_BUILTIN_PCOMNEUW, NE,
     (int)MULTI_ARG_2_HI_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmp_uns2v8hi3,
     "__builtin_ia32_pcomnequw", IX86_BUILTIN_PCOMNEUW, NE,
     (int)MULTI_ARG_2_HI_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmp_unsv8hi3,
     "__builtin_ia32_pcomltuw", IX86_BUILTIN_PCOMLTUW, LTU,
     (int)MULTI_ARG_2_HI_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmp_unsv8hi3,
     "__builtin_ia32_pcomleuw", IX86_BUILTIN_PCOMLEUW, LEU,
     (int)MULTI_ARG_2_HI_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmp_unsv8hi3,
     "__builtin_ia32_pcomgtuw", IX86_BUILTIN_PCOMGTUW, GTU,
     (int)MULTI_ARG_2_HI_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmp_unsv8hi3,
     "__builtin_ia32_pcomgeuw", IX86_BUILTIN_PCOMGEUW, GEU,
     (int)MULTI_ARG_2_HI_CMP},

    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmp_uns2v4si3,
     "__builtin_ia32_pcomequd", IX86_BUILTIN_PCOMEQUD, EQ,
     (int)MULTI_ARG_2_SI_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmp_uns2v4si3,
     "__builtin_ia32_pcomneud", IX86_BUILTIN_PCOMNEUD, NE,
     (int)MULTI_ARG_2_SI_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmp_uns2v4si3,
     "__builtin_ia32_pcomnequd", IX86_BUILTIN_PCOMNEUD, NE,
     (int)MULTI_ARG_2_SI_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmp_unsv4si3,
     "__builtin_ia32_pcomltud", IX86_BUILTIN_PCOMLTUD, LTU,
     (int)MULTI_ARG_2_SI_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmp_unsv4si3,
     "__builtin_ia32_pcomleud", IX86_BUILTIN_PCOMLEUD, LEU,
     (int)MULTI_ARG_2_SI_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmp_unsv4si3,
     "__builtin_ia32_pcomgtud", IX86_BUILTIN_PCOMGTUD, GTU,
     (int)MULTI_ARG_2_SI_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmp_unsv4si3,
     "__builtin_ia32_pcomgeud", IX86_BUILTIN_PCOMGEUD, GEU,
     (int)MULTI_ARG_2_SI_CMP},

    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmp_uns2v2di3,
     "__builtin_ia32_pcomequq", IX86_BUILTIN_PCOMEQUQ, EQ,
     (int)MULTI_ARG_2_DI_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmp_uns2v2di3,
     "__builtin_ia32_pcomneuq", IX86_BUILTIN_PCOMNEUQ, NE,
     (int)MULTI_ARG_2_DI_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmp_uns2v2di3,
     "__builtin_ia32_pcomnequq", IX86_BUILTIN_PCOMNEUQ, NE,
     (int)MULTI_ARG_2_DI_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmp_unsv2di3,
     "__builtin_ia32_pcomltuq", IX86_BUILTIN_PCOMLTUQ, LTU,
     (int)MULTI_ARG_2_DI_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmp_unsv2di3,
     "__builtin_ia32_pcomleuq", IX86_BUILTIN_PCOMLEUQ, LEU,
     (int)MULTI_ARG_2_DI_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmp_unsv2di3,
     "__builtin_ia32_pcomgtuq", IX86_BUILTIN_PCOMGTUQ, GTU,
     (int)MULTI_ARG_2_DI_CMP},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_maskcmp_unsv2di3,
     "__builtin_ia32_pcomgeuq", IX86_BUILTIN_PCOMGEUQ, GEU,
     (int)MULTI_ARG_2_DI_CMP},

    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_com_tfv4sf3,
     "__builtin_ia32_comfalsess", IX86_BUILTIN_COMFALSESS, COM_FALSE_S,
     (int)MULTI_ARG_2_SF_TF},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_com_tfv4sf3,
     "__builtin_ia32_comtruess", IX86_BUILTIN_COMTRUESS, COM_TRUE_S,
     (int)MULTI_ARG_2_SF_TF},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_com_tfv4sf3,
     "__builtin_ia32_comfalseps", IX86_BUILTIN_COMFALSEPS, COM_FALSE_P,
     (int)MULTI_ARG_2_SF_TF},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_com_tfv4sf3,
     "__builtin_ia32_comtrueps", IX86_BUILTIN_COMTRUEPS, COM_TRUE_P,
     (int)MULTI_ARG_2_SF_TF},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_com_tfv2df3,
     "__builtin_ia32_comfalsesd", IX86_BUILTIN_COMFALSESD, COM_FALSE_S,
     (int)MULTI_ARG_2_DF_TF},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_com_tfv2df3,
     "__builtin_ia32_comtruesd", IX86_BUILTIN_COMTRUESD, COM_TRUE_S,
     (int)MULTI_ARG_2_DF_TF},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_com_tfv2df3,
     "__builtin_ia32_comfalsepd", IX86_BUILTIN_COMFALSEPD, COM_FALSE_P,
     (int)MULTI_ARG_2_DF_TF},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_com_tfv2df3,
     "__builtin_ia32_comtruepd", IX86_BUILTIN_COMTRUEPD, COM_TRUE_P,
     (int)MULTI_ARG_2_DF_TF},

    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_pcom_tfv16qi3,
     "__builtin_ia32_pcomfalseb", IX86_BUILTIN_PCOMFALSEB, PCOM_FALSE,
     (int)MULTI_ARG_2_QI_TF},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_pcom_tfv8hi3,
     "__builtin_ia32_pcomfalsew", IX86_BUILTIN_PCOMFALSEW, PCOM_FALSE,
     (int)MULTI_ARG_2_HI_TF},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_pcom_tfv4si3,
     "__builtin_ia32_pcomfalsed", IX86_BUILTIN_PCOMFALSED, PCOM_FALSE,
     (int)MULTI_ARG_2_SI_TF},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_pcom_tfv2di3,
     "__builtin_ia32_pcomfalseq", IX86_BUILTIN_PCOMFALSEQ, PCOM_FALSE,
     (int)MULTI_ARG_2_DI_TF},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_pcom_tfv16qi3,
     "__builtin_ia32_pcomfalseub", IX86_BUILTIN_PCOMFALSEUB, PCOM_FALSE,
     (int)MULTI_ARG_2_QI_TF},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_pcom_tfv8hi3,
     "__builtin_ia32_pcomfalseuw", IX86_BUILTIN_PCOMFALSEUW, PCOM_FALSE,
     (int)MULTI_ARG_2_HI_TF},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_pcom_tfv4si3,
     "__builtin_ia32_pcomfalseud", IX86_BUILTIN_PCOMFALSEUD, PCOM_FALSE,
     (int)MULTI_ARG_2_SI_TF},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_pcom_tfv2di3,
     "__builtin_ia32_pcomfalseuq", IX86_BUILTIN_PCOMFALSEUQ, PCOM_FALSE,
     (int)MULTI_ARG_2_DI_TF},

    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_pcom_tfv16qi3,
     "__builtin_ia32_pcomtrueb", IX86_BUILTIN_PCOMTRUEB, PCOM_TRUE,
     (int)MULTI_ARG_2_QI_TF},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_pcom_tfv8hi3,
     "__builtin_ia32_pcomtruew", IX86_BUILTIN_PCOMTRUEW, PCOM_TRUE,
     (int)MULTI_ARG_2_HI_TF},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_pcom_tfv4si3,
     "__builtin_ia32_pcomtrued", IX86_BUILTIN_PCOMTRUED, PCOM_TRUE,
     (int)MULTI_ARG_2_SI_TF},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_pcom_tfv2di3,
     "__builtin_ia32_pcomtrueq", IX86_BUILTIN_PCOMTRUEQ, PCOM_TRUE,
     (int)MULTI_ARG_2_DI_TF},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_pcom_tfv16qi3,
     "__builtin_ia32_pcomtrueub", IX86_BUILTIN_PCOMTRUEUB, PCOM_TRUE,
     (int)MULTI_ARG_2_QI_TF},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_pcom_tfv8hi3,
     "__builtin_ia32_pcomtrueuw", IX86_BUILTIN_PCOMTRUEUW, PCOM_TRUE,
     (int)MULTI_ARG_2_HI_TF},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_pcom_tfv4si3,
     "__builtin_ia32_pcomtrueud", IX86_BUILTIN_PCOMTRUEUD, PCOM_TRUE,
     (int)MULTI_ARG_2_SI_TF},
    {OPTION_MASK_ISA_SSE5, CODE_FOR_sse5_pcom_tfv2di3,
     "__builtin_ia32_pcomtrueuq", IX86_BUILTIN_PCOMTRUEUQ, PCOM_TRUE,
     (int)MULTI_ARG_2_DI_TF},
};
...
static void ix86_init_mmx_sse_builtins(void) {
  ...
  /* Comparisons.  */
  tree int_ftype_v4sf_v4sf = build_function_type_list(
      integer_type_node, V4SF_type_node, V4SF_type_node, NULL_TREE);
  tree v4si_ftype_v4sf_v4sf = build_function_type_list(
      V4SI_type_node, V4SF_type_node, V4SF_type_node, NULL_TREE);
  /* MMX/SSE/integer conversions.  */
  tree int_ftype_v4sf =
      build_function_type_list(integer_type_node, V4SF_type_node, NULL_TREE);
  tree int64_ftype_v4sf = build_function_type_list(long_long_integer_type_node,
                                                   V4SF_type_node, NULL_TREE);
  tree int_ftype_v8qi =
      build_function_type_list(integer_type_node, V8QI_type_node, NULL_TREE);
  tree v4sf_ftype_v4sf_int = build_function_type_list(
      V4SF_type_node, V4SF_type_node, integer_type_node, NULL_TREE);
  tree v4sf_ftype_v4sf_int64 = build_function_type_list(
      V4SF_type_node, V4SF_type_node, long_long_integer_type_node, NULL_TREE);
  tree v4sf_ftype_v4sf_v2si = build_function_type_list(
      V4SF_type_node, V4SF_type_node, V2SI_type_node, NULL_TREE);

  /* Miscellaneous.  */
  tree v8qi_ftype_v4hi_v4hi = build_function_type_list(
      V8QI_type_node, V4HI_type_node, V4HI_type_node, NULL_TREE);
  tree v4hi_ftype_v2si_v2si = build_function_type_list(
      V4HI_type_node, V2SI_type_node, V2SI_type_node, NULL_TREE);
  tree v4sf_ftype_v4sf_v4sf_int =
      build_function_type_list(V4SF_type_node, V4SF_type_node, V4SF_type_node,
                               integer_type_node, NULL_TREE);
  tree v2si_ftype_v4hi_v4hi = build_function_type_list(
      V2SI_type_node, V4HI_type_node, V4HI_type_node, NULL_TREE);
  tree v4hi_ftype_v4hi_int = build_function_type_list(
      V4HI_type_node, V4HI_type_node, integer_type_node, NULL_TREE);
  tree v2si_ftype_v2si_int = build_function_type_list(
      V2SI_type_node, V2SI_type_node, integer_type_node, NULL_TREE);
  tree v1di_ftype_v1di_int = build_function_type_list(
  ...
  tree void_ftype_unsigned_unsigned = build_function_type_list(
      void_type_node, unsigned_type_node, unsigned_type_node, NULL_TREE);
  tree void_ftype_pcvoid_unsigned_unsigned = build_function_type_list(
      void_type_node, const_ptr_type_node, unsigned_type_node,
  ...
  tree void_ftype_v8qi_v8qi_pchar =
      build_function_type_list(void_type_node, V8QI_type_node, V8QI_type_node,
                               pchar_type_node, NULL_TREE);
  tree v4sf_ftype_pcfloat =
      build_function_type_list(V4SF_type_node, pcfloat_type_node, NULL_TREE);
  tree v4sf_ftype_v4sf_pcv2sf = build_function_type_list(
      V4SF_type_node, V4SF_type_node, pcv2sf_type_node, NULL_TREE);
  tree void_ftype_pv2sf_v4sf = build_function_type_list(
      void_type_node, pv2sf_type_node, V4SF_type_node, NULL_TREE);
  tree void_ftype_pfloat_v4sf = build_function_type_list(
      void_type_node, pfloat_type_node, V4SF_type_node, NULL_TREE);
  tree void_ftype_pdi_di = build_function_type_list(
      void_type_node, pdi_type_node, long_long_unsigned_type_node, NULL_TREE);
  tree void_ftype_pv2di_v2di = build_function_type_list(
      void_type_node, pv2di_type_node, V2DI_type_node, NULL_TREE);
  /* Normal vector unops.  */
  ...
  tree v4sf_ftype_v4sf_v4sf = build_function_type_list(
      V4SF_type_node, V4SF_type_node, V4SF_type_node, NULL_TREE);
  tree v8qi_ftype_v8qi_v8qi = build_function_type_list(
      V8QI_type_node, V8QI_type_node, V8QI_type_node, NULL_TREE);
  tree v4hi_ftype_v4hi_v4hi = build_function_type_list(
      V4HI_type_node, V4HI_type_node, V4HI_type_node, NULL_TREE);
  tree v2si_ftype_v2si_v2si = build_function_type_list(
      V2SI_type_node, V2SI_type_node, V2SI_type_node, NULL_TREE);
  tree v1di_ftype_v1di_v1di = build_function_type_list(
      V1DI_type_node, V1DI_type_node, V1DI_type_node, NULL_TREE);
  tree v1di_ftype_v1di_v1di_int =
      build_function_type_list(V1DI_type_node, V1DI_type_node, V1DI_type_node,
                               integer_type_node, NULL_TREE);
  ...
  tree v2sf_ftype_v2sf_v2sf = build_function_type_list(
      V2SF_type_node, V2SF_type_node, V2SF_type_node, NULL_TREE);
  tree v2si_ftype_v2sf_v2sf = build_function_type_list(
      V2SI_type_node, V2SF_type_node, V2SF_type_node, NULL_TREE);
  ...
  tree int_ftype_v2df_v2df = build_function_type_list(
      integer_type_node, V2DF_type_node, V2DF_type_node, NULL_TREE);
  ...
  tree v4si_ftype_v2df_v2df = build_function_type_list(
      V4SI_type_node, V2DF_type_node, V2DF_type_node, NULL_TREE);
  ...
  tree int64_ftype_v2df = build_function_type_list(long_long_integer_type_node,
                                                   V2DF_type_node, NULL_TREE);
  tree v2df_ftype_v2df_int = build_function_type_list(
      V2DF_type_node, V2DF_type_node, integer_type_node, NULL_TREE);
  tree v2df_ftype_v2df_int64 = build_function_type_list(
      V2DF_type_node, V2DF_type_node, long_long_integer_type_node, NULL_TREE);
  tree v4sf_ftype_v4sf_v2df = build_function_type_list(
      V4SF_type_node, V4SF_type_node, V2DF_type_node, NULL_TREE);
  tree v2df_ftype_v2df_v4sf = build_function_type_list(
      V2DF_type_node, V2DF_type_node, V4SF_type_node, NULL_TREE);
  tree v2df_ftype_v2df_v2df_int =
      build_function_type_list(V2DF_type_node, V2DF_type_node, V2DF_type_node,
                               integer_type_node, NULL_TREE);
  tree v2df_ftype_v2df_pcdouble = build_function_type_list(
      V2DF_type_node, V2DF_type_node, pcdouble_type_node, NULL_TREE);
  tree void_ftype_pdouble_v2df = build_function_type_list(
      void_type_node, pdouble_type_node, V2DF_type_node, NULL_TREE);
  tree void_ftype_pint_int = build_function_type_list(
      void_type_node, pint_type_node, integer_type_node, NULL_TREE);
  tree void_ftype_v16qi_v16qi_pchar =
      build_function_type_list(void_type_node, V16QI_type_node, V16QI_type_node,
                               pchar_type_node, NULL_TREE);
  tree v2df_ftype_pcdouble =
      build_function_type_list(V2DF_type_node, pcdouble_type_node, NULL_TREE);
  tree v2df_ftype_v2df_v2df = build_function_type_list(
      V2DF_type_node, V2DF_type_node, V2DF_type_node, NULL_TREE);
  tree v16qi_ftype_v16qi_v16qi = build_function_type_list(
      V16QI_type_node, V16QI_type_node, V16QI_type_node, NULL_TREE);
  tree v8hi_ftype_v8hi_v8hi = build_function_type_list(
      V8HI_type_node, V8HI_type_node, V8HI_type_node, NULL_TREE);
  tree v4si_ftype_v4si_v4si = build_function_type_list(
      V4SI_type_node, V4SI_type_node, V4SI_type_node, NULL_TREE);
  tree v2di_ftype_v2di_v2di = build_function_type_list(
      V2DI_type_node, V2DI_type_node, V2DI_type_node, NULL_TREE);
  tree v2di_ftype_v2df_v2df = build_function_type_list(
      V2DI_type_node, V2DF_type_node, V2DF_type_node, NULL_TREE);
  tree v2df_ftype_v2df =
      build_function_type_list(V2DF_type_node, V2DF_type_node, NULL_TREE);
  tree v2di_ftype_v2di_int = build_function_type_list(
  ...
  tree v2di_ftype_v2di_v2di_int =
      build_function_type_list(V2DI_type_node, V2DI_type_node, V2DI_type_node,
                               integer_type_node, NULL_TREE);
  tree v4si_ftype_v4si_int = build_function_type_list(
      V4SI_type_node, V4SI_type_node, integer_type_node, NULL_TREE);
  tree v8hi_ftype_v8hi_int = build_function_type_list(
      V8HI_type_node, V8HI_type_node, integer_type_node, NULL_TREE);
  tree v4si_ftype_v8hi_v8hi = build_function_type_list(
      V4SI_type_node, V8HI_type_node, V8HI_type_node, NULL_TREE);
  tree v1di_ftype_v8qi_v8qi = build_function_type_list(
      V1DI_type_node, V8QI_type_node, V8QI_type_node, NULL_TREE);
  tree v1di_ftype_v2si_v2si = build_function_type_list(
      V1DI_type_node, V2SI_type_node, V2SI_type_node, NULL_TREE);
  tree v2di_ftype_v16qi_v16qi = build_function_type_list(
      V2DI_type_node, V16QI_type_node, V16QI_type_node, NULL_TREE);
  tree v2di_ftype_v4si_v4si = build_function_type_list(
      V2DI_type_node, V4SI_type_node, V4SI_type_node, NULL_TREE);
  tree int_ftype_v16qi =
      build_function_type_list(integer_type_node, V16QI_type_node, NULL_TREE);
  tree v16qi_ftype_pcchar =
      build_function_type_list(V16QI_type_node, pcchar_type_node, NULL_TREE);
  tree void_ftype_pchar_v16qi = build_function_type_list(
      void_type_node, pchar_type_node, V16QI_type_node, NULL_TREE);

  tree v2di_ftype_v2di_unsigned_unsigned = build_function_type_list(
      V2DI_type_node, V2DI_type_node, unsigned_type_node, unsigned_type_node,
      NULL_TREE);
  tree v2di_ftype_v2di_v2di_unsigned_unsigned = build_function_type_list(
      V2DI_type_node, V2DI_type_node, V2DI_type_node, unsigned_type_node,
      unsigned_type_node, NULL_TREE);
  tree v2di_ftype_v2di_v16qi = build_function_type_list(
      V2DI_type_node, V2DI_type_node, V16QI_type_node, NULL_TREE);
  ...
  tree v4si_ftype_v16qi =
      build_function_type_list(V4SI_type_node, V16QI_type_node, NULL_TREE);
  tree v2di_ftype_v16qi =
      build_function_type_list(V2DI_type_node, V16QI_type_node, NULL_TREE);
  tree v4si_ftype_v8hi =
      build_function_type_list(V4SI_type_node, V8HI_type_node, NULL_TREE);
  tree v2di_ftype_v8hi =
      build_function_type_list(V2DI_type_node, V8HI_type_node, NULL_TREE);
  tree v2di_ftype_v4si =
      build_function_type_list(V2DI_type_node, V4SI_type_node, NULL_TREE);
  tree v2di_ftype_pv2di =
      build_function_type_list(V2DI_type_node, pv2di_type_node, NULL_TREE);
  ...
  tree v8hi_ftype_v8hi_v8hi_int =
      build_function_type_list(V8HI_type_node, V8HI_type_node, V8HI_type_node,
                               integer_type_node, NULL_TREE);
  tree v4si_ftype_v4si_v4si_int =
      build_function_type_list(V4SI_type_node, V4SI_type_node, V4SI_type_node,
                               integer_type_node, NULL_TREE);
  tree int_ftype_v2di_v2di = build_function_type_list(
      integer_type_node, V2DI_type_node, V2DI_type_node, NULL_TREE);
  tree int_ftype_v16qi_int_v16qi_int_int = build_function_type_list(
      integer_type_node, V16QI_type_node, integer_type_node, V16QI_type_node,
      integer_type_node, integer_type_node, NULL_TREE);
  tree v16qi_ftype_v16qi_int_v16qi_int_int = build_function_type_list(
      V16QI_type_node, V16QI_type_node, integer_type_node, V16QI_type_node,
      integer_type_node, integer_type_node, NULL_TREE);
  ...
  tree v2di_ftype_v2di_si = build_function_type_list(
      V2DI_type_node, V2DI_type_node, integer_type_node, NULL_TREE);

  tree v4si_ftype_v4si_si = build_function_type_list(
      V4SI_type_node, V4SI_type_node, integer_type_node, NULL_TREE);

  tree v8hi_ftype_v8hi_si = build_function_type_list(
      V8HI_type_node, V8HI_type_node, integer_type_node, NULL_TREE);

  tree v16qi_ftype_v16qi_si = build_function_type_list(
      V16QI_type_node, V16QI_type_node, integer_type_node, NULL_TREE);
  tree v4sf_ftype_v4hi =
      build_function_type_list(V4SF_type_node, V4HI_type_node, NULL_TREE);

  tree v4hi_ftype_v4sf =
      build_function_type_list(V4HI_type_node, V4SF_type_node, NULL_TREE);

  tree v2di_ftype_v2di =
      build_function_type_list(V2DI_type_node, V2DI_type_node, NULL_TREE);

  tree v16qi_ftype_v8hi_v8hi = build_function_type_list(
      V16QI_type_node, V8HI_type_node, V8HI_type_node, NULL_TREE);
  tree v8hi_ftype_v4si_v4si = build_function_type_list(
      V8HI_type_node, V4SI_type_node, V4SI_type_node, NULL_TREE);
  tree v8hi_ftype_v16qi_v16qi = build_function_type_list(
      V8HI_type_node, V16QI_type_node, V16QI_type_node, NULL_TREE);
  tree v4hi_ftype_v8qi_v8qi = build_function_type_list(
      V4HI_type_node, V8QI_type_node, V8QI_type_node, NULL_TREE);
  ...
  tree unsigned_ftype_unsigned_unsigned = build_function_type_list(
      unsigned_type_node, unsigned_type_node, unsigned_type_node, NULL_TREE);
  tree uint64_ftype_uint64_uint64 = build_function_type_list(
  ...
  /* AVX builtins  */
  tree V32QI_type_node = build_vector_type_for_mode(char_type_node, V32QImode);
  ...
  tree V4DI_type_node =
      build_vector_type_for_mode(long_long_integer_type_node, V4DImode);
  tree V4DF_type_node = build_vector_type_for_mode(double_type_node, V4DFmode);
  tree v8sf_ftype_v8sf =
      build_function_type_list(V8SF_type_node, V8SF_type_node, NULL_TREE);
  ...
  tree v4df_ftype_v4df =
      build_function_type_list(V4DF_type_node, V4DF_type_node, NULL_TREE);
  ...
  tree v8sf_ftype_v8sf_v8sf = build_function_type_list(
      V8SF_type_node, V8SF_type_node, V8SF_type_node, NULL_TREE);
  tree v4df_ftype_v4df_v4df = build_function_type_list(
      V4DF_type_node, V4DF_type_node, V4DF_type_node, NULL_TREE);
  tree v8sf_ftype_v8sf_int = build_function_type_list(
      V8SF_type_node, V8SF_type_node, integer_type_node, NULL_TREE);
  tree v4si_ftype_v8si_int = build_function_type_list(
      V4SI_type_node, V8SI_type_node, integer_type_node, NULL_TREE);
  tree v4df_ftype_v4df_int = build_function_type_list(
      V4DF_type_node, V4DF_type_node, integer_type_node, NULL_TREE);
  tree v4sf_ftype_v8sf_int = build_function_type_list(
      V4SF_type_node, V8SF_type_node, integer_type_node, NULL_TREE);
  tree v2df_ftype_v4df_int = build_function_type_list(
      V2DF_type_node, V4DF_type_node, integer_type_node, NULL_TREE);
  tree v8sf_ftype_v8sf_v8sf_int =
      build_function_type_list(V8SF_type_node, V8SF_type_node, V8SF_type_node,
                               integer_type_node, NULL_TREE);
  tree v8sf_ftype_v8sf_v8sf_v8sf =
      build_function_type_list(V8SF_type_node, V8SF_type_node, V8SF_type_node,
                               V8SF_type_node, NULL_TREE);
  tree v4df_ftype_v4df_v4df_v4df =
      build_function_type_list(V4DF_type_node, V4DF_type_node, V4DF_type_node,
                               V4DF_type_node, NULL_TREE);
  tree v8si_ftype_v8si_v8si_int =
      build_function_type_list(V8SI_type_node, V8SI_type_node, V8SI_type_node,
                               integer_type_node, NULL_TREE);
  tree v4df_ftype_v4df_v4df_int =
      build_function_type_list(V4DF_type_node, V4DF_type_node, V4DF_type_node,
                               integer_type_node, NULL_TREE);
  tree v8sf_ftype_pcfloat =
      build_function_type_list(V8SF_type_node, pcfloat_type_node, NULL_TREE);
  tree v4df_ftype_pcdouble =
      build_function_type_list(V4DF_type_node, pcdouble_type_node, NULL_TREE);
  ...
  tree v8sf_ftype_pcv4sf =
      build_function_type_list(V8SF_type_node, pcv4sf_type_node, NULL_TREE);
  tree v4df_ftype_pcv2df =
      build_function_type_list(V4DF_type_node, pcv2df_type_node, NULL_TREE);
  tree v32qi_ftype_pcchar =
      build_function_type_list(V32QI_type_node, pcchar_type_node, NULL_TREE);
  tree void_ftype_pchar_v32qi = build_function_type_list(
      void_type_node, pchar_type_node, V32QI_type_node, NULL_TREE);
  tree v8si_ftype_v8si_v4si_int =
      build_function_type_list(V8SI_type_node, V8SI_type_node, V4SI_type_node,
                               integer_type_node, NULL_TREE);
  tree pv4di_type_node = build_pointer_type(V4DI_type_node);
  tree void_ftype_pv4di_v4di = build_function_type_list(
      void_type_node, pv4di_type_node, V4DI_type_node, NULL_TREE);
  tree v8sf_ftype_v8sf_v4sf_int =
      build_function_type_list(V8SF_type_node, V8SF_type_node, V4SF_type_node,
                               integer_type_node, NULL_TREE);
  tree v4df_ftype_v4df_v2df_int =
      build_function_type_list(V4DF_type_node, V4DF_type_node, V2DF_type_node,
                               integer_type_node, NULL_TREE);
  tree void_ftype_pfloat_v8sf = build_function_type_list(
      void_type_node, pfloat_type_node, V8SF_type_node, NULL_TREE);
  tree void_ftype_pdouble_v4df = build_function_type_list(
      void_type_node, pdouble_type_node, V4DF_type_node, NULL_TREE);
  ...
  tree v8sf_ftype_pcv8sf_v8sf = build_function_type_list(
      V8SF_type_node, pcv8sf_type_node, V8SF_type_node, NULL_TREE);
  tree v4df_ftype_pcv4df_v4df = build_function_type_list(
      V4DF_type_node, pcv4df_type_node, V4DF_type_node, NULL_TREE);
  tree v4sf_ftype_pcv4sf_v4sf = build_function_type_list(
      V4SF_type_node, pcv4sf_type_node, V4SF_type_node, NULL_TREE);
  tree v2df_ftype_pcv2df_v2df = build_function_type_list(
      V2DF_type_node, pcv2df_type_node, V2DF_type_node, NULL_TREE);
  tree void_ftype_pv8sf_v8sf_v8sf =
      build_function_type_list(void_type_node, pv8sf_type_node, V8SF_type_node,
                               V8SF_type_node, NULL_TREE);
  tree void_ftype_pv4df_v4df_v4df =
      build_function_type_list(void_type_node, pv4df_type_node, V4DF_type_node,
                               V4DF_type_node, NULL_TREE);
  tree void_ftype_pv4sf_v4sf_v4sf =
      build_function_type_list(void_type_node, pv4sf_type_node, V4SF_type_node,
                               V4SF_type_node, NULL_TREE);
  tree void_ftype_pv2df_v2df_v2df =
      build_function_type_list(void_type_node, pv2df_type_node, V2DF_type_node,
                               V2DF_type_node, NULL_TREE);
  tree v4df_ftype_v2df =
      build_function_type_list(V4DF_type_node, V2DF_type_node, NULL_TREE);
  tree v8sf_ftype_v4sf =
      build_function_type_list(V8SF_type_node, V4SF_type_node, NULL_TREE);
  tree v8si_ftype_v4si =
      build_function_type_list(V8SI_type_node, V4SI_type_node, NULL_TREE);
  tree v2df_ftype_v4df =
      build_function_type_list(V2DF_type_node, V4DF_type_node, NULL_TREE);
  tree v4sf_ftype_v8sf =
      build_function_type_list(V4SF_type_node, V8SF_type_node, NULL_TREE);
  tree v4si_ftype_v8si =
      build_function_type_list(V4SI_type_node, V8SI_type_node, NULL_TREE);
  tree int_ftype_v4df =
      build_function_type_list(integer_type_node, V4DF_type_node, NULL_TREE);
  tree int_ftype_v8sf =
      build_function_type_list(integer_type_node, V8SF_type_node, NULL_TREE);
  tree int_ftype_v8sf_v8sf = build_function_type_list(
      integer_type_node, V8SF_type_node, V8SF_type_node, NULL_TREE);
  tree int_ftype_v4di_v4di = build_function_type_list(
      integer_type_node, V4DI_type_node, V4DI_type_node, NULL_TREE);
  tree int_ftype_v4df_v4df = build_function_type_list(
      integer_type_node, V4DF_type_node, V4DF_type_node, NULL_TREE);
  tree v8sf_ftype_v8sf_v8si = build_function_type_list(
      V8SF_type_node, V8SF_type_node, V8SI_type_node, NULL_TREE);
  tree v4df_ftype_v4df_v4di = build_function_type_list(
      V4DF_type_node, V4DF_type_node, V4DI_type_node, NULL_TREE);
  tree v4sf_ftype_v4sf_v4si = build_function_type_list(
      V4SF_type_node, V4SF_type_node, V4SI_type_node, NULL_TREE);
  tree v2df_ftype_v2df_v2di = build_function_type_list(
      V2DF_type_node, V2DF_type_node, V2DI_type_node, NULL_TREE);

  tree ftype;

  /* Add all special builtins with variable number of operands.  */
  for (i = 0, d = bdesc_special_args; i < ARRAY_SIZE(bdesc_special_args);
       i++, d++) {
    tree type;
  ...
  for (i = 0, d = bdesc_args; i < ARRAY_SIZE(bdesc_args); i++, d++) {
    tree type;
  ...
  /* pcmpestr[im] insns.  */
  for (i = 0, d = bdesc_pcmpestr; i < ARRAY_SIZE(bdesc_pcmpestr); i++, d++) {
  ...
  /* pcmpistr[im] insns.  */
  for (i = 0, d = bdesc_pcmpistr; i < ARRAY_SIZE(bdesc_pcmpistr); i++, d++) {
  ...
  def_builtin(OPTION_MASK_ISA_SSE2, "__builtin_ia32_clflush", void_ftype_pcvoid,
              IX86_BUILTIN_CLFLUSH);
  ...
  /* AVX */
  def_builtin(
      OPTION_MASK_ISA_AVX, "__builtin_ia32_vzeroupper", void_ftype_void,
      TARGET_64BIT ? IX86_BUILTIN_VZEROUPPER_REX64 : IX86_BUILTIN_VZEROUPPER);

  /* Access to the vec_init patterns.  */
  ftype = build_function_type_list(V2SI_type_node, integer_type_node,
                                   integer_type_node, NULL_TREE);
  def_builtin_const(OPTION_MASK_ISA_MMX, "__builtin_ia32_vec_init_v2si", ftype,
                    IX86_BUILTIN_VEC_INIT_V2SI);

  ftype = build_function_type_list(
      V4HI_type_node, short_integer_type_node, short_integer_type_node,
      short_integer_type_node, short_integer_type_node, NULL_TREE);
  def_builtin_const(OPTION_MASK_ISA_MMX, "__builtin_ia32_vec_init_v4hi", ftype,
                    IX86_BUILTIN_VEC_INIT_V4HI);

  ftype = build_function_type_list(
      V8QI_type_node, char_type_node, char_type_node, char_type_node,
      char_type_node, char_type_node, char_type_node, char_type_node,
      char_type_node, NULL_TREE);
  def_builtin_const(OPTION_MASK_ISA_MMX, "__builtin_ia32_vec_init_v8qi", ftype,
                    IX86_BUILTIN_VEC_INIT_V8QI);

  /* Access to the vec_extract patterns.  */
  ftype = build_function_type_list(double_type_node, V2DF_type_node,
                                   integer_type_node, NULL_TREE);
  def_builtin_const(OPTION_MASK_ISA_SSE2, "__builtin_ia32_vec_ext_v2df", ftype,
                    IX86_BUILTIN_VEC_EXT_V2DF);

  ftype = build_function_type_list(long_long_integer_type_node, V2DI_type_node,
                                   integer_type_node, NULL_TREE);
  def_builtin_const(OPTION_MASK_ISA_SSE2, "__builtin_ia32_vec_ext_v2di", ftype,
                    IX86_BUILTIN_VEC_EXT_V2DI);

  ftype = build_function_type_list(float_type_node, V4SF_type_node,
                                   integer_type_node, NULL_TREE);
  def_builtin_const(OPTION_MASK_ISA_SSE, "__builtin_ia32_vec_ext_v4sf", ftype,
                    IX86_BUILTIN_VEC_EXT_V4SF);

  ftype = build_function_type_list(intSI_type_node, V4SI_type_node,
                                   integer_type_node, NULL_TREE);
  def_builtin_const(OPTION_MASK_ISA_SSE2, "__builtin_ia32_vec_ext_v4si", ftype,
                    IX86_BUILTIN_VEC_EXT_V4SI);

  ftype = build_function_type_list(intHI_type_node, V8HI_type_node,
                                   integer_type_node, NULL_TREE);
  def_builtin_const(OPTION_MASK_ISA_SSE2, "__builtin_ia32_vec_ext_v8hi", ftype,
                    IX86_BUILTIN_VEC_EXT_V8HI);
  ...
  ftype = build_function_type_list(intSI_type_node, V2SI_type_node,
                                   integer_type_node, NULL_TREE);
  def_builtin_const(OPTION_MASK_ISA_MMX, "__builtin_ia32_vec_ext_v2si", ftype,
                    IX86_BUILTIN_VEC_EXT_V2SI);

  ftype = build_function_type_list(intQI_type_node, V16QI_type_node,
                                   integer_type_node, NULL_TREE);
  def_builtin_const(OPTION_MASK_ISA_SSE2, "__builtin_ia32_vec_ext_v16qi", ftype,
                    IX86_BUILTIN_VEC_EXT_V16QI);

  /* Access to the vec_set patterns.  */
  ftype =
      build_function_type_list(V2DI_type_node, V2DI_type_node, intDI_type_node,
                               integer_type_node, NULL_TREE);
  ...
  ftype =
      build_function_type_list(V4SF_type_node, V4SF_type_node, float_type_node,
                               integer_type_node, NULL_TREE);
  def_builtin_const(OPTION_MASK_ISA_SSE4_1, "__builtin_ia32_vec_set_v4sf",
                    ftype, IX86_BUILTIN_VEC_SET_V4SF);

  ftype =
      build_function_type_list(V4SI_type_node, V4SI_type_node, intSI_type_node,
                               integer_type_node, NULL_TREE);
  def_builtin_const(OPTION_MASK_ISA_SSE4_1, "__builtin_ia32_vec_set_v4si",
                    ftype, IX86_BUILTIN_VEC_SET_V4SI);

  ftype =
      build_function_type_list(V8HI_type_node, V8HI_type_node, intHI_type_node,
                               integer_type_node, NULL_TREE);
  def_builtin_const(OPTION_MASK_ISA_SSE2, "__builtin_ia32_vec_set_v8hi", ftype,
                    IX86_BUILTIN_VEC_SET_V8HI);

  ftype =
      build_function_type_list(V4HI_type_node, V4HI_type_node, intHI_type_node,
                               integer_type_node, NULL_TREE);
  def_builtin_const(OPTION_MASK_ISA_SSE | OPTION_MASK_ISA_3DNOW_A,
  ...
  ftype =
      build_function_type_list(V16QI_type_node, V16QI_type_node,
                               intQI_type_node, integer_type_node, NULL_TREE);
  ...
  for (i = 0, d = bdesc_multi_arg; i < ARRAY_SIZE(bdesc_multi_arg); i++, d++) {
    ...
    switch ((enum multi_arg_type)d->flag) {
      case MULTI_ARG_3_SF:
        mtype = v4sf_ftype_v4sf_v4sf_v4sf;
        break;
      case MULTI_ARG_3_DF:
        mtype = v2df_ftype_v2df_v2df_v2df;
        break;
      case MULTI_ARG_3_DI:
        mtype = v2di_ftype_v2di_v2di_v2di;
        break;
      case MULTI_ARG_3_SI:
        mtype = v4si_ftype_v4si_v4si_v4si;
        break;
      case MULTI_ARG_3_SI_DI:
        mtype = v4si_ftype_v4si_v4si_v2di;
        break;
      case MULTI_ARG_3_HI:
        mtype = v8hi_ftype_v8hi_v8hi_v8hi;
        break;
      case MULTI_ARG_3_HI_SI:
        mtype = v8hi_ftype_v8hi_v8hi_v4si;
        break;
      case MULTI_ARG_3_QI:
        mtype = v16qi_ftype_v16qi_v16qi_v16qi;
        break;
      case MULTI_ARG_3_PERMPS:
        mtype = v4sf_ftype_v4sf_v4sf_v16qi;
        break;
      case MULTI_ARG_3_PERMPD:
        mtype = v2df_ftype_v2df_v2df_v16qi;
        break;
      case MULTI_ARG_2_SF:
        mtype = v4sf_ftype_v4sf_v4sf;
        break;
      case MULTI_ARG_2_DF:
        mtype = v2df_ftype_v2df_v2df;
        break;
      case MULTI_ARG_2_DI:
        mtype = v2di_ftype_v2di_v2di;
        break;
      case MULTI_ARG_2_SI:
        mtype = v4si_ftype_v4si_v4si;
        break;
      case MULTI_ARG_2_HI:
        mtype = v8hi_ftype_v8hi_v8hi;
        break;
      case MULTI_ARG_2_QI:
        mtype = v16qi_ftype_v16qi_v16qi;
        break;
      case MULTI_ARG_2_DI_IMM:
        mtype = v2di_ftype_v2di_si;
        break;
      case MULTI_ARG_2_SI_IMM:
        mtype = v4si_ftype_v4si_si;
        break;
      case MULTI_ARG_2_HI_IMM:
        mtype = v8hi_ftype_v8hi_si;
        break;
      case MULTI_ARG_2_QI_IMM:
        mtype = v16qi_ftype_v16qi_si;
        break;
      ...
      case MULTI_ARG_2_QI_TF:
        ...
        break;
      case MULTI_ARG_1_SF:
        mtype = v4sf_ftype_v4sf;
        break;
      case MULTI_ARG_1_DF:
        mtype = v2df_ftype_v2df;
        break;
      case MULTI_ARG_1_DI:
        mtype = v2di_ftype_v2di;
        break;
      case MULTI_ARG_1_SI:
        mtype = v4si_ftype_v4si;
        break;
      case MULTI_ARG_1_HI:
        mtype = v8hi_ftype_v8hi;
        break;
      case MULTI_ARG_1_QI:
        mtype = v16qi_ftype_v16qi;
        break;
      case MULTI_ARG_1_SI_DI:
        mtype = v2di_ftype_v4si;
        break;
      case MULTI_ARG_1_HI_DI:
        mtype = v2di_ftype_v8hi;
        break;
      case MULTI_ARG_1_HI_SI:
        mtype = v4si_ftype_v8hi;
        break;
      case MULTI_ARG_1_QI_DI:
        mtype = v2di_ftype_v16qi;
        break;
      case MULTI_ARG_1_QI_SI:
        mtype = v4si_ftype_v16qi;
        break;
      case MULTI_ARG_1_QI_HI:
        mtype = v8hi_ftype_v16qi;
        break;
      case MULTI_ARG_1_PH2PS:
        mtype = v4sf_ftype_v4hi;
        break;
      case MULTI_ARG_1_PS2PH:
        mtype = v4hi_ftype_v4sf;
        break;
...
static void ix86_init_builtins_va_builtins_abi(void) {
  ...
  fnvoid_va_start_sysv =
      build_varargs_function_type_list(void_type_node, sysv_va_ref, NULL_TREE);
  fnvoid_va_copy_ms = build_function_type_list(void_type_node, ms_va_ref,
                                               ms_va_list_type_node, NULL_TREE);
  fnvoid_va_copy_sysv = build_function_type_list(void_type_node, sysv_va_ref,
  ...
  add_builtin_function("__builtin_ms_va_end", fnvoid_va_end_ms, BUILT_IN_VA_END,
                       BUILT_IN_NORMAL, NULL, fnattr_ms);
...
static void ix86_init_builtins(void) {
  ...
  decl = add_builtin_function("__builtin_infq", ftype, IX86_BUILTIN_INFQ,
                              BUILT_IN_MD, NULL, NULL_TREE);
  ix86_builtins[(int)IX86_BUILTIN_INFQ] = decl;

  /* We will expand them to normal call if SSE2 isn't available since
     they are used by libgcc. */
  ftype = build_function_type_list(float128_type_node, float128_type_node,
                                   NULL_TREE);
  ...
  decl =
      add_builtin_function("__builtin_copysignq", ftype, IX86_BUILTIN_COPYSIGNQ,
...
/* Errors in the source file can cause expand_expr to return const0_rtx
   ...
   clear instructions.  */
static rtx safe_vector_operand(rtx x, enum machine_mode mode) {
  if (x == const0_rtx)
    x = CONST0_RTX(mode);
  return x;
}
...
static rtx ix86_expand_binop_builtin(enum insn_code icode, tree exp,
                                     rtx target) {
  rtx pat;
...
static rtx ix86_expand_multi_arg_builtin(enum insn_code icode, tree exp,
                                         rtx target, enum multi_arg_type m_type,
  ...
  switch (nargs) {
    ...
    case 2:
      if (tf_p)
        ...
        rtx cmp_op =
            gen_rtx_fmt_ee(sub_code, GET_MODE(target), args[0].op, args[1].op);
...
static rtx ix86_expand_unop_vec_merge_builtin(enum insn_code icode, tree exp,
                                              rtx target) {
  rtx pat;
  tree arg0 = CALL_EXPR_ARG(exp, 0);
...
static rtx ix86_expand_sse_compare(const struct builtin_description *d,
...
static rtx ix86_expand_sse_comi(const struct builtin_description *d, tree exp,
                                rtx target) {
  rtx pat;
  tree arg0 = CALL_EXPR_ARG(exp, 0);
  tree arg1 = CALL_EXPR_ARG(exp, 1);
  ...
  emit_insn(pat);
  emit_insn(gen_rtx_SET(
      VOIDmode, gen_rtx_STRICT_LOW_PART(VOIDmode, target),
      gen_rtx_fmt_ee(comparison, QImode, SET_DEST(pat), const0_rtx)));
...
static rtx ix86_expand_sse_ptest(const struct builtin_description *d, tree exp,
                                 rtx target) {
  rtx pat;
  tree arg0 = CALL_EXPR_ARG(exp, 0);
  tree arg1 = CALL_EXPR_ARG(exp, 1);
...
static rtx ix86_expand_sse_pcmpestr(const struct builtin_description *d,
                                    tree exp, rtx target) {
  rtx pat;
  tree arg0 = CALL_EXPR_ARG(exp, 0);
  tree arg1 = CALL_EXPR_ARG(exp, 1);
  ...
  if (d->code == IX86_BUILTIN_PCMPESTRI128) {
    if (optimize || !target || GET_MODE(target) != tmode0 ||
    ...
    if (optimize || !target || GET_MODE(target) != tmode1 ||
  ...
  if (d->flag) {
    ...
    emit_insn(gen_rtx_SET(
        ...
        gen_rtx_fmt_ee(EQ, QImode,
                       gen_rtx_REG((enum machine_mode)d->flag, FLAGS_REG),
                       const0_rtx)));
    return SUBREG_REG(target);
  } else
    return target;
...
static rtx ix86_expand_sse_pcmpistr(const struct builtin_description *d,
                                    tree exp, rtx target) {
  rtx pat;
  tree arg0 = CALL_EXPR_ARG(exp, 0);
  tree arg1 = CALL_EXPR_ARG(exp, 1);
...
static rtx ix86_expand_args_builtin(const struct builtin_description *d,
                                    tree exp, rtx target) {
  rtx pat, real_target;
  ...
  switch (nargs) {
    ...
    case 2:
      ...
      break;
    case 3:
      pat = GEN_FCN(icode)(real_target, args[0].op, args[1].op, args[2].op);
      break;
    case 4:
      pat = GEN_FCN(icode)(real_target, args[0].op, args[1].op, args[2].op,
                           args[3].op);
...
static rtx ix86_expand_special_args_builtin(const struct builtin_description *d,
                                            tree exp, rtx target) {
  tree arg;
  rtx pat, op;
...
static int get_element_number(tree vec_type, tree arg) {
  ...
  if (!host_integerp(arg, 1) || (elt = tree_low_cst(arg, 1), elt > max)) {
...
static rtx ix86_expand_vec_init_builtin(tree type, tree exp, rtx target) {
...
static rtx ix86_expand_vec_ext_builtin(tree exp, rtx target) {
...
static rtx ix86_expand_vec_set_builtin(tree exp) {
...
static rtx ix86_expand_builtin(tree exp, rtx target,
  ...
  if (ix86_builtins_isa[fcode].isa &&
    ...
    char *opts = ix86_target_string(ix86_builtins_isa[fcode].isa, 0, NULL, NULL,
                                    NULL, false);
  ...
  switch (fcode) {
    ...
    case IX86_BUILTIN_MASKMOVDQU:
      icode = (fcode == IX86_BUILTIN_MASKMOVQ ? CODE_FOR_mmx_maskmovq
  ...
  for (i = 0, d = bdesc_multi_arg; i < ARRAY_SIZE(bdesc_multi_arg); i++, d++)
    if (d->code == fcode)
      return ix86_expand_multi_arg_builtin(
          d->icode, exp, target, (enum multi_arg_type)d->flag, d->comparison);
...
static tree ix86_builtin_vectorized_function(unsigned int fn, tree type_out,
                                             tree type_in) {
  enum machine_mode in_mode, out_mode;
  int in_n, out_n;

  if (TREE_CODE(type_out) != VECTOR_TYPE || TREE_CODE(type_in) != VECTOR_TYPE)
    return NULL_TREE;
  ...
  switch (fn) {
    case BUILT_IN_SQRT:
      if (out_mode == DFmode && out_n == 2 && in_mode == DFmode && in_n == 2)
        return ix86_builtins[IX86_BUILTIN_SQRTPD];
      break;

    case BUILT_IN_SQRTF:
      if (out_mode == SFmode && out_n == 4 && in_mode == SFmode && in_n == 4)
        return ix86_builtins[IX86_BUILTIN_SQRTPS_NR];
      break;

    case BUILT_IN_LRINT:
      if (out_mode == SImode && out_n == 4 && in_mode == DFmode && in_n == 2)
        return ix86_builtins[IX86_BUILTIN_VEC_PACK_SFIX];
      break;

    case BUILT_IN_LRINTF:
      if (out_mode == SImode && out_n == 4 && in_mode == SFmode && in_n == 4)
...
static tree ix86_veclibabi_svml(enum built_in_function fn, tree type_out,
                                tree type_in) {
  char name[20];
...
static tree ix86_veclibabi_acml(enum built_in_function fn, tree type_out,
                                tree type_in) {
  char name[20] = "__vr.._";
  tree fntype, new_fndecl, args;
  unsigned arity;
  ...
  if (!TARGET_64BIT || !flag_unsafe_math_optimizations)
    return NULL_TREE;
...
static tree ix86_vectorize_builtin_conversion(unsigned int code, tree type) {
...
static tree ix86_builtin_reciprocal(unsigned int fn, bool md_fn,
...
rtx ix86_force_to_memory(enum machine_mode mode, rtx operand) {
  rtx result;

  gcc_assert(reload_completed);
  if (!TARGET_64BIT_MS_ABI && TARGET_RED_ZONE) {
    result = gen_rtx_MEM(
        mode, gen_rtx_PLUS(Pmode, stack_pointer_rtx, GEN_INT(-RED_ZONE_SIZE)));
    ...
    switch (mode) {
      case DImode: {
        ...
        emit_insn(gen_rtx_SET(
            VOIDmode,
            gen_rtx_MEM(SImode, gen_rtx_PRE_DEC(Pmode, stack_pointer_rtx)),
            operands[1]));
        emit_insn(gen_rtx_SET(
            VOIDmode,
            gen_rtx_MEM(SImode, gen_rtx_PRE_DEC(Pmode, stack_pointer_rtx)),
...
void ix86_free_from_memory(enum machine_mode mode) {
  if (!TARGET_RED_ZONE || TARGET_64BIT_MS_ABI) {
    ...
    emit_insn(
        gen_rtx_SET(VOIDmode, stack_pointer_rtx,
                    gen_rtx_PLUS(Pmode, stack_pointer_rtx, GEN_INT(size))));
  }
}
...
enum reg_class ix86_preferred_reload_class(rtx x, enum reg_class regclass) {
  enum machine_mode mode = GET_MODE(x);
...
enum reg_class ix86_preferred_output_reload_class(rtx x,
...
static enum reg_class ix86_secondary_reload(
    bool in_p, rtx x, enum reg_class rclass, enum machine_mode mode,
    secondary_reload_info *sri ATTRIBUTE_UNUSED) {
  /* QImode spills from non-QI registers require
     intermediate register on 32bit targets.  */
  if (!in_p && mode == QImode && !TARGET_64BIT &&
      (rclass == GENERAL_REGS || rclass == LEGACY_REGS ||
       rclass == INDEX_REGS)) {
    int regno;
...
static inline int inline_secondary_memory_needed(enum reg_class class1,
...
int ix86_secondary_memory_needed(enum reg_class class1, enum reg_class class2,
...
bool ix86_cannot_change_mode_class(enum machine_mode from, enum machine_mode to,
                                   enum reg_class regclass) {
  if (from == to)
    return false;
...
/* Return the cost of moving data of mode M between a
   ...
   Q_REGS classes.
 */
static inline int inline_memory_move_cost(enum machine_mode mode,
                                          enum reg_class regclass, int in) {
  int cost;
  ...
  switch (GET_MODE_SIZE(mode)) {
    ...
    default:
      ...
      return (cost * (((int)GET_MODE_SIZE(mode) + UNITS_PER_WORD - 1) /
                      UNITS_PER_WORD));
  }
}

int ix86_memory_move_cost(enum machine_mode mode, enum reg_class regclass,
                          int in) {
...
int ix86_register_move_cost(enum machine_mode mode, enum reg_class class1,
                            enum reg_class class2) {
...
bool ix86_hard_regno_mode_ok(int regno, enum machine_mode mode) {
  /* Flags and only flags can only hold CCmode values.  */
  if (CC_REGNO_P(regno))
    return GET_MODE_CLASS(mode) == MODE_CC;
  if (GET_MODE_CLASS(mode) == MODE_CC || GET_MODE_CLASS(mode) == MODE_RANDOM ||
  ...
  if (SSE_REGNO_P(regno)) {
    /* We implement the move patterns for all vector modes into and
       ...
       enabled.  */
    return ((TARGET_AVX && mode == OImode) || VALID_AVX256_REG_MODE(mode) ||
            VALID_SSE_REG_MODE(mode) || VALID_SSE2_REG_MODE(mode) ||
            VALID_MMX_REG_MODE(mode) || VALID_MMX_REG_MODE_3DNOW(mode));
  }
...
static bool ix86_tieable_integer_mode_p(enum machine_mode mode) {
  switch (mode) {
    case HImode:
    case SImode:
      return true;
...
bool ix86_modes_tieable_p(enum machine_mode mode1, enum machine_mode mode2) {
  if (mode1 == mode2)
    return true;

  if (ix86_tieable_integer_mode_p(mode1) && ix86_tieable_integer_mode_p(mode2))
    return true;
...
static bool ix86_rtx_costs(rtx x, int code, int outer_code_i, int *total,
                           bool speed) {
  ...
  switch (code) {
    ...
    case ASHIFT:
      if (CONST_INT_P(XEXP(x, 1)) &&
        ...
        if ((value == 2 || value == 3) && cost->lea <= cost->shift_const) {
          *total = cost->lea;
          return false;
        }
      }
      ...
      if (SSE_FLOAT_MODE_P(mode) && TARGET_SSE_MATH) {
        ...
        *total = cost->fmul;
        ...
        if ((GET_CODE(op0) == SIGN_EXTEND || GET_CODE(op0) == ZERO_EXTEND) &&
            GET_MODE_SIZE(GET_MODE(XEXP(op0, 0))) * 2 == GET_MODE_SIZE(mode)) {
          int is_mulwiden = 0;
          ...
          if (GET_CODE(op0) == GET_CODE(op1))
            ...
            if (GET_CODE(op0) == SIGN_EXTEND)
              is_mulwiden =
                  trunc_int_for_mode(INTVAL(op1), inner_mode) == INTVAL(op1);
            else
        ...
        *total = (cost->mult_init[MODE_INDEX(mode)] + nbits * cost->mult_bit +
                  rtx_cost(op0, outer_code, speed) +
                  rtx_cost(op1, outer_code, speed));
      ...
      if (GET_MODE_CLASS(mode) == MODE_INT &&
        ...
        if (GET_CODE(XEXP(x, 0)) == PLUS &&
          ...
          if (val == 2 || val == 4 || val == 8) {
            ...
            *total += rtx_cost(XEXP(XEXP(XEXP(x, 0), 0), 0), outer_code, speed);
    ...
    case COMPARE:
      if (GET_CODE(XEXP(x, 0)) == ZERO_EXTRACT &&
          ...
          CONST_INT_P(XEXP(XEXP(x, 0), 2)) && XEXP(x, 1) == const0_rtx) {
        /* This kind of construct is implemented using test[bwl].
           Treat it as if we had an AND.  */
        *total = (cost->add + rtx_cost(XEXP(XEXP(x, 0), 0), outer_code, speed) +
...
void machopic_output_stub(FILE *file, const char *symb, const char *stub) {
  unsigned int length;
...
void x86_order_regs_for_local_alloc(void) {
  int pos = 0;
  int i;
...
static tree ix86_handle_abi_attribute(tree *node, tree name,
...
/* Handle a "ms_struct" or "gcc_struct" attribute; arguments as in
   struct attribute_spec.handler.  */
static tree ix86_handle_struct_attribute(tree *node, tree name,
                                         tree args ATTRIBUTE_UNUSED,
                                         int flags ATTRIBUTE_UNUSED,
                                         bool *no_add_attrs) {
  tree *type = NULL;
...
static bool ix86_ms_bitfield_layout_p(const_tree record_type) {
...
static rtx x86_this_parameter(tree function) {
...
static bool x86_can_output_mi_thunk(const_tree thunk ATTRIBUTE_UNUSED,
...
static void x86_output_mi_thunk(FILE *file ATTRIBUTE_UNUSED,
  ...
  if (vcall_offset) {
    if (TARGET_64BIT)
      ...
      if (lookup_attribute("fastcall", TYPE_ATTRIBUTES(TREE_TYPE(function))))
        tmp_regno = AX_REG;
...
int x86_field_alignment(tree field, int computed) {
  enum machine_mode mode;
  ...
  if (mode == DFmode || mode == DCmode || GET_MODE_CLASS(mode) == MODE_INT ||
...
void x86_function_profiler(FILE *file, int labelno ATTRIBUTE_UNUSED) {
  if (TARGET_64BIT) {
...
static int min_insn_size(rtx insn) {
  int l = 0;
  ...
  if (GET_CODE(PATTERN(insn)) == UNSPEC_VOLATILE &&
    ...
    return 0;
  if (JUMP_P(insn) && (GET_CODE(PATTERN(insn)) == ADDR_VEC ||
                       GET_CODE(PATTERN(insn)) == ADDR_DIFF_VEC))
    return 0;

  /* Important case - calls are always 5 bytes.
     It is common to have many calls in the row.  */
  if (CALL_P(insn) && symbolic_reference_mentioned_p(PATTERN(insn)) &&
      !SIBLING_CALL_P(insn))
    return 5;
...
static void ix86_avoid_jump_misspredicts(void) {
  ...
  for (insn = get_insns(); insn; insn = NEXT_INSN(insn)) {
    ...
    while (njumps > 3) {
      ...
      if ((JUMP_P(start) && GET_CODE(PATTERN(start)) != ADDR_VEC &&
...
static void ix86_pad_returns(void) {
  edge e;
  edge_iterator ei;
  ...
  FOR_EACH_EDGE(e, ei, EXIT_BLOCK_PTR->preds) {
    ...
    if (!replace) {
      ...
      if (prev && ((JUMP_P(prev) && any_condjump_p(prev)) || CALL_P(prev)))
        replace = true;
...
static void ix86_reorg(void) {
  if (TARGET_PAD_RETURNS && optimize && optimize_function_for_speed_p(cfun))
    ix86_pad_returns();
  if (TARGET_FOUR_JUMP_LIMIT && optimize && optimize_function_for_speed_p(cfun))
    ix86_avoid_jump_misspredicts();
}

/* Return nonzero when QImode register that must be represented via REX prefix
   is used.  */
bool x86_extended_QIreg_mentioned_p(rtx insn) {
  int i;
  extract_insn_cached(insn);
  for (i = 0; i < recog_data.n_operands; i++)
    if (REG_P(recog_data.operand[i]) && REGNO(recog_data.operand[i]) > BX_REG)
      return true;
  return false;
}
...
static int extended_reg_mentioned_1(rtx *p, void *data ATTRIBUTE_UNUSED) {
  unsigned int regno;
  if (!REG_P(*p))
    return 0;
  regno = REGNO(*p);
...
/* Return true when INSN mentions register that must be encoded using REX
   prefix.  */
bool x86_extended_reg_mentioned_p(rtx insn) {
...
void x86_emit_floatuns(rtx operands[2]) {
  ...
  i0 = expand_simple_binop(inmode, LSHIFTRT, in, const1_rtx, NULL, 1,
                           OPTAB_DIRECT);
  i1 = expand_simple_binop(inmode, AND, in, const1_rtx, NULL, 1, OPTAB_DIRECT);
...
static bool ix86_expand_vector_init_duplicate(bool mmx_ok,
                                              enum machine_mode mode,
                                              rtx target, rtx val) {
  ...
  switch (mode) {
    ...
    case V8HImode:
      if (TARGET_SSE2) {
        ...
        tmp1 =
            gen_rtx_VEC_MERGE(V4SImode, gen_rtx_VEC_DUPLICATE(V4SImode, tmp1),
                              CONST0_RTX(V4SImode), const1_rtx);
    ...
    widen:
      ...
      x = expand_simple_binop(wsmode, ASHIFT, val,
                              GEN_INT(GET_MODE_BITSIZE(smode)), NULL_RTX, 1,
                              OPTAB_LIB_WIDEN);
    ...
    half : {
      ...
      emit_insn(
          gen_rtx_SET(VOIDmode, target, gen_rtx_VEC_CONCAT(mode, tmp, tmp)));
    }
      return true;
...
static bool ix86_expand_vector_init_one_nonzero(bool mmx_ok,
  ...
  switch (mode) {
    case V2DImode:
      ...
      use_vector_set = (TARGET_64BIT && TARGET_SSE4_1 &&
                        !(TARGET_INTER_UNIT_MOVES && one_var == 0));
      break;
    case V16QImode:
    case V4SImode:
    case V4SFmode:
  ...
  switch (mode) {
    ...
    case V4SImode:
      ...
      if (one_var != 0) {
        ...
        if (mode != V4SFmode && TARGET_SSE2) {
          emit_insn(gen_sse2_pshufd_1(
              new_target, new_target, GEN_INT(1), GEN_INT(one_var == 1 ? 0 : 1),
              GEN_INT(one_var == 2 ? 0 : 1), GEN_INT(one_var == 3 ? 0 : 1)));
        ...
        emit_insn(gen_sse_shufps_v4sf(tmp, tmp, tmp, GEN_INT(1),
    ...
    widen:
      ...
      if (!ix86_expand_vector_init_one_nonzero(mmx_ok, vsimode, x, var,
                                               one_var))
        gcc_unreachable();
...
static bool ix86_expand_vector_init_one_var(bool mmx_ok, enum machine_mode mode,
  ...
  switch (mode) {
    ...
    widen:
      ...
      if (one_var & 1) {
        ...
        var = expand_simple_binop(HImode, ASHIFT, var, GEN_INT(8), NULL_RTX, 1,
                                  OPTAB_LIB_WIDEN);
      ...
      if (x != const0_rtx)
        var = expand_simple_binop(HImode, IOR, var, x, var, 1, OPTAB_LIB_WIDEN);
...
static void ix86_expand_vector_init_concat(enum machine_mode mode, rtx target,
                                           rtx *ops, int n) {
  ...
  switch (n) {
    case 2:
      ...
      emit_insn(gen_rtx_SET(VOIDmode, target,
                            gen_rtx_VEC_CONCAT(mode, ops[0], ops[1])));
      break;
    ...
    half:
      ...
      for (; i > 0; i -= 2, j--) {
        ...
        ix86_expand_vector_init(false, first[j], gen_rtx_PARALLEL(cmode, v));
      }
      ...
      if (n > 2) {
        ...
        for (i = j = 0; i < n; i += 2, j++) {
          ...
          ix86_expand_vector_init_concat(hmode, second[j], &first[i], 2);
        }
        n >>= 1;
...
static void ix86_expand_vector_init_interleave(enum machine_mode mode,
  ...
  for (i = 0; i < n; i++) {
    ...
    op0 = gen_rtx_VEC_MERGE(V4SImode, gen_rtx_VEC_DUPLICATE(V4SImode, op0),
                            CONST0_RTX(V4SImode), const1_rtx);
    ...
    emit_insn((*gen_load_even)(op0, force_reg(inner_mode, ops[i + i + 1]),
                               const1_rtx));
  ...
  switch (second_imode) {
    case V4SImode:
      for (i = j = 0; i < n / 2; i += 2, j++) {
        ...
        emit_insn((*gen_interleave_second_low)(op0, ops[i], ops[i + 1]));
    ...
    case V2DImode:
      op0 = gen_reg_rtx(second_imode);
      emit_insn((*gen_interleave_second_low)(op0, ops[0], ops[1]));

      /* Cast the SECOND_IMODE vector back to a vector on original
         mode.  */
      emit_insn(gen_rtx_SET(VOIDmode, target, gen_lowpart(mode, op0)));
      break;
...
static void ix86_expand_vector_init_general(bool mmx_ok, enum machine_mode mode,
                                            rtx target, rtx vals) {
  rtx ops[32], op0, op1;
  ...
  switch (mode) {
    ...
    half:
      ...
      ix86_expand_vector_init_interleave(half_mode, op0, ops, n >> 2);
      ix86_expand_vector_init_interleave(half_mode, op1, &ops[n >> 1], n >> 2);
      emit_insn(
          gen_rtx_SET(VOIDmode, target, gen_rtx_VEC_CONCAT(mode, op0, op1)));
      return;
    ...
    for (i = 0; i < n_words; ++i) {
      ...
      for (j = 0; j < n_elt_per_word; ++j) {
        ...
        if (j == 0)
          ...
          word = expand_simple_binop(word_mode, ASHIFT, word, shift, word, 1,
                                     OPTAB_LIB_WIDEN);
          word = expand_simple_binop(word_mode, IOR, word, elt, word, 1,
                                     OPTAB_LIB_WIDEN);
        }
      }
...
void ix86_expand_vector_init(bool mmx_ok, rtx target, rtx vals) {
  ...
  if (all_same && ix86_expand_vector_init_duplicate(mmx_ok, mode, target,
                                                    XVECEXP(vals, 0, 0)))
    return;
  ...
  if (n_var == 1) {
    if (all_const_zero &&
        ix86_expand_vector_init_one_nonzero(mmx_ok, mode, target,
                                            XVECEXP(vals, 0, one_var), one_var))
      return;
...
void ix86_expand_vector_set(bool mmx_ok, rtx target, rtx val, int elt) {
  enum machine_mode mode = GET_MODE(target);
  enum machine_mode inner_mode = GET_MODE_INNER(mode);
  ...
  switch (mode) {
    ...
    case V4SFmode:
      ...
      switch (elt) {
        ...
        case 1:
          ...
          /* target = A X C D  */
          emit_insn(gen_sse_shufps_v4sf(target, target, tmp, GEN_INT(1),
                                        GEN_INT(0), GEN_INT(2 + 4),
                                        GEN_INT(3 + 4)));
          return;
        ...
        case 2:
          ...
          /* target = A B X D */
          emit_insn(gen_sse_shufps_v4sf(target, target, tmp, GEN_INT(0),
                                        GEN_INT(1), GEN_INT(0 + 4),
                                        GEN_INT(3 + 4)));
          return;
    ...
    case V4SImode:
      ...
      if (TARGET_SSE2) {
        ...
        emit_insn(gen_sse2_pshufd_1(target, target, order[0], order[1],
                                    order[2], order[3]));
...
void ix86_expand_vector_extract(bool mmx_ok, rtx target, rtx vec, int elt) {
  ...
  switch (mode) {
    ...
    case V4SFmode:
      ...
      switch (elt) {
        ...
        case 3:
          tmp = gen_reg_rtx(mode);
          emit_insn(gen_sse_shufps_v4sf(tmp, vec, vec, GEN_INT(elt),
                                        GEN_INT(elt), GEN_INT(elt + 4),
                                        GEN_INT(elt + 4)));
          break;
    ...
    case V4SImode:
      ...
      if (TARGET_SSE2) {
        switch (elt) {
          ...
          case 3:
            tmp = gen_reg_rtx(mode);
            emit_insn(gen_sse2_pshufd_1(tmp, vec, GEN_INT(elt), GEN_INT(elt),
...
void ix86_expand_reduc_v4sf(rtx (*fn)(rtx, rtx, rtx), rtx dest, rtx in) {
  rtx tmp1, tmp2, tmp3;
  ...
  emit_insn(gen_sse_shufps_v4sf(tmp3, tmp2, tmp2, GEN_INT(1), GEN_INT(1),
                                GEN_INT(1 + 4), GEN_INT(1 + 4)));
  emit_insn(fn(dest, tmp2, tmp3));
}

/* Target hook for scalar_mode_supported_p.  */
static bool ix86_scalar_mode_supported_p(enum machine_mode mode) {
...
static bool ix86_vector_mode_supported_p(enum machine_mode mode) {
...
static enum machine_mode ix86_c_mode_for_suffix(char suffix) {
  if (suffix == 'q')
    return TFmode;
  if (suffix == 'w')
    return XFmode;
...
static tree ix86_md_asm_clobbers(tree outputs ATTRIBUTE_UNUSED,
                                 tree inputs ATTRIBUTE_UNUSED, tree clobbers) {
...
static void ATTRIBUTE_UNUSED ix86_encode_section_info(tree decl, rtx rtl,
                                                      int first) {
  default_encode_section_info(decl, rtl, first);

  if (TREE_CODE(decl) == VAR_DECL &&
      (TREE_STATIC(decl) || DECL_EXTERNAL(decl)) && ix86_in_large_data_p(decl))
    SYMBOL_REF_FLAGS(XEXP(rtl, 0)) |= SYMBOL_FLAG_FAR_ADDR;
}

/* Worker function for REVERSE_CONDITION.  */

enum rtx_code ix86_reverse_condition(enum rtx_code code,
                                     enum machine_mode mode) {
...
const char *output_387_reg_move(rtx insn, rtx *operands) {
  if (REG_P(operands[0])) {
    if (REG_P(operands[1]) &&
...
void ix86_emit_fp_unordered_jump(rtx label) {
  rtx reg = gen_reg_rtx(HImode);
  rtx temp;
...
void ix86_emit_i387_log1p(rtx op0, rtx op1) {
  ...
  emit_insn(gen_cmpxf(
      tmp, CONST_DOUBLE_FROM_REAL_VALUE(
...
void ix86_emit_swdivsf(rtx res, rtx a, rtx b, enum machine_mode mode) {
  ...
  emit_insn(gen_rtx_SET(VOIDmode, x0,
                        gen_rtx_UNSPEC(mode, gen_rtvec(1, b), UNSPEC_RCP)));
  /* e0 = x0 * b */
  emit_insn(gen_rtx_SET(VOIDmode, e0, gen_rtx_MULT(mode, x0, b)));
  /* e1 = 2. - e0 */
  emit_insn(gen_rtx_SET(VOIDmode, e1, gen_rtx_MINUS(mode, two, e0)));
  /* x1 = x0 * e1 */
  emit_insn(gen_rtx_SET(VOIDmode, x1, gen_rtx_MULT(mode, x0, e1)));
  /* res = a * x1 */
  emit_insn(gen_rtx_SET(VOIDmode, res, gen_rtx_MULT(mode, a, x1)));
}

/* Output code to perform a Newton-Rhapson approximation of a
   single precision floating point [reciprocal] square root.  */

void ix86_emit_swsqrtsf(rtx res, rtx a, enum machine_mode mode, bool recip) {
  ...
  /* x0 = rsqrt(a) estimate */
  emit_insn(gen_rtx_SET(VOIDmode, x0,
                        gen_rtx_UNSPEC(mode, gen_rtvec(1, a), UNSPEC_RSQRT)));
  ...
  if (!recip) {
    ...
    emit_insn(gen_rtx_SET(VOIDmode, mask, gen_rtx_NE(mode, zero, a)));

    emit_insn(gen_rtx_SET(VOIDmode, x0, gen_rtx_AND(mode, x0, mask)));
  }

  /* e0 = x0 * a */
  emit_insn(gen_rtx_SET(VOIDmode, e0, gen_rtx_MULT(mode, x0, a)));
  /* e1 = e0 * x0 */
  emit_insn(gen_rtx_SET(VOIDmode, e1, gen_rtx_MULT(mode, e0, x0)));

  /* e2 = e1 - 3. */
  mthree = force_reg(mode, mthree);
  emit_insn(gen_rtx_SET(VOIDmode, e2, gen_rtx_PLUS(mode, e1, mthree)));

  mhalf = force_reg(mode, mhalf);
  if (recip)
    /* e3 = -.5 * x0 */
    emit_insn(gen_rtx_SET(VOIDmode, e3, gen_rtx_MULT(mode, x0, mhalf)));
  else
    /* e3 = -.5 * e0 */
    emit_insn(gen_rtx_SET(VOIDmode, e3, gen_rtx_MULT(mode, e0, mhalf)));
  /* ret = e2 * e3 */
  emit_insn(gen_rtx_SET(VOIDmode, res, gen_rtx_MULT(mode, e2, e3)));
}

/* Solaris implementation of TARGET_ASM_NAMED_SECTION.  */

static void ATTRIBUTE_UNUSED i386_solaris_elf_named_section(const char *name,
                                                            unsigned int flags,
                                                            tree decl) {
  /* With Binutils 2.15, the "@unwind" marker must be specified on
     every occurrence of the ".eh_frame" section, not just the first
     one.  */
  if (TARGET_64BIT && strcmp(name, ".eh_frame") == 0) {
...
static const char *ix86_mangle_type(const_tree type) {
...
static tree ix86_stack_protect_fail(void) {
  return TARGET_64BIT ? default_external_stack_protect_fail()
...
int asm_preferred_eh_data_format(int code, int global) {
  if (flag_pic) {
    int type = DW_EH_PE_sdata8;
    if (!TARGET_64BIT || ix86_cmodel == CM_SMALL_PIC ||
        (ix86_cmodel == CM_MEDIUM_PIC && (global || code)))
      type = DW_EH_PE_sdata4;
    return (global ? DW_EH_PE_indirect : 0) | DW_EH_PE_pcrel | type;
  }
  if (ix86_cmodel == CM_SMALL || (ix86_cmodel == CM_MEDIUM && code))
...
/* Expand copysign from SIGN to the positive value ABS_VALUE
   ...
   the sign-bit.  */
static void ix86_sse_copysign_to_positive(rtx result, rtx abs_value, rtx sign,
                                          rtx mask) {
  ...
  emit_insn(gen_rtx_SET(VOIDmode, sgn, gen_rtx_AND(mode, mask, sign)));
  emit_insn(gen_rtx_SET(VOIDmode, result, gen_rtx_IOR(mode, abs_value, sgn)));
}
...
static rtx ix86_expand_sse_fabs(rtx op0, rtx *smask) {
  ...
  emit_insn(gen_rtx_SET(VOIDmode, xa, gen_rtx_AND(mode, op0, mask)));
...
static rtx ix86_expand_sse_compare_and_jump(enum rtx_code code, rtx op0,
  ...
  emit_insn(gen_rtx_SET(VOIDmode, tmp, gen_rtx_COMPARE(CCFPUmode, op0, op1)));
  tmp = gen_rtx_fmt_ee(code, VOIDmode, tmp, const0_rtx);
  tmp = gen_rtx_IF_THEN_ELSE(VOIDmode, tmp, gen_rtx_LABEL_REF(VOIDmode, label),
                             pc_rtx);
  tmp = emit_jump_insn(gen_rtx_SET(VOIDmode, pc_rtx, tmp));
...
static rtx ix86_expand_sse_compare_mask(enum rtx_code code, rtx op0, rtx op1,
                                        bool swap_operands) {
  enum machine_mode mode = GET_MODE(op0);
...
static rtx ix86_gen_TWO52(enum machine_mode mode) {
...
/* Expand SSE sequence for computing lround from OP1 storing
   into OP0.  */
void ix86_expand_lround(rtx op0, rtx op1) {
...
/* Expand SSE2 sequence for computing lround from OPERAND1 storing
   into OPERAND0.  */
void ix86_expand_lfloorceil(rtx op0, rtx op1, bool do_floor) {
  ...
  label = ix86_expand_sse_compare_and_jump(UNLE, freg, op1, !do_floor);
  tmp = expand_simple_binop(imode, do_floor ? MINUS : PLUS, ireg, const1_rtx,
...
/* Expand rint (IEEE round to nearest) rounding OPERAND1 and storing the
   result in OPERAND0.  */
void ix86_expand_rint(rtx operand0, rtx operand1) {
  /* C code for the stuff we're doing below:
        xa = fabs (operand1);
        if (!isless (xa, 2**52))
          return operand1;
...
/* Expand SSE2 sequence for computing floor or ceil from OPERAND1 storing
   into OPERAND0.  */
void ix86_expand_floorceildf_32(rtx operand0, rtx operand1, bool do_floor) {
  ...
  /* generate 1.0 or -1.0 */
  one = force_reg(
      mode, const_double_from_real_value(do_floor ? dconst1 : dconstm1, mode));

  /* Compensate: xa = xa - (xa > operand1 ? 1 : 0) */
  tmp = ix86_expand_sse_compare_mask(UNGT, xa, res, !do_floor);
  emit_insn(gen_rtx_SET(VOIDmode, tmp, gen_rtx_AND(mode, one, tmp)));
  /* We always need to subtract here to preserve signed zero.  */
  tmp = expand_simple_binop(mode, MINUS, xa, tmp, NULL_RTX, 0, OPTAB_DIRECT);
...
/* Expand SSE2 sequence for computing floor or ceil from OPERAND1 storing
   into OPERAND0.  */
void ix86_expand_floorceil(rtx operand0, rtx operand1, bool do_floor) {
  /* C code for the stuff we expand below.
        double xa = fabs (x), x2;
        if (!isless (xa, TWO52))
          return x;
  ...
  tmp = ix86_expand_sse_compare_mask(UNGT, xa, res, !do_floor);
  emit_insn(gen_rtx_SET(VOIDmode, tmp, gen_rtx_AND(mode, one, tmp)));
  tmp = expand_simple_binop(mode, do_floor ? MINUS : PLUS, xa, tmp, NULL_RTX, 0,
                            OPTAB_DIRECT);
  emit_move_insn(res, tmp);
...
void ix86_expand_rounddf_32(rtx operand0, rtx operand1) {
  /* C code for the stuff we expand below.
  ...
  mhalf =
      expand_simple_binop(mode, MINUS, half, one, NULL_RTX, 0, OPTAB_DIRECT);
...
/* Expand SSE sequence for computing trunc from OPERAND1 storing
   into OPERAND0.  */
void ix86_expand_trunc(rtx operand0, rtx operand1) {
...
/* Expand SSE sequence for computing trunc from OPERAND1 storing
   into OPERAND0.  */
void ix86_expand_truncdf_32(rtx operand0, rtx operand1) {
  enum machine_mode mode = GET_MODE(operand0);
  ...
  emit_insn(gen_rtx_SET(VOIDmode, mask, gen_rtx_AND(mode, mask, one)));
  tmp = expand_simple_binop(mode, MINUS, res, mask, NULL_RTX, 0, OPTAB_DIRECT);
  emit_move_insn(res, tmp);
...
/* Expand SSE sequence for computing round from OPERAND1 storing
   into OPERAND0.  */
void ix86_expand_round(rtx operand0, rtx operand1) {
  /* C code for the stuff we're doing below:
        double xa = fabs (x);
        if (!isless (xa, TWO52))
          return x;
...
bool ix86_sse5_valid_op_p(rtx operands[], rtx insn ATTRIBUTE_UNUSED, int num,
  ...
  for (i = 0; i < num; i++) {
    ...
    if (register_operand(operands[i], mode))
      ...
      if (GET_CODE(pattern) != SET ||
          GET_CODE(SET_SRC(pattern)) != IF_THEN_ELSE || i < 2 ||
  ...
  /* Don't allow more than one memory operation if not optimizing.  */
    ...
    if (reg_mentioned_p(op0, operands[1]) ||
        reg_mentioned_p(op0, operands[2]) || reg_mentioned_p(op0, operands[3]))
      return false;
...
void ix86_expand_sse5_multiple_memory(rtx operands[], int num,
                                      enum machine_mode mode) {
  rtx op0 = operands[0];
  if (num != 4 || memory_operand(op0, mode) ||
      reg_mentioned_p(op0, operands[1]) || reg_mentioned_p(op0, operands[2]) ||
...
static const struct attribute_spec ix86_attribute_table[] = {
     ...
     */
    {(const char *)&ix86_force_align_arg_pointer_string, 0, 0, false, true,
     true, ix86_handle_cconv_attribute},
#if TARGET_DLLIMPORT_DECL_ATTRIBUTES
...
static int x86_builtin_vectorization_cost(bool runtime_test) {
...
tree ix86_fn_abi_va_list(tree fndecl) {
  int abi;
...
tree ix86_canonical_va_list_type(tree type) {
  tree wtype, htype;
  ...
  if (TARGET_64BIT) {
    ...
    if (TREE_CODE(wtype) == ARRAY_TYPE) {
      /* If va_list is an array type, the argument may have decayed
         ...
         underlying records.  */
      if (TREE_CODE(htype) == ARRAY_TYPE || POINTER_TYPE_P(htype)) {
...
int ix86_enum_va_list(int idx, const char **pname, tree *ptree) {
  if (!TARGET_64BIT)
    return 0;
  switch (idx) {
    case 0:
