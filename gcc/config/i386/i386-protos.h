...
extern void ix86_fixup_binary_operands_no_copy(enum rtx_code, enum machine_mode,
                                               rtx[]);
extern void ix86_expand_binary_operator(enum rtx_code, enum machine_mode,
                                        rtx[]);
...
extern bool ix86_cannot_change_mode_class(enum machine_mode, enum machine_mode,
                                          enum reg_class);
...
extern unsigned int ix86_local_alignment(tree, enum machine_mode, unsigned int);
...
extern void x86_elf_aligned_common(FILE *, const char *, unsigned HOST_WIDE_INT,
                                   int);
