...
static void ix86_target_macros_internal(int, enum processor_type,
                                        enum processor_type, enum fpmath_unit,
...
static void ix86_target_macros_internal(
    int isa_flag, enum processor_type arch, enum processor_type tune,
    enum fpmath_unit fpmath, void (*def_or_undef)(cpp_reader *, const char *)) {
...
static bool ix86_pragma_target_parse(tree args, tree pop_target) {
  ...
  ix86_target_macros_internal(prev_isa & diff_isa, prev_arch, prev_tune,
                              prev_opt->fpmath, cpp_undef);

  /* Define all of the macros for new options that were just turned on.  */
  ix86_target_macros_internal(cur_isa & diff_isa, cur_arch, cur_tune,
                              cur_opt->fpmath, cpp_define);
...
void ix86_target_macros(void) {
  ...
  ix86_target_macros_internal(ix86_isa_flags, ix86_arch, ix86_tune, ix86_fpmath,
                              cpp_define);
}
...
void ix86_register_pragmas(void) {
