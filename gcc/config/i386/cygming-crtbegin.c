...
void __gcc_register_frame(void) {
  ...
  if (h)
    register_frame_fn = (void (*)(const void *, struct object *))GetProcAddress(
        h, "__register_frame_info");
  else
  ...
  if (__JCR_LIST__[0]) {
    ...
    if (h)
      register_class_fn =
          (void (*)(const void *))GetProcAddress(h, "_Jv_RegisterClasses");
    else
...
void __gcc_deregister_frame(void) {
  ...
  if (h)
    deregister_frame_fn =
        (void *(*)(const void *))GetProcAddress(h, "__deregister_frame_info");
  else
