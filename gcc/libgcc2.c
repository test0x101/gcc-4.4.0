...
#ifdef L_cmpdi2
cmp_return_type __cmpdi2(DWtype a, DWtype b) {
...
#if defined(L_mulsc3) || defined(L_muldc3) || defined(L_mulxc3) || \
    defined(L_multc3)
...
#if defined(L_divsc3) || defined(L_divdc3) || defined(L_divxc3) || \
    defined(L_divtc3)
...
void __clear_cache(char *beg __attribute__((__unused__)),
