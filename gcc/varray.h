...
typedef union varray_data_tag GTY(()) {
  char GTY((length("%0.num_elements"), tag("VARRAY_DATA_C"))) vdt_c[1];
  unsigned char GTY((length("%0.num_elements"),
                     tag("VARRAY_DATA_UC"))) vdt_uc[1];
  short GTY((length("%0.num_elements"), tag("VARRAY_DATA_S"))) vdt_s[1];
  unsigned short GTY((length("%0.num_elements"),
                      tag("VARRAY_DATA_US"))) vdt_us[1];
  int GTY((length("%0.num_elements"), tag("VARRAY_DATA_I"))) vdt_i[1];
  unsigned int GTY((length("%0.num_elements"), tag("VARRAY_DATA_U"))) vdt_u[1];
  long GTY((length("%0.num_elements"), tag("VARRAY_DATA_L"))) vdt_l[1];
  ...
  char *GTY((length("%0.num_elements"), tag("VARRAY_DATA_CPTR"))) vdt_cptr[1];
  rtx GTY((length("%0.num_elements"), tag("VARRAY_DATA_RTX"))) vdt_rtx[1];
  rtvec GTY((length("%0.num_elements"), tag("VARRAY_DATA_RTVEC"))) vdt_rtvec[1];
  tree GTY((length("%0.num_elements"), tag("VARRAY_DATA_TREE"))) vdt_tree[1];
...
extern void varray_underflow(varray_type, const char *, int,
                             const char *) ATTRIBUTE_NORETURN;
