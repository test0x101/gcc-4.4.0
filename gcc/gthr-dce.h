...
__gthrw(pthread_once) __gthrw(pthread_keycreate) __gthrw(pthread_getspecific)
    __gthrw(pthread_setspecific) __gthrw(pthread_create)
        __gthrw(pthread_mutex_init) __gthrw(pthread_mutex_destroy)
            __gthrw(pthread_mutex_lock) __gthrw(pthread_mutex_trylock)
                __gthrw(pthread_mutex_unlock) __gthrw(pthread_mutexattr_create)
                    __gthrw(pthread_mutexattr_setkind_np)
                        __gthrw(pthread_mutexattr_delete)

#ifdef _LIBOBJC
    /* Objective-C.  */
    __gthrw(pthread_cond_broadcast) __gthrw(pthread_cond_destroy)
        __gthrw(pthread_cond_init) __gthrw(pthread_cond_signal)
            __gthrw(pthread_cond_wait) __gthrw(pthread_exit)
...
#define __gthrw_pthread_getunique_np __gthrw_(pthread_getunique_np)
                ...
                __gthrw(pthread_mutex_destroy) __gthrw(pthread_self)
...
static inline int __gthread_objc_condition_allocate(
    objc_condition_t condition __attribute__((__unused__))) {
  if (__gthread_active_p())
    /* Unimplemented.  */
    return -1;
  else
...
static inline int __gthread_mutx_destroy(__gthread_mutex_t *__mutex) {
  if (__gthread_active_p())
...
static inline int __gthread_recursive_mutex_init_function(
  ...
  if (__gthread_active_p()) {
    ...
    if (!__r)
      __r = __gthrw_(pthread_mutexattr_setkind_np)(&__attr, MUTEX_RECURSIVE_NP);
    if (!__r)
