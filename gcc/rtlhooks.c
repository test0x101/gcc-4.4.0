...
rtx gen_lowpart_general(enum machine_mode mode, rtx x) {
...
rtx gen_lowpart_no_emit_general(enum machine_mode mode, rtx x) {
...
rtx reg_num_sign_bit_copies_general(
    const_rtx x ATTRIBUTE_UNUSED, enum machine_mode mode ATTRIBUTE_UNUSED,
...
rtx reg_nonzero_bits_general(const_rtx x ATTRIBUTE_UNUSED,
...
bool reg_truncated_to_mode_general(enum machine_mode mode ATTRIBUTE_UNUSED,
