...
#define GCOV_COUNTER_NAMES                                                     \
  {                                                                            \
    "arcs", "interval", "pow2", "single", "delta", "indirect_call", "average", \
        "ior"                                                                  \
  }
...
#define GCOV_MERGE_FUNCTIONS                                                \
  {                                                                         \
    "__gcov_merge_add", "__gcov_merge_add", "__gcov_merge_add",             \
        "__gcov_merge_single", "__gcov_merge_delta", "__gcov_merge_single", \
...
extern int __gcov_execve(const char *, char *const[],
