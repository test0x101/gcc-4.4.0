...
__gthrw(thr_keycreate) __gthrw(thr_getspecific) __gthrw(thr_setspecific)
    __gthrw(thr_create) __gthrw(thr_self)

        __gthrw(mutex_init) __gthrw(mutex_destroy) __gthrw(mutex_lock)
            __gthrw(mutex_trylock) __gthrw(mutex_unlock)
#ifdef _LIBOBJC
                __gthrw(thr_exit) __gthrw(thr_getprio) __gthrw(thr_setprio)
                    __gthrw(thr_yield)

                        __gthrw(cond_init) __gthrw(cond_destroy)
                            __gthrw(cond_wait) __gthrw(cond_broadcast)
                                __gthrw(cond_signal)
...
static inline int __gthread_key_delete(__gthread_key_t UNUSED(__key)) {
  /* Not possible.  */
  return -1;
}
...
static inline int __gthread_mutex_destroy(__gthread_mutex_t *UNUSED(__mutex)) {
  if (__gthread_active_p())
