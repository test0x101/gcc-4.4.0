...
static const char *const optabs[] = {
    "convert_optab_handler (sext_optab, $B, $A)->insn_code = "
    "CODE_FOR_$(extend$a$b2$)",
    "convert_optab_handler (zext_optab, $B, $A)->insn_code = "
    "CODE_FOR_$(zero_extend$a$b2$)",
    "convert_optab_handler (sfix_optab, $B, $A)->insn_code = "
    "CODE_FOR_$(fix$F$a$I$b2$)",
    "convert_optab_handler (ufix_optab, $B, $A)->insn_code = "
    "CODE_FOR_$(fixuns$F$a$b2$)",
    "convert_optab_handler (sfixtrunc_optab, $B, $A)->insn_code = "
    "CODE_FOR_$(fix_trunc$F$a$I$b2$)",
    "convert_optab_handler (ufixtrunc_optab, $B, $A)->insn_code = "
    "CODE_FOR_$(fixuns_trunc$F$a$I$b2$)",
    "convert_optab_handler (sfloat_optab, $B, $A)->insn_code = "
    "CODE_FOR_$(float$I$a$F$b2$)",
    "convert_optab_handler (ufloat_optab, $B, $A)->insn_code = "
    "CODE_FOR_$(floatuns$I$a$F$b2$)",
    "convert_optab_handler (trunc_optab, $B, $A)->insn_code = "
    "CODE_FOR_$(trunc$a$b2$)",
    "convert_optab_handler (fract_optab, $B, $A)->insn_code = "
    "CODE_FOR_$(fract$a$b2$)",
    "convert_optab_handler (fractuns_optab, $B, $A)->insn_code = "
    "CODE_FOR_$(fractuns$I$a$Q$b2$)",
    "convert_optab_handler (fractuns_optab, $B, $A)->insn_code = "
    "CODE_FOR_$(fractuns$Q$a$I$b2$)",
    "convert_optab_handler (satfract_optab, $B, $A)->insn_code = "
    "CODE_FOR_$(satfract$a$Q$b2$)",
    "convert_optab_handler (satfractuns_optab, $B, $A)->insn_code = "
    ...
    "optab_handler (umul_highpart_optab, $A)->insn_code = "
    "CODE_FOR_$(umul$a3_highpart$)",
    "optab_handler (smul_highpart_optab, $A)->insn_code = "
    "CODE_FOR_$(smul$a3_highpart$)",
    "optab_handler (smul_widen_optab, $B)->insn_code = CODE_FOR_$(mul$a$b3$)$N",
    "optab_handler (umul_widen_optab, $B)->insn_code = "
    "CODE_FOR_$(umul$a$b3$)$N",
    "optab_handler (usmul_widen_optab, $B)->insn_code = "
    "CODE_FOR_$(usmul$a$b3$)$N",
    "optab_handler (smadd_widen_optab, $B)->insn_code = "
    "CODE_FOR_$(madd$a$b4$)$N",
    "optab_handler (umadd_widen_optab, $B)->insn_code = "
    "CODE_FOR_$(umadd$a$b4$)$N",
    "optab_handler (ssmadd_widen_optab, $B)->insn_code = "
    "CODE_FOR_$(ssmadd$a$b4$)$N",
    "optab_handler (usmadd_widen_optab, $B)->insn_code = "
    "CODE_FOR_$(usmadd$a$b4$)$N",
    "optab_handler (smsub_widen_optab, $B)->insn_code = "
    "CODE_FOR_$(msub$a$b4$)$N",
    "optab_handler (umsub_widen_optab, $B)->insn_code = "
    "CODE_FOR_$(umsub$a$b4$)$N",
    "optab_handler (ssmsub_widen_optab, $B)->insn_code = "
    "CODE_FOR_$(ssmsub$a$b4$)$N",
    "optab_handler (usmsub_widen_optab, $B)->insn_code = "
    "CODE_FOR_$(usmsub$a$b4$)$N",
    ...
    "optab_handler (remainder_optab, $A)->insn_code = "
    "CODE_FOR_$(remainder$a3$)",
    ...
    "optab_handler (copysign_optab, $A)->insn_code = "
    "CODE_FOR_$(copysign$F$a3$)",
    ...
    "convert_optab_handler (lfloor_optab, $B, $A)->insn_code = "
    "CODE_FOR_$(lfloor$F$a$I$b2$)",
    "optab_handler (ceil_optab, $A)->insn_code = CODE_FOR_$(ceil$a2$)",
    "convert_optab_handler (lceil_optab, $B, $A)->insn_code = "
    "CODE_FOR_$(lceil$F$a$I$b2$)",
    "optab_handler (round_optab, $A)->insn_code = CODE_FOR_$(round$a2$)",
    "optab_handler (btrunc_optab, $A)->insn_code = CODE_FOR_$(btrunc$a2$)",
    "optab_handler (nearbyint_optab, $A)->insn_code = "
    "CODE_FOR_$(nearbyint$a2$)",
    "optab_handler (rint_optab, $A)->insn_code = CODE_FOR_$(rint$a2$)",
    "convert_optab_handler (lrint_optab, $B, $A)->insn_code = "
    "CODE_FOR_$(lrint$F$a$I$b2$)",
    "convert_optab_handler (lround_optab, $B, $A)->insn_code = "
    "CODE_FOR_$(lround$F$a$I$b2$)",
    ...
    "optab_handler (movmisalign_optab, $A)->insn_code = "
    "CODE_FOR_$(movmisalign$a$)",
    ...
    "optab_handler (vec_extract_optab, $A)->insn_code = "
    "CODE_FOR_$(vec_extract$a$)",
    "optab_handler (vec_extract_even_optab, $A)->insn_code = "
    "CODE_FOR_$(vec_extract_even$a$)",
    "optab_handler (vec_extract_odd_optab, $A)->insn_code = "
    "CODE_FOR_$(vec_extract_odd$a$)",
    "optab_handler (vec_interleave_high_optab, $A)->insn_code = "
    "CODE_FOR_$(vec_interleave_high$a$)",
    "optab_handler (vec_interleave_low_optab, $A)->insn_code = "
    "CODE_FOR_$(vec_interleave_low$a$)",
    ...
    "optab_handler (vec_realign_load_optab, $A)->insn_code = "
    "CODE_FOR_$(vec_realign_load_$a$)",
    "vcond_gen_code[$A] = CODE_FOR_$(vcond$a$)",
    "vcondu_gen_code[$A] = CODE_FOR_$(vcondu$a$)",
    "optab_handler (ssum_widen_optab, $A)->insn_code = "
    "CODE_FOR_$(widen_ssum$I$a3$)",
    "optab_handler (usum_widen_optab, $A)->insn_code = "
    "CODE_FOR_$(widen_usum$I$a3$)",
    "optab_handler (udot_prod_optab, $A)->insn_code = "
    "CODE_FOR_$(udot_prod$I$a$)",
    "optab_handler (sdot_prod_optab, $A)->insn_code = "
    "CODE_FOR_$(sdot_prod$I$a$)",
    "optab_handler (reduc_smax_optab, $A)->insn_code = "
    "CODE_FOR_$(reduc_smax_$a$)",
    "optab_handler (reduc_umax_optab, $A)->insn_code = "
    "CODE_FOR_$(reduc_umax_$a$)",
    "optab_handler (reduc_smin_optab, $A)->insn_code = "
    "CODE_FOR_$(reduc_smin_$a$)",
    "optab_handler (reduc_umin_optab, $A)->insn_code = "
    "CODE_FOR_$(reduc_umin_$a$)",
    "optab_handler (reduc_splus_optab, $A)->insn_code = "
    "CODE_FOR_$(reduc_splus_$a$)",
    "optab_handler (reduc_uplus_optab, $A)->insn_code = "
    "CODE_FOR_$(reduc_uplus_$a$)",
    "optab_handler (vec_widen_umult_hi_optab, $A)->insn_code = "
    "CODE_FOR_$(vec_widen_umult_hi_$a$)",
    "optab_handler (vec_widen_umult_lo_optab, $A)->insn_code = "
    "CODE_FOR_$(vec_widen_umult_lo_$a$)",
    "optab_handler (vec_widen_smult_hi_optab, $A)->insn_code = "
    "CODE_FOR_$(vec_widen_smult_hi_$a$)",
    "optab_handler (vec_widen_smult_lo_optab, $A)->insn_code = "
    "CODE_FOR_$(vec_widen_smult_lo_$a$)",
    "optab_handler (vec_unpacks_hi_optab, $A)->insn_code = "
    "CODE_FOR_$(vec_unpacks_hi_$a$)",
    "optab_handler (vec_unpacks_lo_optab, $A)->insn_code = "
    "CODE_FOR_$(vec_unpacks_lo_$a$)",
    "optab_handler (vec_unpacku_hi_optab, $A)->insn_code = "
    "CODE_FOR_$(vec_unpacku_hi_$a$)",
    "optab_handler (vec_unpacku_lo_optab, $A)->insn_code = "
    "CODE_FOR_$(vec_unpacku_lo_$a$)",
    "optab_handler (vec_unpacks_float_hi_optab, $A)->insn_code = "
    "CODE_FOR_$(vec_unpacks_float_hi_$a$)",
    "optab_handler (vec_unpacks_float_lo_optab, $A)->insn_code = "
    "CODE_FOR_$(vec_unpacks_float_lo_$a$)",
    "optab_handler (vec_unpacku_float_hi_optab, $A)->insn_code = "
    "CODE_FOR_$(vec_unpacku_float_hi_$a$)",
    "optab_handler (vec_unpacku_float_lo_optab, $A)->insn_code = "
    "CODE_FOR_$(vec_unpacku_float_lo_$a$)",
    "optab_handler (vec_pack_trunc_optab, $A)->insn_code = "
    "CODE_FOR_$(vec_pack_trunc_$a$)",
    "optab_handler (vec_pack_ssat_optab, $A)->insn_code = "
    "CODE_FOR_$(vec_pack_ssat_$a$)",
    "optab_handler (vec_pack_usat_optab, $A)->insn_code = "
    "CODE_FOR_$(vec_pack_usat_$a$)",
    "optab_handler (vec_pack_sfix_trunc_optab, $A)->insn_code = "
    "CODE_FOR_$(vec_pack_sfix_trunc_$a$)",
    "optab_handler (vec_pack_ufix_trunc_optab, $A)->insn_code = "
    "CODE_FOR_$(vec_pack_ufix_trunc_$a$)"};
          ...
          case 'b':
            ...
            for (i = (MAX_MACHINE_MODE)-1; i >= 0; i--) {
              ...
              if (*p == 0 &&
                  ...
                  (!force_partial_int || mode_class[i] == MODE_INT ||
                  ...
                  (!force_fixed || mode_class[i] == MODE_FRACT ||
