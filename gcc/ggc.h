...
#define ggc_alloc_rtvec(NELT)                                                 \
  ((rtvec)ggc_alloc_zone(sizeof(struct rtvec_def) + ((NELT)-1) * sizeof(rtx), \
                         &rtl_zone))
...
#define splay_tree_new_ggc(COMPARE)                                    \
  splay_tree_new_with_allocator(COMPARE, NULL, NULL, &ggc_splay_alloc, \
